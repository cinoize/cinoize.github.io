...
n.ng.ytVideo.module.directive(n.ng.ytVideo.DIRECTIVE_NAME,n.ng.ytVideo.directive);var ja={CHANGE:"change"},ka={LANG_SELECTOR:".h-c-footer__lang-dropdown"};function Y(a,c,d,e){function g(a){a=a.pop();var c=a.target.querySelector(".glue-zippy-toggle-all");if(c&&c.hasAttribute("data-g-action")){var e="expand all";0<a.oldValue.indexOf("glue-is-expanded")&&(e="collapse all");d(function(){c.setAttribute("data-g-action",e)},50)}}function h(a){a.forEach(function(a){var c=a.target;a=a.oldValue;if(null!==a&&c.hasAttribute("data-g-action")){var e="collapse";if(!0===a||"true"===a)e="expand";d(function(){c.setAttribute("data-g-action",e)},50)}})}var k=this;c.addEventListener("keydown",
function(a){27===(a.keyCode?a.keyCode:a.which)&&(a=document.querySelector(".gam-dt"))&&a.classList.contains("is-visible")&&k.toggleDecisionTreeVisibility(a.getAttribute("id"))});this.isShown_=!1;-1=="/about/small-business/ /about/small-business/index.html /intl/it/about/small-business/ /intl/it/about/small-business/index.html /intl/es/about/small-business/ /intl/es/about/small-business/index.html /intl/pt-BR_br/about/small-business/ /intl/pt-BR_br/about/small-business/index.html /intl/fr/about/small-business/ /intl/fr/about/small-business/index.html /intl/nl/about/small-business/ /intl/nl/about/small-business/index.html /intl/de/about/small-business/ /intl/de/about/small-business/index.html".split(" ").indexOf(c.location.pathname)||
c.sessionStorage.getItem("gmpButterbarShown")||(this.isShown_=!0);a=e[0].querySelector(".butterbar-top");var l=e[0].querySelector(".gmp-header__bar");e=e[0].querySelector(".butterbar-margin");this.isShown_&&(this.butterbarEl_=a,this.butterbarEl_.style.display="block",this.butterbarSibling_=l,this.mainContent_=e,setTimeout(function(){k.resizeButterbar_();k.butterbarEl_.style.transform="translate(0,0)"},100),c.addEventListener("resize",function(){k.onResize_()}));c=document.querySelectorAll(".h-c-expansion-panels__list");
e={attributes:!0,childList:!1,subtree:!0,attributeOldValue:!0,attributeFilter:["aria-expanded"]};for(a=0;a<c.length;a++)(new MutationObserver(h)).observe(c[a],e);c=document.querySelectorAll(".glue-zippy-set");e={attributes:!0,childList:!1,subtree:!1,attributeOldValue:!0,attributeFilter:["class"]};for(a=0;a<c.length;a++)(new MutationObserver(g)).observe(c[a],e);document.querySelectorAll("main.gmp-page article.gmp-section a:not([data-g-action])").forEach(function(a){a.setAttribute("target","_blank");
a.addEventListener("click",function(a){window.dataLayer.push({eventCategory:window.dataCategory,eventAction:"link: "+a.target.textContent.toLowerCase().replace(/[\-/]/g," ").replace(/%/g," percent").replace(/\&/g,"and").replace(/@/g,"at").replace(/[\\\^\$\*\?\.\(\)\|\{\}\[\]!,\u201c\u201d<>#\u2019"']/g,"").trim(),eventLabel:window.dataLabel,event:"trackEvent"})})});document.querySelectorAll("form").forEach(function(a){a.addEventListener("change",function(a){a=a.target;if("checkbox"!==a.type||a.checked)window.dataLayer.push({event:"trackEvent",
eventCategory:a.getAttribute("data-g-event"),eventAction:a.getAttribute("data-g-action"),eventLabel:a.getAttribute("data-g-label")});else return!1})});document.querySelectorAll('[data-g-event][data-g-action]:not(input):not(select):not(textarea):not([type="submit"])').forEach(function(a){a.addEventListener("click",function(){window.dataLayer.push({eventCategory:a.getAttribute("data-g-event"),eventAction:a.getAttribute("data-g-action"),eventLabel:a.getAttribute("data-g-label"),event:"trackEvent"})})})}
Y.prototype.closeBanner_=function(){this.isShown_=!1;this.butterbarEl_.style.display="none";this.butterbarSibling_&&(this.butterbarSibling_.style.top="0");this.mainContent_&&(this.mainContent_.style.marginTop=0);window.sessionStorage.setItem("gmpButterbarShown","false")};Y.prototype.onResize_=function(){var a=this;this.isShown_&&(clearTimeout(this.moveTimeout_),this.moveTimeout_=setTimeout(function(){a.resizeButterbar_()},100))};
Y.prototype.resizeButterbar_=function(){var a=this.butterbarEl_.offsetHeight+"px";this.butterbarSibling_.style.top=a;this.mainContent_.style.marginTop=a};Y.prototype.updateTree=function(a){this.decisionTree.submitUrl=null;this.decisionTree.nextLeaf=null;-1<a.indexOf("leaf_")?this.decisionTree.nextLeaf=a:0!==a.indexOf("step_")&&(this.decisionTree.submitUrl=a,delete this.treeFormData.step_2)};
...
c.target;c=e.dataset.dropdownTarget;if("undefined"!==typeof c&&""!==c){var e=d[0],h=a,k=e.querySelector(".dd-menu");k&&!k.classList.contains("visible")&&k.classList.add("visible");c!==h&&fa(e,h);ga(e,c);a=c}else{a:{for(c=e;c&&c!==document;c=c.parentNode)if(c.matches(".dd-menu"))break a;c=null}c||(a=ea(d[0]))}});d.on("mouseleave",function(){a=ea(d[0])})}}}).directive("gmpForm",["$http","$timeout",function(a,c){return{restrict:"A",require:"^form",link:function(d,e,g,h){function k(a){var c=[],d={},e;
...
a+'"]');return ia(a)}function m(a){a=h[a].$$attr.fbxId;return"undefined"!==typeof d.formData[a]&&""!==d.formData[a]}function v(){c(function(){var a=ia(h.$$element[0].querySelectorAll(".gmp-formfield__error:not(.ng-hide)"));a.length&&"function"===typeof a[0].scrollIntoView&&a[0].scrollIntoView({behavior:"smooth"})},270)}function C(a){return h.$$element[0].querySelector(".gmp-formfield--floating-label[data-field-name="+a+"]")}d.setFocus=function(a){C(a).classList.add("is-focused")};d.unsetFocus=function(a){C(a).classList.remove("is-focused")};
d.handleChange=function(a){var c=C(a);c&&(m(a)?c.classList.add("is-dirty"):c.classList.remove("is-dirty"));h[a].$setValidity("valid",!0);delete h[a].$error.invalid};d.toggleAllChoices=function(a){var c=h[a].$$attr.fbxId;d.handleChange(a);var e=d.formData[c].split(",").filter(function(a){return""!==a});a=l(c);var g=[],k=!0;e.length>=a.length&&(k=!1);for(e=0;e<a.length;e++)k&&g.push(a[e].value),a[e].checked=k;d.formData[c]=g.join(",")};d.areAllChoicesSelected=function(a){return!l(h[a].$$attr.fbxId).some(function(a){return!a.checked})};
d.toggleChoice=function(a,c){var e=h[a].$$attr.fbxId;d.handleChange(a);a=d.formData[e].split(",").filter(function(a){return""!==a});var g=a.indexOf(c);-1<g?a.splice(g,1):a.push(c);d.formData[e]=a.join(",")};d.submit=function(c){c.preventDefault();"undefined"!==typeof h.$error.failed_request&&delete h.$error.failed_request;h.$submitted=!0;if(h.$invalid)return v(),!1;var e=g.action,l=JSON.parse(JSON.stringify(d.formData));h.$pending=!0;a({method:"POST",url:e,data:k(l),headers:{"Content-Type":"application/x-www-form-urlencoded"}}).then(function(a){if("accepted"===
a.data.result)ha(c.target),window.location.href=g.redirect;else{var d=a.data.errors;h.$$controls.forEach(function(a){var c=a.$$attr.fbxId;d.hasOwnProperty(c)?(a.$error.invalid=d[c][0],a.$setValidity("valid",!1)):a.$setValidity("valid",!0);v();h.$pending=!1})}},function(){h.$error.failed_request=!0})};d.initForm=function(){"undefined"===typeof d.formData&&(d.formData={});h.$$controls.forEach(function(a){var c=a.$name,e=C(c);e&&!m(c)&&e.classList.remove("has-placeholder");a=a.$$attr.fbxId;c=l(a);0<
c.length&&(d.formData[a]=c.filter(function(a){return a.checked}).map(function(a){return a.value}).join(","))})};d.initForm()}}}]);n.app.bootstrap(ma.name);}).call(window)
