...
"username_color","username_hover_color","username_font","username_size","divider_type","link_color","link_hover_color","link_ticker_color","link_ticker_hover_color","font","font_option","font_size","text_color","time_color","time_font_size"],d;if(a){for(d=0;d<e.length;d++)a[e[d]]!==undefined&&c.add(e[d],a[e[d]]);if(a.style)for(d=0;d<f.length;d++)a.style[f[d]]!==undefined&&c.add(f[d],a.style[f[d]])}c.add("domain",document.domain);b.setAttribute("src","https://stocktwits.com/widgets/stream?"+c.toString());
document.getElementById(a.container||"stocktwits-widget").appendChild(b)}})();
