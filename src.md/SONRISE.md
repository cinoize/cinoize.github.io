...
<!-- saved from url=(0115)https://mail.google.com/mail/u/1/?ui=2&amp;ik=644623e632&amp;view=pt&amp;search=sent&amp;msg=15a13c644a7fefda&amp;siml=15a13c644a7fefda --><html data-inboxsdk-active-app-ids='[{"appId":"sdk_wordzen_7bc143d54d"},{"appId":"sdk_streak_21e9788951","version":"6.2934"}]' data-inboxsdk-app-logger-master-chosen="true" data-inboxsdk-last-event="1486400843216" data-inboxsdk-master-claimed="true" data-inboxsdk-session-id="1486400842497-0.5540190743292668" data-map-id="64e963ecbc3337a5" lang="en"><head data-inboxsdk-script-injected="true"><meta content="text/html; charset=utf-8" http-equiv="Content-Type" /><style type="text/css">
body,td,div,p,a,input {font-family: arial, sans-serif;}
</style><meta content="IE=edge" http-equiv="X-UA-Compatible" /><title>Ministry of Forbidden Knowledge Mail - Fwd: We are now approaching lunar *Sunrise, for everyone back on Earth... a message from the Heavens</title><style type="text/css">
...
.JCEBHBEHaadbcDAc &gt; .inboxsdk__close_button {
  position: absolute;
  bottom: 10px;
  right: 20px;
}
...
.eJAHAbcfbdBaaeBB {
  ...
  cursor: default;
   ...
   .dfbcABCfDFfFFJBH:not(.FcdIfGJEabcHIcFb) .eJAHAbcfbdBaaeBB {
     border-bottom: 1px solid #ddd;
   }

.dfbcABCfDFfFFJBH.fFcJGeddFCBJaaaJ .eJAHAbcfbdBaaeBB:hover,
.dfbcABCfDFfFFJBH.CbcdeabdeaaJBdIf .eJAHAbcfbdBaaeBB {
...
.dfbcABCfDFfFFJBH.fFcJGeddFCBJaaaJ .FbfbaJBFBIbHHdeG {
  cursor: move;
}
...
.JCEBHBEHaadbcDAc.BJGAfDcCEfGHeGcF .eJAHAbcfbdBaaeBB {
  display: none;
}

.dfbcABCfDFfFFJBH.fFcJGeddFCBJaaaJ .eJAHAbcfbdBaaeBB:hover .BDedcBfcIJabJDEe {
  position: absolute;
  top: 0px;
  left: 0px;
  width: 10px;
...
.dfbcABCfDFfFFJBH.fFcJGeddFCBJaaaJ .fadAbCABGJIBEabE {
  visibility: visible;
  cursor: pointer;
}
...
.eJAHAbcfbdBaaeBB:hover .JdJDHEcJHeeDabJb,
.dfbcABCfDFfFFJBH.CbcdeabdeaaJBdIf .eJAHAbcfbdBaaeBB .JdJDHEcJHeeDabJb {
  opacity: .9;
}

.dfbcABCfDFfFFJBH.FcdIfGJEabcHIcFb .JdJDHEcJHeeDabJb {
...
.inboxsdk__tab.BJGAfDcCEfGHeGcF:first-child:last-child {
  display: none;
}
...
.dEIHfEAdBIAdfFIf div[role=complementary] {
  position: static !important;
...
.JCEBHBEHaadbcDAc.BJGAfDcCEfGHeGcF .EDGEbdaDcHAAHBfC {
  padding-top: 0;
}
