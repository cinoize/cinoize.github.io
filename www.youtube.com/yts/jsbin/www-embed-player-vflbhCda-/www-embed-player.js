...
qb.prototype.K=!0;qb.prototype.I=function(){return this.b};
...
var vb=/^(?:(?:https?|mailto|ftp):|[^:/?#]*(?:[/?#]|$))/i;function wb(a){if(a instanceof E)return a;a=a.K?a.I():String(a);vb.test(a)||(a="about:invalid#zClosurez");return xb(a)}
var tb={};function xb(a){var b=new E;b.b=a;return b}
xb("about:blank");function yb(){this.ea="";this.wa=zb;this.b=null}
yb.prototype.fa=!0;yb.prototype.aa=function(){return this.b};
yb.prototype.K=!0;yb.prototype.I=function(){return this.ea};
...
function Cb(a,b,c){a.rel=c;a.href=-1!=c.toLowerCase().indexOf("stylesheet")?sb(b):b instanceof qb?sb(b):b instanceof E?ub(b):wb(b).I()}
...
function Hb(a,b){Ua(b,function(b,d){b&&b.K&&(b=b.I());"style"==d?a.style.cssText=b:"class"==d?a.className=b:"for"==d?a.htmlFor=b:Ib.hasOwnProperty(d)?a.setAttribute(Ib[d],b):0==d.lastIndexOf("aria-",0)||0==d.lastIndexOf("data-",0)?a.setAttribute(d,b):a[d]=b})}
...
for(var e=[],f=[],g=[],h=[128],l=1;64>l;++l)h[l]=0;var m,u;a();return{reset:a,update:c,digest:d,za:function(){for(var a=d(),b="",c=0;c<a.length;c++)b+="0123456789ABCDEF".charAt(Math.floor(a[c]/16))+"0123456789ABCDEF".charAt(a[c]%16);return b}}}
...
function Xb(a){var b=Vb();b.update(a);return b.za().toLowerCase()}
...
rc.prototype.digest=function(){var a=[],b=8*this.i;56>this.h?this.update(this.g,56-this.h):this.update(this.g,this.f-(this.h-56));for(var c=this.f-1;56<=c;c--)this.j[c]=b&255,b/=256;sc(this,this.j);for(c=b=0;5>c;c++)for(var d=24;0<=d;d-=8)a[b]=this.b[c]>>d&255,++b;return a};function G(){this.h=this.h;this.C=this.C}
G.prototype.h=!1;G.prototype.dispose=function(){this.h||(this.h=!0,this.m())};
function tc(a,b){a.h?q(void 0)?b.call(void 0):b():(a.C||(a.C=[]),a.C.push(q(void 0)?x(b,void 0):b))}
...
Ac.prototype.F=function(){return this};
function Bc(a){if(a instanceof Ac)return a;if("function"==typeof a.F)return a.F(!1);if(pa(a)){var b=0,c=new Ac;c.next=function(){for(;;){if(b>=a.length)throw zc;if(b in a)return a[b++];b++}};
...
k.F=function(a){Gc(this);var b=0,c=this.g,d=this,e=new Ac;e.next=function(){if(c!=d.g)throw Error("The map has changed since the iterator was created");if(b>=d.b.length)throw zc;var e=d.b[b++];return a?e:d.h[e]};
...
function Yc(a){return new H(function(b){var c=a.length,d=[];if(c)for(var e=function(a,e,f){c--;d[a]=e?{Z:!0,value:f}:{Z:!1,reason:f};0==c&&b(d)},f=0,g;f<a.length;f++)g=a[f],Vc(g,y(e,f,!0),y(e,f,!1));
else b(d)})}
...
function gd(a){a.j||(a.j=!0,ic(a.C,a))}
function ed(a){var b=null;a.f&&(b=a.f,a.f=b.next,b.next=null);a.f||(a.g=null);return b}
H.prototype.C=function(){for(var a;a=ed(this);)fd(this,a,this.b,this.l);this.j=!1};
...
function ld(a,b,c,d){if(b=a.f[b]){var e=a.b;(b=Aa(b,function(a){return e[a+1]==c&&e[a+2]==d}))&&a.L(b)}}
k.L=function(a){var b=this.b[a];if(b){var c=this.f[b];0!=this.i?(this.g.push(a),this.b[a+1]=ma):(c&&Ba(c,a),delete this.b[a],delete this.b[a+1],delete this.b[a+2])}return!!b};
...
k.clear=function(a){if(a){var b=this.f[a];b&&(C(b,this.L,this),delete this.f[a])}else this.b.length=0,this.f={}};
...
A(sd,rd);function td(){}
;function ud(){}
A(ud,td);ud.prototype.clear=function(){var a=Dc(this.F(!0)),b=this;C(a,function(a){b.remove(a)})};function vd(a){this.b=a}
...
k.F=function(a){var b=0,c=this.b,d=new Ac;d.next=function(){if(b>=c.length)throw zc;var d=c.key(b++);if(a)return d;d=c.getItem(d);if(!r(d))throw"Storage mechanism: Invalid value was encountered";return d};
return d};
...
k.F=function(a){var b=0,c=this.b.XMLDocument.documentElement.attributes,d=new Ac;d.next=function(){if(b>=c.length)throw zc;var d=c[b++];if(a)return decodeURIComponent(d.nodeName.replace(/\./g,"%")).substr(1);d=d.nodeValue;if(!r(d))throw"Storage mechanism: Invalid value was encountered";return d};
return d};
...
Dd.prototype.F=function(a){var b=this.f.F(!0),c=this,d=new Ac;d.next=function(){for(var d=b.next();d.substr(0,c.b.length)!=c.b;)d=b.next();return a?d.substr(c.b.length):c.f.get(d)};
...
Ra:function(){L[8]++},
Sa:function(){0<L[8]&&L[8]--},
Ta:function(){L[8]=0},
shouldRetry:function(){return!1},
na:function(){return L[5]},
la:function(a){try{a()}catch(b){p.setTimeout(function(){throw b;},0)}},
ja:function(){if(!N.da()){var a=p.document,b=function(b){b=Rd(b);a:{try{var c=Qb();break a}catch(h){}c=void 0}var d=c;Md(a,b,d);c=a.createElement("script");c.type="text/javascript";d&&(c.nonce=d);c.onerror=function(){return p.processGoogleToken({},2)};
b=Nb(b);Db(c,b);try{(a.head||a.body||a.documentElement).appendChild(c),N.Ra()}catch(h){}},c=L[1];
b(c);".google.com"!=c&&b(".google.com");b={};var d=(b.newToken="FBT",b);p.setTimeout(function(){return p.processGoogleToken(d,1)},1E3)}}};
function Ud(a){Sd();var b=Qd.googleToken[5]||0;a&&(0!=b||K[3]>=z()?N.la(a):(N.na().push(a),N.ja()));K[3]>=z()&&K[2]>=z()||N.ja()}
function Vd(a){p.processGoogleToken=p.processGoogleToken||function(a,c){var b=a,e=c;b=void 0===b?{}:b;e=void 0===e?0:e;var f=b.newToken||"",g="NT"==f,h=parseInt(b.freshLifetimeSecs||"",10),l=parseInt(b.validLifetimeSecs||"",10);g&&!l&&(l=3600);var m=b["1p_jar"]||"";b=b.pucrd||"";Sd();1==e?N.Ta():N.Sa();if(!f&&N.shouldRetry())Pd(".google.com")&&(L[1]=".google.com"),N.ja();else{var u=Qd.googleToken=Qd.googleToken||{},M=0==e&&f&&r(f)&&!g&&la(h)&&0<h&&la(l)&&0<l&&r(m);g=g&&!N.da()&&(!(K[3]>=z())||"NT"==
K[1]);var Z=!(K[3]>=z())&&0!=e;if(M||g||Z)g=z(),h=g+1E3*h,l=g+1E3*l,1E-5>Math.random()&&(g="https://pagead2.googlesyndication.com/pagead/gen_204?id=imerr&err="+e,p.google_image_requests||(p.google_image_requests=[]),Z=p.document.createElement("img"),Z.src=g,p.google_image_requests.push(Z)),u[5]=e,u[1]=f,u[2]=h,u[3]=l,u[4]=m,u[6]=b,Sd();if(M||!N.da()){e=N.na();for(f=0;f<e.length;f++)N.la(e[f]);e.length=0}}};
Ud(a)}
...
function Ke(a,b){if(window.fetch&&"XML"!=b.format){var c={method:b.method||"GET",credentials:"same-origin"};b.headers&&(c.headers=b.headers);a=Le(a,b);var d=Me(a,b);d&&(c.body=d);b.withCredentials&&(c.credentials="include");var e=!1,f;fetch(a,c).then(function(a){if(!e){e=!0;f&&ee(f);var c=a.ok,d=function(d){d=d||{};var e=b.context||p;c?b.A&&b.A.call(e,d,a):b.onError&&b.onError.call(e,d,a);b.ia&&b.ia.call(e,d,a)};
"JSON"==(b.format||"JSON")&&(c||400<=a.status&&500>a.status)?a.json().then(d,function(){d(null)}):d(null)}});
b.pa&&0<b.timeout&&(f=U(function(){e||(e=!0,ee(f),b.pa.call(b.context||p))},b.timeout))}else Ne(a,b)}
function Ne(a,b){var c=b.format||"JSON";a=Le(a,b);var d=Me(a,b),e=!1,f,g=Oe(a,function(a){if(!e){e=!0;f&&ee(f);var d=Fe(a),g=null;if(d||400<=a.status&&500>a.status)g=Pe(c,a,b.ib);if(d)a:if(a&&204==a.status)d=!0;else{switch(c){case "XML":d=0==parseInt(g&&g.return_code,10);break a;case "RAW":d=!0;break a}d=!!g}g=g||{};var h=b.context||p;d?b.A&&b.A.call(h,a,g):b.onError&&b.onError.call(h,a,g);b.ia&&b.ia.call(h,a,g)}},b.method,d,b.headers,b.responseType,b.withCredentials);
b.M&&0<b.timeout&&(f=U(function(){e||(e=!0,g.abort(),ee(f),b.M.call(b.context||p,g))},b.timeout));
return g}
function Le(a,b){b.Ea&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var c=Q("XSRF_FIELD_NAME",void 0),d=b.eb;if(d){d[c]&&delete d[c];d=d||{};var e=a.split("#",2);c=e[0];e=1<e.length?"#"+e[1]:"";var f=c.split("?",2);c=f[0];f=Ge(f[1]||"");for(var g in d)f[g]=d[g];a=Kd(c,f)+e}return a}
function Me(a,b){var c=Q("XSRF_FIELD_NAME",void 0),d=Q("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.B,g=Yd("XSRF_FIELD_NAME"),h;b.headers&&(h=b.headers["Content-Type"]);b.jb||Hd(J(a)[3]||null)&&!b.withCredentials&&Hd(J(a)[3]||null)!=document.location.hostname||"POST"!=b.method||h&&"application/x-www-form-urlencoded"!=h||b.B&&b.B[g]||(f||(f={}),f[c]=d);f&&r(e)&&(e=Ge(e),bb(e,f),e=b.qa&&"JSON"==b.qa?JSON.stringify(e):Jd(e));f=e||f&&!Ya(f);!Ie&&f&&"POST"!=b.method&&(Ie=!0,R(Error("AJAX request with postData should use POST")));
return e}
...
return b}
function Te(a,b){b.method="POST";b.B||(b.B={});Ne(a,b)}
...
;var Ue={},Ve=0;
function We(a,b,c,d,e){e=void 0===e?"":e;a&&(c&&(c=Pa,c=!(c&&0<=c.toLowerCase().indexOf("cobalt"))),c?a&&(a instanceof E||(a=a.K?a.I():String(a),vb.test(a)||(a="about:invalid#zClosurez"),a=xb(a)),b=ub(a),"about:invalid#zClosurez"===b?a="":(b instanceof yb?a=b:(a=null,b.fa&&(a=b.aa()),b=Ga(b.K?b.I():String(b)),a=Ab(b,a)),a=encodeURIComponent(String(Ic(a instanceof yb&&a.constructor===yb&&a.wa===zb?a.ea:"type_error:SafeHtml")))),/^[\s\xa0]*$/.test(a)||(a=Jb("IFRAME",{src:'javascript:"<body><img src=\\""+'+a+
...
e;h={eb:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,1E3),line:h,level:b,"client.name":f.name},B:{url:Q("PAGE_NAME",window.location.href),file:a.fileName},method:"POST"};f.version&&(h["client.version"]=f.version);l&&(h.B.stack=l);for(var m in f)h.B["client."+m]=f[m];if(m=Q("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(var u in m)h.B[u]=m[u];Ne(Q("ECATCHER_REPORT_HOST","")+"/error_204",h);Ye[a.message]=!0;Ze++}}}
...
;function uf(a){this.o=a;this.b=null;this.i=0;this.l=null;this.j=0;this.f=[];for(a=0;4>a;a++)this.f.push(0);this.g=0;this.D=V(window,"mousemove",x(this.G,this));a=x(this.w,this);qa(a)&&(a=$d(a));this.H=window.setInterval(a,25)}
A(uf,G);uf.prototype.G=function(a){q(a.b)||qf(a);var b=a.b;q(a.f)||qf(a);this.b=new Eb(b,a.f)};
...
uf.prototype.m=function(){window.clearInterval(this.H);tf(this.D)};var vf={};function wf(a){var b=void 0===a?{}:a;a=void 0===b.Fa?!0:b.Fa;b=void 0===b.Pa?!1:b.Pa;if(null==v("_lact",window)){var c=parseInt(Q("LACT"),10);c=isFinite(c)?z()-Math.max(c,0):-1;t("_lact",c,window);t("_fact",c,window);-1==c&&xf();V(document,"keydown",xf);V(document,"keyup",xf);V(document,"mousedown",xf);V(document,"mouseup",xf);a&&(b?V(window,"touchmove",function(){yf("touchmove",200)}):(V(window,"resize",function(){yf("resize",200)}),V(window,"scroll",function(){yf("scroll",200)})));
...
t("ytytLoggingTransportCapturedTime_",v("ytLoggingTransportCapturedTime_")||{},void 0);function Hf(a,b){if(a.W){var c=a.W;var d={};c.videoId?d.videoId=c.videoId:c.playlistId&&(d.playlistId=c.playlistId);Ff[a.W.token]=d;c=If(a.endpoint,a.W.token)}else c=If(a.endpoint);c.push(a.payload);Df[a.endpoint]=new b;c.length>=(Number(S("web_logging_max_batch")||0)||20)?Jf():Kf()}
function Jf(){ee(Ef);if(!Ya(W)){for(var a in W){var b=Df[a];if(b){var c=void 0,d=a,e=b,f=Bf[d],g=Gf[d]||{};Gf[d]=g;b=Math.round(O());for(c in W[d]){var h=e.b;h={client:{hl:h.Ia,gl:h.Ha,clientName:h.Ga,clientVersion:h.innertubeContextClientVersion}};var l=window.devicePixelRatio;l&&1!=l&&(h.client.screenDensityFloat=String(l));Q("DELEGATED_SESSION_ID")&&(h.user={onBehalfOfUser:Q("DELEGATED_SESSION_ID")});h={context:h};h[f]=If(d,c);g.dispatchedEventCount=g.dispatchedEventCount||0;g.dispatchedEventCount+=
...
;function Mf(a,b,c,d){var e=Nf,f={};f.eventTimeMs=Math.round(c||O());f[a]=b;f.context={lastActivityMs:String(c?-1:zf())};Hf({endpoint:"log_event",payload:f,W:d},e)}
...
function Pf(a){var b={"X-Goog-Visitor-Id":Q("VISITOR_DATA","")},c;a?c="Bearer "+v("gapi.auth.getToken")().fb:c=$b([]);c&&(b.Authorization=c,b["X-Goog-AuthUser"]=Q("SESSION_INDEX",0));return b}
...
;function Nf(a){var b=this;this.b=a||{innertubeApiKey:Yd("INNERTUBE_API_KEY"),innertubeApiVersion:Yd("INNERTUBE_API_VERSION"),Ga:Q("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),innertubeContextClientVersion:Yd("INNERTUBE_CONTEXT_CLIENT_VERSION"),Ia:Yd("INNERTUBE_CONTEXT_HL"),Ha:Yd("INNERTUBE_CONTEXT_GL"),Ja:Yd("INNERTUBE_HOST_OVERRIDE")||"",Ka:!!Q("INNERTUBE_USE_THIRD_PARTY_AUTH",!1)};df(function(){Wf(b)})}
function Lf(a,b,c,d){!Q("VISITOR_DATA")&&.01>Math.random()&&R(Error("Missing VISITOR_DATA when sending innertube request."),"WARNING");var e={headers:{"Content-Type":"application/json"},method:"POST",B:c,qa:"JSON",M:function(){d.M()},
pa:d.M,A:function(a,b){d.A&&d.A(b)},
oa:function(a){d.A&&d.A(a)},
onError:function(a,b){if(d.onError)d.onError(b)},
kb:function(a){if(d.onError)d.onError(a)},
timeout:d.timeout,withCredentials:!0},f=a.b.Ka||!1,g=Pf(f);Object.assign(e.headers,g);var h="",l=a.b.Ja;l&&(h=l);e.headers.Authorization&&!h&&(e.headers["x-origin"]=window.location.origin);h=""+h+Of(a.b.innertubeApiVersion,b,c)+"?alt=json&key="+a.b.innertubeApiKey;var m;if(d.retry&&S("retry_web_logging_batches")&&(m=Uf(b,c,g,f))){var u=e.A,M=e.oa;e.A=function(a,b){Vf(m);u(a,b)};
c.oa=function(a,b){Vf(m);M(a,b)}}try{S("use_fetch_for_op_xhr")?Ke(h,e):Te(h,e)}catch(Z){if("InvalidAccessError"==Z)m&&(Vf(m),m=0),R(Error("An extension is blocking network request."),"WARNING");
...
n(lg,G);lg.prototype.m=function(){for(;this.b.length;){var a=this.b.pop();a.target.removeEventListener(a.name,a.hb)}G.prototype.m.call(this)};var mg=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function ng(a){a=a||"";if(window.spf){var b=a.match(mg);spf.style.load(a,b?b[1]:"",void 0)}else og(a)}
...
wg.prototype.toString=function(){return this.topic};var xg=v("ytPubsub2Pubsub2Instance")||new I;I.prototype.subscribe=I.prototype.subscribe;I.prototype.unsubscribeByKey=I.prototype.L;I.prototype.publish=I.prototype.J;I.prototype.clear=I.prototype.clear;t("ytPubsub2Pubsub2Instance",xg,void 0);t("ytPubsub2Pubsub2SubscribedKeys",v("ytPubsub2Pubsub2SubscribedKeys")||{},void 0);t("ytPubsub2Pubsub2TopicToKeys",v("ytPubsub2Pubsub2TopicToKeys")||{},void 0);t("ytPubsub2Pubsub2IsAsync",v("ytPubsub2Pubsub2IsAsync")||{},void 0);
...
;function $g(a,b){G.call(this);this.l=this.T=a;this.H=b;this.o=!1;this.f={};this.R=this.G=null;this.w=new I;tc(this,y(uc,this.w));this.i={};this.O=this.S=this.g=this.Y=this.b=null;this.N=!1;this.j=this.D=null;this.U={};this.ua=["onReady"];this.X=null;this.ka=NaN;this.P={};ah(this);this.V("WATCH_LATER_VIDEO_ADDED",this.Ma.bind(this));this.V("WATCH_LATER_VIDEO_REMOVED",this.Na.bind(this));this.V("onAdAnnounce",this.ya.bind(this));this.va=new lg(this);tc(this,y(uc,this.va))}
n($g,G);k=$g.prototype;
k.ha=function(a){if(!this.h){a instanceof ig||(a=new ig(a));this.Y=a;this.b=a.clone();this.g=this.b.attrs.id||this.g;"video-player"==this.g&&(this.g=this.H,this.b.attrs.id=this.H);this.l.id==this.g&&(this.g+="-player",this.b.attrs.id=this.g);this.b.args.enablejsapi="1";this.b.args.playerapiid=this.H;this.S||(this.S=bh(this,this.b.args.jsapicallback||"onYouTubePlayerReady"));this.b.args.jsapicallback=null;if(a=this.b.attrs.width)this.l.style.width=Sb(Number(a)||a);if(a=this.b.attrs.height)this.l.style.height=Sb(Number(a)||
...
function ch(a){if(!a.h&&!a.N){var b=eh(a);if(b&&"html5"==(fh(a)?"html5":null))a.O="html5",a.o||gh(a);else if(hh(a),a.O="html5",b&&a.j)a.T.appendChild(a.j),gh(a);else{a.b.loaded=!0;var c=!1;a.D=function(){c=!0;var b=a.b.clone();v("yt.player.Application.create")(a.T,b);gh(a)};
a.N=!0;b?a.D():(re(a.b.assets.js,a.D),ng(a.b.assets.css),ih(a)&&!c&&t("yt.player.Application.create",null,void 0))}}}
function fh(a){var b=Gb(a.g);!b&&a.l&&a.l.querySelector&&(b=a.l.querySelector("#"+a.g));return b}
function gh(a){if(!a.h){var b=fh(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.N=!1,b.isNotServable&&b.isNotServable(a.b.args.video_id)||jh(a)):a.ka=U(function(){gh(a)},50)}}
function jh(a){ah(a);a.o=!0;var b=fh(a);b.addEventListener&&(a.G=kh(a,b,"addEventListener"));b.removeEventListener&&(a.R=kh(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.f[e]||(a.f[e]=kh(a,b,e))}for(var f in a.i)a.G(f,a.i[f]);dh(a);a.S&&a.S(a.f);a.w.J("onReady",a.f)}
function kh(a,b,c){var d=b[c];return function(){try{return a.X=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.X=e,R(e,"WARNING",void 0,void 0,void 0))}}}
function ah(a){a.o=!1;if(a.R)for(var b in a.i)a.R(b,a.i[b]);for(var c in a.P)ee(parseInt(c,10));a.P={};a.G=null;a.R=null;for(var d in a.f)a.f[d]=null;a.f.addEventListener=a.V.bind(a);a.f.removeEventListener=a.Ua.bind(a);a.f.destroy=a.dispose.bind(a);a.f.getLastError=a.Ca.bind(a);a.f.getPlayerType=a.Da.bind(a);a.f.getCurrentVideoConfig=a.Ba.bind(a);a.f.loadNewVideoConfig=a.ha.bind(a);a.f.isReady=a.La.bind(a)}
k.La=function(){return this.o};
k.V=function(a,b){var c=this,d=bh(this,b);if(d){if(!(0<=xa(this.ua,a)||this.i[a])){var e=lh(this,a);this.G&&this.G(a,e)}this.w.subscribe(a,d);"onReady"==a&&this.o&&U(function(){d(c.f)},0)}};
k.Ua=function(a,b){if(!this.h){var c=bh(this,b);c&&ld(this.w,a,c)}};
function bh(a,b){var c=b;if("string"==typeof b){if(a.U[b])return a.U[b];c=function(){var a=v(b);a&&a.apply(p,arguments)};
a.U[b]=c}return c?c:null}
function lh(a,b){var c="ytPlayer"+b+a.H;a.i[b]=c;p[c]=function(c){var d=a.b&&a.b.args&&a.b.args.fflags;if(d&&0>d.indexOf("use_html5_player_event_timeout=true"))a.w.J(b,c);else{var f=U(function(){if(!a.h){a.w.J(b,c);var d=a.P,e=String(f);e in d&&delete d[e]}},0);
Za(a.P,String(f))}};
return c}
k.ya=function(a){me("a11y-announce",a)};
k.Ma=function(a){me("WATCH_LATER_VIDEO_ADDED",a)};
k.Na=function(a){me("WATCH_LATER_VIDEO_REMOVED",a)};
k.Da=function(){return this.O||(fh(this)?"html5":null)};
k.Ca=function(){return this.X};
function hh(a){Mg("dcp");a.cancel();ah(a);a.O=null;a.b&&(a.b.loaded=!1);var b=fh(a);b&&(eh(a)||!ih(a)?a.j=b:(b&&b.destroy&&b.destroy(),a.j=null));for(a=a.T;b=a.firstChild;)a.removeChild(b)}
k.cancel=function(){this.D&&xe(this.b.assets.js,this.D);ee(this.ka);this.N=!1};
k.m=function(){hh(this);if(this.j&&this.b&&this.j.destroy)try{this.j.destroy()}catch(b){R(b)}this.U=null;for(var a in this.i)p[this.i[a]]=null;this.Y=this.b=this.f=null;delete this.T;delete this.l;G.prototype.m.call(this)};
function ih(a){return a.b&&a.b.args&&a.b.args.fflags?-1!=a.b.args.fflags.indexOf("player_destroy_old_version=true"):!1}
;var mh={},nh="player_uid_"+(1E9*Math.random()>>>0);function oh(a){var b="player";b=r(b)?Gb(b):b;var c=nh+"_"+(b[sa]||(b[sa]=++ta)),d=mh[c];if(d)return d.ha(a),d.f;d=new $g(b,c);mh[c]=d;me("player-added",d.f);tc(d,y(ph,d));U(function(){d.ha(a)},0);
return d.f}
function ph(a){delete mh[a.H]}
...
;function yh(a){G.call(this);this.b=a;this.b.subscribe("command",this.ra,this);this.f={};this.i=!1}
A(yh,G);k=yh.prototype;k.start=function(){this.i||this.h||(this.i=!0,zh(this.b,"RECEIVING"))};
k.ra=function(a,b,c){if(this.i&&!this.h){var d=b||{};switch(a){case "addEventListener":r(d.event)&&(a=d.event,a in this.f||(c=x(this.Wa,this,a),this.f[a]=c,this.addEventListener(a,c)));break;case "removeEventListener":r(d.event)&&Ah(this,d.event);break;default:this.g.isReady()&&this.g[a]&&(b=Bh(a,b||{}),c=this.g.handleExternalCall(a,b,c||null),(c=Ch(a,c))&&this.i&&!this.h&&zh(this.b,a,c))}}};
k.Wa=function(a,b){this.i&&!this.h&&zh(this.b,a,this.ba(a,b))};
k.ba=function(a,b){if(null!=b)return{value:b}};
function Ah(a,b){b in a.f&&(a.removeEventListener(b,a.f[b]),delete a.f[b])}
k.m=function(){var a=this.b;a.h||ld(a.b,"command",this.ra,this);this.b=null;for(var b in this.f)Ah(this,b);yh.u.m.call(this)};function Dh(a,b){yh.call(this,b);this.g=a;this.start()}
...
Dh.prototype.ba=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return Dh.u.ba.call(this,a,b)};
Dh.prototype.m=function(){Dh.u.m.call(this);delete this.g};function Eh(a,b,c,d){G.call(this);this.f=b||null;this.o="*";this.g=c||null;this.sessionId=null;this.channel=d||null;this.D=!!a;this.l=x(this.w,this);window.addEventListener("message",this.l)}
...
n(Fh,Eh);function Gh(){var a=this.f=new Fh(!!Q("WIDGET_ID_ENFORCE")),b=x(this.Qa,this);a.i=b;a.j=null;this.f.channel="widget";if(a=Q("WIDGET_ID"))this.f.sessionId=a;this.g=[];this.j=!1;this.i={}}
k=Gh.prototype;k.Qa=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.i[a]||"onReady"==a||(this.addEventListener(a,Hh(this,a)),this.i[a]=!0)):this.ta(a,b,c)};
k.ta=function(){};
function Hh(a,b){return x(function(a){this.sendMessage(b,a)},a)}
k.addEventListener=function(){};
k.Aa=function(){this.j=!0;this.sendMessage("initialDelivery",this.ca());this.sendMessage("onReady");C(this.g,this.sa,this);this.g=[]};
k.ca=function(){return null};
function Ih(a,b){a.sendMessage("infoDelivery",b)}
k.sa=function(a){this.j?this.f.sendMessage(a):this.g.push(a)};
k.sendMessage=function(a,b){this.sa({event:a,info:void 0==b?null:b})};
k.dispose=function(){this.f=null};function Jh(a){Gh.call(this);this.b=a;this.h=[];this.addEventListener("onReady",x(this.Oa,this));this.addEventListener("onVideoProgress",x(this.ab,this));this.addEventListener("onVolumeChange",x(this.bb,this));this.addEventListener("onApiChange",x(this.Va,this));this.addEventListener("onPlaybackQualityChange",x(this.Xa,this));this.addEventListener("onPlaybackRateChange",x(this.Ya,this));this.addEventListener("onStateChange",x(this.Za,this));this.addEventListener("onWebglSettingsChanged",x(this.cb,
this))}
A(Jh,Gh);k=Jh.prototype;k.ta=function(a,b,c){if(this.b[a]){b=b||[];if(0<b.length&&th(a)){var d=b;if(ra(d[0])&&!w(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=vh.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=uh.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=wh.apply(window,d)}d=e}xh(d);b.length=1;b[0]=d}this.b.handleExternalCall(a,b,c);th(a)&&Ih(this,this.ca())}};
k.Oa=function(){var a=x(this.Aa,this);this.f.b=a};
k.addEventListener=function(a,b){this.h.push({eventType:a,listener:b});this.b.addEventListener(a,b)};
k.ca=function(){if(!this.b)return null;var a=this.b.getApiInterface();Ba(a,"getVideoData");for(var b={apiInterface:a},c=0,d=a.length;c<d;c++){var e=a[c],f=e;if(0==f.search("get")||0==f.search("is")){f=e;var g=0;0==f.search("get")?g=3:0==f.search("is")&&(g=2);f=f.charAt(g).toLowerCase()+f.substr(g+1);try{var h=this.b[e]();b[f]=h}catch(l){}}}b.videoData=this.b.getVideoData();b.currentTimeLastUpdated_=z()/1E3;return b};
k.Za=function(a){a={playerState:a,currentTime:this.b.getCurrentTime(),duration:this.b.getDuration(),videoData:this.b.getVideoData(),videoStartBytes:0,videoBytesTotal:this.b.getVideoBytesTotal(),videoLoadedFraction:this.b.getVideoLoadedFraction(),playbackQuality:this.b.getPlaybackQuality(),availableQualityLevels:this.b.getAvailableQualityLevels(),videoUrl:this.b.getVideoUrl(),playlist:this.b.getPlaylist(),playlistIndex:this.b.getPlaylistIndex(),currentTimeLastUpdated_:z()/1E3,playbackRate:this.b.getPlaybackRate(),
...
k.Xa=function(a){Ih(this,{playbackQuality:a})};
k.Ya=function(a){Ih(this,{playbackRate:a})};
k.Va=function(){for(var a=this.b.getOptions(),b={namespaces:a},c=0,d=a.length;c<d;c++){var e=a[c],f=this.b.getOptions(e);b[e]={options:f};for(var g=0,h=f.length;g<h;g++){var l=f[g],m=this.b.getOption(e,l);b[e][l]=m}}this.sendMessage("apiInfoDelivery",b)};
k.bb=function(){Ih(this,{muted:this.b.isMuted(),volume:this.b.getVolume()})};
k.ab=function(a){a={currentTime:a,videoBytesLoaded:this.b.getVideoBytesLoaded(),videoLoadedFraction:this.b.getVideoLoadedFraction(),currentTimeLastUpdated_:z()/1E3,playbackRate:this.b.getPlaybackRate(),mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());Ih(this,a)};
k.cb=function(){if(this.b.getSphericalProperties){var a={sphericalProperties:this.b.getSphericalProperties()};Ih(this,a)}};
...
Kh.prototype.j=function(a,b){this.h||this.b.J.apply(this.b,arguments)};function Lh(a,b,c){Kh.call(this);this.f=a;this.g=b;this.i=c}
...
Mh.prototype.m=function(){tf(this.i);this.b=null;Mh.u.m.call(this)};function Nh(){var a=$a(Oh),b;return bd(new H(function(c,d){a.A=function(a){Fe(a)?c(a):d(new Ph("Request failed, status="+a.status,"net.badstatus",a))};
a.onError=function(a){d(new Ph("Unknown request error","net.unknown",a))};
a.M=function(a){d(new Ph("Request timed out","net.timeout",a))};
...
;function di(a){if("1"!==Va(Zd(),"args","privembed")){a&&(v("yt.ads.biscotti.getId_")||wa("yt.ads.biscotti.getId_",Wh));try{var b=ai();if(S("enable_yuzu")){v("yt.ads.yuzu.getId_")||t("yt.ads.yuzu.getId_",ci,void 0);try{var c=v("yt.ads.yuzu.getId_")()}catch(d){c=Uc(d)}}else c=Uc(new bi("unimplemented"));Yc([b,c]).then(function(a){var b=a[0];a=a[1];if(b.Z||a.Z){b=b.value;a=a.value;var c={};c.dt=Tb;c.flash="0";a:{try{var d=window.top.location.href}catch(Sa){d=2;break a}d=null!=d?d==window.document.location.href?
