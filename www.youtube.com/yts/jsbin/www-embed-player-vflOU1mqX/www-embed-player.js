...
if("function"==typeof Object.setPrototypeOf)ea=Object.setPrototypeOf;else{var fa;a:{var ha={qa:!0},ia={};try{ia.__proto__=ha;fa=ia.qa;break a}catch(a){}fa=!1}ea=fa?function(a,b){a.__proto__=b;if(a.__proto__!==b)throw new TypeError(a+" is not extensible");return a}:null}var ja=ea;
...
c.prototype=b.prototype;a.A=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.gb=function(a,c,f){for(var d=Array(arguments.length-2),e=2;e<arguments.length;e++)d[e-2]=arguments[e];return b.prototype[c].apply(a,d)}}
...
A(C,Error);C.prototype.name="CustomError";var Ia=Array.prototype.indexOf?function(a,b){return Array.prototype.indexOf.call(a,b,void 0)}:function(a,b){if(t(a))return t(b)&&1==b.length?a.indexOf(b,0):-1;
...
function Ra(a){if(!Sa.test(a))return a;-1!=a.indexOf("&")&&(a=a.replace(Ta,"&amp;"));-1!=a.indexOf("<")&&(a=a.replace(Ua,"&lt;"));-1!=a.indexOf(">")&&(a=a.replace(Va,"&gt;"));-1!=a.indexOf('"')&&(a=a.replace(Wa,"&quot;"));-1!=a.indexOf("'")&&(a=a.replace(Ya,"&#39;"));-1!=a.indexOf("\x00")&&(a=a.replace(Za,"&#0;"));return a}
var Ta=/&/g,Ua=/</g,Va=/>/g,Wa=/"/g,Ya=/'/g,Za=/\x00/g,Sa=/[\x00&<>"']/;function $a(a){for(var b=0,c=0;c<a.length;++c)b=31*b+a.charCodeAt(c)>>>0;return b}
...
return a}
var gc={Sa:"allow-forms",Ta:"allow-modals",Ua:"allow-orientation-lock",Va:"allow-pointer-lock",Wa:"allow-popups",Xa:"allow-popups-to-escape-sandbox",Ya:"allow-presentation",Za:"allow-same-origin",ab:"allow-scripts",bb:"allow-top-navigation",cb:"allow-top-navigation-by-user-activation"},ic=Fb(function(){return hc()});
...
function ed(a,b){if(a.classList)var c=a.classList.contains(b);else c=dd(a),c=0<=Ia(c,b);return c}
...
yf.prototype.invoke=function(a){a=void 0===a?{}:a;return this.b?this.b.invoke(void 0,void 0,a):null};
...
function Hf(a){a=void 0===a?{}:a;return Af.invoke(a)}
...
Qf.prototype.l=function(){window.clearInterval(this.H);Pf(this.D)};var Rf={};function Sf(a){var b=void 0===a?{}:a;a=void 0===b.b?!0:b.b;b=void 0===b.f?!1:b.f;if(null==w("_lact",window)){var c=parseInt(P("LACT"),10);c=isFinite(c)?z()-Math.max(c,0):-1;u("_lact",c,window);u("_fact",c,window);-1==c&&Tf();U(document,"keydown",Tf);U(document,"keyup",Tf);U(document,"mousedown",Tf);U(document,"mouseup",Tf);a&&(b?U(window,"touchmove",function(){Uf("touchmove",200)},{passive:!0}):(U(window,"resize",function(){Uf("resize",200)}),U(window,"scroll",function(){Uf("scroll",200)})));
...
function jg(a,b){var c=Zf[a],d=eg[a]||{};eg[a]=d;var e=Math.round(N());for(m in V[a]){var f=b.b;f={client:{hl:f.Aa,gl:f.za,clientName:f.ya,clientVersion:f.innertubeContextClientVersion}};var g=window.devicePixelRatio;g&&1!=g&&(f.client.screenDensityFloat=String(g));P("DELEGATED_SESSION_ID")&&!S("pageid_as_header_web")&&(f.user={onBehalfOfUser:P("DELEGATED_SESSION_ID")});f={context:f};f[c]=gg(a,m);d.dispatchedEventCount=d.dispatchedEventCount||0;d.dispatchedEventCount+=f[c].length;if(g=dg[m])a:{var h=
...
;function og(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||P("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.fb||P("AUTHORIZATION"))||(a?b="Bearer "+w("gapi.auth.getToken")().eb:b=Jc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=P("SESSION_INDEX",0),S("pageid_as_header_web")&&(d["X-Goog-PageId"]=P("DELEGATED_SESSION_ID")));return d}
...
;function ng(a){var b=this;this.b=a||{innertubeApiKey:Q("INNERTUBE_API_KEY"),innertubeApiVersion:Q("INNERTUBE_API_VERSION"),ya:P("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),innertubeContextClientVersion:Q("INNERTUBE_CONTEXT_CLIENT_VERSION"),Aa:Q("INNERTUBE_CONTEXT_HL"),za:Q("INNERTUBE_CONTEXT_GL"),Ba:Q("INNERTUBE_HOST_OVERRIDE")||"",Ca:!!P("INNERTUBE_USE_THIRD_PARTY_AUTH",!1)};rf(function(){vg(b)},0,5E3)}
...
return a.join("")}
;var yg=w("ytLoggingTimeDocumentNonce_")||xg();u("ytLoggingTimeDocumentNonce_",yg,void 0);function zg(a){this.b=a}
...
u("yt.logging.screen.setCurrentScreen",Hg,void 0);function Ig(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=P("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=P("VALID_SESSION_TEMPDATA_DOMAINS",[]),f=nc(H(window.location.href)[3]||null);f&&e.push(f);f=nc(H(d)[3]||null);if(0<=Ia(e,f)||!f&&0==d.lastIndexOf("/",0))if(S("autoescape_tempdata_url")&&(e=document.createElement("a"),Sb(e,d),d=e.href),d){f=H(d);d=f[5];e=f[6];f=f[7];var g="";d&&(g+=d);e&&(g+="?"+e);f&&(g+="#"+f);d=g;e=d.indexOf("#");if(d=0>e?d:d.substr(0,e)){if(b.itct||b.ved)b.csn=b.csn||
...
n(Pg,J);Pg.prototype.l=function(){for(;this.b.length;){var a=this.b.pop();a.target.removeEventListener(a.name,a.hb)}J.prototype.l.call(this)};var Qg=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function Rg(a){a=a||"";if(window.spf){var b=a.match(Qg);spf.style.load(a,b?b[1]:"",void 0)}else Sg(a)}
...
n(fh,Zg);var gh=new $g("aft-recorded"),hh=new $g("timing-sent");var ih={vc:!0},X={},jh=(X.ad_allowed="adTypesAllowed",X.yt_abt="adBreakType",X.ad_cpn="adClientPlaybackNonce",X.ad_docid="adVideoId",X.yt_ad_an="adNetworks",X.ad_at="adType",X.browse_id="browseId",X.p="httpProtocol",X.t="transportProtocol",X.cpn="clientPlaybackNonce",X.csn="clientScreenNonce",X.docid="videoId",X.is_continuation="isContinuation",X.is_nav="isNavigation",X.b_p="kabukiInfo.browseParams",X.is_prefetch="kabukiInfo.isPrefetch",X.is_secondary_nav="kabukiInfo.isSecondaryNav",X.prev_browse_id=
"kabukiInfo.prevBrowseId",X.query_source="kabukiInfo.querySource",X.voz_type="kabukiInfo.vozType",X.yt_lt="loadType",X.yt_ad="isMonetized",X.nr="webInfo.navigationReason",X.ncnp="webInfo.nonPreloadedNodeCount",X.paused="playerInfo.isPausedOnLoad",X.fmt="playerInfo.itag",X.yt_pl="watchInfo.isPlaylist",X.yt_ad_pr="prerollAllowed",X.yt_red="isRedSubscriber",X.st="serverTimeMs",X.aq="tvInfo.appQuality",X.br_trs="tvInfo.bedrockTriggerState",X.label="tvInfo.label",X.is_mdx="tvInfo.isMdx",X.preloaded="tvInfo.isPreloaded",
X.query="unpluggedInfo.query",X.upg_chip_ids_string="unpluggedInfo.upgChipIdsString",X.yt_vst="videoStreamType",X.vph="viewportHeight",X.vpw="viewportWidth",X.yt_vis="isVisible",X),kh="ap c cver cbrand cmodel ei srt yt_fss yt_li plid vpil vpni vpst yt_eil vpni2 vpil2 icrc icrt pa GetBrowse_rid GetPlayer_rid GetSearch_rid GetWatchNext_rid cmt d_vpct d_vpnfi d_vpni pc pfa pfeh pftr prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis yt_ref yt_sts".split(" "),
lh="isContinuation isNavigation kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist".split(" "),mh={},nh=(mh.yt_vst="VIDEO_STREAM_TYPE_",mh),oh=!1;
function ph(){var a=qh().info.yt_lt="hot_bg";rh().info_yt_lt=a;if(sh())if("yt_lt"in jh){var b=jh.yt_lt;0<=Ia(lh,b)&&(a=!!a);"yt_lt"in nh&&(a=nh.yt_lt+a.toUpperCase());var c=a;if(sh()){a={};b=b.split(".");for(var d=a,e=0;e<b.length-1;e++)d[b[e]]=d[b[e]]||{},d=d[b[e]];d[b[b.length-1]]=c;c=th();b=Object.keys(a).join("");Xg("info_"+b+"_"+c)||(a.clientActionNonce=c,mg("latencyActionInfo",a,void 0,void 0))}}else 0<=Ia(kh,"yt_lt")||R(Error("Unknown label yt_lt logged with GEL CSI."))}
...
function Eh(a){a.m=!1;if(a.P)for(var b in a.h)a.P(b,a.h[b]);for(var c in a.O)qe(parseInt(c,10));a.O={};a.B=null;a.P=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.V.bind(a);a.api.removeEventListener=a.Ia.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.va.bind(a);a.api.getPlayerType=a.wa.bind(a);a.api.getCurrentVideoConfig=a.ua.bind(a);a.api.loadNewVideoConfig=a.ea.bind(a);a.api.isReady=a.Da.bind(a)}
k.Da=function(){return this.m};
k.V=function(a,b){var c=this,d=Fh(this,b);if(d){if(!(0<=Ia(this.oa,a)||this.h[a])){var e=Ph(this,a);this.B&&this.B(a,e)}this.G.subscribe(a,d);"onReady"==a&&this.m&&T(function(){d(c.api)},0)}};
k.Ia=function(a,b){if(!this.f){var c=Fh(this,b);c&&Od(this.G,a,c)}};
...
k.Ea=function(a){cf("WATCH_LATER_VIDEO_ADDED",a)};
k.Fa=function(a){cf("WATCH_LATER_VIDEO_REMOVED",a)};
...
n(ii,hi);function ji(){var a=this.f=new ii(!!P("WIDGET_ID_ENFORCE")),b=y(this.Ha,this);a.i=b;a.j=null;this.f.channel="widget";if(a=P("WIDGET_ID"))this.f.sessionId=a;this.h=[];this.j=!1;this.i={}}
k=ji.prototype;k.Ha=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.i[a]||"onReady"==a||(this.addEventListener(a,ki(this,a)),this.i[a]=!0)):this.na(a,b,c)};
k.na=function(){};
...
k.dispose=function(){this.f=null};function mi(a){ji.call(this);this.b=a;this.g=[];this.addEventListener("onReady",y(this.Ga,this));this.addEventListener("onVideoProgress",y(this.Oa,this));this.addEventListener("onVolumeChange",y(this.Pa,this));this.addEventListener("onApiChange",y(this.Ja,this));this.addEventListener("onPlaybackQualityChange",y(this.La,this));this.addEventListener("onPlaybackRateChange",y(this.Ma,this));this.addEventListener("onStateChange",y(this.Na,this));this.addEventListener("onWebglSettingsChanged",y(this.Qa,
this))}
...
k.Ga=function(){var a=y(this.ta,this);this.f.b=a};
...
k.La=function(a){li(this,{playbackQuality:a})};
k.Ma=function(a){li(this,{playbackRate:a})};
k.Ja=function(){for(var a=this.b.getOptions(),b={namespaces:a},c=0,d=a.length;c<d;c++){var e=a[c],f=this.b.getOptions(e);b[e]={options:f};for(var g=0,h=f.length;g<h;g++){var l=f[g],m=this.b.getOption(e,l);b[e][l]=m}}this.sendMessage("apiInfoDelivery",b)};
k.Pa=function(){li(this,{muted:this.b.isMuted(),volume:this.b.getVolume()})};
k.Oa=function(a){a={currentTime:a,videoBytesLoaded:this.b.getVideoBytesLoaded(),videoLoadedFraction:this.b.getVideoLoadedFraction(),currentTimeLastUpdated_:z()/1E3,playbackRate:this.b.getPlaybackRate(),mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());li(this,a)};
k.Qa=function(){var a={sphericalProperties:this.b.getSphericalProperties()};li(this,a)};
...
;function Fi(a){if("1"!==eb(ke(),"args","privembed")){a&&(w("yt.ads.biscotti.getId_")||Fa("yt.ads.biscotti.getId_",zi));try{Ei().then(function(a){var b={};b.dt=Ec;b.flash="0";a:{try{var d=window.top.location.href}catch(Xa){d=2;break a}d=null!=d?d==window.document.location.href?0:1:2}b=(b.frm=d,b);b.u_tz=-(new Date).getTimezoneOffset();var e=void 0===e?B:e;try{var f=e.history.length}catch(Xa){f=0}b.u_his=f;b.u_java=!!B.navigator&&"unknown"!==typeof B.navigator.javaEnabled&&!!B.navigator.javaEnabled&&
B.navigator.javaEnabled();B.screen&&(b.u_h=B.screen.height,b.u_w=B.screen.width,b.u_ah=B.screen.availHeight,b.u_aw=B.screen.availWidth,b.u_cd=B.screen.colorDepth);B.navigator&&B.navigator.plugins&&(b.u_nplug=B.navigator.plugins.length);B.navigator&&B.navigator.mimeTypes&&(b.u_nmime=B.navigator.mimeTypes.length);b.ca_type="image";f=window;try{var g=f.screenX;var h=f.screenY}catch(Xa){}try{var l=f.outerWidth;var m=f.outerHeight}catch(Xa){}try{var v=f.innerWidth;var da=f.innerHeight}catch(Xa){}g=[f.screenLeft,
f.screenTop,g,h,f.screen?f.screen.availWidth:void 0,f.screen?f.screen.availTop:void 0,l,m,v,da];h=window.top;try{var G=(h||window).document,Y="CSS1Compat"==G.compatMode?G.documentElement:G.body;var Ha=(new Vb(Y.clientWidth,Y.clientHeight)).round()}catch(Xa){Ha=new Vb(-12245933,-12245933)}G={};Y=new fe;q.SVGElement&&q.document.createElementNS&&Y.set(0);h=jc();h["allow-top-navigation-by-user-activation"]&&Y.set(1);h["allow-popups-to-escape-sandbox"]&&Y.set(2);Y=he(Y);G.bc=Y;G.bih=Ha.height;G.biw=Ha.width;
G.brdim=g.join();Ha=(G.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[Ga.visibilityState||Ga.webkitVisibilityState||Ga.mozVisibilityState||""]||0,G.wgl=!!B.WebGLRenderingContext,G);for(var ge in Ha)b[ge]=Ha[ge];b.bid=a;b.bsq=Gi++;Ie("//www.youtube.com/ad_data_204",{xa:!1,C:b,withCredentials:!0})},function(){}),T(Fi,18E5)}catch(b){R(b)}}}
