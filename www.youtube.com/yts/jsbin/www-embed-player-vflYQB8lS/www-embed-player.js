...
return d};function Sd(a){if(!ua(a))if(a&&"function"==typeof a.handleEvent)a=x(a.handleEvent,a);else throw Error("Invalid listener argument");return 2147483647<Number(5E3)?-1:p.setTimeout(a,5E3)}
function Td(){var a=null;return od(new H(function(b,c){a=Sd(function(){b(void 0)});
...
var He={};var Le=null;function Me(){var a=Q("BG_I",null),b=Q("BG_IU",null),c=Q("BG_P",void 0);b?Ee(b,function(){window.botguard?Ne(c):(Je(b),R(Error("Unable to load Botguard from "+b),"WARNING"))}):a&&(eval(a),window.botguard?Ne(c):R(Error("Unable to load Botguard from JS"),"WARNING"))}
function Ne(a){Le=new window.botguard.bg(a);S("botguard_periodic_refresh")&&O()}
...
;function Te(a){"?"==a.charAt(0)&&(a=a.substr(1));a=a.split("&");for(var b={},c=0,d=a.length;c<d;c++){var e=a[c].split("=");if(1==e.length&&e[0]||2==e.length){var f=decodeURIComponent((e[0]||"").replace(/\+/g," "));e=decodeURIComponent((e[1]||"").replace(/\+/g," "));f in b?w(b[f])?Ja(b[f],e):b[f]=[b[f],e]:b[f]=e}}return b}
...
function We(a,b){b=void 0===b?{}:b;if(!c)var c=window.location.href;var d=J(a)[1]||null,e=Vd(J(a)[3]||null);d&&e?(d=c,c=J(a),d=J(d),c=c[3]==d[3]&&c[1]==d[1]&&c[4]==d[4]):c=e?Vd(J(c)[3]||null)==e&&(Number(J(c)[4]||null)||null)==(Number(J(a)[4]||null)||null):!0;for(var f in Ue){if((e=d=Q(Ue[f]))&&!(e=c)){e=f;var g=Q("CORS_HEADER_WHITELIST")||{},h=Vd(J(a)[3]||null);e=h?(g=g[h])?0<=Ba(g,e):!1:!0}e&&(b[f]=d)}return b}
...
b.na&&0<b.timeout&&(f=T(function(){e||(e=!0,re(f),b.na.call(b.context||p))},b.timeout))}else $e(a,b)}
function $e(a,b){var c=b.format||"JSON";a=Ye(a,b);var d=Ze(a,b),e=!1,f,g=af(a,function(a){if(!e){e=!0;f&&re(f);var d=Se(a),g=null;if(d||400<=a.status&&500>a.status)g=bf(c,a,b.qb);if(d)a:if(a&&204==a.status)d=!0;else{switch(c){case "XML":d=0==parseInt(g&&g.return_code,10);break a;case "RAW":d=!0;break a}d=!!g}g=g||{};var h=b.context||p;d?b.onSuccess&&b.onSuccess.call(h,a,g):b.onError&&b.onError.call(h,a,g);b.ga&&b.ga.call(h,a,g)}},b.method,d,b.headers,b.responseType,b.withCredentials);
b.L&&0<b.timeout&&(f=T(function(){e||(e=!0,g.abort(),re(f),b.L.call(b.context||p,g))},b.timeout));
return g}
function Ye(a,b){b.Ba&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var c=Q("XSRF_FIELD_NAME",void 0),d=b.ab;if(d){d[c]&&delete d[c];d=d||{};var e=a.split("#",2);c=e[0];e=1<e.length?"#"+e[1]:"";var f=c.split("?",2);c=f[0];f=Te(f[1]||"");for(var g in d)f[g]=d[g];a=Yd(c,f)+e}return a}
function Ze(a,b){var c=Q("XSRF_FIELD_NAME",void 0),d=Q("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.A,g=ke("XSRF_FIELD_NAME"),h;b.headers&&(h=b.headers["Content-Type"]);b.rb||Vd(J(a)[3]||null)&&!b.withCredentials&&Vd(J(a)[3]||null)!=document.location.hostname||"POST"!=b.method||h&&"application/x-www-form-urlencoded"!=h||b.A&&b.A[g]||(f||(f={}),f[c]=d);f&&r(e)&&(e=Te(e),gb(e,f),e=b.oa&&"JSON"==b.oa?JSON.stringify(e):Xd(e));f=e||f&&!bb(f);!Ve&&f&&"POST"!=b.method&&(Ve=!0,R(Error("AJAX request with postData should use POST")));
return e}
...
return d}
function ef(a){if(va(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);if(c){c=b;var d=Fb(a[b],null);a[c]=d}else ef(a[b])}}
...
return b}
function ff(a,b){b.method="POST";b.A||(b.A={});$e(a,b)}
function af(a,b,c,d,e,f,g){function h(){4==(l&&"readyState"in l?l.readyState:0)&&b&&me(b)(l)}
c=void 0===c?"GET":c;d=void 0===d?"":d;var l=Re();if(!l)return null;"onloadend"in l?l.addEventListener("loadend",h,!1):l.onreadystatechange=h;l.open(c,a,!0);f&&(l.responseType=f);g&&(l.withCredentials=!0);c="POST"==c&&(void 0===window.FormData||!(d instanceof FormData));if(e=We(a,e))for(var m in e)l.setRequestHeader(m,e[m]),"content-type"==m.toLowerCase()&&(c=!1);c&&l.setRequestHeader("Content-Type","application/x-www-form-urlencoded");l.send(d);return l}
;var gf={},hf=0;
...
'+"\\"></body>"',style:"display:none"}),(9==a.nodeType?a:a.ownerDocument||a.document).body.appendChild(a))):e?af(a,b,"POST",e,d):Q("USE_NET_AJAX_FOR_PING_TRANSPORT",!1)||d?af(a,b,"GET","",d):kf(a,b))}
function kf(a,b){var c=new Image,d=""+hf++;gf[d]=c;c.onload=c.onerror=function(){b&&gf[d]&&b();delete gf[d]};
c.src=a}
;var lf={},mf=0;
function nf(a,b,c,d,e,f){f=f||{};f.name=c||Q("INNERTUBE_CONTEXT_CLIENT_NAME",1);f.version=d||Q("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0);b=void 0===b?"ERROR":b;e=void 0===e?!1:e;b=void 0===b?"ERROR":b;e=window&&window.yterr||(void 0===e?!1:e)||!1;if(a&&e&&!(5<=mf)){e=a.stacktrace;c=a.columnNumber;a.hasOwnProperty("params")&&(f.params=JSON.stringify(a.params));d=v("window.location.href");if(r(a))a={message:a,name:"Unknown error",lineNumber:"Not available",fileName:d,stack:"Not available"};else{var g=
!1;try{var h=a.lineNumber||a.line||"Not available"}catch(N){h="Not available",g=!0}try{var l=a.fileName||a.filename||a.sourceURL||p.$googDebugFname||d}catch(N){l="Not available",g=!0}a=!g&&a.lineNumber&&a.fileName&&a.stack&&a.message&&a.name?a:{message:a.message||"Not available",name:a.name||"UnknownError",lineNumber:h,fileName:l,stack:a.stack||"Not available"}}e=e||a.stack;h=a.lineNumber.toString();isNaN(h)||isNaN(c)||(h=h+":"+c);if(!(lf[a.message]||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js"))){l=
e;h={ab:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,1E3),line:h,level:b,"client.name":f.name},A:{url:Q("PAGE_NAME",window.location.href),file:a.fileName},method:"POST"};f.version&&(h["client.version"]=f.version);l&&(h.A.stack=l);for(var m in f)h.A["client."+m]=f[m];if(m=Q("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(var t in m)h.A[t]=m[t];$e(Q("ECATCHER_REPORT_HOST","")+"/error_204",h);lf[a.message]=!0;mf++}}}
;var of=window.yt&&window.yt.msgs_||window.ytcfg&&window.ytcfg.msgs||{};u("yt.msgs_",of,void 0);function pf(a){ie(of,arguments)}
;function qf(){}
function rf(a,b){return sf(a,1,b)}
;function tf(){}
n(tf,qf);function sf(a,b,c){isNaN(c)&&(c=void 0);var d=v("yt.scheduler.instance.addJob");return d?d(a,b,c):void 0===c?(a(),NaN):T(a,c||0)}
function uf(a){if(!isNaN(a)){var b=v("yt.scheduler.instance.cancelJob");b?b(a):re(a)}}
tf.prototype.start=function(){var a=v("yt.scheduler.instance.start");a&&a()};
tf.prototype.pause=function(){var a=v("yt.scheduler.instance.pause");a&&a()};
qa(tf);tf.getInstance();var vf=[],wf=!1;function xf(){if("1"!=Za(le(),"args","privembed")){var a=function(){wf=!0;"google_ad_status"in window?P("DCLKSTAT",1):P("DCLKSTAT",2)};
Ee("//static.doubleclick.net/instream/ad_status.js",a);vf.push(rf(function(){wf||"google_ad_status"in window||(Ke("//static.doubleclick.net/instream/ad_status.js",a),P("DCLKSTAT",3))},5E3))}}
function yf(){return parseInt(Q("DCLKSTAT",0),10)}
;var zf=0;u("ytDomDomGetNextId",v("ytDomDomGetNextId")||function(){return++zf},void 0);var Af={stopImmediatePropagation:1,stopPropagation:1,preventMouseEvent:1,preventManipulation:1,preventDefault:1,layerX:1,layerY:1,screenX:1,screenY:1,scale:1,rotation:1,webkitMovementX:1,webkitMovementY:1};
...
function Cf(a){if(document.body&&document.documentElement){var b=document.body.scrollTop+document.documentElement.scrollTop;a.b=a.clientX+(document.body.scrollLeft+document.documentElement.scrollLeft);a.f=a.clientY+b}}
...
Bf.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var ab=v("ytEventsEventsListeners")||{};u("ytEventsEventsListeners",ab,void 0);var Df=v("ytEventsEventsCounter")||{count:0};u("ytEventsEventsCounter",Df,void 0);
...
var Ff=Rb(function(){var a=!1;try{var b=Object.defineProperty({},"capture",{get:function(){a=!0}});
window.addEventListener("test",null,b)}catch(c){}return a});
function V(a,b,c,d){d=void 0===d?{}:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=Ef(a,b,c,d);if(e)return e;e=++Df.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document);var g=f?function(d){d=new Bf(d);if(!Qb(d.relatedTarget,function(b){return b==a}))return d.currentTarget=a,d.type=b,c.call(a,d)}:function(b){b=new Bf(b);
b.currentTarget=a;return c.call(a,b)};
g=me(g);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),Ff()||la(d)?a.addEventListener(b,g,d):a.addEventListener(b,g,!!d.capture)):a.attachEvent("on"+b,g);ab[e]=[a,b,c,g,d];return e}
function Gf(a){a&&("string"==typeof a&&(a=[a]),C(a,function(a){if(a in ab){var b=ab[a],d=b[0],e=b[1],f=b[3];b=b[4];d.removeEventListener?Ff()||la(b)?d.removeEventListener(e,f,b):d.removeEventListener(e,f,!!b.capture):d.detachEvent&&d.detachEvent("on"+e,f);delete ab[a]}}))}
;function Hf(a){this.o=a;this.b=null;this.i=0;this.l=null;this.j=0;this.f=[];for(a=0;4>a;a++)this.f.push(0);this.h=0;this.C=V(window,"mousemove",x(this.F,this));a=x(this.w,this);ua(a)&&(a=me(a));this.G=window.setInterval(a,25)}
A(Hf,G);Hf.prototype.F=function(a){q(a.b)||Cf(a);var b=a.b;q(a.f)||Cf(a);this.b=new Jb(b,a.f)};
Hf.prototype.w=function(){if(this.b){var a=O();if(0!=this.i){var b=this.l,c=this.b,d=b.x-c.x;b=b.y-c.y;d=Math.sqrt(d*d+b*b)/(a-this.i);this.f[this.h]=.5<Math.abs((d-this.j)/this.j)?1:0;for(c=b=0;4>c;c++)b+=this.f[c]||0;3<=b&&this.o();this.j=d}this.i=a;this.l=this.b;this.h=(this.h+1)%4}};
Hf.prototype.m=function(){window.clearInterval(this.G);Gf(this.C)};var If={};
function Jf(a){var b=void 0===a?{}:a;a=void 0===b.Ca?!0:b.Ca;b=void 0===b.Ma?!1:b.Ma;if(null==v("_lact",window)){var c=parseInt(Q("LACT"),10);c=isFinite(c)?z()-Math.max(c,0):-1;u("_lact",c,window);u("_fact",c,window);-1==c&&Kf();V(document,"keydown",Kf);V(document,"keyup",Kf);V(document,"mousedown",Kf);V(document,"mouseup",Kf);a&&(b?V(window,"touchmove",function(){Lf("touchmove",200)},{passive:!0}):(V(window,"resize",function(){Lf("resize",200)}),V(window,"scroll",function(){Lf("scroll",200)})));
new Hf(function(){Lf("mouse",100)});
V(document,"touchstart",Kf,{passive:!0});V(document,"touchend",Kf,{passive:!0})}}
function Lf(a,b){If[a]||(If[a]=!0,rf(function(){Kf();If[a]=!1},b))}
function Kf(){null==v("_lact",window)&&Jf();var a=z();u("_lact",a,window);-1==v("_fact",window)&&u("_fact",a,window);(a=v("ytglobal.ytUtilActivityCallback_"))&&a()}
function Mf(){var a=v("_lact",window);return null==a?-1:Math.max(z()-a,0)}
;var Nf=Math.pow(2,16)-1,Of={log_event:"events",log_interaction:"interactions"},Pf=Object.create(null);Pf.log_event="GENERIC_EVENT_LOGGING";Pf.log_interaction="INTERACTION_LOGGING";var Qf={},Rf=0,W=v("ytLoggingTransportLogPayloadsQueue_")||{};u("ytLoggingTransportLogPayloadsQueue_",W,void 0);var Sf=v("ytLoggingTransportTokensToCttTargetIds_")||{};u("ytLoggingTransportTokensToCttTargetIds_",Sf,void 0);var Tf=v("ytLoggingTransportDispatchedStats_")||{};u("ytLoggingTransportDispatchedStats_",Tf,void 0);
u("ytytLoggingTransportCapturedTime_",v("ytLoggingTransportCapturedTime_")||{},void 0);function Uf(a,b){if(a.V){var c=a.V;var d={};c.videoId?d.videoId=c.videoId:c.playlistId&&(d.playlistId=c.playlistId);Sf[a.V.token]=d;c=Vf(a.endpoint,a.V.token)}else c=Vf(a.endpoint);c.push(a.payload);Qf[a.endpoint]=new b;c.length>=(Number(S("web_logging_max_batch")||0)||20)?Wf():Xf()}
function Wf(){re(Rf);if(!bb(W)){for(var a in W){var b=Qf[a];if(b){var c=void 0,d=a,e=b,f=Of[d],g=Tf[d]||{};Tf[d]=g;b=Math.round(O());for(c in W[d]){var h=e.b;h={client:{hl:h.Fa,gl:h.Ea,clientName:h.Da,clientVersion:h.innertubeContextClientVersion}};var l=window.devicePixelRatio;l&&1!=l&&(h.client.screenDensityFloat=String(l));Q("DELEGATED_SESSION_ID")&&(h.user={onBehalfOfUser:Q("DELEGATED_SESSION_ID")});h={context:h};h[f]=Vf(d,c);g.dispatchedEventCount=g.dispatchedEventCount||0;g.dispatchedEventCount+=
h[f].length;if(l=Sf[c])a:{var m=h,t=c;if(l.videoId)var N="VIDEO";else if(l.playlistId)N="PLAYLIST";else break a;m.credentialTransferTokenTargetId=l;m.context=m.context||{};m.context.user=m.context.user||{};m.context.user.credentialTransferTokens=[{token:t,scope:N}]}delete Sf[c];l=h;l.requestTimeMs=b;(N=Q("EVENT_ID",void 0))&&S("enable_gel_web_client_event_id")&&(m=(Q("BATCH_CLIENT_COUNTER",void 0)||0)+1,m>Nf&&(m=1),P("BATCH_CLIENT_COUNTER",m),l.serializedClientEventId={serializedEventId:N,clientCounter:m});
Yf(e,d,h,{retry:!0})}c=g;d=b;c.previousDispatchMs&&(b=d-c.previousDispatchMs,e=c.diffCount||0,c.averageTimeBetweenDispatchesMs=e?(c.averageTimeBetweenDispatchesMs*e+b)/(e+1):b,c.diffCount=e+1);c.previousDispatchMs=d;delete W[a]}}bb(W)||Xf()}}
function Xf(){re(Rf);Rf=T(Wf,Q("LOGGING_BATCH_TIMEOUT",1E4))}
function Vf(a,b){b=void 0===b?"":b;W[a]=W[a]||{};W[a][b]=W[a][b]||[];return W[a][b]}
;function Zf(a,b,c,d){var e=$f,f={};f.eventTimeMs=Math.round(c||O());f[a]=b;f.context={lastActivityMs:String(c?-1:Mf())};Uf({endpoint:"log_event",payload:f,V:d},e)}
;function ag(a){var b={"X-Goog-Visitor-Id":Q("VISITOR_DATA","")},c;a?c="Bearer "+v("gapi.auth.getToken")().nb:c=mc([]);c&&(b.Authorization=c,b["X-Goog-AuthUser"]=Q("SESSION_INDEX",0));return b}
function bg(a){a=Object.assign({},a);delete a.Authorization;var b=mc();if(b){var c=new Ec;c.update(Q("INNERTUBE_API_KEY",void 0));c.update(b);b=c.digest();if(!Bc)for(Bc={},Cc={},c=0;65>c;c++)Bc[c]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(c),Cc[c]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_.".charAt(c);c=Cc;for(var d=[],e=0;e<b.length;e+=3){var f=b[e],g=e+1<b.length,h=g?b[e+1]:0,l=e+2<b.length,m=l?b[e+2]:0,t=f>>2;f=(f&3)<<4|h>>4;h=(h&15)<<2|m>>
6;m&=63;l||(m=64,g||(h=64));d.push(c[t],c[f],c[h],c[m])}a.hash=d.join("")}return a}
;function cg(a,b,c,d){lc.set(""+a,b,c,"/",void 0===d?"youtube.com":d,!1)}
;function dg(){var a=new Jd;(a=a.isAvailable()?new Qd(a,"yt.innertube"):null)||(a=new Ld("yt.innertube"),a=a.isAvailable()?a:null);this.b=a?new Ed(a):null;this.f=document.domain||window.location.hostname}
dg.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.b)try{this.b.set(a,b,z()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(Vc(b))}catch(f){return}else e=escape(b);cg(a,e,c,this.f)};
dg.prototype.get=function(a,b){var c=void 0,d=!this.b;if(!d)try{c=this.b.get(a)}catch(e){d=!0}if(d&&(c=lc.get(""+a,void 0))&&(c=unescape(c),b))try{c=JSON.parse(c)}catch(e){this.remove(a),c=void 0}return c};
dg.prototype.remove=function(a){this.b&&this.b.remove(a);var b=this.f;lc.remove(""+a,"/",void 0===b?"youtube.com":b)};var eg=new dg;function fg(a,b,c,d){if(d)return null;d=eg.get("nextId",!0)||1;var e=eg.get("requests",!0)||{};e[d]={method:a,request:b,authState:bg(c),requestTime:Math.round(O())};eg.set("nextId",d+1,86400,!0);eg.set("requests",e,86400,!0);return d}
function gg(a){var b=eg.get("requests",!0)||{};delete b[a];eg.set("requests",b,86400,!0)}
function hg(a){var b=eg.get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round(O())-d.requestTime)){var e=d.authState,f=bg(ag(!1));db(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round(O())),Yf(a,d.method,e,{}));delete b[c]}}eg.set("requests",b,86400,!0)}}
;function $f(a){var b=this;this.b=a||{innertubeApiKey:ke("INNERTUBE_API_KEY"),innertubeApiVersion:ke("INNERTUBE_API_VERSION"),Da:Q("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),innertubeContextClientVersion:ke("INNERTUBE_CONTEXT_CLIENT_VERSION"),Fa:ke("INNERTUBE_CONTEXT_HL"),Ea:ke("INNERTUBE_CONTEXT_GL"),Ga:ke("INNERTUBE_HOST_OVERRIDE")||"",Ha:!!Q("INNERTUBE_USE_THIRD_PARTY_AUTH",!1)};sf(function(){hg(b)},0,5E3)}
function Yf(a,b,c,d){!Q("VISITOR_DATA")&&.01>Math.random()&&R(Error("Missing VISITOR_DATA when sending innertube request."),"WARNING");var e={headers:{"Content-Type":"application/json"},method:"POST",A:c,oa:"JSON",L:function(){d.L()},
...
timeout:d.timeout,withCredentials:!0},f=a.b.Ha||!1,g=ag(f);Object.assign(e.headers,g);var h="",l=a.b.Ga;l&&(h=l);e.headers.Authorization&&!h&&(e.headers["x-origin"]=window.location.origin);h=""+h+("/youtubei/"+a.b.innertubeApiVersion+"/"+b)+"?alt=json&key="+a.b.innertubeApiKey;var m;if(d.retry&&S("retry_web_logging_batches")&&(m=fg(b,c,g,f))){var t=e.onSuccess,N=e.ma;e.onSuccess=function(a,b){gg(m);t(a,b)};
c.ma=function(a,b){gg(m);N(a,b)}}try{S("use_fetch_for_op_xhr")?Xe(h,e):ff(h,e)}catch(Ga){if("InvalidAccessError"==Ga)m&&(gg(m),m=0),R(Error("An extension is blocking network request."),"WARNING");
else throw Ga;}m&&sf(function(){hg(a)},0,5E3)}
;var ig=z().toString();
function jg(){a:{if(window.crypto&&window.crypto.getRandomValues)try{var a=Array(16),b=new Uint8Array(16);window.crypto.getRandomValues(b);for(var c=0;c<a.length;c++)a[c]=b[c];var d=a;break a}catch(e){}d=Array(16);for(a=0;16>a;a++){b=z();for(c=0;c<b%23;c++)d[a]=Math.random();d[a]=Math.floor(256*Math.random())}if(ig)for(a=1,b=0;b<ig.length;b++)d[a%16]=d[a%16]^d[(a-1)%16]/4^ig.charCodeAt(b),a++}a=[];for(b=0;b<d.length;b++)a.push("ABCDEFGHIJLKMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(d[b]&63));
return a.join("")}
;var kg=jg();function lg(a){this.b=a}
...
var ng=1;function og(){var a=Q("ROOT_VE_TYPE",void 0);return a?new lg({veType:a}):null}
function pg(){var a=Q("client-screen-nonce")||Q("EVENT_ID");return a?a:null}
function qg(a,b){function c(){setTimeout(function(){a&&Zf("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:kg,clientScreenNonce:a})},0)}
P("client-screen-nonce",a);P("ROOT_VE_TYPE",b);"requestAnimationFrame"in window?window.requestAnimationFrame(c):c()}
;function rg(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=Q("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=Q("VALID_SESSION_TEMPDATA_DOMAINS",[]),f=Vd(J(window.location.href)[3]||null);f&&e.push(f);f=Vd(J(d)[3]||null);if(0<=Ba(e,f)||!f&&0==d.lastIndexOf("/",0))if(S("autoescape_tempdata_url")&&(e=document.createElement("a"),Gb(e,d),d=e.href),d){f=J(d);d=f[5];e=f[6];f=f[7];var g="";d&&(g+=d);e&&(g+="?"+e);f&&(g+="#"+f);d=g;e=d.indexOf("#");if(d=0>e?d:d.substr(0,e)){if(b.itct||b.ved)b.csn=b.csn||
pg();if(h){var h=parseInt(h,10);isFinite(h)&&0<h&&(d="ST-"+Ua(d).toString(36),b=b?Xd(b):"",cg(d,b,h||5))}else h="ST-"+Ua(d).toString(36),b=b?Xd(b):"",cg(h,b,5)}}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var m=void 0===m?"":m;var t=void 0===t?window:t;c=t.location;a=Yd(a,l)+m;a=a instanceof E?a:Bb(a);c.href=zb(a)}return!0}
;function sg(a,b,c){tg({attachChild:{csn:a,parentVisualElement:mg(b),visualElements:[mg(c)]}})}
function tg(a){var b=$f;a.eventTimeMs=Math.round(O());a.lactMs=Mf();Uf({endpoint:"log_interaction",payload:a},b)}
;function ug(a){a=a||{};this.url=a.url||"";this.args=a.args||eb(vg);this.assets=a.assets||{};this.attrs=a.attrs||eb(wg);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
var vg={enablejsapi:1},wg={};ug.prototype.clone=function(){var a=new ug,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];a[b]="object"==ra(c)?eb(c):c}return a};function xg(){G.call(this);this.b=[]}
n(xg,G);xg.prototype.m=function(){for(;this.b.length;){var a=this.b.pop();a.target.removeEventListener(a.name,a.pb)}G.prototype.m.call(this)};var yg=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function zg(a){a=a||"";if(window.spf){var b=a.match(yg);spf.style.load(a,b?b[1]:"",void 0)}else Ag(a)}
function Ag(a){var b=Bg(a),c=document.getElementById(b),d=c&&pe(c,"loaded");d||c&&!d||(c=Cg(a,b,function(){pe(c,"loaded")||(ne(c),ze(b),T(y(Ae,b),0))}))}
...
function Bg(a){var b=document.createElement("A");a=Cb(a);Gb(b,a);b=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Ua(b)}
;var Dg=v("ytLoggingLatencyUsageStats_")||{};u("ytLoggingLatencyUsageStats_",Dg,void 0);var Eg=0;function Fg(a){Dg[a]=Dg[a]||{count:0};var b=Dg[a];b.count++;b.time=O();Eg||(Eg=sf(Gg,0,5E3));return 10<b.count?(11==b.count&&nf(Error("CSI data exceeded logging limit with key: "+a),0==a.indexOf("info")?"WARNING":"ERROR"),!0):!1}
function Gg(){var a=O(),b;for(b in Dg)6E4<a-Dg[b].time&&delete Dg[b];Eg=0}
;function Hg(a,b){this.version=a;this.args=b}
;function Ig(a){this.topic=a}
Ig.prototype.toString=function(){return this.topic};var Jg=v("ytPubsub2Pubsub2Instance")||new I;I.prototype.subscribe=I.prototype.subscribe;I.prototype.unsubscribeByKey=I.prototype.K;I.prototype.publish=I.prototype.I;I.prototype.clear=I.prototype.clear;u("ytPubsub2Pubsub2Instance",Jg,void 0);u("ytPubsub2Pubsub2SubscribedKeys",v("ytPubsub2Pubsub2SubscribedKeys")||{},void 0);u("ytPubsub2Pubsub2TopicToKeys",v("ytPubsub2Pubsub2TopicToKeys")||{},void 0);u("ytPubsub2Pubsub2IsAsync",v("ytPubsub2Pubsub2IsAsync")||{},void 0);
u("ytPubsub2Pubsub2SkipSubKey",null,void 0);function Kg(a,b){var c=v("ytPubsub2Pubsub2Instance");c&&c.publish.call(c,a.toString(),a,b)}
;var X=window.performance||window.mozPerformance||window.msPerformance||window.webkitPerformance||{};function Lg(){var a=Q("TIMING_TICK_EXPIRATION");a||(a={},P("TIMING_TICK_EXPIRATION",a));return a}
function Mg(){var a=Lg(),b;for(b in a)uf(a[b]);P("TIMING_TICK_EXPIRATION",{})}
;function Ng(a,b){Hg.call(this,1,arguments)}
n(Ng,Hg);function Og(a,b){Hg.call(this,1,arguments)}
n(Og,Hg);var Pg=new Ig("aft-recorded"),Qg=new Ig("timing-sent");var Rg={vc:!0},Y={},Sg=(Y.ad_allowed="adTypesAllowed",Y.ad_at="adType",Y.ad_cpn="adClientPlaybackNonce",Y.ad_docid="adVideoId",Y.yt_ad_an="adNetworks",Y.p="httpProtocol",Y.t="transportProtocol",Y.cpn="clientPlaybackNonce",Y.csn="clientScreenNonce",Y.docid="videoId",Y.is_nav="isNavigation",Y.yt_lt="loadType",Y.yt_ad="isMonetized",Y.nr="webInfo.navigationReason",Y.ncnp="webInfo.nonPreloadedNodeCount",Y.paused="playerInfo.isPausedOnLoad",Y.fmt="playerInfo.itag",Y.yt_pl="watchInfo.isPlaylist",Y.yt_ad_pr=
"prerollAllowed",Y.yt_red="isRedSubscriber",Y.st="serverTimeMs",Y.vph="viewportHeight",Y.vpw="viewportWidth",Y.yt_vis="isVisible",Y),Tg="ap c cver ei srt yt_fss yt_li plid vpil vpni vpst yt_eil vpni2 vpil2 icrc icrt pa GetBrowse_rid GetPlayer_rid GetSearch_rid GetWatchNext_rid cmt d_vpct d_vpnfi d_vpni pc pfa pfeh pftr prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis yt_ref yt_sts".split(" "),Ug="isNavigation isMonetized playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber isVisible watchInfo.isPlaylist".split(" "),
Vg=!1;function Yg(){var a=Zg().info.yt_lt="hot_bg";$g().info_yt_lt=a;if(ah())if("yt_lt"in Sg){var b=Sg.yt_lt;0<=Ba(Ug,b)&&(a=!!a);if(ah()){var c={};b=b.split(".");for(var d=c,e=0;e<b.length-1;e++)d[b[e]]=d[b[e]]||{},d=d[b[e]];d[b[b.length-1]]=a;a=bh();b=Object.keys(c).join("");Fg("info_"+b+"_"+a)||(c.clientActionNonce=a,Zf("latencyActionInfo",c,void 0,void 0))}}else 0<=Ba(Tg,"yt_lt")||R(Error("Unknown label yt_lt logged with GEL CSI."))}
function ch(){var a=dh();if(a.aft)return a.aft;for(var b=Q("TIMING_AFT_KEYS",["ol"]),c=b.length,d=0;d<c;d++){var e=a[b[d]];if(e)return e}return NaN}
var eh=x(X.clearResourceTimings||X.webkitClearResourceTimings||X.mozClearResourceTimings||X.msClearResourceTimings||X.oClearResourceTimings||pa,X);function bh(){var a=Zg().nonce;a||(a=jg(),Zg().nonce=a);return a}
function dh(){return Zg().tick}
function $g(){var a=Zg();"gel"in a||(a.gel={});return a.gel}
function Zg(){return v("ytcsi.data_")||fh()}
function fh(){var a={tick:{},info:{}};u("ytcsi.data_",a,void 0);return a}
function gh(a,b){u("yt.timing."+(b||"")+"pingSent_",a,void 0)}
function hh(){var a=dh(),b=a.pbr,c=a.vc;a=a.pbs;return b&&c&&a&&b<c&&c<a&&1==Zg().info.yt_pvis}
function ah(){return!!S("csi_on_gel")}
function ih(){Mg();if(!ah()){var a=dh(),b=Zg().info,c=a._start;for(f in a)if(0==f.lastIndexOf("_",0)&&w(a[f])){var d=f.slice(1);if(d in Rg){var e=Da(a[f],function(a){return Math.round(a-c)});
b["all_"+d]=e.join()}delete a[f]}var f=!!b.ap;if(d=v("ytglobal.timingReportbuilder_")){if(a=d(a,b,void 0))jh(a,f),fh(),eh(),gh(!1,void 0),Q("TIMING_ACTION")&&P("PREVIOUS_ACTION",Q("TIMING_ACTION")),P("TIMING_ACTION","")}else{var g=Q("CSI_SERVICE_NAME","youtube");d={v:2,s:g,action:Q("TIMING_ACTION",void 0)};e=Yg.srt;void 0!==a.srt&&delete b.srt;if(b.h5jse){var h=window.location.protocol+v("ytplayer.config.assets.js");(h=X.getEntriesByName?X.getEntriesByName(h)[0]:null)?b.h5jse=Math.round(b.h5jse-h.responseEnd):
delete b.h5jse}a.aft=ch();hh()&&"youtube"==g&&(Yg(),g=a.vc,h=a.pbs,delete a.aft,b.aft=Math.round(h-g));for(var l in b)"_"!=l.charAt(0)&&(d[l]=b[l]);a.ps=O();b={};l=[];for(var m in a)"_"!=m.charAt(0)&&(g=Math.round(a[m]-c),b[m]=g,l.push(m+"."+g));d.rt=l.join(",");(a=v("ytdebug.logTiming"))&&a(d,b);jh(d,f,void 0);Kg(Qg,new Og(b.aft+(e||0),void 0))}}}
function jh(a,b,c){if(S("debug_csi_data")){var d=v("yt.timing.csiData");d||(d=[],u("yt.timing.csiData",d,void 0));d.push({page:location.href,time:new Date,args:a})}d="";for(var e in a)d+="&"+e+"="+a[e];a="/csi_204?";S("redirect_csi_204_to_qoe")&&(a="/api/stats/qoe?",d+="&redirect_csi_204_to_qoe=true");a+=d.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b){var f=void 0===f?"":f;try{window.navigator&&window.navigator.sendBeacon&&window.navigator.sendBeacon(a,f)||jf(a,void 0,void 0,void 0,
f)}catch(g){jf(a,void 0,void 0,void 0,f)}}else jf(a);gh(!0,c)}
function kh(a){if("_"!=a[0]){var b=a;X.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),X.mark(b))}b=dh();var c=O();b[a]&&(b["_"+a]=b["_"+a]||[b[a]],b["_"+a].push(c));b[a]=c;b=Lg();if(c=b[a])uf(c),b[a]=0;$g()["tick_"+a]=void 0;O();ah()?(b=bh(),"_start"==a?Fg("baseline_"+b)||Zf("latencyActionBaselined",{clientActionNonce:b},void 0,void 0):Fg("tick_"+a+"_"+b)||Zf("latencyActionTicked",{tickName:a,clientActionNonce:b},void 0,void 0),a=!0):a=!1;if(a=!a)a=!v("yt.timing.pingSent_");if(a&&(b=ke("TIMING_ACTION"),
a=dh(),v("ytglobal.timingready_")&&b&&a._start&&(b=ch()))){S("tighter_critical_section")&&!Vg&&(Kg(Pg,new Ng(Math.round(b-a._start),void 0)),Vg=!0);b=!0;c=Q("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&ih()}}
;function lh(a,b){G.call(this);this.l=this.S=a;this.G=b;this.o=!1;this.f={};this.P=this.F=null;this.w=new I;Gc(this,y(Hc,this.w));this.i={};this.N=this.R=this.h=this.X=this.b=null;this.M=!1;this.j=this.C=null;this.T={};this.sa=["onReady"];this.W=null;this.ia=NaN;this.O={};mh(this);this.U("WATCH_LATER_VIDEO_ADDED",this.Ja.bind(this));this.U("WATCH_LATER_VIDEO_REMOVED",this.Ka.bind(this));this.U("onAdAnnounce",this.va.bind(this));this.ta=new xg(this);Gc(this,y(Hc,this.ta))}
n(lh,G);k=lh.prototype;
k.fa=function(a){if(!this.g){a instanceof ug||(a=new ug(a));this.X=a;this.b=a.clone();this.h=this.b.attrs.id||this.h;"video-player"==this.h&&(this.h=this.G,this.b.attrs.id=this.G);this.l.id==this.h&&(this.h+="-player",this.b.attrs.id=this.h);this.b.args.enablejsapi="1";this.b.args.playerapiid=this.G;this.R||(this.R=nh(this,this.b.args.jsapicallback||"onYouTubePlayerReady"));this.b.args.jsapicallback=null;if(a=this.b.attrs.width)this.l.style.width=bc(Number(a)||a);if(a=this.b.attrs.height)this.l.style.height=bc(Number(a)||
a);oh(this);this.o&&ph(this)}};
k.ya=function(){return this.X};
function ph(a){a.b.loaded||(a.b.loaded=!0,"0"!=a.b.args.autoplay?a.f.loadVideoByPlayerVars(a.b.args):a.f.cueVideoByPlayerVars(a.b.args))}
function qh(a){var b=!0,c=rh(a);c&&a.b&&(a=a.b,b=pe(c,"version")==a.assets.js);return b&&!!v("yt.player.Application.create")}
function oh(a){if(!a.g&&!a.M){var b=qh(a);if(b&&"html5"==(rh(a)?"html5":null))a.N="html5",a.o||sh(a);else if(th(a),a.N="html5",b&&a.j)a.S.appendChild(a.j),sh(a);else{a.b.loaded=!0;var c=!1;a.C=function(){c=!0;var b=a.b.clone();v("yt.player.Application.create")(a.S,b);sh(a)};
a.M=!0;b?a.C():(Ee(a.b.assets.js,a.C),zg(a.b.assets.css),uh(a)&&!c&&u("yt.player.Application.create",null,void 0))}}}
function rh(a){var b=Lb(a.h);!b&&a.l&&a.l.querySelector&&(b=a.l.querySelector("#"+a.h));return b}
function sh(a){if(!a.g){var b=rh(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.M=!1,b.isNotServable&&b.isNotServable(a.b.args.video_id)||vh(a)):a.ia=T(function(){sh(a)},50)}}
function vh(a){mh(a);a.o=!0;var b=rh(a);b.addEventListener&&(a.F=wh(a,b,"addEventListener"));b.removeEventListener&&(a.P=wh(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.f[e]||(a.f[e]=wh(a,b,e))}for(var f in a.i)a.F(f,a.i[f]);ph(a);a.R&&a.R(a.f);a.w.I("onReady",a.f)}
function wh(a,b,c){var d=b[c];return function(){try{return a.W=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.W=e,R(e,"WARNING",void 0,void 0,void 0))}}}
function mh(a){a.o=!1;if(a.P)for(var b in a.i)a.P(b,a.i[b]);for(var c in a.O)re(parseInt(c,10));a.O={};a.F=null;a.P=null;for(var d in a.f)a.f[d]=null;a.f.addEventListener=a.U.bind(a);a.f.removeEventListener=a.Ra.bind(a);a.f.destroy=a.dispose.bind(a);a.f.getLastError=a.za.bind(a);a.f.getPlayerType=a.Aa.bind(a);a.f.getCurrentVideoConfig=a.ya.bind(a);a.f.loadNewVideoConfig=a.fa.bind(a);a.f.isReady=a.Ia.bind(a)}
k.Ia=function(){return this.o};
k.U=function(a,b){var c=this,d=nh(this,b);if(d){if(!(0<=Ba(this.sa,a)||this.i[a])){var e=xh(this,a);this.F&&this.F(a,e)}this.w.subscribe(a,d);"onReady"==a&&this.o&&T(function(){d(c.f)},0)}};
k.Ra=function(a,b){if(!this.g){var c=nh(this,b);c&&yd(this.w,a,c)}};
function nh(a,b){var c=b;if("string"==typeof b){if(a.T[b])return a.T[b];c=function(){var a=v(b);a&&a.apply(p,arguments)};
a.T[b]=c}return c?c:null}
function xh(a,b){var c="ytPlayer"+b+a.G;a.i[b]=c;p[c]=function(c){var d=a.b&&a.b.args&&a.b.args.fflags;if(d&&0>d.indexOf("use_html5_player_event_timeout=true"))a.w.I(b,c);else{var f=T(function(){if(!a.g){a.w.I(b,c);var d=a.O,e=String(f);e in d&&delete d[e]}},0);
cb(a.O,String(f))}};
return c}
...
k.Aa=function(){return this.N||(rh(this)?"html5":null)};
k.za=function(){return this.W};
function th(a){kh("dcp");a.cancel();mh(a);a.N=null;a.b&&(a.b.loaded=!1);var b=rh(a);b&&(qh(a)||!uh(a)?a.j=b:(b&&b.destroy&&b.destroy(),a.j=null));for(a=a.S;b=a.firstChild;)a.removeChild(b)}
k.cancel=function(){this.C&&Ke(this.b.assets.js,this.C);re(this.ia);this.M=!1};
k.m=function(){th(this);if(this.j&&this.b&&this.j.destroy)try{this.j.destroy()}catch(b){R(b)}this.T=null;for(var a in this.i)p[this.i[a]]=null;this.X=this.b=this.f=null;delete this.S;delete this.l;G.prototype.m.call(this)};
function uh(a){return a.b&&a.b.args&&a.b.args.fflags?-1!=a.b.args.fflags.indexOf("player_destroy_old_version=true"):!1}
;var yh={},zh="player_uid_"+(1E9*Math.random()>>>0);function Ah(a){var b="player";b=r(b)?Lb(b):b;var c=zh+"_"+(b[wa]||(b[wa]=++xa)),d=yh[c];if(d)return d.fa(a),d.f;d=new lh(b,c);yh[c]=d;ze("player-added",d.f);Gc(d,y(Bh,d));T(function(){d.fa(a)},0);
return d.f}
function Bh(a){delete yh[a.G]}
;function Ch(){var a=Dh(),b=Eh();if(!a&&!b||!window.JSON)return null;try{var c=a.get("yt-player-two-stage-token")}catch(d){}if(!r(c))try{c=b.get("yt-player-two-stage-token")}catch(d){}if(!r(c))return null;try{c=JSON.parse(c,void 0)}catch(d){}return c}
var Eh=Rb(function(){var a=new Jd;return a.isAvailable()?new Fd(a):null}),Dh=Rb(function(){var a=new Kd;
return a.isAvailable()?new Fd(a):null});function Fh(a){return(0==a.search("cue")||0==a.search("load"))&&"loadModule"!=a}
...
function Hh(a,b,c){if(va(a)){b="endSeconds startSeconds mediaContentUrl suggestedQuality videoId two_stage_token".split(" ");c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}return{videoId:a,startSeconds:b,suggestedQuality:c}}
function Ih(a,b,c,d){if(va(a)&&!w(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};r(a)&&16==a.length?b.list="PL"+a:b.playlist=a;return b}
function Jh(a){var b=a.video_id||a.videoId;if(r(b)){var c=Ch()||{},d=Ch()||{};q(void 0)?d[b]=void 0:delete d[b];var e=z()+3E5,f=Eh();if(f&&window.JSON){r(d)||(d=JSON.stringify(d,void 0));try{f.set("yt-player-two-stage-token",d,e)}catch(g){f.remove("yt-player-two-stage-token")}}(b=c[b])&&(a.two_stage_token=b)}}
;function Kh(a){G.call(this);this.b=a;this.b.subscribe("command",this.pa,this);this.f={};this.i=!1}
A(Kh,G);k=Kh.prototype;k.start=function(){this.i||this.g||(this.i=!0,Lh(this.b,"RECEIVING"))};
...
k.Ta=function(a,b){this.i&&!this.g&&Lh(this.b,a,this.aa(a,b))};
k.aa=function(a,b){if(null!=b)return{value:b}};
function Mh(a,b){b in a.f&&(a.removeEventListener(b,a.f[b]),delete a.f[b])}
k.m=function(){var a=this.b;a.g||yd(a.b,"command",this.pa,this);this.b=null;for(var b in this.f)Mh(this,b);Kh.u.m.call(this)};function Ph(a,b){Kh.call(this,b);this.h=a;this.start()}
...
Ph.prototype.aa=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return Ph.u.aa.call(this,a,b)};
Ph.prototype.m=function(){Ph.u.m.call(this);delete this.h};function Qh(a,b,c,d){G.call(this);this.f=b||null;this.o="*";this.h=c||null;this.sessionId=null;this.channel=d||null;this.C=!!a;this.l=x(this.w,this);window.addEventListener("message",this.l)}
n(Qh,G);Qh.prototype.w=function(a){if(!("*"!=this.h&&a.origin!=this.h||this.f&&a.source!=this.f)&&r(a.data)){try{var b=JSON.parse(a.data)}catch(c){return}if(!(null==b||this.C&&(this.sessionId&&this.sessionId!=b.id||this.channel&&this.channel!=b.channel))&&b)switch(b.event){case "listening":"null"!=a.origin&&(this.h=this.o=a.origin);this.f=a.source;this.sessionId=b.id;this.b&&(this.b(),this.b=null);break;case "command":this.i&&(!this.j||0<=Ba(this.j,b.func))&&this.i(b.func,b.args,a.origin)}}};
Qh.prototype.sendMessage=function(a,b){var c=b||this.f;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=Vc(a);c.postMessage(d,this.o)}catch(e){R(e,"WARNING")}}};
Qh.prototype.m=function(){window.removeEventListener("message",this.l);G.prototype.m.call(this)};function Rh(a,b,c){Qh.call(this,a,b,c||Q("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname,"widget");this.j=this.b=this.i=null}
n(Rh,Qh);function Sh(){var a=this.f=new Rh(!!Q("WIDGET_ID_ENFORCE")),b=x(this.Na,this);a.i=b;a.j=null;this.f.channel="widget";if(a=Q("WIDGET_ID"))this.f.sessionId=a;this.h=[];this.j=!1;this.i={}}
k=Sh.prototype;k.Na=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.i[a]||"onReady"==a||(this.addEventListener(a,Th(this,a)),this.i[a]=!0)):this.ra(a,b,c)};
k.ra=function(){};
...
k.dispose=function(){this.f=null};function Vh(a){Sh.call(this);this.b=a;this.g=[];this.addEventListener("onReady",x(this.La,this));this.addEventListener("onVideoProgress",x(this.Xa,this));this.addEventListener("onVolumeChange",x(this.Ya,this));this.addEventListener("onApiChange",x(this.Sa,this));this.addEventListener("onPlaybackQualityChange",x(this.Ua,this));this.addEventListener("onPlaybackRateChange",x(this.Va,this));this.addEventListener("onStateChange",x(this.Wa,this));this.addEventListener("onWebglSettingsChanged",x(this.Za,
this))}
A(Vh,Sh);k=Vh.prototype;k.ra=function(a,b,c){if(this.b[a]){b=b||[];if(0<b.length&&Fh(a)){var d=b;if(va(d[0])&&!w(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=Hh.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=Gh.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=Ih.apply(window,d)}d=e}Jh(d);b.length=1;b[0]=d}this.b.handleExternalCall(a,b,c);Fh(a)&&Uh(this,this.ba())}};
...
k.Ua=function(a){Uh(this,{playbackQuality:a})};
k.Va=function(a){Uh(this,{playbackRate:a})};
...
k.Ya=function(){Uh(this,{muted:this.b.isMuted(),volume:this.b.getVolume()})};
k.Xa=function(a){a={currentTime:a,videoBytesLoaded:this.b.getVideoBytesLoaded(),videoLoadedFraction:this.b.getVideoLoadedFraction(),currentTimeLastUpdated_:z()/1E3,playbackRate:this.b.getPlaybackRate(),mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());Uh(this,a)};
k.Za=function(){if(this.b.getSphericalProperties){var a={sphericalProperties:this.b.getSphericalProperties()};Uh(this,a)}};
k.dispose=function(){Vh.u.dispose.call(this);for(var a=0;a<this.g.length;a++){var b=this.g[a];this.b.removeEventListener(b.eventType,b.listener)}this.g=[]};function Wh(){G.call(this);this.b=new I;Gc(this,y(Hc,this.b))}
A(Wh,G);Wh.prototype.subscribe=function(a,b,c){return this.g?0:this.b.subscribe(a,b,c)};
Wh.prototype.j=function(a,b){this.g||this.b.I.apply(this.b,arguments)};function Xh(a,b,c){Wh.call(this);this.f=a;this.h=b;this.i=c}
A(Xh,Wh);function Lh(a,b,c){if(!a.g){var d=a.f;d.g||a.h!=d.b||(a={id:a.i,command:b},c&&(a.data=c),d.b.postMessage(Vc(a),d.h))}}
Xh.prototype.m=function(){this.h=this.f=null;Xh.u.m.call(this)};function Yh(a,b,c){G.call(this);this.b=a;this.h=c;this.i=V(window,"message",x(this.j,this));this.f=new Xh(this,a,b);Gc(this,y(Hc,this.f))}
A(Yh,G);Yh.prototype.j=function(a){var b;if(b=!this.g)if(b=a.origin==this.h)a:{b=this.b;do{b:{var c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,r(b))){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.f,c.g||c.j("command",b.command,b.data,a.origin))}};
Yh.prototype.m=function(){Gf(this.i);this.b=null;Yh.u.m.call(this)};function Zh(){var a=eb($h),b;return od(new H(function(c,d){a.onSuccess=function(a){Se(a)?c(a):d(new ai("Request failed, status="+a.status,"net.badstatus",a))};
a.onError=function(a){d(new ai("Unknown request error","net.unknown",a))};
a.L=function(a){d(new ai("Request timed out","net.timeout",a))};
b=$e("//googleads.g.doubleclick.net/pagead/id",a)}),function(a){a instanceof pd&&b.abort();
return gd(a)})}
function ai(a,b){B.call(this,a+", errorCode="+b);this.errorCode=b;this.name="PromiseAjaxError"}
n(ai,B);function bi(a){this.g=void 0===a?null:a;this.f=0;this.b=null}
bi.prototype.then=function(a,b,c){return this.g?this.g.then(a,b,c):1===this.f&&a?(a=a.call(c,this.b),bd(a)?a:ci(a)):2===this.f&&b?(a=b.call(c,this.b),bd(a)?a:di(a)):this};
bi.prototype.getValue=function(){return this.b};
ad(bi);function di(a){var b=new bi;a=void 0===a?null:a;b.f=2;b.b=void 0===a?null:a;return b}
function ci(a){var b=new bi;a=void 0===a?null:a;b.f=1;b.b=void 0===a?null:a;return b}
;function ei(a){B.call(this,a.message||a.description||a.name);this.isMissing=a instanceof fi;this.isTimeout=a instanceof ai&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof pd}
n(ei,B);ei.prototype.name="BiscottiError";function fi(){B.call(this,"Biscotti ID is missing from server")}
n(fi,B);fi.prototype.name="BiscottiMissingError";var $h={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},gi=null;function hi(){if("1"===Za(le(),"args","privembed"))return gd(Error("Biscotti ID is not available in private embed mode"));gi||(gi=od(Zh().then(ii),function(a){return ji(2,a)}));
return gi}
function ii(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new fi;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new fi;a=a.id;ki(a);gi=ci(a);li(18E5,2);return a}
function ji(a,b){var c=new ei(b);ki("");gi=di(c);0<a&&li(12E4,a-1);throw c;}
function li(a,b){T(function(){od(Zh().then(ii,function(a){return ji(b,a)}),pa)},a)}
function ki(a){u("yt.ads.biscotti.lastId_",a,void 0)}
function mi(){try{var a=v("yt.ads.biscotti.getId_");return a?a():hi()}catch(b){return gd(b)}}
;function ni(a){B.apply(this,arguments)}
n(ni,B);ni.prototype.name="YuzuError";function oi(){var a=new ni("ID is missing"),b=new ni("Timeout"),c=null,d=!1;he(function(){c=fe();d=!0});
if(d)return c?ci(c):di(a);var e=new H(function(b,c){he(function(){var d=fe();d?b(d):c(a)})}),f=Td().then(function(){return gd(b)});
return md(jd([e,f]),function(){return f.cancel()})}
;function pi(a){if("1"!==Za(le(),"args","privembed")){a&&(v("yt.ads.biscotti.getId_")||Aa("yt.ads.biscotti.getId_",hi));try{var b=mi();if(S("enable_yuzu")){v("yt.ads.yuzu.getId_")||u("yt.ads.yuzu.getId_",oi,void 0);try{var c=v("yt.ads.yuzu.getId_")()}catch(d){c=gd(d)}}else c=gd(new ni("unimplemented"));kd([b,c]).then(function(a){var b=a[0];a=a[1];if(b.Y||a.Y){b=b.value;a=a.value;var c={};c.dt=fc;c.flash="0";a:{try{var d=window.top.location.href}catch(Ta){d=2;break a}d=null!=d?d==window.document.location.href?
...
F.navigator.mimeTypes.length);d.ca_type="image";if(S("enable_server_side_search_pyv")||S("enable_server_side_mweb_search_pyv")){l=window;try{var m=l.screenX;var t=l.screenY}catch(Ta){}try{var N=l.outerWidth;var Ga=l.outerHeight}catch(Ta){}try{var Wg=l.innerWidth;var Xg=l.innerHeight}catch(Ta){}m=[l.screenLeft,l.screenTop,m,t,l.screen?l.screen.availWidth:void 0,l.screen?l.screen.availTop:void 0,N,Ga,Wg,Xg];t=window.top;try{var U=(t||window).document,sa="CSS1Compat"==U.compatMode?U.documentElement:
...
for(var Rd in Ha)d[Rd]=Ha[Rd]}void 0!==b&&(d.bid=b);void 0!==a&&(d.anid=a);d.bsq=qi++;ff("//www.youtube.com/ad_data_204",{Ba:!1,A:d,withCredentials:!0})}});
T(pi,18E5)}catch(d){R(d)}}}
var qi=0;var Z=v("ytglobal.prefsUserPrefsPrefs_")||{};u("ytglobal.prefsUserPrefsPrefs_",Z,void 0);function ri(){this.b=Q("ALT_PREF_COOKIE_NAME","PREF");var a=lc.get(""+this.b,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
k=ri.prototype;k.get=function(a,b){si(a);ti(a);var c=void 0!==Z[a]?Z[a].toString():null;return null!=c?c:b?b:""};
k.set=function(a,b){si(a);ti(a);if(null==b)throw Error("ExpectedNotNull");Z[a]=b.toString()};
k.remove=function(a){si(a);ti(a);delete Z[a]};
k.save=function(){var a=this.b,b=[],c;for(c in Z)b.push(c+"="+encodeURIComponent(String(Z[c])));cg(a,b.join("&"),63072E3)};
...
qa(ri);var vi=null,wi=null,xi=null,yi={};function zi(a){Zf(a.payload_name,a.payload,void 0,void 0)}
function Ai(a){var b=a.id;a=a.ve_type;var c=ng++;a=new lg({veType:a,veCounter:c,elementIndex:void 0,dataElement:void 0,youtubeData:void 0});yi[b]=a;b=pg();c=og();b&&c&&sg(b,c,a)}
function Bi(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(qg(b,a),a=og()))for(var c in yi){var d=yi[c];d&&sg(b,a,d)}}
function Ci(a){yi[a.id]=new lg({trackingParams:a.tracking_params})}
function Di(a){var b=pg();a=yi[a.id];b&&a&&(S("interaction_click_on_gel_web")?Zf("visualElementGestured",{csn:b,ve:mg(a),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"}):tg({click:{csn:b,visualElement:mg(a)}}))}
function Ei(a){a=a.ids;var b=pg();if(b)for(var c=0;c<a.length;c++){var d=yi[a[c]];d&&Zf("visualElementShown",{csn:b,ve:mg(d),eventType:1})}}
function Fi(){var a=vi;a&&a.startInteractionLogging&&a.startInteractionLogging()}
;u("yt.setConfig",P,void 0);u("yt.config.set",P,void 0);u("yt.setMsg",pf,void 0);u("yt.msgs.set",pf,void 0);u("yt.logging.errors.log",nf,void 0);
u("writeEmbed",function(){var a=Q("PLAYER_CONFIG",void 0);pi(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=Q("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);Q("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");a.args.autoplay&&Jh(a.args);vi=a=Ah(a);a.addEventListener("onScreenChanged",Bi);a.addEventListener("onLogClientVeCreated",Ai);a.addEventListener("onLogServerVeCreated",Ci);a.addEventListener("onLogToGel",zi);
a.addEventListener("onLogVeClicked",Di);a.addEventListener("onLogVesShown",Ei);a.addEventListener("onReady",Fi);b=Q("POST_MESSAGE_ID","player");Q("ENABLE_JS_API")?xi=new Vh(a):Q("ENABLE_POST_API")&&r(b)&&r(c)&&(wi=new Yh(window.parent,b,c),xi=new Ph(a,wi.f));Q("BG_P")&&(Q("BG_I")||Q("BG_IU"))&&Me();xf()},void 0);
u("yt.www.watch.ads.restrictioncookie.spr",function(a){jf(a+"mac_204?action_fcts=1");return!0},void 0);
var Gi=me(function(){kh("ol");var a=ri.getInstance(),b=!!((ui("f"+(Math.floor(119/31)+1))||0)&67108864),c=1<window.devicePixelRatio;if(document.body&&Kc(document.body,"exp-invert-logo"))if(c&&!Kc(document.body,"inverted-hdpi")){var d=document.body;d.classList?d.classList.add("inverted-hdpi"):Kc(d,"inverted-hdpi")||(d.className+=0<d.className.length?" inverted-hdpi":"inverted-hdpi")}else!c&&Kc(document.body,"inverted-hdpi")&&Lc();b!=c&&(b="f"+(Math.floor(119/31)+1),d=ui(b)||0,d=c?d|67108864:d&-67108865,
0==d?delete Z[b]:Z[b]=d.toString(16).toString(),a.save())}),Hi=me(function(){var a=vi;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();Q("PL_ATT")&&(Le=null);a=0;for(var b=vf.length;a<b;a++)uf(vf[a]);vf.length=0;Je("//static.doubleclick.net/instream/ad_status.js");wf=!1;P("DCLKSTAT",0);Ic(xi,wi);if(a=vi)a.removeEventListener("onScreenChanged",Bi),a.removeEventListener("onLogClientVeCreated",Ai),a.removeEventListener("onLogServerVeCreated",Ci),a.removeEventListener("onLogToGel",zi),a.removeEventListener("onLogVeClicked",Di),a.removeEventListener("onLogVesShown",Ei),a.removeEventListener("onReady",
Fi),a.destroy();yi={}});
window.addEventListener?(window.addEventListener("load",Gi),window.addEventListener("unload",Hi)):window.attachEvent&&(window.attachEvent("onload",Gi),window.attachEvent("onunload",Hi));Aa("yt.abuse.botguardInitialized",v("yt.abuse.botguardInitialized")||Oe);Aa("yt.abuse.invokeBotguard",v("yt.abuse.invokeBotguard")||Pe);Aa("yt.abuse.dclkstatus.checkDclkStatus",v("yt.abuse.dclkstatus.checkDclkStatus")||yf);Aa("yt.player.exports.navigate",v("yt.player.exports.navigate")||rg);
Aa("yt.util.activity.init",v("yt.util.activity.init")||Jf);Aa("yt.util.activity.getTimeSinceActive",v("yt.util.activity.getTimeSinceActive")||Mf);Aa("yt.util.activity.setTimestamp",v("yt.util.activity.setTimestamp")||Kf);}).call(this);
