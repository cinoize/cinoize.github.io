...
;function jc(a,b,c){a.addEventListener?a.addEventListener(b,c,void 0):a.attachEvent&&a.attachEvent("on"+b,c)}
function kc(a,b,c){a.removeEventListener?a.removeEventListener(b,c,void 0):a.detachEvent&&a.detachEvent("on"+b,c)}
;function lc(a){var b=!1,c=!1;c=void 0===c?!1:c;b=void 0===b?!1:b;p.google_image_requests||(p.google_image_requests=[]);var d=p.document.createElement("img");if(b){var e=function(){b&&Ga(p.google_image_requests,d);kc(d,"load",e);kc(d,"error",e)};
jc(d,"load",e);jc(d,"error",e)}c&&(d.referrerPolicy="no-referrer");d.src=a;p.google_image_requests.push(d)}
...
throw b;})}
;function ne(a,b,c){var d="script";d=void 0===d?"":d;var e=a.createElement("link");Ob(e,b,"preload");d&&(e.as=d);c&&(e.nonce=c);if(a=a.getElementsByTagName("head")[0])try{a.appendChild(e)}catch(f){}}
...
;function Ge(a){"?"==a.charAt(0)&&(a=a.substr(1));a=a.split("&");for(var b={},c=0,d=a.length;c<d;c++){var e=a[c].split("=");if(1==e.length&&e[0]||2==e.length){var f=decodeURIComponent((e[0]||"").replace(/\+/g," "));e=decodeURIComponent((e[1]||"").replace(/\+/g," "));f in b?w(b[f])?Ka(b[f],e):b[f]=[b[f],e]:b[f]=e}}return b}
...
function Me(a,b){var c=R("XSRF_FIELD_NAME",void 0),d=R("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.A,g=ze("XSRF_FIELD_NAME"),h;b.headers&&(h=b.headers["Content-Type"]);b.sb||oc(G(a)[3]||null)&&!b.withCredentials&&oc(G(a)[3]||null)!=document.location.hostname||"POST"!=b.method||h&&"application/x-www-form-urlencoded"!=h||b.A&&b.A[g]||(f||(f={}),f[c]=d);f&&r(e)&&(e=Ge(e),hb(e,f),e=b.pa&&"JSON"==b.pa?JSON.stringify(e):qc(e));f=e||f&&!cb(f);!Ie&&f&&"POST"!=b.method&&(Ie=!0,S(Error("AJAX request with postData should use POST")));
return e}
function Pe(a,b,c){var d=null;switch(a){case "JSON":a=b.responseText;b=b.getResponseHeader("Content-Type")||"";a&&0<=b.indexOf("json")&&(d=JSON.parse(a));break;case "XML":if(b=(b=b.responseXML)?Qe(b):null)d={},D(b.getElementsByTagName("*"),function(a){d[a.tagName]=Re(a)})}c&&Se(d);
return d}
function Se(a){if(ua(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);if(c){c=b;var d=Mb(a[b],null);a[c]=d}else Se(a[b])}}
function Qe(a){return a?(a=("responseXML"in a?a.responseXML:a).getElementsByTagName("root"))&&0<a.length?a[0]:null:null}
function Re(a){var b="";D(a.childNodes,function(a){b+=a.nodeValue});
return b}
...
;var gf=v("ytPubsubPubsubInstance")||new K;K.prototype.subscribe=K.prototype.subscribe;K.prototype.unsubscribeByKey=K.prototype.K;K.prototype.publish=K.prototype.J;K.prototype.clear=K.prototype.clear;u("ytPubsubPubsubInstance",gf,void 0);var hf=v("ytPubsubPubsubSubscribedKeys")||{};u("ytPubsubPubsubSubscribedKeys",hf,void 0);var jf=v("ytPubsubPubsubTopicToKeys")||{};u("ytPubsubPubsubTopicToKeys",jf,void 0);var kf=v("ytPubsubPubsubIsSynchronous")||{};u("ytPubsubPubsubIsSynchronous",kf,void 0);
...
function nf(a){var b=mf();b&&(ma(a)?a=[a]:r(a)&&(a=[parseInt(a,10)]),D(a,function(a){b.unsubscribeByKey(a);delete hf[a]}))}
...
function qf(a){jf[a]&&(a=jf[a],D(a,function(a){hf[a]&&delete hf[a]}),a.length=0)}
...
function vf(a){var b=document.createElement("a");Nb(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+Ua(a)}
var wf={};function Af(){}
...
qa(Df);Df.getInstance();var Ff=[],Gf=!1;function Hf(){if("1"!=$a(Ae(),"args","privembed")){var a=function(){Gf=!0;"google_ad_status"in window?Q("DCLKSTAT",1):Q("DCLKSTAT",2)};
...
Vf.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var bb=v("ytEventsEventsListeners")||{};u("ytEventsEventsListeners",bb,void 0);var Xf=v("ytEventsEventsCounter")||{count:0};u("ytEventsEventsCounter",Xf,void 0);
...
var Zf=Ab(function(){var a=!1;try{var b=Object.defineProperty({},"capture",{get:function(){a=!0}});
window.addEventListener("test",null,b)}catch(c){}return a});
function W(a,b,c,d){d=void 0===d?{}:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=Yf(a,b,c,d);if(e)return e;e=++Xf.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document);var g=f?function(d){d=new Vf(d);if(!Xb(d.relatedTarget,function(b){return b==a}))return d.currentTarget=a,d.type=b,c.call(a,d)}:function(b){b=new Vf(b);
b.currentTarget=a;return c.call(a,b)};
g=Be(g);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),Zf()||la(d)?a.addEventListener(b,g,d):a.addEventListener(b,g,!!d.capture)):a.attachEvent("on"+b,g);bb[e]=[a,b,c,g,d];return e}
function $f(a){a&&("string"==typeof a&&(a=[a]),D(a,function(a){if(a in bb){var b=bb[a],d=b[0],e=b[1],f=b[3];b=b[4];d.removeEventListener?Zf()||la(b)?d.removeEventListener(e,f,b):d.removeEventListener(e,f,!!b.capture):d.detachEvent&&d.detachEvent("on"+e,f);delete bb[a]}}))}
...
A(ag,I);ag.prototype.F=function(a){q(a.b)||Wf(a);var b=a.b;q(a.f)||Wf(a);this.b=new Qb(b,a.f)};
...
function pg(){Fe(kg);if(!cb(X)){for(var a in X){var b=jg[a];if(b){var c=void 0,d=a,e=b,f=hg[d],g=mg[d]||{};mg[d]=g;b=Math.round(O());for(c in X[d]){var h=e.b;h={client:{hl:h.Ga,gl:h.Fa,clientName:h.Ea,clientVersion:h.innertubeContextClientVersion}};var l=window.devicePixelRatio;l&&1!=l&&(h.client.screenDensityFloat=String(l));R("DELEGATED_SESSION_ID")&&(h.user={onBehalfOfUser:R("DELEGATED_SESSION_ID")});h={context:h};h[f]=og(d,c);g.dispatchedEventCount=g.dispatchedEventCount||0;g.dispatchedEventCount+=
...
rg(e,d,h,{retry:!0})}c=g;d=b;c.previousDispatchMs&&(b=d-c.previousDispatchMs,e=c.diffCount||0,c.averageTimeBetweenDispatchesMs=e?(c.averageTimeBetweenDispatchesMs*e+b)/(e+1):b,c.diffCount=e+1);c.previousDispatchMs=d;delete X[a]}}cb(X)||qg()}}
...
;function ug(a,b){var c={"X-Goog-Visitor-Id":R("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return c;var d;a?d="Bearer "+v("gapi.auth.getToken")().ob:d=Ic([]);d&&(c.Authorization=d,c["X-Goog-AuthUser"]=R("SESSION_INDEX",0));return c}
...
;function wg(a,b,c,d){zb.set(""+a,b,c,"/",void 0===d?"youtube.com":d,!1)}
...
xg.prototype.get=function(a,b){var c=void 0,d=!this.b;if(!d)try{c=this.b.get(a)}catch(e){d=!0}if(d&&(c=zb.get(""+a,void 0))&&(c=unescape(c),b))try{c=JSON.parse(c)}catch(e){this.remove(a),c=void 0}return c};
xg.prototype.remove=function(a){this.b&&this.b.remove(a);var b=this.f;zb.remove(""+a,"/",void 0===b?"youtube.com":b)};var yg=new xg;function zg(a,b,c,d){if(d)return null;d=yg.get("nextId",!0)||1;var e=yg.get("requests",!0)||{};e[d]={method:a,request:b,authState:vg(c),requestTime:Math.round(O())};yg.set("nextId",d+1,86400,!0);yg.set("requests",e,86400,!0);return d}
function Ag(a){var b=yg.get("requests",!0)||{};delete b[a];yg.set("requests",b,86400,!0)}
function Bg(a){var b=yg.get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round(O())-d.requestTime)){var e=d.authState,f=vg(ug(!1));eb(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round(O())),rg(a,d.method,e,{}));delete b[c]}}yg.set("requests",b,86400,!0)}}
...
;function Ng(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=R("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=R("VALID_SESSION_TEMPDATA_DOMAINS",[]),f=oc(G(window.location.href)[3]||null);f&&e.push(f);f=oc(G(d)[3]||null);if(0<=Ca(e,f)||!f&&0==d.lastIndexOf("/",0))if(U("autoescape_tempdata_url")&&(e=document.createElement("a"),Nb(e,d),d=e.href),d){f=G(d);d=f[5];e=f[6];f=f[7];var g="";d&&(g+=d);e&&(g+="?"+e);f&&(g+="#"+f);d=g;e=d.indexOf("#");if(d=0>e?d:d.substr(0,e)){if(b.itct||b.ved)b.csn=b.csn||
Lg();if(h){var h=parseInt(h,10);isFinite(h)&&0<h&&(d="ST-"+Ua(d).toString(36),b=b?qc(b):"",wg(d,b,h||5))}else h="ST-"+Ua(d).toString(36),b=b?qc(b):"",wg(h,b,5)}}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var m=void 0===m?"":m;var t=void 0===t?window:t;c=t.location;a=rc(a,l)+m;a=a instanceof F?a:Ib(a);c.href=Gb(a)}return!0}
...
;function Pg(a){a=a||{};this.url=a.url||"";this.args=a.args||fb(Qg);this.assets=a.assets||{};this.attrs=a.attrs||fb(Rg);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
var Qg={enablejsapi:1},Rg={};Pg.prototype.clone=function(){var a=new Pg,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];a[b]="object"==ra(c)?fb(c):c}return a};function Sg(){I.call(this);this.b=[]}
...
function Wg(a){var b=document.createElement("A");a=Jb(a);Nb(b,a);b=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Ua(b)}
...
qh=!1;function th(){var a=uh().info.yt_lt="hot_bg";vh().info_yt_lt=a;if(wh())if("yt_lt"in nh){var b=nh.yt_lt;0<=Ca(ph,b)&&(a=!!a);if(wh()){var c={};b=b.split(".");for(var d=c,e=0;e<b.length-1;e++)d[b[e]]=d[b[e]]||{},d=d[b[e]];d[b[b.length-1]]=a;a=xh();b=Object.keys(c).join("");$g("info_"+b+"_"+a)||(c.clientActionNonce=a,sg("latencyActionInfo",c,void 0,void 0))}}else 0<=Ca(oh,"yt_lt")||S(Error("Unknown label yt_lt logged with GEL CSI."))}
...
function Eh(){hh();if(!wh()){var a=zh(),b=uh().info,c=a._start;for(f in a)if(0==f.lastIndexOf("_",0)&&w(a[f])){var d=f.slice(1);if(d in mh){var e=Ea(a[f],function(a){return Math.round(a-c)});
...
;function Hh(a,b){I.call(this);this.l=this.T=a;this.F=b;this.o=!1;this.f={};this.P=this.C=null;this.G=new K;$c(this,y(ad,this.G));this.i={};this.N=this.R=this.h=this.Y=this.b=null;this.M=!1;this.j=this.w=null;this.U={};this.ta=["onReady"];this.X=null;this.ja=NaN;this.O={};Ih(this);this.V("WATCH_LATER_VIDEO_ADDED",this.Ka.bind(this));this.V("WATCH_LATER_VIDEO_REMOVED",this.La.bind(this));this.V("onAdAnnounce",this.wa.bind(this));this.ua=new Sg(this);$c(this,y(ad,this.ua))}
n(Hh,I);k=Hh.prototype;
k.ga=function(a){if(!this.g){a instanceof Pg||(a=new Pg(a));this.Y=a;this.b=a.clone();this.h=this.b.attrs.id||this.h;"video-player"==this.h&&(this.h=this.F,this.b.attrs.id=this.F);this.l.id==this.h&&(this.h+="-player",this.b.attrs.id=this.h);this.b.args.enablejsapi="1";this.b.args.playerapiid=this.F;this.R||(this.R=Jh(this,this.b.args.jsapicallback||"onYouTubePlayerReady"));this.b.args.jsapicallback=null;if(a=this.b.attrs.width)this.l.style.width=ic(Number(a)||a);if(a=this.b.attrs.height)this.l.style.height=ic(Number(a)||
...
function Kh(a){if(!a.g&&!a.M){var b=Mh(a);if(b&&"html5"==(Nh(a)?"html5":null))a.N="html5",a.o||Oh(a);else if(Ph(a),a.N="html5",b&&a.j)a.T.appendChild(a.j),Oh(a);else{a.b.loaded=!0;var c=!1;a.w=function(){c=!0;var b=a.b.clone();v("yt.player.Application.create")(a.T,b);Oh(a)};
a.M=!0;b?a.w():(tf(a.b.assets.js,a.w),Ug(a.b.assets.css),Qh(a)&&!c&&u("yt.player.Application.create",null,void 0))}}}
function Nh(a){var b=Sb(a.h);!b&&a.l&&a.l.querySelector&&(b=a.l.querySelector("#"+a.h));return b}
...
function Rh(a){Ih(a);a.o=!0;var b=Nh(a);b.addEventListener&&(a.C=Sh(a,b,"addEventListener"));b.removeEventListener&&(a.P=Sh(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.f[e]||(a.f[e]=Sh(a,b,e))}for(var f in a.i)a.C(f,a.i[f]);Lh(a);a.R&&a.R(a.f);a.G.J("onReady",a.f)}
...
function Ih(a){a.o=!1;if(a.P)for(var b in a.i)a.P(b,a.i[b]);for(var c in a.O)Fe(parseInt(c,10));a.O={};a.C=null;a.P=null;for(var d in a.f)a.f[d]=null;a.f.addEventListener=a.V.bind(a);a.f.removeEventListener=a.Sa.bind(a);a.f.destroy=a.dispose.bind(a);a.f.getLastError=a.Aa.bind(a);a.f.getPlayerType=a.Ba.bind(a);a.f.getCurrentVideoConfig=a.za.bind(a);a.f.loadNewVideoConfig=a.ga.bind(a);a.f.isReady=a.Ja.bind(a)}
k.Ja=function(){return this.o};
k.V=function(a,b){var c=this,d=Jh(this,b);if(d){if(!(0<=Ca(this.ta,a)||this.i[a])){var e=Th(this,a);this.C&&this.C(a,e)}this.G.subscribe(a,d);"onReady"==a&&this.o&&T(function(){d(c.f)},0)}};
k.Sa=function(a,b){if(!this.g){var c=Jh(this,b);c&&Sd(this.G,a,c)}};
...
function Th(a,b){var c="ytPlayer"+b+a.F;a.i[b]=c;p[c]=function(c){var d=T(function(){if(!a.g){a.G.J(b,c);var e=a.O,g=String(d);g in e&&delete e[g]}},0);
db(a.O,String(d))};
return c}
...
k.cancel=function(){this.w&&zf(this.b.assets.js,this.w);Fe(this.ja);this.M=!1};
...
;var Uh={},Vh="player_uid_"+(1E9*Math.random()>>>0);function Wh(a){var b="player";b=r(b)?Sb(b):b;var c=Vh+"_"+(b[wa]||(b[wa]=++xa)),d=Uh[c];if(d)return d.ga(a),d.f;d=new Hh(b,c);Uh[c]=d;of("player-added",d.f);$c(d,y(Xh,d));T(function(){d.ga(a)},0);
return d.f}
function Xh(a){delete Uh[a.F]}
...
var $h=Ab(function(){var a=new ce;return a.isAvailable()?new Zd(a):null}),Zh=Ab(function(){var a=new de;
...
ri.prototype.j=function(a,b){this.g||this.b.J.apply(this.b,arguments)};function si(a,b,c){ri.call(this);this.f=a;this.h=b;this.i=c}
...
ti.prototype.m=function(){$f(this.i);this.b=null;ti.u.m.call(this)};function ui(){var a=fb(vi),b;return Id(new J(function(c,d){a.onSuccess=function(a){Ee(a)?c(a):d(new wi("Request failed, status="+a.status,"net.badstatus",a))};
...
return Ad(a)})}
function wi(a,b){C.call(this,a+", errorCode="+b);this.errorCode=b;this.name="PromiseAjaxError"}
n(wi,C);function xi(a){this.g=void 0===a?null:a;this.f=0;this.b=null}
...
;function Ai(a){C.call(this,a.message||a.description||a.name);this.isMissing=a instanceof Bi;this.isTimeout=a instanceof wi&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof Jd}
n(Ai,C);Ai.prototype.name="BiscottiError";function Bi(){C.call(this,"Biscotti ID is missing from server")}
n(Bi,C);Bi.prototype.name="BiscottiMissingError";var vi={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Ci=null;function Di(){if("1"===$a(Ae(),"args","privembed"))return Ad(Error("Biscotti ID is not available in private embed mode"));Ci||(Ci=Id(ui().then(Ei),function(a){return Fi(2,a)}));
return Ci}
...
;function Ji(a){C.apply(this,arguments)}
n(Ji,C);Ji.prototype.name="YuzuError";function Ki(){var a=new Ji("ID is missing"),b=new Ji("Timeout"),c=null,d=!1;we(function(){c=ue();d=!0});
...
for(var he in Ia)d[he]=Ia[he]}void 0!==b&&(d.bid=b);void 0!==a&&(d.anid=a);d.bsq=Mi++;Te("//www.youtube.com/ad_data_204",{Ca:!1,A:d,withCredentials:!0})}});
T(Li,18E5)}catch(d){S(d)}}}
var Mi=0;var Z=v("ytglobal.prefsUserPrefsPrefs_")||{};u("ytglobal.prefsUserPrefsPrefs_",Z,void 0);function Ni(){this.b=R("ALT_PREF_COOKIE_NAME","PREF");var a=zb.get(""+this.b,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
