...
c.prototype=b.prototype;a.A=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.hb=function(a,c,f){for(var d=Array(arguments.length-2),e=2;e<arguments.length;e++)d[e-2]=arguments[e];return b.prototype[c].apply(a,d)}}
...
A(fe,Wd);fe.prototype.set=function(a,b){this.f.set(this.b+a,b)};
fe.prototype.get=function(a){return this.f.get(this.b+a)};
fe.prototype.remove=function(a){this.f.remove(this.b+a)};
fe.prototype.F=function(a){var b=this.f.F(!0),c=this,d=new hd;d.next=function(){for(var d=b.next();d.substr(0,c.b.length)!=c.b;)d=b.next();return a?d.substr(c.b.length):c.f.get(d)};
return d};function ge(){this.f=[];this.b=-1}
ge.prototype.set=function(a,b){b=void 0===b?!0:b;0<=a&&52>a&&0===a%1&&this.f[a]!=b&&(this.f[a]=b,this.b=-1)};
ge.prototype.get=function(a){return!!this.f[a]};
...
;function S(a,b){za(a)&&(a=le(a));return window.setTimeout(a,b)}
...
function ue(a,b){b=void 0===b?{}:b;if(!c)var c=window.location.href;var d=H(a)[1]||null,e=nc(H(a)[3]||null);d&&e?(d=c,c=H(a),d=H(d),c=c[3]==d[3]&&c[1]==d[1]&&c[4]==d[4]):c=e?nc(H(c)[3]||null)==e&&(Number(H(c)[4]||null)||null)==(Number(H(a)[4]||null)||null):!0;for(var f in se)(d=P(se[f]))&&(c||ve(a,f))&&(b[f]=d);if(c||ve(a,"X-YouTube-Utc-Offset"))b["X-YouTube-Utc-Offset"]=-(new Date).getTimezoneOffset();return b}
function ve(a,b){var c=P("CORS_HEADER_WHITELIST")||{},d=nc(H(a)[3]||null);return d?(c=c[d])?0<=Ha(c,b):!1:!0}
...
b.ja&&0<b.timeout&&(f=S(function(){e||(e=!0,qe(f),b.ja.call(b.context||q))},b.timeout))}else ze(a,b)}
function ze(a,b){var c=b.format||"JSON";a=xe(a,b);var d=ye(a,b),e=!1,f,g=Ae(a,function(a){if(!e){e=!0;f&&qe(f);var d=pe(a),g=null,h=400<=a.status&&500>a.status,da=500<=a.status&&600>a.status;if(d||h||da)g=Be(c,a,b.jb);if(d)a:if(a&&204==a.status)d=!0;else{switch(c){case "XML":d=0==parseInt(g&&g.return_code,10);break a;case "RAW":d=!0;break a}d=!!g}g=g||{};h=b.context||q;d?b.onSuccess&&b.onSuccess.call(h,a,g):b.onError&&b.onError.call(h,a,g);b.fa&&b.fa.call(h,a,g)}},b.method,d,b.headers,b.responseType,
b.withCredentials);
b.M&&0<b.timeout&&(f=S(function(){e||(e=!0,g.abort(),qe(f),b.M.call(b.context||q,g))},b.timeout));
return g}
function xe(a,b){b.xa&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var c=P("XSRF_FIELD_NAME",void 0),d=b.Ta;if(d){d[c]&&delete d[c];d=d||{};var e=a.split("#",2);c=e[0];e=1<e.length?"#"+e[1]:"";var f=c.split("?",2);c=f[0];f=re(f[1]||"");for(var g in d)f[g]=d[g];a=qc(c,f)+e}return a}
function ye(a,b){var c=P("XSRF_FIELD_NAME",void 0),d=P("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.C,g=Q("XSRF_FIELD_NAME"),h;b.headers&&(h=b.headers["Content-Type"]);b.kb||nc(H(a)[3]||null)&&!b.withCredentials&&nc(H(a)[3]||null)!=document.location.hostname||"POST"!=b.method||h&&"application/x-www-form-urlencoded"!=h||b.C&&b.C[g]||(f||(f={}),f[c]=d);f&&t(e)&&(e=re(e),mb(e,f),e=b.ka&&"JSON"==b.ka?JSON.stringify(e):pc(e));f=e||f&&!hb(f);!te&&f&&"POST"!=b.method&&(te=!0,R(Error("AJAX request with postData should use POST")));
return e}
function Be(a,b,c){var d=null;switch(a){case "JSON":a=b.responseText;b=b.getResponseHeader("Content-Type")||"";a&&0<=b.indexOf("json")&&(d=JSON.parse(a));break;case "XML":if(b=(b=b.responseXML)?Ce(b):null)d={},D(b.getElementsByTagName("*"),function(a){d[a.tagName]=De(a)})}c&&Ee(d);
return d}
function Ee(a){if(x(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);if(c){c=b;var d=Rb(a[b],null);a[c]=d}else Ee(a[b])}}
function Ce(a){return a?(a=("responseXML"in a?a.responseXML:a).getElementsByTagName("root"))&&0<a.length?a[0]:null:null}
function De(a){var b="";D(a.childNodes,function(a){b+=a.nodeValue});
return b}
function Fe(a,b){b.method="POST";b.C||(b.C={});ze(a,b)}
function Ae(a,b,c,d,e,f,g){function h(){4==(l&&"readyState"in l?l.readyState:0)&&b&&le(b)(l)}
...
Zb("IFRAME",{src:'javascript:"<body><img src=\\""+'+a+'+"\\"></body>"',style:"display:none"}),(9==a.nodeType?a:a.ownerDocument||a.document).body.appendChild(a))):e?Ae(a,b,"POST",e,d):P("USE_NET_AJAX_FOR_PING_TRANSPORT",!1)||d?Ae(a,b,"GET","",d):Je(a,b))}
function Je(a,b){var c=new Image,d=""+He++;Ge[d]=c;c.onload=c.onerror=function(){b&&Ge[d]&&b();delete Ge[d]};
c.src=a}
;var Ke={},Le=0;
function Me(a,b,c,d,e,f){f=f||{};f.name=c||P("INNERTUBE_CONTEXT_CLIENT_NAME",1);f.version=d||P("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0);b=void 0===b?"ERROR":b;e=void 0===e?!1:e;b=void 0===b?"ERROR":b;e=window&&window.yterr||(void 0===e?!1:e)||!1;if(a&&e&&!(5<=Le)){e=a.stacktrace;c=a.columnNumber;a.hasOwnProperty("params")&&(f.params=JSON.stringify(a.params).substr(0,500));d=w("window.location.href");if(t(a))a={message:a,name:"Unknown error",lineNumber:"Not available",fileName:d,stack:"Not available"};else{var g=
!1;try{var h=a.lineNumber||a.line||"Not available"}catch(da){h="Not available",g=!0}try{var l=a.fileName||a.filename||a.sourceURL||q.$googDebugFname||d}catch(da){l="Not available",g=!0}a=!g&&a.lineNumber&&a.fileName&&a.stack&&a.message&&a.name?a:{message:a.message||"Not available",name:a.name||"UnknownError",lineNumber:h,fileName:l,stack:a.stack||"Not available"}}e=e||a.stack;h=a.lineNumber.toString();isNaN(h)||isNaN(c)||(h=h+":"+c);if(!(Ke[a.message]||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js"))){l=
e;h={Ta:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,1E3),line:h,level:b,"client.name":f.name},C:{url:P("PAGE_NAME",window.location.href),file:a.fileName},method:"POST"};f.version&&(h["client.version"]=f.version);l&&(h.C.stack=l);for(var m in f)h.C["client."+m]=f[m];if(m=P("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(var v in m)h.C[v]=m[v];ze(P("ECATCHER_REPORT_HOST","")+"/error_204",h);Ke[a.message]=!0;Le++}}}
;var Ne=window.yt&&window.yt.msgs_||window.ytcfg&&window.ytcfg.msgs||{};u("yt.msgs_",Ne,void 0);function Oe(a){ie(Ne,arguments)}
;function Pe(a){a&&(a.dataset?a.dataset[Qe("loaded")]="true":a.setAttribute("data-loaded","true"))}
...
;var Te=w("ytPubsubPubsubInstance")||new L;L.prototype.subscribe=L.prototype.subscribe;L.prototype.unsubscribeByKey=L.prototype.L;L.prototype.publish=L.prototype.K;L.prototype.clear=L.prototype.clear;u("ytPubsubPubsubInstance",Te,void 0);var Ue=w("ytPubsubPubsubSubscribedKeys")||{};u("ytPubsubPubsubSubscribedKeys",Ue,void 0);var Ve=w("ytPubsubPubsubTopicToKeys")||{};u("ytPubsubPubsubTopicToKeys",Ve,void 0);var We=w("ytPubsubPubsubIsSynchronous")||{};u("ytPubsubPubsubIsSynchronous",We,void 0);
function Xe(a,b){var c=Ye();if(c){var d=c.subscribe(a,function(){var c=arguments;var f=function(){Ue[d]&&b.apply(window,c)};
try{We[a]?f():S(f,0)}catch(g){R(g)}},void 0);
Ue[d]=!0;Ve[a]||(Ve[a]=[]);Ve[a].push(d);return d}return 0}
function Ze(a){var b=Ye();b&&("number"==typeof a?a=[a]:t(a)&&(a=[parseInt(a,10)]),D(a,function(a){b.unsubscribeByKey(a);delete Ue[a]}))}
...
function Ye(){return w("ytPubsubPubsubInstance")}
function bf(a){Ve[a]&&(a=Ve[a],D(a,function(a){Ue[a]&&delete Ue[a]}),a.length=0)}
;var cf=/\.vflset|-vfl[a-zA-Z0-9_+=-]+/,df=/-[a-zA-Z]{2,3}_[a-zA-Z]{2,3}(?=(\/|$))/;function ef(a,b,c){c=void 0===c?null:c;if(window.spf){c="";if(a){var d=a.indexOf("jsbin/"),e=a.lastIndexOf(".js"),f=d+6;-1<d&&-1<e&&e>f&&(c=a.substring(f,e),c=c.replace(cf,""),c=c.replace(df,""),c=c.replace("debug-",""),c=c.replace("tracing-",""))}spf.script.load(a,c,b)}else ff(a,b,c)}
function ff(a,b,c){c=void 0===c?null:c;var d=gf(a),e=document.getElementById(d),f=e&&Re(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=Xe(d,b),b=""+(b[Aa]||(b[Aa]=++Ba)),hf[b]=f),g||(e=jf(a,d,function(){Re(e,"loaded")||(Pe(e),$e(d),S(Ea(af,d),0))},c)))}
function jf(a,b,c,d){d=void 0===d?null:d;var e=document.createElement("SCRIPT");e.id=b;e.onload=function(){c&&setTimeout(c,0)};
...
function kf(a){a=gf(a);var b=document.getElementById(a);b&&(af(a),b.parentNode.removeChild(b))}
function lf(a,b){if(a&&b){var c=""+(b[Aa]||(b[Aa]=++Ba));(c=hf[c])&&Ze(c)}}
function gf(a){var b=document.createElement("a");Sb(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+$a(a)}
var hf={};function mf(){}
function nf(a,b){return of(a,1,b)}
;function pf(){}
n(pf,mf);function of(a,b,c){isNaN(c)&&(c=void 0);var d=w("yt.scheduler.instance.addJob");return d?d(a,b,c):void 0===c?(a(),NaN):S(a,c||0)}
function qf(a){if(!isNaN(a)){var b=w("yt.scheduler.instance.cancelJob");b?b(a):qe(a)}}
pf.prototype.start=function(){var a=w("yt.scheduler.instance.start");a&&a()};
pf.prototype.pause=function(){var a=w("yt.scheduler.instance.pause");a&&a()};
va(pf);pf.getInstance();var rf=[],sf=!1;function tf(){if("1"!=eb(ke(),"args","privembed")){var a=function(){sf=!0;"google_ad_status"in window?O("DCLKSTAT",1):O("DCLKSTAT",2)};
ef("//static.doubleclick.net/instream/ad_status.js",a);rf.push(nf(function(){sf||"google_ad_status"in window||(lf("//static.doubleclick.net/instream/ad_status.js",a),O("DCLKSTAT",3))},5E3))}}
function uf(){return parseInt(P("DCLKSTAT",0),10)}
;function vf(){this.f=!1;this.b=null}
vf.prototype.initialize=function(a,b,c,d,e){b?(this.f=!0,ef(b,function(){this.f=!1;window.botguard?wf(this,c,d):(kf(b),R(Error("Unable to load Botguard from "+b),"WARNING"))}.bind(this),e)):a&&(eval(a),window.botguard?wf(this,c,d):R(Error("Unable to load Botguard from JS"),"WARNING"))};
...
vf.prototype.dispose=function(){this.b=null};function T(a){return P("EXPERIMENT_FLAGS",{})[a]}
;var xf=new vf,yf=!1,zf=0,Af="";function Bf(a){T("botguard_periodic_refresh")?zf=N():T("botguard_always_refresh")&&(Af=a)}
function Cf(a){if(a){if(xf.f)return!1;if(T("botguard_periodic_refresh"))return 72E5<N()-zf;if(T("botguard_always_refresh"))return Af!=a}else return!1;return!yf}
function Df(){return null!==xf.b}
function Ef(){return xf.invoke()}
;var Ff=0;u("ytDomDomGetNextId",w("ytDomDomGetNextId")||function(){return++Ff},void 0);var Gf={stopImmediatePropagation:1,stopPropagation:1,preventMouseEvent:1,preventManipulation:1,preventDefault:1,layerX:1,layerY:1,screenX:1,screenY:1,scale:1,rotation:1,webkitMovementX:1,webkitMovementY:1};
...
function If(a){if(document.body&&document.documentElement){var b=document.body.scrollTop+document.documentElement.scrollTop;a.b=a.clientX+(document.body.scrollLeft+document.documentElement.scrollLeft);a.f=a.clientY+b}}
...
Hf.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var gb=w("ytEventsEventsListeners")||{};u("ytEventsEventsListeners",gb,void 0);var Jf=w("ytEventsEventsCounter")||{count:0};u("ytEventsEventsCounter",Jf,void 0);
...
var Lf=Fb(function(){var a=!1;try{var b=Object.defineProperty({},"capture",{get:function(){a=!0}});
window.addEventListener("test",null,b)}catch(c){}return a});
function U(a,b,c,d){d=void 0===d?{}:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=Kf(a,b,c,d);if(e)return e;e=++Jf.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document);var g=f?function(d){d=new Hf(d);if(!ac(d.relatedTarget,function(b){return b==a}))return d.currentTarget=a,d.type=b,c.call(a,d)}:function(b){b=new Hf(b);
b.currentTarget=a;return c.call(a,b)};
g=le(g);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),Lf()||"boolean"==typeof d?a.addEventListener(b,g,d):a.addEventListener(b,g,!!d.capture)):a.attachEvent("on"+b,g);gb[e]=[a,b,c,g,d];return e}
function Mf(a){a&&("string"==typeof a&&(a=[a]),D(a,function(a){if(a in gb){var b=gb[a],d=b[0],e=b[1],f=b[3];b=b[4];d.removeEventListener?Lf()||"boolean"==typeof b?d.removeEventListener(e,f,b):d.removeEventListener(e,f,!!b.capture):d.detachEvent&&d.detachEvent("on"+e,f);delete gb[a]}}))}
;function Nf(a){this.w=a;this.b=null;this.i=0;this.m=null;this.j=0;this.g=[];for(a=0;4>a;a++)this.g.push(0);this.h=0;this.D=U(window,"mousemove",y(this.G,this));a=y(this.B,this);za(a)&&(a=le(a));this.H=window.setInterval(a,25)}
A(Nf,J);Nf.prototype.G=function(a){r(a.b)||If(a);var b=a.b;r(a.f)||If(a);this.b=new Ub(b,a.f)};
Nf.prototype.B=function(){if(this.b){var a=N();if(0!=this.i){var b=this.m,c=this.b,d=b.x-c.x;b=b.y-c.y;d=Math.sqrt(d*d+b*b)/(a-this.i);this.g[this.h]=.5<Math.abs((d-this.j)/this.j)?1:0;for(c=b=0;4>c;c++)b+=this.g[c]||0;3<=b&&this.w();this.j=d}this.i=a;this.m=this.b;this.h=(this.h+1)%4}};
Nf.prototype.l=function(){window.clearInterval(this.H);Mf(this.D)};var Of={};
function Pf(a){var b=void 0===a?{}:a;a=void 0===b.ya?!0:b.ya;b=void 0===b.Ia?!1:b.Ia;if(null==w("_lact",window)){var c=parseInt(P("LACT"),10);c=isFinite(c)?z()-Math.max(c,0):-1;u("_lact",c,window);u("_fact",c,window);-1==c&&Qf();U(document,"keydown",Qf);U(document,"keyup",Qf);U(document,"mousedown",Qf);U(document,"mouseup",Qf);a&&(b?U(window,"touchmove",function(){Rf("touchmove",200)},{passive:!0}):(U(window,"resize",function(){Rf("resize",200)}),U(window,"scroll",function(){Rf("scroll",200)})));
new Nf(function(){Rf("mouse",100)});
U(document,"touchstart",Qf,{passive:!0});U(document,"touchend",Qf,{passive:!0})}}
function Rf(a,b){Of[a]||(Of[a]=!0,nf(function(){Qf();Of[a]=!1},b))}
function Qf(){null==w("_lact",window)&&Pf();var a=z();u("_lact",a,window);-1==w("_fact",window)&&u("_fact",a,window);(a=w("ytglobal.ytUtilActivityCallback_"))&&a()}
function Sf(){var a=w("_lact",window);return null==a?-1:Math.max(z()-a,0)}
;var Tf=Math.pow(2,16)-1,Uf=null,Vf=0,Wf={log_event:"events",log_interaction:"interactions"},Xf=Object.create(null);Xf.log_event="GENERIC_EVENT_LOGGING";Xf.log_interaction="INTERACTION_LOGGING";var Yf=new Set(["log_event"]),Zf={},$f=0,V=w("ytLoggingTransportLogPayloadsQueue_")||{};u("ytLoggingTransportLogPayloadsQueue_",V,void 0);var ag=w("ytLoggingTransportTokensToCttTargetIds_")||{};u("ytLoggingTransportTokensToCttTargetIds_",ag,void 0);var bg=w("ytLoggingTransportDispatchedStats_")||{};
u("ytLoggingTransportDispatchedStats_",bg,void 0);u("ytytLoggingTransportCapturedTime_",w("ytLoggingTransportCapturedTime_")||{},void 0);function cg(a,b){if(a.W){var c=a.W;var d={};c.videoId?d.videoId=c.videoId:c.playlistId&&(d.playlistId=c.playlistId);ag[a.W.token]=d;c=dg(a.endpoint,a.W.token)}else c=dg(a.endpoint);c.push(a.payload);Zf[a.endpoint]=new b;c.length>=(Number(T("web_logging_max_batch")||0)||20)?eg():fg()}
function eg(){qe($f);if(!hb(V)){for(var a in V){var b=Zf[a];b&&(gg(a,b),delete V[a])}hb(V)||fg()}}
function fg(){qe($f);$f=S(eg,P("LOGGING_BATCH_TIMEOUT",1E4))}
function dg(a,b){b=void 0===b?"":b;V[a]=V[a]||{};V[a][b]=V[a][b]||[];return V[a][b]}
function gg(a,b){var c=Wf[a],d=bg[a]||{};bg[a]=d;var e=Math.round(N());for(m in V[a]){var f=b.b;f={client:{hl:f.Ba,gl:f.Aa,clientName:f.za,clientVersion:f.innertubeContextClientVersion}};var g=window.devicePixelRatio;g&&1!=g&&(f.client.screenDensityFloat=String(g));P("DELEGATED_SESSION_ID")&&!T("pageid_as_header_web")&&(f.user={onBehalfOfUser:P("DELEGATED_SESSION_ID")});f={context:f};f[c]=dg(a,m);d.dispatchedEventCount=d.dispatchedEventCount||0;d.dispatchedEventCount+=f[c].length;if(g=ag[m])a:{var h=
m;if(g.videoId)var l="VIDEO";else if(g.playlistId)l="PLAYLIST";else break a;f.credentialTransferTokenTargetId=g;f.context=f.context||{};f.context.user=f.context.user||{};f.context.user.credentialTransferTokens=[{token:h,scope:l}]}delete ag[m];f.requestTimeMs=e;if(g=Q("EVENT_ID"))l=(P("BATCH_CLIENT_COUNTER",void 0)||0)+1,l>Tf&&(l=1),O("BATCH_CLIENT_COUNTER",l),g={serializedEventId:g,clientCounter:l},f.serializedClientEventId=g,Uf&&Vf&&T("log_gel_rtt_web")&&(f.previousBatchInfo={serializedClientEventId:Uf,
roundtripMs:Vf}),Uf=g,Vf=0;hg(b,a,f,{retry:Yf.has(a),onSuccess:ig.bind(this,N())})}if(d.previousDispatchMs){c=e-d.previousDispatchMs;var m=d.diffCount||0;d.averageTimeBetweenDispatchesMs=m?(d.averageTimeBetweenDispatchesMs*m+c)/(m+1):c;d.diffCount=m+1}d.previousDispatchMs=e}
function ig(a){Vf=Math.round(N()-a)}
;function jg(a,b,c,d){var e=kg,f={};f.eventTimeMs=Math.round(c||N());f[a]=b;f.context={lastActivityMs:String(c?-1:Sf())};cg({endpoint:"log_event",payload:f,W:d},e)}
;function lg(a,b){var c={"X-Goog-Visitor-Id":P("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return c;var d;a?d="Bearer "+w("gapi.auth.getToken")().gb:d=Jc([]);d&&(c.Authorization=d,c["X-Goog-AuthUser"]=P("SESSION_INDEX",0),T("pageid_as_header_web")&&(c["X-Goog-PageId"]=P("DELEGATED_SESSION_ID")));return c}
...
;function ng(a,b,c,d){Eb.set(""+a,b,c,"/",void 0===d?"youtube.com":d,!1)}
;function og(){var a=new Yd;(a=a.isAvailable()?new fe(a,"yt.innertube"):null)||(a=new $d("yt.innertube"),a=a.isAvailable()?a:null);this.b=a?new M(a):null;this.f=document.domain||window.location.hostname}
og.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.b)try{this.b.set(a,b,z()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(pd(b))}catch(f){return}else e=escape(b);ng(a,e,c,this.f)};
og.prototype.get=function(a,b){var c=void 0,d=!this.b;if(!d)try{c=this.b.get(a)}catch(e){d=!0}if(d&&(c=Eb.get(""+a,void 0))&&(c=unescape(c),b))try{c=JSON.parse(c)}catch(e){this.remove(a),c=void 0}return c};
og.prototype.remove=function(a){this.b&&this.b.remove(a);var b=this.f;Eb.remove(""+a,"/",void 0===b?"youtube.com":b)};var pg=new og;function qg(a,b,c,d){if(d)return null;d=pg.get("nextId",!0)||1;var e=pg.get("requests",!0)||{};e[d]={method:a,request:b,authState:mg(c),requestTime:Math.round(N())};pg.set("nextId",d+1,86400,!0);pg.set("requests",e,86400,!0);return d}
function rg(a){var b=pg.get("requests",!0)||{};delete b[a];pg.set("requests",b,86400,!0)}
function sg(a){var b=pg.get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round(N())-d.requestTime)){var e=d.authState,f=mg(lg(!1));jb(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round(N())),hg(a,d.method,e,{}));delete b[c]}}pg.set("requests",b,86400,!0)}}
;function kg(a){var b=this;this.b=a||{innertubeApiKey:Q("INNERTUBE_API_KEY"),innertubeApiVersion:Q("INNERTUBE_API_VERSION"),za:P("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),innertubeContextClientVersion:Q("INNERTUBE_CONTEXT_CLIENT_VERSION"),Ba:Q("INNERTUBE_CONTEXT_HL"),Aa:Q("INNERTUBE_CONTEXT_GL"),Ca:Q("INNERTUBE_HOST_OVERRIDE")||"",Da:!!P("INNERTUBE_USE_THIRD_PARTY_AUTH",!1)};of(function(){sg(b)},0,5E3)}
function hg(a,b,c,d){!P("VISITOR_DATA")&&.01>Math.random()&&R(Error("Missing VISITOR_DATA when sending innertube request."),"WARNING");var e={headers:{"Content-Type":"application/json"},method:"POST",C:c,ka:"JSON",M:function(){d.M()},
ja:d.M,onSuccess:function(a,b){if(d.onSuccess)d.onSuccess(b)},
ia:function(a){if(d.onSuccess)d.onSuccess(a)},
onError:function(a,b){if(d.onError)d.onError(b)},
lb:function(a){if(d.onError)d.onError(a)},
timeout:d.timeout,withCredentials:!0},f="",g=a.b.Ca;g&&(f=g);g=a.b.Da||!1;var h=lg(g,f);Object.assign(e.headers,h);e.headers.Authorization&&!f&&(e.headers["x-origin"]=window.location.origin);var l=""+f+("/youtubei/"+a.b.innertubeApiVersion+"/"+b)+"?alt=json&key="+a.b.innertubeApiKey,m;if(d.retry&&T("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=f&&(m=qg(b,c,h,g))){var v=e.onSuccess,da=e.ia;e.onSuccess=function(a,b){rg(m);v(a,b)};
c.ia=function(a,b){rg(m);da(a,b)}}try{T("use_fetch_for_op_xhr")?we(l,e):Fe(l,e)}catch(G){if("InvalidAccessError"==G)m&&(rg(m),m=0),R(Error("An extension is blocking network request."),"WARNING");
else throw G;}m&&of(function(){sg(a)},0,5E3)}
;var tg=z().toString();
function ug(){a:{if(window.crypto&&window.crypto.getRandomValues)try{var a=Array(16),b=new Uint8Array(16);window.crypto.getRandomValues(b);for(var c=0;c<a.length;c++)a[c]=b[c];var d=a;break a}catch(e){}d=Array(16);for(a=0;16>a;a++){b=z();for(c=0;c<b%23;c++)d[a]=Math.random();d[a]=Math.floor(256*Math.random())}if(tg)for(a=1,b=0;b<tg.length;b++)d[a%16]=d[a%16]^d[(a-1)%16]/4^tg.charCodeAt(b),a++}a=[];for(b=0;b<d.length;b++)a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(d[b]&63));
return a.join("")}
;var vg=ug();function wg(a){this.b=a}
function xg(a){var b={};void 0!==a.b.trackingParams?b.trackingParams=a.b.trackingParams:(b.veType=a.b.veType,null!=a.b.veCounter&&(b.veCounter=a.b.veCounter),null!=a.b.elementIndex&&(b.elementIndex=a.b.elementIndex));void 0!==a.b.dataElement&&(b.dataElement=xg(a.b.dataElement));void 0!==a.b.youtubeData&&(b.youtubeData=a.b.youtubeData);return b}
var yg=1;function zg(a){a=void 0===a?0:a;return 0==a?"client-screen-nonce":"client-screen-nonce."+a}
function Ag(a){a=void 0===a?0:a;return 0==a?"ROOT_VE_TYPE":"ROOT_VE_TYPE."+a}
function Bg(a){return P(Ag(void 0===a?0:a),void 0)}
u("yt.logging.screen.getRootVeType",Bg,void 0);function Cg(){var a=Bg(0),b;a?b=new wg({veType:a,youtubeData:void 0}):b=null;return b}
function Dg(a){a=void 0===a?0:a;var b=P(zg(a));b||0!=a||(b=P("EVENT_ID"));return b?b:null}
u("yt.logging.screen.getCurrentCsn",Dg,void 0);function Eg(a,b,c){c=void 0===c?0:c;O(zg(c),a);O(Ag(c),b);0==c&&(b=function(){setTimeout(function(){a&&jg("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:vg,clientScreenNonce:a})},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b())}
u("yt.logging.screen.setCurrentScreen",Eg,void 0);function Fg(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=P("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=P("VALID_SESSION_TEMPDATA_DOMAINS",[]),f=nc(H(window.location.href)[3]||null);f&&e.push(f);f=nc(H(d)[3]||null);if(0<=Ha(e,f)||!f&&0==d.lastIndexOf("/",0))if(T("autoescape_tempdata_url")&&(e=document.createElement("a"),Sb(e,d),d=e.href),d){f=H(d);d=f[5];e=f[6];f=f[7];var g="";d&&(g+=d);e&&(g+="?"+e);f&&(g+="#"+f);d=g;e=d.indexOf("#");if(d=0>e?d:d.substr(0,e)){if(b.itct||b.ved)b.csn=b.csn||
Dg();if(h){var h=parseInt(h,10);isFinite(h)&&0<h&&(d="ST-"+$a(d).toString(36),b=b?pc(b):"",ng(d,b,h||5))}else h="ST-"+$a(d).toString(36),b=b?pc(b):"",ng(h,b,5)}}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var m=void 0===m?"":m;var v=void 0===v?window:v;c=v.location;a=qc(a,l)+m;a=a instanceof F?a:Nb(a);c.href=Lb(a)}return!0}
;function Gg(a,b,c){T("attach_child_on_gel_web")?Hg(a,b,[c]):Ig({attachChild:{csn:a,parentVisualElement:xg(b),visualElements:[xg(c)]}})}
function Hg(a,b,c){T("attach_child_on_gel_web")?(a={csn:a,parentVe:xg(b),childVes:Ka(c,function(a){return xg(a)})},jg("visualElementAttached",a)):(a={csn:a,
parentVisualElement:xg(b),visualElements:Ka(c,function(a){return xg(a)})},Ig({attachChild:a}))}
function Ig(a){var b=kg;a.eventTimeMs=Math.round(N());a.lactMs=Sf();cg({endpoint:"log_interaction",payload:a},b)}
;function Jg(a){a=a||{};this.url=a.url||"";this.args=a.args||kb(Kg);this.assets=a.assets||{};this.attrs=a.attrs||kb(Lg);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
var Kg={enablejsapi:1},Lg={};Jg.prototype.clone=function(){var a=new Jg,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];a[b]="object"==wa(c)?kb(c):c}return a};function Mg(){J.call(this);this.b=[]}
n(Mg,J);Mg.prototype.l=function(){for(;this.b.length;){var a=this.b.pop();a.target.removeEventListener(a.name,a.ib)}J.prototype.l.call(this)};var Ng=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function Og(a){a=a||"";if(window.spf){var b=a.match(Ng);spf.style.load(a,b?b[1]:"",void 0)}else Pg(a)}
function Pg(a){var b=Qg(a),c=document.getElementById(b),d=c&&Re(c,"loaded");d||c&&!d||(c=Rg(a,b,function(){Re(c,"loaded")||(Pe(c),$e(b),S(Ea(af,b),0))}))}
...
function Qg(a){var b=document.createElement("A");a=Ob(a);Sb(b,a);b=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+$a(b)}
;var Sg=w("ytLoggingLatencyUsageStats_")||{};u("ytLoggingLatencyUsageStats_",Sg,void 0);var Tg=0;function Ug(a){Sg[a]=Sg[a]||{count:0};var b=Sg[a];b.count++;b.time=N();Tg||(Tg=of(Vg,0,5E3));return 10<b.count?(11==b.count&&Me(Error("CSI data exceeded logging limit with key: "+a),0==a.indexOf("info")?"WARNING":"ERROR"),!0):!1}
function Vg(){var a=N(),b;for(b in Sg)6E4<a-Sg[b].time&&delete Sg[b];Tg=0}
;function Wg(a,b){this.version=a;this.args=b}
;function Xg(a){this.topic=a}
Xg.prototype.toString=function(){return this.topic};var Yg=w("ytPubsub2Pubsub2Instance")||new L;L.prototype.subscribe=L.prototype.subscribe;L.prototype.unsubscribeByKey=L.prototype.L;L.prototype.publish=L.prototype.K;L.prototype.clear=L.prototype.clear;u("ytPubsub2Pubsub2Instance",Yg,void 0);u("ytPubsub2Pubsub2SubscribedKeys",w("ytPubsub2Pubsub2SubscribedKeys")||{},void 0);u("ytPubsub2Pubsub2TopicToKeys",w("ytPubsub2Pubsub2TopicToKeys")||{},void 0);u("ytPubsub2Pubsub2IsAsync",w("ytPubsub2Pubsub2IsAsync")||{},void 0);
u("ytPubsub2Pubsub2SkipSubKey",null,void 0);function Zg(a,b){var c=w("ytPubsub2Pubsub2Instance");c&&c.publish.call(c,a.toString(),a,b)}
;var W=window.performance||window.mozPerformance||window.msPerformance||window.webkitPerformance||{};function $g(){var a=P("TIMING_TICK_EXPIRATION");a||(a={},O("TIMING_TICK_EXPIRATION",a));return a}
function ah(){var a=$g(),b;for(b in a)qf(a[b]);O("TIMING_TICK_EXPIRATION",{})}
;function bh(a,b){Wg.call(this,1,arguments)}
n(bh,Wg);function ch(a,b){Wg.call(this,1,arguments)}
n(ch,Wg);var dh=new Xg("aft-recorded"),eh=new Xg("timing-sent");var fh={vc:!0},X={},gh=(X.ad_allowed="adTypesAllowed",X.yt_abt="adBreakType",X.ad_cpn="adClientPlaybackNonce",X.ad_docid="adVideoId",X.yt_ad_an="adNetworks",X.ad_at="adType",X.p="httpProtocol",X.t="transportProtocol",X.cpn="clientPlaybackNonce",X.csn="clientScreenNonce",X.docid="videoId",X.is_nav="isNavigation",X.yt_lt="loadType",X.yt_ad="isMonetized",X.nr="webInfo.navigationReason",X.ncnp="webInfo.nonPreloadedNodeCount",X.paused="playerInfo.isPausedOnLoad",X.fmt="playerInfo.itag",X.yt_pl="watchInfo.isPlaylist",
X.yt_ad_pr="prerollAllowed",X.yt_red="isRedSubscriber",X.st="serverTimeMs",X.vph="viewportHeight",X.vpw="viewportWidth",X.yt_vis="isVisible",X),hh="ap c cver ei srt yt_fss yt_li plid vpil vpni vpst yt_eil vpni2 vpil2 icrc icrt pa GetBrowse_rid GetPlayer_rid GetSearch_rid GetWatchNext_rid cmt d_vpct d_vpnfi d_vpni pc pfa pfeh pftr prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis yt_ref yt_sts".split(" "),ih="isNavigation isMonetized playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber isVisible watchInfo.isPlaylist".split(" "),
jh=!1;function kh(){var a=lh().info.yt_lt="hot_bg";mh().info_yt_lt=a;if(nh())if("yt_lt"in gh){var b=gh.yt_lt;0<=Ha(ih,b)&&(a=!!a);var c=a;if(nh()){a={};b=b.split(".");for(var d=a,e=0;e<b.length-1;e++)d[b[e]]=d[b[e]]||{},d=d[b[e]];d[b[b.length-1]]=c;c=oh();b=Object.keys(a).join("");Ug("info_"+b+"_"+c)||(a.clientActionNonce=c,jg("latencyActionInfo",a,void 0,void 0))}}else 0<=Ha(hh,"yt_lt")||R(Error("Unknown label yt_lt logged with GEL CSI."))}
...
var rh=y(W.clearResourceTimings||W.webkitClearResourceTimings||W.mozClearResourceTimings||W.msClearResourceTimings||W.oClearResourceTimings||ua,W);function oh(){var a=lh().nonce;a||(a=ug(),lh().nonce=a);return a}
function qh(){return lh().tick}
function mh(){var a=lh();"gel"in a||(a.gel={});return a.gel}
function lh(){return w("ytcsi.data_")||sh()}
function sh(){var a={tick:{},info:{}};u("ytcsi.data_",a,void 0);return a}
function th(a,b){u("yt.timing."+(b||"")+"pingSent_",a,void 0)}
function uh(){var a=qh(),b=a.pbr,c=a.vc;a=a.pbs;return b&&c&&a&&b<c&&c<a&&1==lh().info.yt_pvis}
function nh(){return!!T("csi_on_gel")||!!lh().useGel}
function vh(){ah();if(!nh()){var a=qh(),b=lh().info,c=a._start;for(f in a)if(0==f.lastIndexOf("_",0)&&xa(a[f])){var d=f.slice(1);if(d in fh){var e=Ka(a[f],function(a){return Math.round(a-c)});
b["all_"+d]=e.join()}delete a[f]}var f=!!b.ap;if(d=w("ytglobal.timingReportbuilder_")){if(a=d(a,b,void 0))wh(a,f),sh(),rh(),th(!1,void 0),P("TIMING_ACTION")&&O("PREVIOUS_ACTION",P("TIMING_ACTION")),O("TIMING_ACTION","")}else{var g=P("CSI_SERVICE_NAME","youtube");d={v:2,s:g,action:P("TIMING_ACTION",void 0)};e=kh.srt;void 0!==a.srt&&delete b.srt;if(b.h5jse){var h=window.location.protocol+w("ytplayer.config.assets.js");(h=W.getEntriesByName?W.getEntriesByName(h)[0]:null)?b.h5jse=Math.round(b.h5jse-h.responseEnd):
delete b.h5jse}a.aft=ph();uh()&&"youtube"==g&&(kh(),g=a.vc,h=a.pbs,delete a.aft,b.aft=Math.round(h-g));for(var l in b)"_"!=l.charAt(0)&&(d[l]=b[l]);a.ps=N();b={};l=[];for(var m in a)"_"!=m.charAt(0)&&(g=Math.round(a[m]-c),b[m]=g,l.push(m+"."+g));d.rt=l.join(",");(a=w("ytdebug.logTiming"))&&a(d,b);wh(d,f,void 0);Zg(eh,new ch(b.aft+(e||0),void 0))}}}
function wh(a,b,c){if(T("debug_csi_data")){var d=w("yt.timing.csiData");d||(d=[],u("yt.timing.csiData",d,void 0));d.push({page:location.href,time:new Date,args:a})}d="";for(var e in a)d+="&"+e+"="+a[e];a="/csi_204?"+d.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b){var f=void 0===f?"":f;try{window.navigator&&window.navigator.sendBeacon&&window.navigator.sendBeacon(a,f)||Ie(a,void 0,void 0,void 0,f)}catch(g){Ie(a,void 0,void 0,void 0,f)}}else Ie(a);th(!0,c)}
function xh(a){if("_"!=a[0]){var b=a;W.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),W.mark(b))}b=qh();var c=N();b[a]&&(b["_"+a]=b["_"+a]||[b[a]],b["_"+a].push(c));b[a]=c;b=$g();if(c=b[a])qf(c),b[a]=0;mh()["tick_"+a]=void 0;N();nh()?(b=oh(),"_start"==a?Ug("baseline_"+b)||jg("latencyActionBaselined",{clientActionNonce:b},void 0,void 0):Ug("tick_"+a+"_"+b)||jg("latencyActionTicked",{tickName:a,clientActionNonce:b},void 0,void 0),a=!0):a=!1;if(a=!a)a=!w("yt.timing.pingSent_");if(a&&(b=Q("TIMING_ACTION"),
a=qh(),w("ytglobal.timingready_")&&b&&a._start&&(b=ph()))){jh||(Zg(dh,new bh(Math.round(b-a._start),void 0)),jh=!0);b=!0;c=P("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&vh()}}
;function yh(a,b){J.call(this);this.j=this.T=a;this.D=b;this.m=!1;this.api={};this.P=this.B=null;this.G=new L;ad(this,Ea(bd,this.G));this.h={};this.N=this.R=this.g=this.Y=this.b=null;this.H=!1;this.i=this.w=null;this.U={};this.oa=["onReady"];this.X=null;this.ga=NaN;this.O={};zh(this);this.V("WATCH_LATER_VIDEO_ADDED",this.Fa.bind(this));this.V("WATCH_LATER_VIDEO_REMOVED",this.Ga.bind(this));this.V("onAdAnnounce",this.ra.bind(this));this.pa=new Mg(this);ad(this,Ea(bd,this.pa))}
n(yh,J);k=yh.prototype;
k.ea=function(a){if(!this.f){a instanceof Jg||(a=new Jg(a));this.Y=a;this.b=a.clone();this.g=this.b.attrs.id||this.g;"video-player"==this.g&&(this.g=this.D,this.b.attrs.id=this.D);this.j.id==this.g&&(this.g+="-player",this.b.attrs.id=this.g);this.b.args.enablejsapi="1";this.b.args.playerapiid=this.D;this.R||(this.R=Ah(this,this.b.args.jsapicallback||"onYouTubePlayerReady"));this.b.args.jsapicallback=null;if(a=this.b.attrs.width)this.j.style.width=kc(Number(a)||a);if(a=this.b.attrs.height)this.j.style.height=kc(Number(a)||
a);Bh(this);this.m&&Ch(this)}};
...
function Dh(a){var b=!0,c=Eh(a);c&&a.b&&(a=a.b,b=Re(c,"version")==a.assets.js);return b&&!!w("yt.player.Application.create")}
function Bh(a){if(!a.f&&!a.H){var b=Dh(a);if(b&&"html5"==(Eh(a)?"html5":null))a.N="html5",a.m||Fh(a);else if(Gh(a),a.N="html5",b&&a.i)a.T.appendChild(a.i),Fh(a);else{a.b.loaded=!0;var c=!1;a.w=function(){c=!0;var b=a.b.clone();w("yt.player.Application.create")(a.T,b);Fh(a)};
a.H=!0;b?a.w():(ef(a.b.assets.js,a.w),Og(a.b.assets.css),Hh(a)&&!c&&u("yt.player.Application.create",null,void 0))}}}
function Eh(a){var b=Wb(a.g);!b&&a.j&&a.j.querySelector&&(b=a.j.querySelector("#"+a.g));return b}
function Fh(a){if(!a.f){var b=Eh(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.H=!1,b.isNotServable&&b.isNotServable(a.b.args.video_id)||Ih(a)):a.ga=S(function(){Fh(a)},50)}}
function Ih(a){zh(a);a.m=!0;var b=Eh(a);b.addEventListener&&(a.B=Jh(a,b,"addEventListener"));b.removeEventListener&&(a.P=Jh(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.api[e]||(a.api[e]=Jh(a,b,e))}for(var f in a.h)a.B(f,a.h[f]);Ch(a);a.R&&a.R(a.api);a.G.K("onReady",a.api)}
function Jh(a,b,c){var d=b[c];return function(){try{return a.X=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.X=e,me(e))}}}
function zh(a){a.m=!1;if(a.P)for(var b in a.h)a.P(b,a.h[b]);for(var c in a.O)qe(parseInt(c,10));a.O={};a.B=null;a.P=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.V.bind(a);a.api.removeEventListener=a.Ka.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.va.bind(a);a.api.getPlayerType=a.wa.bind(a);a.api.getCurrentVideoConfig=a.ua.bind(a);a.api.loadNewVideoConfig=a.ea.bind(a);a.api.isReady=a.Ea.bind(a)}
k.Ea=function(){return this.m};
k.V=function(a,b){var c=this,d=Ah(this,b);if(d){if(!(0<=Ha(this.oa,a)||this.h[a])){var e=Kh(this,a);this.B&&this.B(a,e)}this.G.subscribe(a,d);"onReady"==a&&this.m&&S(function(){d(c.api)},0)}};
k.Ka=function(a,b){if(!this.f){var c=Ah(this,b);c&&Od(this.G,a,c)}};
function Ah(a,b){var c=b;if("string"==typeof b){if(a.U[b])return a.U[b];c=function(){var a=w(b);a&&a.apply(q,arguments)};
a.U[b]=c}return c?c:null}
function Kh(a,b){var c="ytPlayer"+b+a.D;a.h[b]=c;q[c]=function(c){var d=S(function(){if(!a.f){a.G.K(b,c);var e=a.O,g=String(d);g in e&&delete e[g]}},0);
ib(a.O,String(d))};
return c}
k.ra=function(a){$e("a11y-announce",a)};
k.Fa=function(a){$e("WATCH_LATER_VIDEO_ADDED",a)};
k.Ga=function(a){$e("WATCH_LATER_VIDEO_REMOVED",a)};
k.wa=function(){return this.N||(Eh(this)?"html5":null)};
k.va=function(){return this.X};
function Gh(a){xh("dcp");a.cancel();zh(a);a.N=null;a.b&&(a.b.loaded=!1);var b=Eh(a);b&&(Dh(a)||!Hh(a)?a.i=b:(b&&b.destroy&&b.destroy(),a.i=null));for(a=a.T;b=a.firstChild;)a.removeChild(b)}
k.cancel=function(){this.w&&lf(this.b.assets.js,this.w);qe(this.ga);this.H=!1};
k.l=function(){Gh(this);if(this.i&&this.b&&this.i.destroy)try{this.i.destroy()}catch(b){R(b)}this.U=null;for(var a in this.h)q[this.h[a]]=null;this.Y=this.b=this.api=null;delete this.T;delete this.j;J.prototype.l.call(this)};
function Hh(a){return a.b&&a.b.args&&a.b.args.fflags?-1!=a.b.args.fflags.indexOf("player_destroy_old_version=true"):!1}
;var Lh={},Mh="player_uid_"+(1E9*Math.random()>>>0);function Nh(a){var b="player";b=t(b)?Wb(b):b;var c=Mh+"_"+(b[Aa]||(b[Aa]=++Ba)),d=Lh[c];if(d)return d.ea(a),d.api;d=new yh(b,c);Lh[c]=d;$e("player-added",d.api);ad(d,Ea(Oh,d));S(function(){d.ea(a)},0);
return d.api}
function Oh(a){delete Lh[a.D]}
;function Ph(){var a=Qh(),b=Rh();if(!a&&!b||!window.JSON)return null;try{var c=a.get("yt-player-two-stage-token")}catch(d){}if(!t(c))try{c=b.get("yt-player-two-stage-token")}catch(d){}if(!t(c))return null;try{c=JSON.parse(c,void 0)}catch(d){}return c}
var Rh=Fb(function(){var a=new Yd;return a.isAvailable()?new Ud(a):null}),Qh=Fb(function(){var a=new Zd;
return a.isAvailable()?new Ud(a):null});function Sh(a){return(0==a.search("cue")||0==a.search("load"))&&"loadModule"!=a}
...
function Uh(a,b,c){if(x(a)){b="endSeconds startSeconds mediaContentUrl suggestedQuality videoId two_stage_token".split(" ");c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}return{videoId:a,startSeconds:b,suggestedQuality:c}}
function Vh(a,b,c,d){if(x(a)&&!xa(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};t(a)&&16==a.length?b.list="PL"+a:b.playlist=a;return b}
function Wh(a){var b=a.video_id||a.videoId;if(t(b)){var c=Ph()||{},d=Ph()||{};r(void 0)?d[b]=void 0:delete d[b];var e=z()+3E5,f=Rh();if(f&&window.JSON){t(d)||(d=JSON.stringify(d,void 0));try{f.set("yt-player-two-stage-token",d,e)}catch(g){f.remove("yt-player-two-stage-token")}}(b=c[b])&&(a.two_stage_token=b)}}
;function Xh(a){J.call(this);this.b=a;this.b.subscribe("command",this.la,this);this.g={};this.i=!1}
A(Xh,J);k=Xh.prototype;k.start=function(){this.i||this.f||(this.i=!0,Yh(this.b,"RECEIVING"))};
k.la=function(a,b,c){if(this.i&&!this.f){var d=b||{};switch(a){case "addEventListener":t(d.event)&&(a=d.event,a in this.g||(c=y(this.Ma,this,a),this.g[a]=c,this.addEventListener(a,c)));break;case "removeEventListener":t(d.event)&&Zh(this,d.event);break;default:this.h.isReady()&&this.h[a]&&(b=$h(a,b||{}),c=this.h.handleExternalCall(a,b,c||null),(c=ai(a,c))&&this.i&&!this.f&&Yh(this.b,a,c))}}};
k.Ma=function(a,b){this.i&&!this.f&&Yh(this.b,a,this.aa(a,b))};
k.aa=function(a,b){if(null!=b)return{value:b}};
function Zh(a,b){b in a.g&&(a.removeEventListener(b,a.g[b]),delete a.g[b])}
k.l=function(){var a=this.b;a.f||Od(a.b,"command",this.la,this);this.b=null;for(var b in this.g)Zh(this,b);Xh.A.l.call(this)};function bi(a,b){Xh.call(this,b);this.h=a;this.start()}
A(bi,Xh);bi.prototype.addEventListener=function(a,b){this.h.addEventListener(a,b)};
bi.prototype.removeEventListener=function(a,b){this.h.removeEventListener(a,b)};
function $h(a,b){switch(a){case "loadVideoById":return b=Uh(b),Wh(b),[b];case "cueVideoById":return b=Uh(b),Wh(b),[b];case "loadVideoByPlayerVars":return Wh(b),[b];case "cueVideoByPlayerVars":return Wh(b),[b];case "loadPlaylist":return b=Vh(b),Wh(b),[b];case "cuePlaylist":return b=Vh(b),Wh(b),[b];case "seekTo":return[b.seconds,b.allowSeekAhead];case "playVideoAt":return[b.index];case "setVolume":return[b.volume];case "setPlaybackQuality":return[b.suggestedQuality];case "setPlaybackRate":return[b.suggestedRate];
...
bi.prototype.aa=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return bi.A.aa.call(this,a,b)};
bi.prototype.l=function(){bi.A.l.call(this);delete this.h};function ci(a,b,c,d){J.call(this);this.g=b||null;this.w="*";this.h=c||null;this.sessionId=null;this.channel=d||null;this.D=!!a;this.m=y(this.B,this);window.addEventListener("message",this.m)}
...
ci.prototype.sendMessage=function(a,b){var c=b||this.g;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=pd(a);c.postMessage(d,this.w)}catch(e){R(e,"WARNING")}}};
ci.prototype.l=function(){window.removeEventListener("message",this.m);J.prototype.l.call(this)};function di(a,b,c){ci.call(this,a,b,c||P("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname,"widget");this.j=this.b=this.i=null}
n(di,ci);function ei(){var a=this.f=new di(!!P("WIDGET_ID_ENFORCE")),b=y(this.Ja,this);a.i=b;a.j=null;this.f.channel="widget";if(a=P("WIDGET_ID"))this.f.sessionId=a;this.h=[];this.j=!1;this.i={}}
k=ei.prototype;k.Ja=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.i[a]||"onReady"==a||(this.addEventListener(a,fi(this,a)),this.i[a]=!0)):this.na(a,b,c)};
k.na=function(){};
function fi(a,b){return y(function(a){this.sendMessage(b,a)},a)}
...
k.dispose=function(){this.f=null};function hi(a){ei.call(this);this.b=a;this.g=[];this.addEventListener("onReady",y(this.Ha,this));this.addEventListener("onVideoProgress",y(this.Qa,this));this.addEventListener("onVolumeChange",y(this.Ra,this));this.addEventListener("onApiChange",y(this.La,this));this.addEventListener("onPlaybackQualityChange",y(this.Na,this));this.addEventListener("onPlaybackRateChange",y(this.Oa,this));this.addEventListener("onStateChange",y(this.Pa,this));this.addEventListener("onWebglSettingsChanged",y(this.Sa,
this))}
A(hi,ei);k=hi.prototype;k.na=function(a,b,c){if(this.b[a]){b=b||[];if(0<b.length&&Sh(a)){var d=b;if(x(d[0])&&!xa(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=Uh.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=Th.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=Vh.apply(window,d)}d=e}Wh(d);b.length=1;b[0]=d}this.b.handleExternalCall(a,b,c);Sh(a)&&gi(this,this.ba())}};
...
mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getVideoContentRect&&(a.videoContentRect=this.b.getVideoContentRect());this.b.getProgressState&&(a.progressState=this.b.getProgressState());this.b.getStoryboardFormat&&(a.storyboardFormat=this.b.getStoryboardFormat());gi(this,a)};
k.Na=function(a){gi(this,{playbackQuality:a})};
k.Oa=function(a){gi(this,{playbackRate:a})};
...
k.Ra=function(){gi(this,{muted:this.b.isMuted(),volume:this.b.getVolume()})};
k.Qa=function(a){a={currentTime:a,videoBytesLoaded:this.b.getVideoBytesLoaded(),videoLoadedFraction:this.b.getVideoLoadedFraction(),currentTimeLastUpdated_:z()/1E3,playbackRate:this.b.getPlaybackRate(),mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());gi(this,a)};
k.Sa=function(){var a={sphericalProperties:this.b.getSphericalProperties()};gi(this,a)};
k.dispose=function(){hi.A.dispose.call(this);for(var a=0;a<this.g.length;a++){var b=this.g[a];this.b.removeEventListener(b.eventType,b.listener)}this.g=[]};function ii(a){a=void 0===a?!1:a;J.call(this);this.b=new L(a);ad(this,Ea(bd,this.b))}
A(ii,J);ii.prototype.subscribe=function(a,b,c){return this.f?0:this.b.subscribe(a,b,c)};
...
A(ji,ii);function Yh(a,b,c){if(!a.f){var d=a.g;d.f||a.h!=d.b||(a={id:a.j,command:b},c&&(a.data=c),d.b.postMessage(pd(a),d.h))}}
ji.prototype.l=function(){this.h=this.g=null;ji.A.l.call(this)};function ki(a,b,c){J.call(this);this.b=a;this.h=c;this.i=U(window,"message",y(this.j,this));this.g=new ji(this,a,b);ad(this,Ea(bd,this.g))}
...
ki.prototype.l=function(){Mf(this.i);this.b=null;ki.A.l.call(this)};function li(){var a=kb(mi),b;return Dd(new K(function(c,d){a.onSuccess=function(a){pe(a)?c(a):d(new ni("Request failed, status="+a.status,"net.badstatus",a))};
a.onError=function(a){d(new ni("Unknown request error","net.unknown",a))};
a.M=function(a){d(new ni("Request timed out","net.timeout",a))};
b=ze("//googleads.g.doubleclick.net/pagead/id",a)}),function(a){a instanceof Ed&&b.abort();
return Bd(a)})}
function ni(a,b){C.call(this,a+", errorCode="+b);this.errorCode=b;this.name="PromiseAjaxError"}
n(ni,C);function oi(a){this.g=void 0===a?null:a;this.f=0;this.b=null}
oi.prototype.then=function(a,b,c){return this.g?this.g.then(a,b,c):1===this.f&&a?(a=a.call(c,this.b),wd(a)?a:pi(a)):2===this.f&&b?(a=b.call(c,this.b),wd(a)?a:qi(a)):this};
oi.prototype.getValue=function(){return this.b};
vd(oi);function qi(a){var b=new oi;a=void 0===a?null:a;b.f=2;b.b=void 0===a?null:a;return b}
function pi(a){var b=new oi;a=void 0===a?null:a;b.f=1;b.b=void 0===a?null:a;return b}
;function ri(a){C.call(this,a.message||a.description||a.name);this.isMissing=a instanceof si;this.isTimeout=a instanceof ni&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof Ed}
n(ri,C);ri.prototype.name="BiscottiError";function si(){C.call(this,"Biscotti ID is missing from server")}
n(si,C);si.prototype.name="BiscottiMissingError";var mi={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},ti=null;function ui(){if("1"===eb(ke(),"args","privembed"))return Bd(Error("Biscotti ID is not available in private embed mode"));ti||(ti=Dd(li().then(vi),function(a){return wi(2,a)}));
return ti}
function vi(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new si;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new si;a=a.id;xi(a);ti=pi(a);yi(18E5,2);return a}
function wi(a,b){var c=new ri(b);xi("");ti=qi(c);0<a&&yi(12E4,a-1);throw c;}
function yi(a,b){S(function(){Dd(li().then(vi,function(a){return wi(b,a)}),ua)},a)}
function xi(a){u("yt.ads.biscotti.lastId_",a,void 0)}
function zi(){try{var a=w("yt.ads.biscotti.getId_");return a?a():ui()}catch(b){return Bd(b)}}
;function Ai(a){if("1"!==eb(ke(),"args","privembed")){a&&(w("yt.ads.biscotti.getId_")||Fa("yt.ads.biscotti.getId_",ui));try{zi().then(function(a){var b={};b.dt=Ec;b.flash="0";a:{try{var d=window.top.location.href}catch(Za){d=2;break a}d=null!=d?d==window.document.location.href?0:1:2}b=(b.frm=d,b);b.u_tz=-(new Date).getTimezoneOffset();var e=void 0===e?B:e;try{var f=e.history.length}catch(Za){f=0}b.u_his=f;b.u_java=!!B.navigator&&"unknown"!==typeof B.navigator.javaEnabled&&!!B.navigator.javaEnabled&&
B.navigator.javaEnabled();B.screen&&(b.u_h=B.screen.height,b.u_w=B.screen.width,b.u_ah=B.screen.availHeight,b.u_aw=B.screen.availWidth,b.u_cd=B.screen.colorDepth);B.navigator&&B.navigator.plugins&&(b.u_nplug=B.navigator.plugins.length);B.navigator&&B.navigator.mimeTypes&&(b.u_nmime=B.navigator.mimeTypes.length);b.ca_type="image";if(T("enable_server_side_search_pyv")||T("enable_server_side_mweb_search_pyv")){f=window;try{var g=f.screenX;var h=f.screenY}catch(Za){}try{var l=f.outerWidth;var m=f.outerHeight}catch(Za){}try{var v=
f.innerWidth;var da=f.innerHeight}catch(Za){}g=[f.screenLeft,f.screenTop,g,h,f.screen?f.screen.availWidth:void 0,f.screen?f.screen.availTop:void 0,l,m,v,da];h=window.top;try{var G=(h||window).document,Y="CSS1Compat"==G.compatMode?G.documentElement:G.body;var Ia=(new Vb(Y.clientWidth,Y.clientHeight)).round()}catch(Za){Ia=new Vb(-12245933,-12245933)}G={};Y=new ge;q.SVGElement&&q.document.createElementNS&&Y.set(0);h=jc();h["allow-top-navigation-by-user-activation"]&&Y.set(1);h["allow-popups-to-escape-sandbox"]&&
Y.set(2);Y=he(Y);G.bc=Y;G.bih=Ia.height;G.biw=Ia.width;G.brdim=g.join();Ia=(G.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[Ga.visibilityState||Ga.webkitVisibilityState||Ga.mozVisibilityState||""]||0,G.wgl=!!B.WebGLRenderingContext,G);for(var de in Ia)b[de]=Ia[de]}b.bid=a;b.bsq=Bi++;Fe("//www.youtube.com/ad_data_204",{xa:!1,C:b,withCredentials:!0})},function(){}),S(Ai,18E5)}catch(b){R(b)}}}
var Bi=0;var Z=w("ytglobal.prefsUserPrefsPrefs_")||{};u("ytglobal.prefsUserPrefsPrefs_",Z,void 0);function Ci(){this.b=P("ALT_PREF_COOKIE_NAME","PREF");var a=Eb.get(""+this.b,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
k=Ci.prototype;k.get=function(a,b){Di(a);Ei(a);var c=void 0!==Z[a]?Z[a].toString():null;return null!=c?c:b?b:""};
k.set=function(a,b){Di(a);Ei(a);if(null==b)throw Error("ExpectedNotNull");Z[a]=b.toString()};
k.remove=function(a){Di(a);Ei(a);delete Z[a]};
k.save=function(){ng(this.b,this.dump(),63072E3)};
...
va(Ci);var Gi=null,Hi=null,Ii=null,Ji={};function Ki(a){var b=a.id;a=a.ve_type;var c=yg++;a=new wg({veType:a,veCounter:c,elementIndex:void 0,dataElement:void 0,youtubeData:void 0});Ji[b]=a;b=Dg();c=Cg();b&&c&&Gg(b,c,a)}
function Li(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(Eg(b,a),a=Cg()))for(var c in Ji){var d=Ji[c];d&&Gg(b,a,d)}}
function Mi(a){Ji[a.id]=new wg({trackingParams:a.tracking_params})}
function Ni(a){var b=Dg();a=Ji[a.id];b&&a&&jg("visualElementGestured",{csn:b,ve:xg(a),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"})}
function Oi(a){a=a.ids;var b=Dg();if(b)for(var c=0;c<a.length;c++){var d=Ji[a[c]];d&&jg("visualElementShown",{csn:b,ve:xg(d),eventType:1})}}
function Pi(){var a=Gi;a&&a.startInteractionLogging&&a.startInteractionLogging()}
;u("yt.setConfig",O,void 0);u("yt.config.set",O,void 0);u("yt.setMsg",Oe,void 0);u("yt.msgs.set",Oe,void 0);u("yt.logging.errors.log",Me,void 0);
u("writeEmbed",function(){var a=P("PLAYER_CONFIG",void 0);Ai(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=P("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);P("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");a.args.autoplay&&Wh(a.args);Gi=a=Nh(a);a.addEventListener("onScreenChanged",Li);a.addEventListener("onLogClientVeCreated",Ki);a.addEventListener("onLogServerVeCreated",Mi);a.addEventListener("onLogVeClicked",
Ni);a.addEventListener("onLogVesShown",Oi);a.addEventListener("onReady",Pi);b=P("POST_MESSAGE_ID","player");P("ENABLE_JS_API")?Ii=new hi(a):P("ENABLE_POST_API")&&t(b)&&t(c)&&(Hi=new ki(window.parent,b,c),Ii=new bi(a,Hi.g));c=Q("BG_P");Cf(c)&&(P("BG_I")||P("BG_IU"))&&(yf=!0,xf.initialize(P("BG_I",null),P("BG_IU",null),c,Bf,void 0));tf()},void 0);
u("yt.www.watch.ads.restrictioncookie.spr",function(a){Ie(a+"mac_204?action_fcts=1");return!0},void 0);
var Qi=le(function(){xh("ol");var a=Ci.getInstance(),b=!!((Fi("f"+(Math.floor(119/31)+1))||0)&67108864),c=1<window.devicePixelRatio;if(document.body&&ed(document.body,"exp-invert-logo"))if(c&&!ed(document.body,"inverted-hdpi")){var d=document.body;d.classList?d.classList.add("inverted-hdpi"):ed(d,"inverted-hdpi")||(d.className+=0<d.className.length?" inverted-hdpi":"inverted-hdpi")}else!c&&ed(document.body,"inverted-hdpi")&&fd();b!=c&&(b="f"+(Math.floor(119/31)+1),d=Fi(b)||0,d=c?d|67108864:d&-67108865,
0==d?delete Z[b]:Z[b]=d.toString(16).toString(),a.save())}),Ri=le(function(){var a=Gi;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();P("PL_ATT")&&xf.dispose();a=0;for(var b=rf.length;a<b;a++)qf(rf[a]);rf.length=0;kf("//static.doubleclick.net/instream/ad_status.js");sf=!1;O("DCLKSTAT",0);cd(Ii,Hi);if(a=Gi)a.removeEventListener("onScreenChanged",Li),a.removeEventListener("onLogClientVeCreated",Ki),a.removeEventListener("onLogServerVeCreated",Mi),a.removeEventListener("onLogVeClicked",Ni),a.removeEventListener("onLogVesShown",Oi),a.removeEventListener("onReady",Pi),a.destroy();Ji=
{}});
window.addEventListener?(window.addEventListener("load",Qi),window.addEventListener("unload",Ri)):window.attachEvent&&(window.attachEvent("onload",Qi),window.attachEvent("onunload",Ri));Fa("yt.abuse.player.botguardInitialized",w("yt.abuse.player.botguardInitialized")||Df);Fa("yt.abuse.player.invokeBotguard",w("yt.abuse.player.invokeBotguard")||Ef);Fa("yt.abuse.dclkstatus.checkDclkStatus",w("yt.abuse.dclkstatus.checkDclkStatus")||uf);
Fa("yt.player.exports.navigate",w("yt.player.exports.navigate")||Fg);Fa("yt.util.activity.init",w("yt.util.activity.init")||Pf);Fa("yt.util.activity.getTimeSinceActive",w("yt.util.activity.getTimeSinceActive")||Sf);Fa("yt.util.activity.setTimestamp",w("yt.util.activity.setTimestamp")||Qf);}).call(this);
