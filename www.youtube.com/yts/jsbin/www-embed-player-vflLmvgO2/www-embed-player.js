...
A(C,Error);C.prototype.name="CustomError";var Ma=Array.prototype.indexOf?function(a,b){return Array.prototype.indexOf.call(a,b,void 0)}:function(a,b){if(r(a))return r(b)&&1==b.length?a.indexOf(b,0):-1;
...
function Sa(a,b){var c=Ma(a,b);0<=c&&Array.prototype.splice.call(a,c,1)}
...
;var eb;a:{var gb=p.navigator;if(gb){var hb=gb.userAgent;if(hb){eb=hb;break a}}eb=""}function E(a){return-1!=eb.indexOf(a)}
...
sb[" "]=za;var tb=E("Opera"),ub=E("Trident")||E("MSIE"),vb=E("Edge"),wb=E("Gecko")&&!(-1!=eb.toLowerCase().indexOf("webkit")&&!E("Edge"))&&!(E("Trident")||E("MSIE"))&&!E("Edge"),xb=-1!=eb.toLowerCase().indexOf("webkit")&&!E("Edge");function yb(){var a=p.document;return a?a.documentMode:void 0}
var zb;a:{var Ab="",Bb=function(){var a=eb;if(wb)return/rv:([^\);]+)(\)|;)/.exec(a);if(vb)return/Edge\/([\d\.]+)/.exec(a);if(ub)return/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a);if(xb)return/WebKit\/(\S+)/.exec(a);if(tb)return/(?:Version)[ \/]?(\S+)/.exec(a)}();
...
var Rb=/^(?:(?:https?|mailto|ftp):|[^:/?#]*(?:[/?#]|$))/i;function Sb(a){if(a instanceof F)return a;a="object"==typeof a&&a.J?a.I():String(a);Rb.test(a)||(a="about:invalid#zClosurez");return Tb(a)}
...
function cc(a,b){ib(b,function(b,d){b&&"object"==typeof b&&b.J&&(b=b.I());"style"==d?a.style.cssText=b:"class"==d?a.className=b:"for"==d?a.htmlFor=b:dc.hasOwnProperty(d)?a.setAttribute(dc[d],b):0==d.lastIndexOf("aria-",0)||0==d.lastIndexOf("data-",0)?a.setAttribute(d,b):a[d]=b})}
...
return c}
;function qc(a,b,c){a.addEventListener&&a.addEventListener(b,c,!1)}
;function rc(a){var b=!1,c=!1;c=void 0===c?!1:c;b=void 0===b?!1:b;p.google_image_requests||(p.google_image_requests=[]);var d=p.document.createElement("img");if(b){var e=function(){b&&Sa(p.google_image_requests,d);d.removeEventListener&&d.removeEventListener("load",e,!1);d.removeEventListener&&d.removeEventListener("error",e,!1)};
...
function kd(a,b){if(a.classList)var c=a.classList.contains(b);else c=jd(a),c=0<=Ma(c,b);return c}
...
function se(){var a=null;return Pd(new J(function(b,c){a=re(function(){b(void 0)});
...
function Te(a,b){var c=Q("CORS_HEADER_WHITELIST")||{},d=vc(G(a)[3]||null);return d?(c=c[d])?0<=Ma(c,b):!1:!0}
...
;var df={},ef=0;
function ff(a,b,c,d,e){e=void 0===e?"":e;a&&(c&&(c=eb,c=!(c&&0<=c.toLowerCase().indexOf("cobalt"))),c?a&&(a instanceof F||(a="object"==typeof a&&a.J?a.I():String(a),Rb.test(a)||(a="about:invalid#zClosurez"),a=Tb(a)),b=Qb(a),"about:invalid#zClosurez"===b?a="":(b instanceof Ub?a=b:(d="object"==typeof b,a=null,d&&b.fa&&(a=b.ba()),b=Wa(d&&b.J?b.I():String(b)),a=Wb(b,a)),a=encodeURIComponent(String(vd(a instanceof Ub&&a.constructor===Ub&&a.g===Vb?a.b:"type_error:SafeHtml")))),/^[\s\xa0]*$/.test(a)||(a=
ec("IFRAME",{src:'javascript:"<body><img src=\\""+'+a+'+"\\"></body>"',style:"display:none"}),(9==a.nodeType?a:a.ownerDocument||a.document).body.appendChild(a))):e?Ye(a,b,"POST",e,d):Q("USE_NET_AJAX_FOR_PING_TRANSPORT",!1)||d?Ye(a,b,"GET","",d):gf(a,b))}
...
function Eg(a,b){var c=tg[a],d=zg[a]||{};zg[a]=d;var e=Math.round(O());for(m in X[a]){var f=b.b;f={client:{hl:f.Ha,gl:f.Ga,clientName:f.Fa,clientVersion:f.innertubeContextClientVersion}};var g=window.devicePixelRatio;g&&1!=g&&(f.client.screenDensityFloat=String(g));Q("DELEGATED_SESSION_ID")&&!V("pageid_as_header_web")&&(f.user={onBehalfOfUser:Q("DELEGATED_SESSION_ID")});f={context:f};f[c]=Bg(a,m);d.dispatchedEventCount=d.dispatchedEventCount||0;d.dispatchedEventCount+=f[c].length;if(g=yg[m])a:{var h=
m;if(g.videoId)var l="VIDEO";else if(g.playlistId)l="PLAYLIST";else break a;f.credentialTransferTokenTargetId=g;f.context=f.context||{};f.context.user=f.context.user||{};f.context.user.credentialTransferTokens=[{token:h,scope:l}]}delete yg[m];f.requestTimeMs=e;if(g=R("EVENT_ID"))l=(Q("BATCH_CLIENT_COUNTER",void 0)||0)+1,l>qg&&(l=1),P("BATCH_CLIENT_COUNTER",l),g={serializedEventId:g,clientCounter:l},f.serializedClientEventId=g,rg&&sg&&V("log_gel_rtt_web")&&(f.previousBatchInfo={serializedClientEventId:rg,
...
;function Jg(a,b){var c={"X-Goog-Visitor-Id":Q("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return c;var d;a?d="Bearer "+v("gapi.auth.getToken")().pb:d=Pc([]);d&&(c.Authorization=d,c["X-Goog-AuthUser"]=Q("SESSION_INDEX",0),V("pageid_as_header_web")&&(c["X-Goog-PageId"]=Q("DELEGATED_SESSION_ID")));return c}
...
c.oa=function(a,b){Pg(m);ca(a,b)}}try{V("use_fetch_for_op_xhr")?Ue(l,e):cf(l,e)}catch(Ka){if("InvalidAccessError"==Ka)m&&(Pg(m),m=0),S(Error("An extension is blocking network request."),"WARNING");
...
;function ch(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=Q("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=Q("VALID_SESSION_TEMPDATA_DOMAINS",[]),f=vc(G(window.location.href)[3]||null);f&&e.push(f);f=vc(G(d)[3]||null);if(0<=Ma(e,f)||!f&&0==d.lastIndexOf("/",0))if(V("autoescape_tempdata_url")&&(e=document.createElement("a"),Xb(e,d),d=e.href),d){f=G(d);d=f[5];e=f[6];f=f[7];var g="";d&&(g+=d);e&&(g+="?"+e);f&&(g+="#"+f);d=g;e=d.indexOf("#");if(d=0>e?d:d.substr(0,e)){if(b.itct||b.ved)b.csn=b.csn||
...
;function dh(a,b,c){V("attach_child_on_gel_web")?eh(a,b,[c]):fh({attachChild:{csn:a,parentVisualElement:Vg(b),visualElements:[Vg(c)]}})}
function eh(a,b,c){V("attach_child_on_gel_web")?(a={csn:a,parentVe:Vg(b),childVes:Pa(c,function(a){return Vg(a)})},Hg("visualElementAttached",a)):(a={csn:a,
parentVisualElement:Vg(b),visualElements:Pa(c,function(a){return Vg(a)})},fh({attachChild:a}))}
function fh(a){var b=Ig;a.eventTimeMs=Math.round(O());a.lactMs=pg();Ag({endpoint:"log_interaction",payload:a},b)}
;function gh(a){a=a||{};this.url=a.url||"";this.args=a.args||pb(hh);this.assets=a.assets||{};this.attrs=a.attrs||pb(ih);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
var hh={enablejsapi:1},ih={};gh.prototype.clone=function(){var a=new gh,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];a[b]="object"==Ba(c)?pb(c):c}return a};function jh(){I.call(this);this.b=[]}
...
function mh(a){var b=nh(a),c=document.getElementById(b),d=c&&pf(c,"loaded");d||c&&!d||(c=oh(a,b,function(){pf(c,"loaded")||(nf(c),yf(b),T(y(zf,b),0))}))}
...
function nh(a){var b=document.createElement("A");a=Tb(a);Xb(b,a);b=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+db(b)}
...
Kh=!1;function Lh(){var a=Mh().info.yt_lt="hot_bg";Nh().info_yt_lt=a;if(Oh())if("yt_lt"in Hh){var b=Hh.yt_lt;0<=Ma(Jh,b)&&(a=!!a);var c=a;if(Oh()){a={};b=b.split(".");for(var d=a,e=0;e<b.length-1;e++)d[b[e]]=d[b[e]]||{},d=d[b[e]];d[b[b.length-1]]=c;c=Ph();b=Object.keys(a).join("");rh("info_"+b+"_"+c)||(a.clientActionNonce=c,Hg("latencyActionInfo",a,void 0,void 0))}}else 0<=Ma(Ih,"yt_lt")||S(Error("Unknown label yt_lt logged with GEL CSI."))}
...
var Sh=x(xh.clearResourceTimings||xh.webkitClearResourceTimings||xh.mozClearResourceTimings||xh.msClearResourceTimings||xh.oClearResourceTimings||za,xh);function Ph(){var a=Mh().nonce;a||(a=Sg(),Mh().nonce=a);return a}
...
function Oh(){return!!V("csi_on_gel")||!!Mh().useGel}
function Wh(){zh();if(!Oh()){var a=Rh(),b=Mh().info,c=a._start;for(f in a)if(0==f.lastIndexOf("_",0)&&w(a[f])){var d=f.slice(1);if(d in Gh){var e=Pa(a[f],function(a){return Math.round(a-c)});
...
function Xh(a,b,c){if(V("debug_csi_data")){var d=v("yt.timing.csiData");d||(d=[],u("yt.timing.csiData",d,void 0));d.push({page:location.href,time:new Date,args:a})}d="";for(var e in a)d+="&"+e+"="+a[e];a="/csi_204?"+d.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b){var f=void 0===f?"":f;try{window.navigator&&window.navigator.sendBeacon&&window.navigator.sendBeacon(a,f)||ff(a,void 0,void 0,void 0,f)}catch(g){ff(a,void 0,void 0,void 0,f)}}else ff(a);Uh(!0,c)}
function Yh(a){if("_"!=a[0]){var b=a;xh.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),xh.mark(b))}b=Rh();var c=O();b[a]&&(b["_"+a]=b["_"+a]||[b[a]],b["_"+a].push(c));b[a]=c;b=yh();if(c=b[a])Of(c),b[a]=0;Nh()["tick_"+a]=void 0;O();Oh()?(b=Ph(),"_start"==a?rh("baseline_"+b)||Hg("latencyActionBaselined",{clientActionNonce:b},void 0,void 0):rh("tick_"+a+"_"+b)||Hg("latencyActionTicked",{tickName:a,clientActionNonce:b},void 0,void 0),a=!0):a=!1;if(a=!a)a=!v("yt.timing.pingSent_");if(a&&(b=R("TIMING_ACTION"),
...
;function Zh(a,b){I.call(this);this.l=this.U=a;this.G=b;this.u=!1;this.f={};this.R=this.D=null;this.H=new K;gd(this,y(hd,this.H));this.i={};this.O=this.T=this.h=this.Z=this.b=null;this.N=!1;this.j=this.A=null;this.V={};this.ua=["onReady"];this.Y=null;this.ka=NaN;this.P={};$h(this);this.W("WATCH_LATER_VIDEO_ADDED",this.La.bind(this));this.W("WATCH_LATER_VIDEO_REMOVED",this.Ma.bind(this));this.W("onAdAnnounce",this.xa.bind(this));this.va=new jh(this);gd(this,y(hd,this.va))}
n(Zh,I);k=Zh.prototype;
k.ha=function(a){if(!this.g){a instanceof gh||(a=new gh(a));this.Z=a;this.b=a.clone();this.h=this.b.attrs.id||this.h;"video-player"==this.h&&(this.h=this.G,this.b.attrs.id=this.G);this.l.id==this.h&&(this.h+="-player",this.b.attrs.id=this.h);this.b.args.enablejsapi="1";this.b.args.playerapiid=this.G;this.T||(this.T=ai(this,this.b.args.jsapicallback||"onYouTubePlayerReady"));this.b.args.jsapicallback=null;if(a=this.b.attrs.width)this.l.style.width=sc(Number(a)||a);if(a=this.b.attrs.height)this.l.style.height=sc(Number(a)||
...
function ei(a){var b=bc(a.h);!b&&a.l&&a.l.querySelector&&(b=a.l.querySelector("#"+a.h));return b}
function fi(a){if(!a.g){var b=ei(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.N=!1,b.isNotServable&&b.isNotServable(a.b.args.video_id)||ii(a)):a.ka=T(function(){fi(a)},50)}}
...
k.W=function(a,b){var c=this,d=ai(this,b);if(d){if(!(0<=Ma(this.ua,a)||this.i[a])){var e=ki(this,a);this.D&&this.D(a,e)}this.H.subscribe(a,d);"onReady"==a&&this.u&&T(function(){d(c.f)},0)}};
k.Ta=function(a,b){if(!this.g){var c=ai(this,b);c&&Zd(this.H,a,c)}};
...
function ki(a,b){var c="ytPlayer"+b+a.G;a.i[b]=c;p[c]=function(c){var d=T(function(){if(!a.g){a.H.K(b,c);var e=a.P,g=String(d);g in e&&delete e[g]}},0);
nb(a.P,String(d))};
return c}
...
k.m=function(){gi(this);if(this.j&&this.b&&this.j.destroy)try{this.j.destroy()}catch(b){S(b)}this.V=null;for(var a in this.i)p[this.i[a]]=null;this.Z=this.b=this.f=null;delete this.U;delete this.l;I.prototype.m.call(this)};
function hi(a){return a.b&&a.b.args&&a.b.args.fflags?-1!=a.b.args.fflags.indexOf("player_destroy_old_version=true"):!1}
;var li={},mi="player_uid_"+(1E9*Math.random()>>>0);function ni(a){var b="player";b=r(b)?bc(b):b;var c=mi+"_"+(b[Fa]||(b[Fa]=++Ga)),d=li[c];if(d)return d.ha(a),d.f;d=new Zh(b,c);li[c]=d;yf("player-added",d.f);gd(d,y(oi,d));T(function(){d.ha(a)},0);
return d.f}
...
var ri=Kb(function(){var a=new je;return a.isAvailable()?new fe(a):null}),qi=Kb(function(){var a=new ke;
return a.isAvailable()?new fe(a):null});function si(a){return(0==a.search("cue")||0==a.search("load"))&&"loadModule"!=a}
...
function ui(a,b,c){if(Ea(a)){b="endSeconds startSeconds mediaContentUrl suggestedQuality videoId two_stage_token".split(" ");c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}return{videoId:a,startSeconds:b,suggestedQuality:c}}
function vi(a,b,c,d){if(Ea(a)&&!w(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};r(a)&&16==a.length?b.list="PL"+a:b.playlist=a;return b}
...
k.m=function(){var a=this.b;a.g||Zd(a.b,"command",this.ra,this);this.b=null;for(var b in this.f)zi(this,b);xi.w.m.call(this)};function Ci(a,b){xi.call(this,b);this.h=a;this.start()}
...
Di.prototype.sendMessage=function(a,b){var c=b||this.f;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=vd(a);c.postMessage(d,this.u)}catch(e){S(e,"WARNING")}}};
...
this))}
A(Ii,Fi);k=Ii.prototype;k.ta=function(a,b,c){if(this.b[a]){b=b||[];if(0<b.length&&si(a)){var d=b;if(Ea(d[0])&&!w(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=ui.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=ti.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=vi.apply(window,d)}d=e}wi(d);b.length=1;b[0]=d}this.b.handleExternalCall(a,b,c);si(a)&&Hi(this,this.da())}};
...
k.dispose=function(){Ii.w.dispose.call(this);for(var a=0;a<this.g.length;a++){var b=this.g[a];this.b.removeEventListener(b.eventType,b.listener)}this.g=[]};function Ji(a){a=void 0===a?!1:a;I.call(this);this.b=new K(a);gd(this,y(hd,this.b))}
...
A(Ki,Ji);function yi(a,b,c){if(!a.g){var d=a.f;d.g||a.h!=d.b||(a={id:a.j,command:b},c&&(a.data=c),d.b.postMessage(vd(a),d.h))}}
Ki.prototype.m=function(){this.h=this.f=null;Ki.w.m.call(this)};function Li(a,b,c){I.call(this);this.b=a;this.h=c;this.i=W(window,"message",x(this.j,this));this.f=new Ki(this,a,b);gd(this,y(hd,this.f))}
...
Li.prototype.m=function(){jg(this.i);this.b=null;Li.w.m.call(this)};function Mi(){var a=pb(Ni),b;return Pd(new J(function(c,d){a.onSuccess=function(a){Ne(a)?c(a):d(new Oi("Request failed, status="+a.status,"net.badstatus",a))};
...
Pi.prototype.then=function(a,b,c){return this.g?this.g.then(a,b,c):1===this.f&&a?(a=a.call(c,this.b),Cd(a)?a:Qi(a)):2===this.f&&b?(a=b.call(c,this.b),Cd(a)?a:Ri(a)):this};
Pi.prototype.getValue=function(){return this.b};
Bd(Pi);function Ri(a){var b=new Pi;a=void 0===a?null:a;b.f=2;b.b=void 0===a?null:a;return b}
function Qi(a){var b=new Pi;a=void 0===a?null:a;b.f=1;b.b=void 0===a?null:a;return b}
;function Si(a){C.call(this,a.message||a.description||a.name);this.isMissing=a instanceof Ti;this.isTimeout=a instanceof Oi&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof Qd}
n(Si,C);Si.prototype.name="BiscottiError";function Ti(){C.call(this,"Biscotti ID is missing from server")}
n(Ti,C);Ti.prototype.name="BiscottiMissingError";var Ni={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Ui=null;function Vi(){if("1"===jb(Ie(),"args","privembed"))return Hd(Error("Biscotti ID is not available in private embed mode"));Ui||(Ui=Pd(Mi().then(Wi),function(a){return Xi(2,a)}));
return Ui}
...
function Zi(a,b){T(function(){Pd(Mi().then(Wi,function(a){return Xi(b,a)}),za)},a)}
function Yi(a){u("yt.ads.biscotti.lastId_",a,void 0)}
function $i(){try{var a=v("yt.ads.biscotti.getId_");return a?a():Vi()}catch(b){return Hd(b)}}
;function aj(a){C.apply(this,arguments)}
n(aj,C);aj.prototype.name="YuzuError";function bj(){var a=new aj("ID is missing"),b=new aj("Timeout"),c=null,d=!1;Fe(function(){c=De();d=!0});
if(d)return c?Qi(c):Ri(a);var e=new J(function(b,c){Fe(function(){var d=De();d?b(d):c(a)})}),f=se().then(function(){return Hd(b)});
return Nd(Kd([e,f]),function(){return f.cancel()})}
;function cj(a){if("1"!==jb(Ie(),"args","privembed")){a&&(v("yt.ads.biscotti.getId_")||Ja("yt.ads.biscotti.getId_",Vi));try{var b=$i();if(V("enable_yuzu")){v("yt.ads.yuzu.getId_")||u("yt.ads.yuzu.getId_",bj,void 0);try{var c=v("yt.ads.yuzu.getId_")()}catch(d){c=Hd(d)}}else c=Hd(new aj("unimplemented"));Ld([b,c]).then(function(a){var b=a[0];a=a[1];if(b.aa||a.aa){b=b.value;a=a.value;var c={};c.dt=Kc;c.flash="0";a:{try{var d=window.top.location.href}catch(fb){d=2;break a}d=null!=d?d==window.document.location.href?
...
B.navigator.mimeTypes.length);d.ca_type="image";if(V("enable_server_side_search_pyv")||V("enable_server_side_mweb_search_pyv")){l=window;try{var m=l.screenX;var t=l.screenY}catch(fb){}try{var ca=l.outerWidth;var Ka=l.outerHeight}catch(fb){}try{var Dh=l.innerWidth;var Eh=l.innerHeight}catch(fb){}m=[l.screenLeft,l.screenTop,m,t,l.screen?l.screen.availWidth:void 0,l.screen?l.screen.availTop:void 0,ca,Ka,Dh,Eh];t=window.top;try{var U=(t||window).document,ea="CSS1Compat"==U.compatMode?U.documentElement:
U.body;var Na=(new ac(ea.clientWidth,ea.clientHeight)).round()}catch(fb){Na=new ac(-12245933,-12245933)}U={};ea=new ue;p.SVGElement&&p.document.createElementNS&&ea.set(0);t=pc();t["allow-top-navigation-by-user-activation"]&&ea.set(1);t["allow-popups-to-escape-sandbox"]&&ea.set(2);ea=ve(ea);U.bc=ea;U.bih=Na.height;U.biw=Na.width;U.brdim=m.join();Na=(U.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[La.visibilityState||La.webkitVisibilityState||La.mozVisibilityState||""]||0,U.wgl=!!B.WebGLRenderingContext,
U);for(var te in Na)d[te]=Na[te]}void 0!==b&&(d.bid=b);void 0!==a&&(d.anid=a);d.bsq=dj++;cf("//www.youtube.com/ad_data_204",{Da:!1,B:d,withCredentials:!0})}});
T(cj,18E5)}catch(d){S(d)}}}
var dj=0;var Z=v("ytglobal.prefsUserPrefsPrefs_")||{};u("ytglobal.prefsUserPrefsPrefs_",Z,void 0);function ej(){this.b=Q("ALT_PREF_COOKIE_NAME","PREF");var a=Jb.get(""+this.b,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
...
Aa(ej);var ij=null,jj=null,kj=null,lj={};function mj(a){var b=a.id;a=a.ve_type;var c=Wg++;a=new Ug({veType:a,veCounter:c,elementIndex:void 0,dataElement:void 0,youtubeData:void 0});lj[b]=a;b=ah();c=$g();b&&c&&dh(b,c,a)}
...
pj);a.addEventListener("onLogVesShown",qj);a.addEventListener("onReady",rj);b=Q("POST_MESSAGE_ID","player");Q("ENABLE_JS_API")?kj=new Ii(a):Q("ENABLE_POST_API")&&r(b)&&r(c)&&(jj=new Li(window.parent,b,c),kj=new Ci(a,jj.f));c=R("BG_P");$f(c)&&(Q("BG_I")||Q("BG_IU"))&&(Wf=!0,Vf.initialize(Q("BG_I",null),Q("BG_IU",null),c,Zf));Rf()},void 0);
...
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();Q("PL_ATT")&&Vf.dispose();a=0;for(var b=Pf.length;a<b;a++)Of(Pf[a]);Pf.length=0;If("//static.doubleclick.net/instream/ad_status.js");Qf=!1;P("DCLKSTAT",0);id(kj,jj);if(a=ij)a.removeEventListener("onScreenChanged",nj),a.removeEventListener("onLogClientVeCreated",mj),a.removeEventListener("onLogServerVeCreated",oj),a.removeEventListener("onLogVeClicked",pj),a.removeEventListener("onLogVesShown",qj),a.removeEventListener("onReady",rj),a.destroy();lj=
{}});
window.addEventListener?(window.addEventListener("load",sj),window.addEventListener("unload",tj)):window.attachEvent&&(window.attachEvent("onload",sj),window.attachEvent("onunload",tj));Ja("yt.abuse.player.botguardInitialized",v("yt.abuse.player.botguardInitialized")||ag);Ja("yt.abuse.player.invokeBotguard",v("yt.abuse.player.invokeBotguard")||bg);Ja("yt.abuse.dclkstatus.checkDclkStatus",v("yt.abuse.dclkstatus.checkDclkStatus")||Sf);
Ja("yt.player.exports.navigate",v("yt.player.exports.navigate")||ch);Ja("yt.util.activity.init",v("yt.util.activity.init")||mg);Ja("yt.util.activity.getTimeSinceActive",v("yt.util.activity.getTimeSinceActive")||pg);Ja("yt.util.activity.setTimestamp",v("yt.util.activity.setTimestamp")||ng);}).call(this);
