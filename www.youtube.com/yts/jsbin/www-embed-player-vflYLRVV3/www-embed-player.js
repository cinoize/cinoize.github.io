...
b.prototype.then=function(h,g){function k(u,p){return"function"==typeof u?function(B){try{l(u(B))}catch(K){n(K)}}:p}
var l,n,r=new b(function(u,p){l=u;n=p});
this.W(k(h,l),k(g,n));return r};
...
b.all=function(h){var g=q(h),k=g.next();return k.done?d([]):new b(function(l,n){function r(B){return function(K){u[B]=K;p--;0==p&&l(u)}}
var u=[],p=0;do u.push(void 0),p++,d(k.value).W(r(u.length-1),n),k=g.next();while(!k.done)})};
return b});
...
function xa(){}
function ya(a){a.ea=void 0;a.getInstance=function(){return a.ea?a.ea:a.ea=new a}}
...
ib.prototype.da=!0;ib.prototype.aa=function(){return 1};
...
H.prototype.da=!0;H.prototype.aa=function(){return 1};
...
zb("about:blank");var Ab;a:{var Bb=v.navigator;if(Bb){var Cb=Bb.userAgent;if(Cb){Ab=Cb;break a}}Ab=""};function Eb(){this.f="";this.h=Fb;this.g=null}
Eb.prototype.da=!0;Eb.prototype.aa=function(){return this.g};
Eb.prototype.J=!0;Eb.prototype.I=function(){return this.f.toString()};
function Gb(a){if(a instanceof Eb&&a.constructor===Eb&&a.h===Fb)return a.f;za(a);return"type_error:SafeHtml"}
var Fb={};function Hb(a,b){var c=new Eb;c.f=a;c.g=b;return c}
...
return a}
var kc={Xa:"allow-forms",Ya:"allow-modals",Za:"allow-orientation-lock",ab:"allow-pointer-lock",bb:"allow-popups",cb:"allow-popups-to-escape-sandbox",eb:"allow-presentation",fb:"allow-same-origin",gb:"allow-scripts",hb:"allow-top-navigation",ib:"allow-top-navigation-by-user-activation"},mc=Ta(function(){return lc()});
...
function b(r){for(var u=h,p=0;64>p;p+=4)u[p/4]=r[p]<<24|r[p+1]<<16|r[p+2]<<8|r[p+3];for(p=16;80>p;p++)r=u[p-3]^u[p-8]^u[p-14]^u[p-16],u[p]=(r<<1|r>>>31)&4294967295;r=e[0];var B=e[1],K=e[2],qa=e[3],tc=e[4];for(p=0;80>p;p++){if(40>p)if(20>p){var Ka=qa^B&(K^qa);var Db=1518500249}else Ka=B^K^qa,Db=1859775393;else 60>p?(Ka=B&K|qa&(B|K),Db=2400959708):(Ka=B^K^qa,Db=3395469782);Ka=((r<<5|r>>>27)&4294967295)+Ka+tc+Db+u[p]&4294967295;tc=qa;qa=K;K=(B<<30|B>>>2)&4294967295;B=r;r=Ka}e[0]=e[0]+r&4294967295;e[1]=
e[1]+B&4294967295;e[2]=e[2]+K&4294967295;e[3]=e[3]+qa&4294967295;e[4]=e[4]+tc&4294967295}
function c(r,u){if("string"===typeof r){r=unescape(encodeURIComponent(r));for(var p=[],B=0,K=r.length;B<K;++B)p.push(r.charCodeAt(B));r=p}u||(u=r.length);p=0;if(0==l)for(;p+64<u;)b(r.slice(p,p+64)),p+=64,n+=64;for(;p<u;)if(f[l++]=r[p++],n++,64==l)for(l=0,b(f);p+64<u;)b(r.slice(p,p+64)),p+=64,n+=64}
function d(){var r=[],u=8*n;56>l?c(g,56-l):c(g,64-(l-56));for(var p=63;56<=p;p--)f[p]=u&255,u>>>=8;b(f);for(p=u=0;5>p;p++)for(var B=24;0<=B;B-=8)r[u++]=e[p]>>B&255;return r}
for(var e=[],f=[],h=[],g=[128],k=1;64>k;++k)g[k]=0;var l,n;a();return{reset:a,update:c,digest:d,sa:function(){for(var r=d(),u="",p=0;p<r.length;p++)u+="0123456789ABCDEF".charAt(Math.floor(r[p]/16))+"0123456789ABCDEF".charAt(r[p]%16);return u}}}
;function sc(a,b,c){var d=[],e=[];if(1==(Aa(c)?2:1))return e=[b,a],G(d,function(g){e.push(g)}),uc(e.join(" "));
...
a=uc(e.join(" "));a=[c,a];0==h.length||a.push(h.join(""));return a.join("_")}
function uc(a){var b=rc();b.update(a);return b.sa().toLowerCase()}
...
if("undefined"!==typeof a&&-1==Ab.indexOf("Trident")&&-1==Ab.indexOf("MSIE")){var b=new a,c={},d=c;b.port1.onmessage=function(){if(w(c.next)){c=c.next;var e=c.ha;c.ha=null;e()}};
...
D(Fd,Cd);Fd.prototype.set=function(a,b,c){if(b=Ed(b)){if(c){if(c<C()){Fd.prototype.remove.call(this,a);return}b.expiration=c}b.creation=C()}Fd.C.set.call(this,a,b)};
Fd.prototype.g=function(a){var b=Fd.C.g.call(this,a);if(b){var c=b.creation,d=b.expiration;if(d&&d<C()||c&&c>C())Fd.prototype.remove.call(this,a);else return b}};function Gd(){}
;function Hd(){}
...
y("yt.ads_.signals_.getAdSignalsString",function(){return ge()},void 0);C();function ne(a,b){var c=S(a);return void 0===c&&void 0!==b?b:Number(c||0)}
...
function xe(a,b){if(window.fetch&&"XML"!=b.format){var c={method:b.method||"GET",credentials:"same-origin"};b.headers&&(c.headers=b.headers);a=ye(a,b);var d=ze(a,b);d&&(c.body=d);b.withCredentials&&(c.credentials="include");var e=!1,f;fetch(a,c).then(function(h){if(!e){e=!0;f&&U(f);var g=h.ok,k=function(l){l=l||{};var n=b.context||v;g?b.onSuccess&&b.onSuccess.call(n,l,h):b.onError&&b.onError.call(n,l,h);b.fa&&b.fa.call(n,l,h)};
"JSON"==(b.format||"JSON")&&(g||400<=h.status&&500>h.status)?h.json().then(k,function(){k(null)}):k(null)}});
b.ja&&0<b.timeout&&(f=T(function(){e||(e=!0,U(f),b.ja.call(b.context||v))},b.timeout))}else Ae(a,b)}
function Ae(a,b){var c=b.format||"JSON";a=ye(a,b);var d=ze(a,b),e=!1,f,h=Be(a,function(g){if(!e){e=!0;f&&U(f);var k=qe(g),l=null,n=400<=g.status&&500>g.status,r=500<=g.status&&600>g.status;if(k||n||r)l=Ce(c,g,b.nb);if(k)a:if(g&&204==g.status)k=!0;else{switch(c){case "XML":k=0==parseInt(l&&l.return_code,10);break a;case "RAW":k=!0;break a}k=!!l}l=l||{};n=b.context||v;k?b.onSuccess&&b.onSuccess.call(n,g,l):b.onError&&b.onError.call(n,g,l);b.fa&&b.fa.call(n,g,l)}},b.method,d,b.headers,b.responseType,
b.withCredentials);
b.N&&0<b.timeout&&(f=T(function(){e||(e=!0,h.abort(),U(f),b.N.call(b.context||v,h))},b.timeout));
return h}
function ye(a,b){b.xa&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var c=Q("XSRF_FIELD_NAME",void 0),d=b.Wa;d&&(d[c]&&delete d[c],a=je(a,d||{},!0));return a}
function ze(a,b){var c=Q("XSRF_FIELD_NAME",void 0),d=Q("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.F,h=$d("XSRF_FIELD_NAME"),g;b.headers&&(g=b.headers["Content-Type"]);b.ob||M(N(3,a))&&!b.withCredentials&&M(N(3,a))!=document.location.hostname||"POST"!=b.method||g&&"application/x-www-form-urlencoded"!=g||b.F&&b.F[h]||(f||(f={}),f[c]=d);f&&x(e)&&(e=ie(e),db(e,f),e=b.ka&&"JSON"==b.ka?JSON.stringify(e):Sd(e));f=e||f&&!Ya(f);!te&&f&&"POST"!=b.method&&(te=!0,R(Error("AJAX request with postData should use POST")));
return e}
...
return k}
;var He={},Ie=0;
function Je(a,b,c,d,e){e=void 0===e?"":e;a&&(c&&(c=Ab,c=!(c&&0<=c.toLowerCase().indexOf("cobalt"))),c?a&&(a instanceof H||(a="object"==typeof a&&a.J?a.I():String(a),xb.test(a)||(a="about:invalid#zClosurez"),a=zb(a)),b=wb(a).toString(),"about:invalid#zClosurez"===b?a="":(b instanceof Eb?a=b:(d="object"==typeof b,a=null,d&&b.da&&(a=b.aa()),b=nb(d&&b.J?b.I():String(b)),a=Hb(b,a)),a=Gb(a).toString(),a=encodeURIComponent(String(bd(a)))),/^[\s\xa0]*$/.test(a)||(a=dc("IFRAME",{src:'javascript:"<body><img src=\\""+'+a+
...
function Rf(a){var b=void 0===a?{}:a;a=void 0===b.ya?!0:b.ya;b=void 0===b.La?!1:b.La;if(null==z("_lact",window)){var c=parseInt(Q("LACT"),10);c=isFinite(c)?C()-Math.max(c,0):-1;y("_lact",c,window);y("_fact",c,window);-1==c&&Sf();V(document,"keydown",Sf);V(document,"keyup",Sf);V(document,"mousedown",Sf);V(document,"mouseup",Sf);a&&(b?V(window,"touchmove",function(){Tf("touchmove",200)},{passive:!0}):(V(window,"resize",function(){Tf("resize",200)}),V(window,"scroll",function(){Tf("scroll",200)})));
...
function Sf(){null==z("_lact",window)&&Rf();var a=C();y("_lact",a,window);-1==z("_fact",window)&&y("_fact",a,window);(a=z("ytglobal.ytUtilActivityCallback_"))&&a()}
function Uf(){var a=z("_lact",window);return null==a?-1:Math.max(C()-a,0)}
...
function gg(a,b){var c=Yf[a],d=eg[a]||{};eg[a]=d;var e=Math.round(O());for(l in W[a]){var f=bb,h=b.f;h={client:{hl:h.Ea,gl:h.Da,clientName:h.Ba,clientVersion:h.Ca}};var g=window.devicePixelRatio;g&&1!=g&&(h.client.screenDensityFloat=String(g));Q("DELEGATED_SESSION_ID")&&!S("pageid_as_header_web")&&(h.user={onBehalfOfUser:Q("DELEGATED_SESSION_ID")});f=f({context:h});f[c]=ig(a,l);d.dispatchedEventCount=d.dispatchedEventCount||0;d.dispatchedEventCount+=f[c].length;if(h=dg[l])a:{var k=l;if(h.videoId)g=
...
;function lg(a,b,c,d){d=void 0===d?{}:d;var e={};e.eventTimeMs=Math.round(d.timestamp||O());e[a]=b;e.context={lastActivityMs:String(d.timestamp?-1:Uf())};(a=d.Z)?(b={},a.videoId?b.videoId=a.videoId:a.playlistId&&(b.playlistId=a.playlistId),dg[a.token]=b,a=ig("log_event",a.token)):a=ig("log_event");a.push(e);c&&(ag.log_event=new c);a.length>=(ne("web_logging_max_batch")||100)?fg():hg()}
;function mg(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||Q("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.kb||Q("AUTHORIZATION"))||(a?b="Bearer "+z("gapi.auth.getToken")().jb:b=vc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=Q("SESSION_INDEX",0),S("pageid_as_header_web")&&(d["X-Goog-PageId"]=Q("DELEGATED_SESSION_ID")));return d}
...
;function pg(){var a=new Jd;(a=a.isAvailable()?new Pd(a,"yt.innertube"):null)||(a=new Kd("yt.innertube"),a=a.isAvailable()?a:null);this.f=a?new Fd(a):null;this.g=document.domain||window.location.hostname}
pg.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.f)try{this.f.set(a,b,C()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(bd(b))}catch(f){return}else e=escape(b);og(a,e,c,this.g)};
...
pg.prototype.remove=function(a){this.f&&this.f.remove(a);var b=this.g;Vb.remove(""+a,"/",void 0===b?"youtube.com":b)};var qg=new pg;function rg(a,b,c,d){if(d)return null;d=qg.get("nextId",!0)||1;var e=qg.get("requests",!0)||{};e[d]={method:a,request:b,authState:ng(c),requestTime:Math.round(O())};qg.set("nextId",d+1,86400,!0);qg.set("requests",e,86400,!0);return d}
function sg(a){var b=qg.get("requests",!0)||{};delete b[a];qg.set("requests",b,86400,!0)}
function tg(a){var b=qg.get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round(O())-d.requestTime)){var e=d.authState,f=ng(mg(!1));$a(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round(O())),jg(a,d.method,e,{}));delete b[c]}}qg.set("requests",b,86400,!0)}}
;function ug(a){var b=this;this.f=a||{za:$d("INNERTUBE_API_KEY"),Aa:$d("INNERTUBE_API_VERSION"),Ba:Q("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),Ca:$d("INNERTUBE_CONTEXT_CLIENT_VERSION"),Ea:$d("INNERTUBE_CONTEXT_HL"),Da:$d("INNERTUBE_CONTEXT_GL"),Fa:$d("INNERTUBE_HOST_OVERRIDE")||"",Ga:!!Q("INNERTUBE_USE_THIRD_PARTY_AUTH",!1)};qf(function(){tg(b)},0,5E3)}
function jg(a,b,c,d){!Q("VISITOR_DATA")&&.01>Math.random()&&R(Error("Missing VISITOR_DATA when sending innertube request."),"WARNING");var e={headers:{"Content-Type":"application/json"},method:"POST",F:c,ka:"JSON",N:function(){d.N()},
ja:d.N,onSuccess:function(u,p){if(d.onSuccess)d.onSuccess(p)},
ia:function(u){if(d.onSuccess)d.onSuccess(u)},
onError:function(u,p){if(d.onError)d.onError(p)},
pb:function(u){if(d.onError)d.onError(u)},
timeout:d.timeout,withCredentials:!0},f="",h=a.f.Fa;h&&(f=h);h=a.f.Ga||!1;var g=mg(h,f,d);Object.assign(e.headers,g);e.headers.Authorization&&!f&&(e.headers["x-origin"]=window.location.origin);var k=""+f+("/youtubei/"+a.f.Aa+"/"+b)+"?alt=json&key="+a.f.za,l;if(d.retry&&S("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=f&&(l=rg(b,c,g,h))){var n=e.onSuccess,r=e.ia;e.onSuccess=function(u,p){sg(l);n(u,p)};
c.ia=function(u,p){sg(l);r(u,p)}}try{S("use_fetch_for_op_xhr")?xe(k,e):Ge(k,e)}catch(u){if("InvalidAccessError"==u)l&&(sg(l),l=0),R(Error("An extension is blocking network request."),"WARNING");
else throw u;}l&&qf(function(){tg(a)},0,5E3)}
;var vg=C().toString();
function wg(){a:{if(window.crypto&&window.crypto.getRandomValues)try{var a=Array(16),b=new Uint8Array(16);window.crypto.getRandomValues(b);for(var c=0;c<a.length;c++)a[c]=b[c];var d=a;break a}catch(e){}d=Array(16);for(a=0;16>a;a++){b=C();for(c=0;c<b%23;c++)d[a]=Math.random();d[a]=Math.floor(256*Math.random())}if(vg)for(a=1,b=0;b<vg.length;b++)d[a%16]=d[a%16]^d[(a-1)%16]/4^vg.charCodeAt(b),a++}a=[];for(b=0;b<d.length;b++)a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(d[b]&63));
return a.join("")}
;var xg=z("ytLoggingTimeDocumentNonce_")||wg();y("ytLoggingTimeDocumentNonce_",xg,void 0);function yg(a){this.f=a}
...
function Dg(a){return Q(Cg(void 0===a?0:a),void 0)}
y("yt_logging_screen.getRootVeType",Dg,void 0);function Eg(){var a=Dg(0),b;a?b=new yg({veType:a,youtubeData:void 0}):b=null;return b}
function Fg(a){a=void 0===a?0:a;var b=Q(Bg(a));b||0!=a||(b=Q("EVENT_ID"));return b?b:null}
y("yt_logging_screen.getCurrentCsn",Fg,void 0);function Gg(a,b,c){c=void 0===c?0:c;if(a!==Q(Bg(c))||b!==Q(Cg(c)))P(Bg(c),a),P(Cg(c),b),0==c&&(b=function(){setTimeout(function(){a&&lg("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:xg,clientScreenNonce:a},ug)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b())}
y("yt_logging_screen.setCurrentScreen",Gg,void 0);function Hg(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=Q("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=Q("VALID_SESSION_TEMPDATA_DOMAINS",[]),h=M(N(3,window.location.href));h&&f.push(h);h=M(N(3,d));if(0<=La(f,h)||!h&&0==d.lastIndexOf("/",0))if(S("autoescape_tempdata_url")&&(f=document.createElement("a"),Jb(f,d),d=f.href),d){h=d.match(Qd);d=h[5];f=h[6];h=h[7];var g="";d&&(g+=d);f&&(g+="?"+f);h&&(g+="#"+h);d=g;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&(b.itct||b.ved)&&
(b.csn=b.csn||Fg()),k){var k=parseInt(k,10);isFinite(k)&&0<k&&(e="ST-"+Nb(d).toString(36),b=b?Sd(b):"",og(e,b,k||5))}else k="ST-"+Nb(d).toString(36),b=b?Sd(b):"",og(k,b,5)}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var n=void 0===n?"":n;var r=void 0===r?window:r;c=r.location;a=Td(a,l)+n;a=a instanceof H?a:yb(a);c.href=wb(a)}return!0}
;function Ig(a,b,c){a={csn:a,parentVe:zg(b),childVes:Na(c,function(d){return zg(d)})};
c=q(c);for(b=c.next();!b.done;b=c.next())b=zg(b.value),(Ya(b)||!b.trackingParams&&!b.veType)&&Oe(Error("Child VE logged with no data"),"WARNING");lg("visualElementAttached",a,ug,{Z:void 0})}
;function Jg(a){a=a||{};var b={enablejsapi:1},c={};this.url=a.url||"";this.args=a.args||ab(b);this.assets=a.assets||{};this.attrs=a.attrs||ab(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
Jg.prototype.clone=function(){var a=new Jg,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==za(c)?a[b]=ab(c):a[b]=c}return a};function Kg(){I.call(this);this.f=[]}
t(Kg,I);Kg.prototype.m=function(){for(;this.f.length;){var a=this.f.pop();a.target.removeEventListener(a.name,a.mb)}I.prototype.m.call(this)};var Lg=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function Mg(a){a=a||"";if(window.spf){var b=a.match(Lg);spf.style.load(a,b?b[1]:"",void 0)}else Ng(a)}
function Ng(a){var b=Og(a),c=document.getElementById(b),d=c&&Te(c,"loaded");d||c&&!d||(c=Pg(a,b,function(){Te(c,"loaded")||(Re(c),bf(b),T(Ia(cf,b),0))}))}
...
function Og(a){var b=document.createElement("A");a=zb(a);Jb(b,a);b=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Nb(b)}
;function Qg(a,b){I.call(this);this.l=this.T=a;this.D=b;this.o=!1;this.api={};this.R=this.B=null;this.G=new L;Nc(this,Ia(Oc,this.G));this.i={};this.O=this.S=this.h=this.Y=this.f=null;this.K=!1;this.j=this.A=null;this.U={};this.oa=["onReady"];this.X=null;this.ga=NaN;this.P={};Rg(this);this.V("WATCH_LATER_VIDEO_ADDED",this.Ia.bind(this));this.V("WATCH_LATER_VIDEO_REMOVED",this.Ja.bind(this));this.V("onAdAnnounce",this.ra.bind(this));this.qa=new Kg(this);Nc(this,Ia(Oc,this.qa))}
t(Qg,I);m=Qg.prototype;m.getId=function(){return this.D};
m.loadNewVideoConfig=function(a){if(!this.g){a instanceof Jg||(a=new Jg(a));this.Y=a;this.f=a.clone();this.h=this.f.attrs.id||this.h;"video-player"==this.h&&(this.h=this.D,this.f.attrs.id=this.D);this.l.id==this.h&&(this.h+="-player",this.f.attrs.id=this.h);this.f.args.enablejsapi="1";this.f.args.playerapiid=this.D;this.S||(this.S=Sg(this,this.f.args.jsapicallback||"onYouTubePlayerReady"));this.f.args.jsapicallback=null;if(a=this.f.attrs.width)this.l.style.width=oc(Number(a)||a);if(a=this.f.attrs.height)this.l.style.height=
oc(Number(a)||a);Tg(this);this.o&&Ug(this)}};
m.ua=function(){return this.Y};
function Ug(a){a.f.loaded||(a.f.loaded=!0,"0"!=a.f.args.autoplay?a.api.loadVideoByPlayerVars(a.f.args):a.api.cueVideoByPlayerVars(a.f.args))}
function Vg(a){var b=!0,c=Wg(a);c&&a.f&&(a=a.f,b=Te(c,"version")==a.assets.js);return b&&!!z("yt.player.Application.create")}
function Tg(a){if(!a.g&&!a.K){var b=Vg(a);if(b&&"html5"==(Wg(a)?"html5":null))a.O="html5",a.o||Xg(a);else if(Yg(a),a.O="html5",b&&a.j)a.T.appendChild(a.j),Xg(a);else{a.f.loaded=!0;var c=!1;a.A=function(){c=!0;var d=a.f.clone();z("yt.player.Application.create")(a.T,d);Xg(a)};
a.K=!0;b?a.A():(gf(a.f.assets.js,a.A),Mg(a.f.assets.css),Zg(a)&&!c&&y("yt.player.Application.create",null,void 0))}}}
function Wg(a){var b=ac(a.h);!b&&a.l&&a.l.querySelector&&(b=a.l.querySelector("#"+a.h));return b}
function Xg(a){if(!a.g){var b=Wg(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.K=!1,b.isNotServable&&b.isNotServable(a.f.args.video_id)||$g(a)):a.ga=T(function(){Xg(a)},50)}}
function $g(a){Rg(a);a.o=!0;var b=Wg(a);b.addEventListener&&(a.B=ah(a,b,"addEventListener"));b.removeEventListener&&(a.R=ah(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.api[e]||(a.api[e]=ah(a,b,e))}for(var f in a.i)a.B(f,a.i[f]);Ug(a);a.S&&a.S(a.api);a.G.L("onReady",a.api)}
function ah(a,b,c){var d=b[c];return function(){try{return a.X=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.X=e,fe(e))}}}
function Rg(a){a.o=!1;if(a.R)for(var b in a.i)a.R(b,a.i[b]);for(var c in a.P)U(parseInt(c,10));a.P={};a.B=null;a.R=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.V.bind(a);a.api.removeEventListener=a.Na.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.va.bind(a);a.api.getPlayerType=a.wa.bind(a);a.api.getCurrentVideoConfig=a.ua.bind(a);a.api.loadNewVideoConfig=a.loadNewVideoConfig.bind(a);a.api.isReady=a.Ha.bind(a)}
m.Ha=function(){return this.o};
m.V=function(a,b){var c=this,d=Sg(this,b);if(d){if(!(0<=La(this.oa,a)||this.i[a])){var e=bh(this,a);this.B&&this.B(a,e)}this.G.subscribe(a,d);"onReady"==a&&this.o&&T(function(){d(c.api)},0)}};
m.Na=function(a,b){if(!this.g){var c=Sg(this,b);c&&zd(this.G,a,c)}};
function Sg(a,b){var c=b;if("string"==typeof b){if(a.U[b])return a.U[b];c=function(){var d=z(b);d&&d.apply(v,arguments)};
a.U[b]=c}return c?c:null}
function bh(a,b){var c="ytPlayer"+b+a.D;a.i[b]=c;v[c]=function(d){var e=T(function(){if(!a.g){a.G.L(b,d);var f=a.P,h=String(e);h in f&&delete f[h]}},0);
Za(a.P,String(e))};
return c}
m.ra=function(a){bf("a11y-announce",a)};
m.Ia=function(a){bf("WATCH_LATER_VIDEO_ADDED",a)};
m.Ja=function(a){bf("WATCH_LATER_VIDEO_REMOVED",a)};
m.wa=function(){return this.O||(Wg(this)?"html5":null)};
m.va=function(){return this.X};
function Yg(a){a.cancel();Rg(a);a.O=null;a.f&&(a.f.loaded=!1);var b=Wg(a);b&&(Vg(a)||!Zg(a)?a.j=b:(b&&b.destroy&&b.destroy(),a.j=null));for(a=a.T;b=a.firstChild;)a.removeChild(b)}
m.cancel=function(){this.A&&nf(this.f.assets.js,this.A);U(this.ga);this.K=!1};
m.m=function(){Yg(this);if(this.j&&this.f&&this.j.destroy)try{this.j.destroy()}catch(b){R(b)}this.U=null;for(var a in this.i)v[this.i[a]]=null;this.Y=this.f=this.api=null;delete this.T;delete this.l;I.prototype.m.call(this)};
function Zg(a){return a.f&&a.f.args&&a.f.args.fflags?-1!=a.f.args.fflags.indexOf("player_destroy_old_version=true"):!1}
;var ch={},dh="player_uid_"+(1E9*Math.random()>>>0);function eh(a){var b="player";b=x(b)?ac(b):b;var c=dh+"_"+(b[Ea]||(b[Ea]=++Fa)),d=ch[c];if(d)return d.loadNewVideoConfig(a),d.api;d=new Qg(b,c);ch[c]=d;bf("player-added",d.api);Nc(d,Ia(fh,d));T(function(){d.loadNewVideoConfig(a)},0);
return d.api}
function fh(a){delete ch[a.getId()]}
;function gh(a,b,c){c=void 0===c?{}:c;var d=ug;Q("ytLoggingEventsDefaultDisabled",!1)&&ug==ug&&(d=null);lg(a,b,d,c)}
;var hh=z("ytLoggingLatencyUsageStats_")||{};y("ytLoggingLatencyUsageStats_",hh,void 0);var ih=0;function jh(a){hh[a]=hh[a]||{count:0};var b=hh[a];b.count++;b.time=O();ih||(ih=qf(kh,0,5E3));if(5<b.count){if(6==b.count&&1>1E5*Math.random()){b=0==a.indexOf("info")?"WARNING":"ERROR";var c=Error("CSI data exceeded logging limit with key");c.params=a;Oe(c,b)}return!0}return!1}
function kh(){var a=O(),b;for(b in hh)6E4<a-hh[b].time&&delete hh[b];ih=0}
;function lh(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];if(!mh(a)||c.some(function(e){return!mh(e)}))throw Error("Only objects may be merged.");
c=q(c);for(d=c.next();!d.done;d=c.next())nh(a,d.value)}
function nh(a,b){for(var c in b)if(mh(b[c])){if(c in a&&!mh(a[c]))throw Error("Cannot merge an object into a non-object.");c in a||(a[c]={});nh(a[c],b[c])}else if(oh(b[c])){if(c in a&&!oh(a[c]))throw Error("Cannot merge an array into a non-array.");c in a||(a[c]=[]);ph(a[c],b[c])}else a[c]=b[c];return a}
function ph(a,b){for(var c=q(b),d=c.next();!d.done;d=c.next())d=d.value,mh(d)?a.push(nh({},d)):oh(d)?a.push(ph([],d)):a.push(d);return a}
function mh(a){return"object"===typeof a&&!Array.isArray(a)}
function oh(a){return"object"===typeof a&&Array.isArray(a)}
;function qh(a,b){this.version=a;this.args=b}
;function rh(a){this.topic=a}
rh.prototype.toString=function(){return this.topic};var sh=z("ytPubsub2Pubsub2Instance")||new L;L.prototype.subscribe=L.prototype.subscribe;L.prototype.unsubscribeByKey=L.prototype.M;L.prototype.publish=L.prototype.L;L.prototype.clear=L.prototype.clear;y("ytPubsub2Pubsub2Instance",sh,void 0);y("ytPubsub2Pubsub2SubscribedKeys",z("ytPubsub2Pubsub2SubscribedKeys")||{},void 0);y("ytPubsub2Pubsub2TopicToKeys",z("ytPubsub2Pubsub2TopicToKeys")||{},void 0);y("ytPubsub2Pubsub2IsAsync",z("ytPubsub2Pubsub2IsAsync")||{},void 0);
y("ytPubsub2Pubsub2SkipSubKey",null,void 0);function th(a,b){var c=z("ytPubsub2Pubsub2Instance");c&&c.publish.call(c,a.toString(),a,b)}
;var X=window.performance||window.mozPerformance||window.msPerformance||window.webkitPerformance||{};function uh(){var a=Q("TIMING_TICK_EXPIRATION");a||(a={},P("TIMING_TICK_EXPIRATION",a));return a}
function vh(){var a=uh(),b;for(b in a)sf(a[b]);P("TIMING_TICK_EXPIRATION",{})}
;function wh(a,b){qh.call(this,1,arguments)}
t(wh,qh);function xh(a,b){qh.call(this,1,arguments)}
t(xh,qh);var yh=new rh("aft-recorded"),zh=new rh("timing-sent");var Ah={vc:!0},Y={},Bh=(Y.ad_allowed="adTypesAllowed",Y.yt_abt="adBreakType",Y.ad_cpn="adClientPlaybackNonce",Y.ad_docid="adVideoId",Y.yt_ad_an="adNetworks",Y.ad_at="adType",Y.browse_id="browseId",Y.p="httpProtocol",Y.t="transportProtocol",Y.cpn="clientPlaybackNonce",Y.csn="clientScreenNonce",Y.docid="videoId",Y.is_continuation="isContinuation",Y.is_nav="isNavigation",Y.b_p="kabukiInfo.browseParams",Y.is_prefetch="kabukiInfo.isPrefetch",Y.is_secondary_nav="kabukiInfo.isSecondaryNav",Y.prev_browse_id=
...
Y.label="tvInfo.label",Y.is_mdx="tvInfo.isMdx",Y.preloaded="tvInfo.isPreloaded",Y.query="unpluggedInfo.query",Y.upg_chip_ids_string="unpluggedInfo.upgChipIdsString",Y.yt_vst="videoStreamType",Y.vph="viewportHeight",Y.vpw="viewportWidth",Y.yt_vis="isVisible",Y),Ch="ap c cver cbrand cmodel ei srt yt_fss yt_li plid vpil vpni vpst yt_eil vpni2 vpil2 icrc icrt pa GetBrowse_rid GetPlayer_rid GetSearch_rid GetWatchNext_rid cmt d_vpct d_vpnfi d_vpni pc pfa pfeh pftr prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis yt_ref yt_sts".split(" "),
Dh="isContinuation isNavigation kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist".split(" "),Eh={},Fh=(Eh.pa="LATENCY_ACTION_",Eh.yt_pt="LATENCY_PLAYER_",Eh.yt_vst="VIDEO_STREAM_TYPE_",Eh),Gh=!1;
function Hh(){Ih().info.yt_lt="hot_bg";if(Jh()){var a="hot_bg";Kh().info_yt_lt=a;if("yt_lt"in Bh){var b=Bh.yt_lt;0<=La(Dh,b)&&(a=!!a);"yt_lt"in Fh&&(a=Fh.yt_lt+a.toUpperCase());var c={};b=b.split(".");for(var d=c,e=0;e<b.length-1;e++)d[b[e]]=d[b[e]]||{},d=d[b[e]];d[b[b.length-1]]=a;Jh()&&(a=Ih(),"gelInfo"in a||(a.gelInfo={}),lh(a.gelInfo,c),a=Lh(),b=Object.keys(c).join(""),jh("info_"+b+"_"+a)||(c.clientActionNonce=a,gh("latencyActionInfo",c)))}else 0<=La(Ch,"yt_lt")||(c=Error("Unknown label logged with GEL CSI"),
c.params="yt_lt",fe(c))}}
function Mh(){var a=Nh();if(a.aft)return a.aft;for(var b=Q("TIMING_AFT_KEYS",["ol"]),c=b.length,d=0;d<c;d++){var e=a[b[d]];if(e)return e}return NaN}
A(X.clearResourceTimings||X.webkitClearResourceTimings||X.mozClearResourceTimings||X.msClearResourceTimings||X.oClearResourceTimings||xa,X);function Lh(){var a=Ih().nonce;a||(a=wg(),Ih().nonce=a);return a}
function Nh(){return Ih().tick}
function Kh(){var a=Ih();"gel"in a||(a.gel={});return a.gel}
function Ih(){var a;(a=z("ytcsi.data_"))||(a={tick:{},info:{}},Ja("ytcsi.data_",a));return a}
function Oh(){var a=Nh(),b=a.pbr,c=a.vc;a=a.pbs;return b&&c&&a&&b<c&&c<a&&1==Ih().info.yt_pvis}
function Jh(){return!!S("csi_on_gel")||!!Ih().useGel}
function Ph(){vh();if(!Jh()){var a=Nh(),b=Ih().info,c=a._start;for(f in a)if(0==f.lastIndexOf("_",0)&&Aa(a[f])){var d=f.slice(1);if(d in Ah){var e=Na(a[f],function(l){return Math.round(l-c)});
b["all_"+d]=e.join()}delete a[f]}e=Q("CSI_SERVICE_NAME","youtube");var f={v:2,s:e,action:Q("TIMING_ACTION",void 0)};d=Hh.srt;void 0!==a.srt&&delete b.srt;if(b.h5jse){var h=window.location.protocol+z("ytplayer.config.assets.js");(h=X.getEntriesByName?X.getEntriesByName(h)[0]:null)?b.h5jse=Math.round(b.h5jse-h.responseEnd):delete b.h5jse}a.aft=Mh();Oh()&&"youtube"==e&&(Hh(),e=a.vc,h=a.pbs,delete a.aft,b.aft=Math.round(h-e));for(var g in b)"_"!=g.charAt(0)&&(f[g]=b[g]);a.ps=O();g={};e=[];for(var k in a)"_"!=
k.charAt(0)&&(h=Math.round(a[k]-c),g[k]=h,e.push(k+"."+h));f.rt=e.join(",");(a=z("ytdebug.logTiming"))&&a(f,g);Qh(f,!!b.ap);th(zh,new xh(g.aft+(d||0),void 0))}}
function Qh(a,b){if(S("debug_csi_data")){var c=z("yt.timing.csiData");c||(c=[],y("yt.timing.csiData",c,void 0));c.push({page:location.href,time:new Date,args:a})}c="";for(var d in a)c+="&"+d+"="+a[d];d="/csi_204?"+c.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b){var e=void 0===e?"":e;Ke(d,e)||Je(d,void 0,void 0,void 0,e)}else Je(d);Ja("yt.timing.pingSent_",!0)}
;function Rh(a){return(0==a.search("cue")||0==a.search("load"))&&"loadModule"!=a}
function Sh(a,b,c){x(a)&&(a={mediaContentUrl:a,startSeconds:b,suggestedQuality:c});b=/\/([ve]|embed)\/([^#?]+)/.exec(a.mediaContentUrl);a.videoId=b&&b[2]?b[2]:null;return Th(a)}
function Th(a,b,c){if(Da(a)){b=["endSeconds","startSeconds","mediaContentUrl","suggestedQuality","videoId"];c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}return{videoId:a,startSeconds:b,suggestedQuality:c}}
function Uh(a,b,c,d){if(Da(a)&&!Aa(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};x(a)&&16==a.length?b.list="PL"+a:b.playlist=a;return b}
;function Vh(a){I.call(this);this.f=a;this.f.subscribe("command",this.la,this);this.h={};this.j=!1}
D(Vh,I);m=Vh.prototype;m.start=function(){this.j||this.g||(this.j=!0,Wh(this.f,"RECEIVING"))};
m.la=function(a,b,c){if(this.j&&!this.g){var d=b||{};switch(a){case "addEventListener":x(d.event)&&(a=d.event,a in this.h||(c=A(this.Pa,this,a),this.h[a]=c,this.addEventListener(a,c)));break;case "removeEventListener":x(d.event)&&Xh(this,d.event);break;default:this.i.isReady()&&this.i.isExternalMethodAvailable(a,c||null)&&(b=Yh(a,b||{}),c=this.i.handleExternalCall(a,b,c||null),(c=Zh(a,c))&&this.j&&!this.g&&Wh(this.f,a,c))}}};
m.Pa=function(a,b){this.j&&!this.g&&Wh(this.f,a,this.ba(a,b))};
m.ba=function(a,b){if(null!=b)return{value:b}};
function Xh(a,b){b in a.h&&(a.removeEventListener(b,a.h[b]),delete a.h[b])}
m.m=function(){var a=this.f;a.g||zd(a.f,"command",this.la,this);this.f=null;for(var b in this.h)Xh(this,b);Vh.C.m.call(this)};function $h(a,b){Vh.call(this,b);this.i=a;this.start()}
D($h,Vh);$h.prototype.addEventListener=function(a,b){this.i.addEventListener(a,b)};
$h.prototype.removeEventListener=function(a,b){this.i.removeEventListener(a,b)};
function Yh(a,b){switch(a){case "loadVideoById":return b=Th(b),[b];case "cueVideoById":return b=Th(b),[b];case "loadVideoByPlayerVars":return[b];case "cueVideoByPlayerVars":return[b];case "loadPlaylist":return b=Uh(b),[b];case "cuePlaylist":return b=Uh(b),[b];case "seekTo":return[b.seconds,b.allowSeekAhead];case "playVideoAt":return[b.index];case "setVolume":return[b.volume];case "setPlaybackQuality":return[b.suggestedQuality];case "setPlaybackRate":return[b.suggestedRate];case "setLoop":return[b.loopPlaylists];
...
function Zh(a,b){switch(a){case "isMuted":return{muted:b};case "getVolume":return{volume:b};case "getPlaybackRate":return{playbackRate:b};case "getAvailablePlaybackRates":return{availablePlaybackRates:b};case "getVideoLoadedFraction":return{videoLoadedFraction:b};case "getPlayerState":return{playerState:b};case "getCurrentTime":return{currentTime:b};case "getPlaybackQuality":return{playbackQuality:b};case "getAvailableQualityLevels":return{availableQualityLevels:b};case "getDuration":return{duration:b};
case "getVideoUrl":return{videoUrl:b};case "getVideoEmbedCode":return{videoEmbedCode:b};case "getPlaylist":return{playlist:b};case "getPlaylistIndex":return{playlistIndex:b};case "getOptions":return{options:b};case "getOption":return{option:b}}}
$h.prototype.ba=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return $h.C.ba.call(this,a,b)};
$h.prototype.m=function(){$h.C.m.call(this);delete this.i};function ai(a,b,c,d){I.call(this);this.h=b||null;this.A="*";this.i=c||null;this.sessionId=null;this.channel=d||null;this.D=!!a;this.o=A(this.B,this);window.addEventListener("message",this.o)}
t(ai,I);ai.prototype.B=function(a){if(!("*"!=this.i&&a.origin!=this.i||this.h&&a.source!=this.h)&&x(a.data)){try{var b=JSON.parse(a.data)}catch(c){return}if(!(null==b||this.D&&(this.sessionId&&this.sessionId!=b.id||this.channel&&this.channel!=b.channel))&&b)switch(b.event){case "listening":"null"!=a.origin&&(this.i=this.A=a.origin);this.h=a.source;this.sessionId=b.id;this.f&&(this.f(),this.f=null);break;case "command":this.j&&(!this.l||0<=La(this.l,b.func))&&this.j(b.func,b.args,a.origin)}}};
ai.prototype.sendMessage=function(a,b){var c=b||this.h;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=bd(a);c.postMessage(d,this.A)}catch(e){R(e,"WARNING")}}};
ai.prototype.m=function(){window.removeEventListener("message",this.o);I.prototype.m.call(this)};function bi(a,b,c){ai.call(this,a,b,c||Q("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname,"widget");this.l=this.f=this.j=null}
t(bi,ai);function ci(){var a=this.g=new bi(!!Q("WIDGET_ID_ENFORCE")),b=A(this.Ma,this);a.j=b;a.l=null;this.g.channel="widget";if(a=Q("WIDGET_ID"))this.g.sessionId=a;this.i=[];this.l=!1;this.j={}}
m=ci.prototype;m.Ma=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.j[a]||"onReady"==a||(this.addEventListener(a,di(this,a)),this.j[a]=!0)):this.na(a,b,c)};
m.na=function(){};
function di(a,b){return A(function(c){this.sendMessage(b,c)},a)}
m.addEventListener=function(){};
m.ta=function(){this.l=!0;this.sendMessage("initialDelivery",this.ca());this.sendMessage("onReady");G(this.i,this.ma,this);this.i=[]};
m.ca=function(){return null};
function ei(a,b){a.sendMessage("infoDelivery",b)}
m.ma=function(a){this.l?this.g.sendMessage(a):this.i.push(a)};
m.sendMessage=function(a,b){this.ma({event:a,info:void 0==b?null:b})};
m.dispose=function(){this.g=null};function fi(a){ci.call(this);this.f=a;this.h=[];this.addEventListener("onReady",A(this.Ka,this));this.addEventListener("onVideoProgress",A(this.Ta,this));this.addEventListener("onVolumeChange",A(this.Ua,this));this.addEventListener("onApiChange",A(this.Oa,this));this.addEventListener("onPlaybackQualityChange",A(this.Qa,this));this.addEventListener("onPlaybackRateChange",A(this.Ra,this));this.addEventListener("onStateChange",A(this.Sa,this));this.addEventListener("onWebglSettingsChanged",A(this.Va,
this))}
D(fi,ci);m=fi.prototype;m.na=function(a,b,c){if(this.f.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&Rh(a)){var d=b;if(Da(d[0])&&!Aa(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=Th.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=Sh.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=Uh.apply(window,d)}d=e}b.length=1;b[0]=d}this.f.handleExternalCall(a,b,c);Rh(a)&&ei(this,this.ca())}};
...
m.Qa=function(a){ei(this,{playbackQuality:a})};
m.Ra=function(a){ei(this,{playbackRate:a})};
...
m.Ua=function(){ei(this,{muted:this.f.isMuted(),volume:this.f.getVolume()})};
m.Ta=function(a){a={currentTime:a,videoBytesLoaded:this.f.getVideoBytesLoaded(),videoLoadedFraction:this.f.getVideoLoadedFraction(),currentTimeLastUpdated_:C()/1E3,playbackRate:this.f.getPlaybackRate(),mediaReferenceTime:this.f.getMediaReferenceTime()};this.f.getProgressState&&(a.progressState=this.f.getProgressState());ei(this,a)};
m.Va=function(){var a={sphericalProperties:this.f.getSphericalProperties()};ei(this,a)};
m.dispose=function(){fi.C.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function gi(a){a=void 0===a?!1:a;I.call(this);this.f=new L(a);Nc(this,Ia(Oc,this.f))}
D(gi,I);gi.prototype.subscribe=function(a,b,c){return this.g?0:this.f.subscribe(a,b,c)};
gi.prototype.j=function(a,b){this.g||this.f.L.apply(this.f,arguments)};function hi(a,b,c){gi.call(this);this.h=a;this.i=b;this.l=c}
D(hi,gi);function Wh(a,b,c){if(!a.g){var d=a.h;d.g||a.i!=d.f||(a={id:a.l,command:b},c&&(a.data=c),d.f.postMessage(bd(a),d.i))}}
hi.prototype.m=function(){this.i=this.h=null;hi.C.m.call(this)};function ii(a,b,c){I.call(this);this.f=a;this.i=c;this.j=V(window,"message",A(this.l,this));this.h=new hi(this,a,b);Nc(this,Ia(Oc,this.h))}
D(ii,I);ii.prototype.l=function(a){var b;if(b=!this.g)if(b=a.origin==this.i)a:{b=this.f;do{b:{var c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,x(b))){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.h,c.g||c.j("command",b.command,b.data,a.origin))}};
ii.prototype.m=function(){Of(this.j);this.f=null;ii.C.m.call(this)};function ji(){var a=ab(ki),b;return od(new J(function(c,d){a.onSuccess=function(e){qe(e)?c(e):d(new li("Request failed, status="+e.status,"net.badstatus",e))};
a.onError=function(e){d(new li("Unknown request error","net.unknown",e))};
a.N=function(e){d(new li("Request timed out","net.timeout",e))};
b=Ae("//googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof pd&&b.abort();
return md(c)})}
function li(a,b){F.call(this,a+", errorCode="+b);this.errorCode=b;this.name="PromiseAjaxError"}
t(li,F);function mi(){this.g=0;this.f=null}
mi.prototype.then=function(a,b,c){return 1===this.g&&a?(a=a.call(c,this.f),hd(a)?a:ni(a)):2===this.g&&b?(a=b.call(c,this.f),hd(a)?a:oi(a)):this};
...
;function pi(a){F.call(this,a.message||a.description||a.name);this.isMissing=a instanceof qi;this.isTimeout=a instanceof li&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof pd}
t(pi,F);pi.prototype.name="BiscottiError";function qi(){F.call(this,"Biscotti ID is missing from server")}
t(qi,F);qi.prototype.name="BiscottiMissingError";var ki={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},ri=null;function ce(){if("1"===Va(ae(),"args","privembed"))return md(Error("Biscotti ID is not available in private embed mode"));ri||(ri=od(ji().then(si),function(a){return ti(2,a)}));
return ri}
...
function ui(a,b){T(function(){od(ji().then(si,function(c){return ti(b,c)}),xa)},a)}
function vi(){try{var a=z("yt.ads.biscotti.getId_");return a?a():ce()}catch(b){return md(b)}}
;function wi(a){if("1"!==Va(ae(),"args","privembed")){a&&be();try{vi().then(function(b){S("pass_biscotti_id_in_header_ajax_tv")||S("pass_biscotti_id_in_header_ajax")||(b=he(b),b.bsq=xi++,Ge("//www.youtube.com/ad_data_204",{xa:!1,F:b,withCredentials:!0}))},function(){}),T(wi,18E5)}catch(b){R(b)}}}
var xi=0;var Z=z("ytglobal.prefsUserPrefsPrefs_")||{};y("ytglobal.prefsUserPrefsPrefs_",Z,void 0);function yi(){this.f=Q("ALT_PREF_COOKIE_NAME","PREF");var a=Vb.get(""+this.f,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
m=yi.prototype;m.get=function(a,b){zi(a);Ai(a);var c=void 0!==Z[a]?Z[a].toString():null;return null!=c?c:b?b:""};
m.set=function(a,b){zi(a);Ai(a);if(null==b)throw Error("ExpectedNotNull");Z[a]=b.toString()};
m.remove=function(a){zi(a);Ai(a);delete Z[a]};
...
function Ai(a){if(/^f([1-9][0-9]*)$/.test(a))throw Error("ExpectedRegexMatch: "+a);}
function zi(a){if(!/^\w+$/.test(a))throw Error("ExpectedRegexMismatch: "+a);}
function Bi(a){a=void 0!==Z[a]?Z[a].toString():null;return null!=a&&/^[A-Fa-f0-9]+$/.test(a)?parseInt(a,16):null}
ya(yi);var Ci=null,Di=null,Ei=null,Fi={};function Gi(a){var b=a.id;a=a.ve_type;var c=Ag++;a=new yg({veType:a,veCounter:c,elementIndex:void 0,dataElement:void 0,youtubeData:void 0});Fi[b]=a;b=Fg();c=Eg();b&&c&&Ig(b,c,[a])}
function Hi(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(Gg(b,a),a=Eg()))for(var c in Fi){var d=Fi[c];d&&Ig(b,a,[d])}}
function Ii(a){Fi[a.id]=new yg({trackingParams:a.tracking_params})}
function Ji(a){var b=Fg();a=Fi[a.id];b&&a&&lg("visualElementGestured",{csn:b,ve:zg(a),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"},ug,{Z:void 0})}
function Ki(a){a=a.ids;var b=Fg();if(b)for(var c=0;c<a.length;c++){var d=Fi[a[c]];d&&lg("visualElementShown",{csn:b,ve:zg(d),eventType:1},ug,{Z:void 0})}}
...
y("writeEmbed",function(){var a=Q("PLAYER_CONFIG",void 0);wi(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=Q("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);Q("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");Ci=a=eh(a);a.addEventListener("onScreenChanged",Hi);a.addEventListener("onLogClientVeCreated",Gi);a.addEventListener("onLogServerVeCreated",Ii);a.addEventListener("onLogVeClicked",Ji);a.addEventListener("onLogVesShown",
Ki);b=Q("POST_MESSAGE_ID","player");Q("ENABLE_JS_API")?Ei=new fi(a):Q("ENABLE_POST_API")&&x(b)&&x(c)&&(Di=new ii(window.parent,b,c),Ei=new $h(a,Di.h));c=$d("BG_P");Ef(c)&&(Q("BG_I")||Q("BG_IU"))&&(Af=!0,zf.initialize(Q("BG_I",null),Q("BG_IU",null),c,Df,void 0));vf()},void 0);
y("yt.www.watch.ads.restrictioncookie.spr",function(a){Je(a+"mac_204?action_fcts=1");return!0},void 0);
var Li=ee(function(){var a="ol";X.mark&&(0==a.lastIndexOf("mark_",0)||(a="mark_"+a),X.mark(a));a=Nh();var b=O();a.ol&&(a._ol=a._ol||[a.ol],a._ol.push(b));a.ol=b;a=uh();if(b=a.ol)sf(b),a.ol=0;Kh().tick_ol=void 0;O();Jh()?(a=Lh(),jh("tick_ol_"+a)||gh("latencyActionTicked",{tickName:"ol",clientActionNonce:a},{timestamp:void 0}),a=!0):a=!1;if(a=!a)a=!z("yt.timing.pingSent_");if(a&&(b=Q("TIMING_ACTION",void 0),a=Nh(),z("ytglobal.timingready_")&&b&&a._start&&(b=Mh()))){Gh||(th(yh,new wh(Math.round(b-a._start),
void 0)),Gh=!0);b=!0;var c=Q("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&Ph()}a=yi.getInstance();c=!!((Bi("f"+(Math.floor(119/31)+1))||0)&67108864);b=1<window.devicePixelRatio;document.body&&Rc(document.body,"exp-invert-logo")&&(b&&!Rc(document.body,"inverted-hdpi")?(d=document.body,d.classList?d.classList.add("inverted-hdpi"):Rc(d,"inverted-hdpi")||(d.className+=0<d.className.length?" inverted-hdpi":"inverted-hdpi")):!b&&Rc(document.body,"inverted-hdpi")&&
Sc());c!=b&&(c="f"+(Math.floor(119/31)+1),d=Bi(c)||0,d=b?d|67108864:d&-67108865,0==d?delete Z[c]:(b=d.toString(16),Z[c]=b.toString()),a.save())}),Mi=ee(function(){var a=Ci;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();Q("PL_ATT")&&zf.dispose();a=0;for(var b=tf.length;a<b;a++)sf(tf[a]);tf.length=0;mf("//static.doubleclick.net/instream/ad_status.js");uf=!1;P("DCLKSTAT",0);Pc(Ei,Di);if(a=Ci)a.removeEventListener("onScreenChanged",Hi),a.removeEventListener("onLogClientVeCreated",Gi),a.removeEventListener("onLogServerVeCreated",Ii),a.removeEventListener("onLogVeClicked",Ji),a.removeEventListener("onLogVesShown",Ki),a.destroy();Fi={}});
window.addEventListener?(window.addEventListener("load",Li),window.addEventListener("unload",Mi)):window.attachEvent&&(window.attachEvent("onload",Li),window.attachEvent("onunload",Mi));Ja("yt.abuse.player.botguardInitialized",z("yt.abuse.player.botguardInitialized")||Ff);Ja("yt.abuse.player.invokeBotguard",z("yt.abuse.player.invokeBotguard")||Gf);Ja("yt.abuse.dclkstatus.checkDclkStatus",z("yt.abuse.dclkstatus.checkDclkStatus")||wf);
Ja("yt.player.exports.navigate",z("yt.player.exports.navigate")||Hg);Ja("yt.util.activity.init",z("yt.util.activity.init")||Rf);Ja("yt.util.activity.getTimeSinceActive",z("yt.util.activity.getTimeSinceActive")||Uf);Ja("yt.util.activity.setTimestamp",z("yt.util.activity.setTimestamp")||Sf);}).call(this);
