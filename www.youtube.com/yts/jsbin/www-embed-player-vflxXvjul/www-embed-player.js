...
function Dd(a,b,c){var d=Cd.get();d.f=a;d.onRejected=b;d.context=c;return d}
...
function Gd(a,b,c,d){var e=Dd(null,null,null);e.b=new M(function(a,g){e.f=b?function(c){try{var e=b.call(d,c);a(e)}catch(l){g(l)}}:a;
...
return b.join("&")}
function we(a){"?"==a.charAt(0)&&(a=a.substr(1));a=a.split("&");for(var b={},c=0,d=a.length;c<d;c++){var e=a[c].split("=");if(1==e.length&&e[0]||2==e.length)try{var f=decodeURIComponent((e[0]||"").replace(/\+/g," ")),g=decodeURIComponent((e[1]||"").replace(/\+/g," "));f in b?x(b[f])?Oa(b[f],g):b[f]=[b[f],g]:b[f]=g}catch(m){if(S("catch_invalid_url_components")){var h=Error("Error decoding URL component");h.params="key: "+e[0]+", value: "+e[1];"q"==e[0]?se(h):R(h)}else throw m;}}return b}
...
v("yt.ads_.signals_.getAdSignalsString",function(){return ue()},void 0);B();var Be=r(XMLHttpRequest)?function(){return new XMLHttpRequest}:r(ActiveXObject)?function(){return new ActiveXObject("Microsoft.XMLHTTP")}:null;
...
c.ga=function(a,b){Fg(l);ea(a,b)}}try{S("use_fetch_for_op_xhr")?Ke(m,e):Te(m,e)}catch(Ed){if("InvalidAccessError"==Ed)l&&(Fg(l),l=0),R(Error("An extension is blocking network request."),"WARNING");
else throw Ed;}l&&Df(function(){Gg(a)},0,5E3)}
;var Ig=B().toString();
...
c=ba(c);for(b=c.next();!b.done;b=c.next())b=Mg(b.value),(gb(b)||!b.trackingParams&&!b.veType)&&af(Error("Child VE logged with no data"),"WARNING");yg("visualElementAttached",a,Hg,void 0,void 0)}
