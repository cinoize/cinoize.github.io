...
function Cd(a,b){if(0==a.b)if(a.f){var c=a.f;if(c.c){for(var d=0,e=null,f=null,g=c.c;g&&(g.f||(d++,g.b==a&&(e=g),!(e&&1<d)));g=g.next)e||(f=g);e&&(0==c.b&&1==d?Cd(c,b):(f?(d=f,d.next==c.g&&(c.g=d),d.next=d.next.next):Dd(c),Ed(c,e,3,b)))}a.f=null}else ud(a,3,b)}
...
function Dd(a){var b=null;a.c&&(b=a.c,a.c=b.next,b.next=null);a.c||(a.g=null);return b}
M.prototype.l=function(){for(var a;a=Dd(this);)Ed(this,a,this.b,this.o);this.i=!1};
function Ed(a,b,c,d){if(3==c&&b.onRejected&&!b.f)for(;a&&a.h;a=a.f)a.h=!1;if(b.b)b.b.f=null,Kd(b,c,d);else try{b.f?b.c.call(b.context):Kd(b,c,d)}catch(e){Ld.call(null,e)}Jc(wd,b)}
...
c.ga=function(a,b){xg(m);da(a,b)}}try{S("use_fetch_for_op_xhr")?De(l,e):Me(l,e)}catch(Fd){if("InvalidAccessError"==Fd)m&&(xg(m),m=0),R(Error("An extension is blocking network request."),"WARNING");
else throw Fd;}m&&vf(function(){yg(a)},0,5E3)}
;var Ag=A().toString();
