...
function b(q){for(var v=g,p=0;64>p;p+=4)v[p/4]=q[p]<<24|q[p+1]<<16|q[p+2]<<8|q[p+3];for(p=16;80>p;p++)q=v[p-3]^v[p-8]^v[p-14]^v[p-16],v[p]=(q<<1|q>>>31)&4294967295;q=e[0];var C=e[1],K=e[2],qa=e[3],Ac=e[4];for(p=0;80>p;p++){if(40>p)if(20>p){var Ia=qa^C&(K^qa);var Jb=1518500249}else Ia=C^K^qa,Jb=1859775393;else 60>p?(Ia=C&K|qa&(C|K),Jb=2400959708):(Ia=C^K^qa,Jb=3395469782);Ia=((q<<5|q>>>27)&4294967295)+Ia+Ac+Jb+v[p]&4294967295;Ac=qa;qa=K;K=(C<<30|C>>>2)&4294967295;C=q;q=Ia}e[0]=e[0]+q&4294967295;e[1]=
e[1]+C&4294967295;e[2]=e[2]+K&4294967295;e[3]=e[3]+qa&4294967295;e[4]=e[4]+Ac&4294967295}
...
window.console.log(c.join("\n"),e)),e=a.stacktrace,c=a.columnNumber,a.hasOwnProperty("params")&&(d=String(JSON.stringify(a.params)),f.params=d.substr(0,500)),a=Wb(a),e=e||a.stack,d=a.lineNumber.toString(),isNaN(d)||isNaN(c)||(d=d+":"+c),window.yterr&&Ca(window.yterr)&&window.yterr(a),Oe[a.message]||0<=e.indexOf("/YouTubeCenter.js")||0<=e.indexOf("/mytube.js")))){b={bb:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,250),line:d,level:b,"client.name":f.name},F:{url:P("PAGE_NAME",window.location.href),
...
function Vf(a){var b=void 0===a?{}:a;a=void 0===b.Ba?!0:b.Ba;b=void 0===b.Qa?!1:b.Qa;if(null==z("_lact",window)){var c=parseInt(P("LACT"),10);c=isFinite(c)?B()-Math.max(c,0):-1;y("_lact",c,window);y("_fact",c,window);-1==c&&Wf();V(document,"keydown",Wf);V(document,"keyup",Wf);V(document,"mousedown",Wf);V(document,"mouseup",Wf);a&&(b?V(window,"touchmove",function(){Xf("touchmove",200)},{passive:!0}):(V(window,"resize",function(){Xf("resize",200)}),V(window,"scroll",function(){Xf("scroll",200)})));
...
function qg(a,b,c,d){d=void 0===d?{}:d;var e={};e.eventTimeMs=Math.round(d.timestamp||U());e[a]=b;e.context={lastActivityMs:String(d.timestamp?-1:Yf())};R("log_sequence_info_on_gel_web")&&d.P&&(a=e.context,b=d.P,pg[b]=b in pg?pg[b]+1:0,a.sequence={index:pg[b],groupKey:b},d.sb&&delete pg[d.P]);(d=d.da)?(a={},d.videoId?a.videoId=d.videoId:d.playlistId&&(a.playlistId=d.playlistId),hg[d.token]=a,d=mg("log_event",d.token)):d=mg("log_event");d.push(e);c&&(eg.log_event=new c);d.length>=(pe("web_logging_max_batch")||
100)?jg():lg()}
...
function Mg(a,b,c){Ig.push({Pa:a,payload:b,options:c});Jg||(Jg=Eg())}
function Fg(a){if(Ig){for(var b=r(Ig),c=b.next();!c.done;c=b.next())c=c.value,c.payload&&(c.payload.csn=a.csn,qg(c.Pa,c.payload,null,c.options));Ig.length=0}Jg=0}
;function Ng(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||P("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.pb||P("AUTHORIZATION"))||(a?b="Bearer "+z("gapi.auth.getToken")().ob:b=Bc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=P("SESSION_INDEX",0),R("pageid_as_header_web")&&(d["X-Goog-PageId"]=P("DELEGATED_SESSION_ID")));return d}
...
timeout:d.timeout,withCredentials:!0},f="",g=a.f.Ja;g&&(f=g);g=a.f.Ka||!1;var h=Ng(g,f,d);Object.assign(e.headers,h);e.headers.Authorization&&!f&&(e.headers["x-origin"]=window.location.origin);var k=ie(""+f+("/youtubei/"+a.f.Da+"/"+b),{alt:"json",key:a.f.Ca}),l;if(d.retry&&R("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=f&&(l=Sg(b,c,h,g))){var n=e.onSuccess,q=e.na;e.onSuccess=function(v,p){Tg(l);n(v,p)};
...
t(fh,L);fh.prototype.o=function(){for(;this.f.length;){var a=this.f.pop();a.target.removeEventListener(a.name,a.qb)}L.prototype.o.call(this)};var gh=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function hh(a){a=a||"";if(window.spf){var b=a.match(gh);spf.style.load(a,b?b[1]:"",void 0)}else ih(a)}
...
function mh(a){a.A=!1;if(a.V)for(var b in a.i)a.V(b,a.i[b]);for(var c in a.S)T(parseInt(c,10));a.S={};a.C=null;a.V=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.Z.bind(a);a.api.removeEventListener=a.Sa.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.za.bind(a);a.api.getPlayerType=a.Aa.bind(a);a.api.getCurrentVideoConfig=a.ya.bind(a);a.api.loadNewVideoConfig=a.loadNewVideoConfig.bind(a);a.api.isReady=a.La.bind(a)}
...
m.Sa=function(a,b){if(!this.g){var c=ph(this,b);c&&Fd(this.D,a,c)}};
...
m.Ma=function(a){df("WATCH_LATER_VIDEO_ADDED",a)};
m.Na=function(a){df("WATCH_LATER_VIDEO_REMOVED",a)};
...
m.Ua=function(a,b){this.j&&!this.g&&ri(this.f,a,this.fa(a,b))};
...
xi.prototype.o=function(){window.removeEventListener("message",this.m);L.prototype.o.call(this)};function yi(){var a=this.g=new xi(!!P("WIDGET_ID_ENFORCE")),b=A(this.Ra,this);a.j=b;a.l=null;this.g.channel="widget";if(a=P("WIDGET_ID"))this.g.sessionId=a;this.i=[];this.l=!1;this.j={}}
m=yi.prototype;m.Ra=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.j[a]||"onReady"==a||(this.addEventListener(a,zi(this,a)),this.j[a]=!0)):this.ma(a,b,c)};
m.ma=function(){};
...
m.dispose=function(){this.g=null};function Bi(a){yi.call(this);this.f=a;this.h=[];this.addEventListener("onReady",A(this.Oa,this));this.addEventListener("onVideoProgress",A(this.Ya,this));this.addEventListener("onVolumeChange",A(this.Za,this));this.addEventListener("onApiChange",A(this.Ta,this));this.addEventListener("onPlaybackQualityChange",A(this.Va,this));this.addEventListener("onPlaybackRateChange",A(this.Wa,this));this.addEventListener("onStateChange",A(this.Xa,this));this.addEventListener("onWebglSettingsChanged",A(this.ab,
this))}
...
m.Va=function(a){Ai(this,{playbackQuality:a})};
m.Wa=function(a){Ai(this,{playbackRate:a})};
...
m.Za=function(){Ai(this,{muted:this.f.isMuted(),volume:this.f.getVolume()})};
m.Ya=function(a){a={currentTime:a,videoBytesLoaded:this.f.getVideoBytesLoaded(),videoLoadedFraction:this.f.getVideoLoadedFraction(),currentTimeLastUpdated_:B()/1E3,playbackRate:this.f.getPlaybackRate(),mediaReferenceTime:this.f.getMediaReferenceTime()};this.f.getProgressState&&(a.progressState=this.f.getProgressState());Ai(this,a)};
m.ab=function(){var a={sphericalProperties:this.f.getSphericalProperties()};Ai(this,a)};
...
var dj=ee(function(){var a=Lh(),b;(b=!R("use_first_tick"))||(b=!("ol"in Lh()));if(b){b="ol";X.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),X.mark(b));b=Sf();a.ol&&(a._ol=a._ol||[a.ol],a._ol.push(b));a.ol=b;a=Dh();if(b=a.ol)uf(b),a.ol=0;a=di();a.gelTicks&&(a.gelTicks.tick_ol=!0);Sf();ci()?(a=Mh(),Qh("tick_ol_"+a)||Nh("latencyActionTicked",{tickName:"ol",clientActionNonce:a},{timestamp:void 0}),a=!0):a=!1;if(a=!a)a=!z("yt.timing.pingSent_");if(a&&(b=P("TIMING_ACTION",void 0),a=Lh(),z("ytglobal.timingready_")&&
