...
function lg(){R("web_gel_timeout_cap")&&!gg&&(gg=T(jg,3E4));U(fg);fg=T(jg,O("LOGGING_BATCH_TIMEOUT",1E4))}
...
;function Ci(a){if("1"!==ab(ge(),"args","privembed")){a&&he();try{Bi().then(function(a){a=ke(a);a.bsq=Di++;Le("//www.youtube.com/ad_data_204",{wa:!1,C:a,withCredentials:!0})},function(){}),T(Ci,18E5)}catch(b){Q(b)}}}
...
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();O("PL_ATT")&&Df.dispose();a=0;for(var b=xf.length;a<b;a++)wf(xf[a]);xf.length=0;qf("//static.doubleclick.net/instream/ad_status.js");yf=!1;N("DCLKSTAT",0);Zc(Ki,Ji);if(a=Ii)a.removeEventListener("onScreenChanged",Ni),a.removeEventListener("onLogClientVeCreated",Mi),a.removeEventListener("onLogServerVeCreated",Oi),a.removeEventListener("onLogVeClicked",Pi),a.removeEventListener("onLogVesShown",Qi),a.removeEventListener("onReady",Ri),a.destroy();Li=
{}});
