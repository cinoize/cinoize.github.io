...
;function og(){var a=new Yd;(a=a.isAvailable()?new ee(a,"yt.innertube"):null)||(a=new $d("yt.innertube"),a=a.isAvailable()?a:null);this.b=a?new M(a):null;this.f=document.domain||window.location.hostname}
...
u("yt.logging.screen.getCurrentCsn",Dg,void 0);function Eg(a,b,c){c=void 0===c?0:c;if(a!==P(zg(c))||b!==P(Ag(c)))O(zg(c),a),O(Ag(c),b),0==c&&(b=function(){setTimeout(function(){a&&jg("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:vg,clientScreenNonce:a})},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b())}
...
Y.set(2);Y=he(Y);G.bc=Y;G.bih=Ia.height;G.biw=Ia.width;G.brdim=g.join();Ia=(G.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[Ga.visibilityState||Ga.webkitVisibilityState||Ga.mozVisibilityState||""]||0,G.wgl=!!B.WebGLRenderingContext,G);for(var fe in Ia)b[fe]=Ia[fe]}b.bid=a;b.bsq=Bi++;Fe("//www.youtube.com/ad_data_204",{xa:!1,C:b,withCredentials:!0})},function(){}),S(Ai,18E5)}catch(b){R(b)}}}
