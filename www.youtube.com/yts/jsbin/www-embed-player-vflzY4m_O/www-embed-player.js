...
function b(q){for(var v=g,p=0;64>p;p+=4)v[p/4]=q[p]<<24|q[p+1]<<16|q[p+2]<<8|q[p+3];for(p=16;80>p;p++)q=v[p-3]^v[p-8]^v[p-14]^v[p-16],v[p]=(q<<1|q>>>31)&4294967295;q=e[0];var D=e[1],K=e[2],qa=e[3],Ac=e[4];for(p=0;80>p;p++){if(40>p)if(20>p){var Ia=qa^D&(K^qa);var Jb=1518500249}else Ia=D^K^qa,Jb=1859775393;else 60>p?(Ia=D&K|qa&(D|K),Jb=2400959708):(Ia=D^K^qa,Jb=3395469782);Ia=((q<<5|q>>>27)&4294967295)+Ia+Ac+Jb+v[p]&4294967295;Ac=qa;qa=K;K=(D<<30|D>>>2)&4294967295;D=q;q=Ia}e[0]=e[0]+q&4294967295;e[1]=
...
function xe(a){var b=window.location.search,c=I(J(3,a)),d=I(J(5,a));d=(c=c&&(c.endsWith("youtube.com")||c.endsWith("youtube-nocookie.com")))&&d&&d.startsWith("/api/");if(!c||d)return a;var e=he(b),f={};G(te,function(g){e[g]&&(f[g]=e[g])});
return je(a,f||{},!1)}
...
function jf(a,b,c){c=void 0===c?null:c;var d=kf(a),e=document.getElementById(d),f=e&&Ue(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=$e(d,b),b=""+(b[Ea]||(b[Ea]=++Fa)),lf[b]=f),g||(e=mf(a,d,function(){Ue(e,"loaded")||(Se(e),cf(d),S(Ja(df,d),0))},c)))}
...
function hh(a){var b=ih(a),c=document.getElementById(b),d=c&&Ue(c,"loaded");d||c&&!d||(c=jh(a,b,function(){Ue(c,"loaded")||(Se(c),cf(b),S(Ja(df,b),0))}))}
...
;function oi(a){a=void 0===a?!1:a;L.call(this);this.f=new N(a);Tc(this,Ja(Uc,this.f))}
...
m.dispose=function(){xi.prototype.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function Bi(a,b,c){L.call(this);this.f=a;this.i=c;this.j=V(window,"message",A(this.l,this));this.h=new pi(this,a,b);Tc(this,Ja(Uc,this.h))}
