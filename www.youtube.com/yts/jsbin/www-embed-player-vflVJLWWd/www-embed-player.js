...
function vc(){var a=wc;this.events=[];this.c=a||q;var b=null;a&&(a.google_js_reporting_queue=a.google_js_reporting_queue||[],this.events=a.google_js_reporting_queue,b=a.google_measure_js_timing);this.b=uc()||(null!=b?b:1>Math.random())}
vc.prototype.disable=function(){this.b=!1;this.events!=this.c.google_js_reporting_queue&&(uc()&&F(this.events,xc),this.events.length=0)};
...
;function Ic(a,b){this.f=a;this.g=b;this.c=0;this.b=null}
Ic.prototype.get=function(){if(0<this.c){this.c--;var a=this.b;this.b=a.next;a.next=null}else a=this.f();return a};
function Jc(a,b){a.g(b);100>a.c&&(a.c++,b.next=a.b,a.b=b)}
...
;function Nc(){this.c=this.b=null}
var Pc=new Ic(function(){return new Oc},function(a){a.reset()});
Nc.prototype.add=function(a,b){var c=Pc.get();c.set(a,b);this.c?this.c.next=c:this.b=c;this.c=c};
Nc.prototype.remove=function(){var a=null;this.b&&(a=this.b,this.b=this.b.next,this.b||(this.c=null),a.next=null);return a};
...
;function Wc(){this.c=-1}
;function Xc(){this.c=64;this.b=[];this.i=[];this.o=[];this.g=[];this.g[0]=128;for(var a=1;a<this.c;++a)this.g[a]=0;this.h=this.f=0;this.reset()}
C(Xc,Wc);Xc.prototype.reset=function(){this.b[0]=1732584193;this.b[1]=4023233417;this.b[2]=2562383102;this.b[3]=271733878;this.b[4]=3285377520;this.h=this.f=0};
function Yc(a,b,c){c||(c=0);var d=a.o;if(t(b))for(var e=0;16>e;e++)d[e]=b.charCodeAt(c)<<24|b.charCodeAt(c+1)<<16|b.charCodeAt(c+2)<<8|b.charCodeAt(c+3),c+=4;else for(e=0;16>e;e++)d[e]=b[c]<<24|b[c+1]<<16|b[c+2]<<8|b[c+3],c+=4;for(e=16;80>e;e++){var f=d[e-3]^d[e-8]^d[e-14]^d[e-16];d[e]=(f<<1|f>>>31)&4294967295}b=a.b[0];c=a.b[1];var g=a.b[2],k=a.b[3],l=a.b[4];for(e=0;80>e;e++){if(40>e)if(20>e){f=k^c&(g^k);var m=1518500249}else f=c^g^k,m=1859775393;else 60>e?(f=c&g|k&(c|g),m=2400959708):(f=c^g^k,m=
...
Xc.prototype.update=function(a,b){if(null!=a){r(b)||(b=a.length);for(var c=b-this.c,d=0,e=this.i,f=this.f;d<b;){if(0==f)for(;d<=c;)Yc(this,a,d),d+=this.c;if(t(a))for(;d<b;){if(e[f]=a.charCodeAt(d),++f,++d,f==this.c){Yc(this,e);f=0;break}}else for(;d<b;)if(e[f]=a[d],++f,++d,f==this.c){Yc(this,e);f=0;break}}this.f=f;this.h+=b}};
Xc.prototype.digest=function(){var a=[],b=8*this.h;56>this.f?this.update(this.g,56-this.f):this.update(this.g,this.c-(this.f-56));for(var c=this.c-1;56<=c;c--)this.i[c]=b&255,b/=256;Yc(this,this.i);for(c=b=0;5>c;c++)for(var d=24;0<=d;d-=8)a[b]=this.b[c]>>d&255,++b;return a};function L(){this.c=this.c;this.o=this.o}
L.prototype.c=!1;L.prototype.dispose=function(){this.c||(this.c=!0,this.j())};
function Zc(a,b){a.c?r(void 0)?b.call(void 0):b():(a.o||(a.o=[]),a.o.push(r(void 0)?z(b,void 0):b))}
...
return b}
;function jd(a,b){this.f={};this.b=[];this.g=this.c=0;var c=arguments.length;if(1<c){if(c%2)throw Error("Uneven number of arguments");for(var d=0;d<c;d+=2)this.set(arguments[d],arguments[d+1])}else if(a)if(a instanceof jd)for(c=kd(a),d=0;d<c.length;d++)this.set(c[d],a.get(c[d]));else for(d in a)this.set(d,a[d])}
function kd(a){ld(a);return a.b.concat()}
h=jd.prototype;h.equals=function(a,b){if(this===a)return!0;if(this.c!=a.c)return!1;var c=b||md;ld(this);for(var d,e=0;d=this.b[e];e++)if(!c(this.get(d),a.get(d)))return!1;return!0};
function md(a,b){return a===b}
h.isEmpty=function(){return 0==this.c};
h.clear=function(){this.f={};this.g=this.c=this.b.length=0};
h.remove=function(a){return Object.prototype.hasOwnProperty.call(this.f,a)?(delete this.f[a],this.c--,this.g++,this.b.length>2*this.c&&ld(this),!0):!1};
function ld(a){if(a.c!=a.b.length){for(var b=0,c=0;b<a.b.length;){var d=a.b[b];Object.prototype.hasOwnProperty.call(a.f,d)&&(a.b[c++]=d);b++}a.b.length=c}if(a.c!=a.b.length){var e={};for(c=b=0;b<a.b.length;)d=a.b[b],Object.prototype.hasOwnProperty.call(e,d)||(a.b[c++]=d,e[d]=1),b++;a.b.length=c}}
...
h.D=function(a){ld(this);var b=0,c=this.g,d=this,e=new fd;e.next=function(){if(c!=d.g)throw Error("The map has changed since the iterator was created");if(b>=d.b.length)throw ed;var e=d.b[b++];return a?e:d.f[e]};
...
;function M(a){this.b=0;this.o=void 0;this.g=this.c=this.f=null;this.h=this.i=!1;if(a!=va)try{var b=this;a.call(void 0,function(a){ud(b,2,a)},function(a){ud(b,3,a)})}catch(c){ud(this,3,c)}}
function vd(){this.next=this.context=this.onRejected=this.c=this.b=null;this.f=!1}
vd.prototype.reset=function(){this.context=this.onRejected=this.c=this.b=null;this.f=!1};
var wd=new Ic(function(){return new vd},function(a){a.reset()});
function xd(a,b,c){var d=wd.get();d.c=a;d.onRejected=b;d.context=c;return d}
...
function Cd(a,b){if(0==a.b)if(a.f){var c=a.f;if(c.c){for(var d=0,e=null,f=null,g=c.c;g&&(g.f||(d++,g.b==a&&(e=g),!(e&&1<d)));g=g.next)e||(f=g);e&&(0==c.b&&1==d?Cd(c,b):(f?(d=f,d.next==c.g&&(c.g=d),d.next=d.next.next):Ed(c),Fd(c,e,3,b)))}a.f=null}else ud(a,3,b)}
function Gd(a,b){a.c||2!=a.b&&3!=a.b||Hd(a);a.g?a.g.next=b:a.c=b;a.g=b}
function zd(a,b,c,d){var e=xd(null,null,null);e.b=new M(function(a,g){e.c=b?function(c){try{var e=b.call(d,c);a(e)}catch(m){g(m)}}:a;
e.onRejected=c?function(b){try{var e=c.call(d,b);!r(e)&&b instanceof Bd?g(b):a(e)}catch(m){g(m)}}:g});
e.b.f=a;Gd(a,e);return e.b}
M.prototype.u=function(a){this.b=0;ud(this,2,a)};
M.prototype.A=function(a){this.b=0;ud(this,3,a)};
function ud(a,b,c){if(0==a.b){a===c&&(b=3,c=new TypeError("Promise cannot resolve to itself"));a.b=1;a:{var d=c,e=a.u,f=a.A;if(d instanceof M){Gd(d,xd(e||va,f||null,a));var g=!0}else if(td(d))d.then(e,f,a),g=!0;else{if(y(d))try{var k=d.then;if(za(k)){Id(d,k,e,f,a);g=!0;break a}}catch(l){f.call(a,l);g=!0;break a}g=!1}}g||(a.o=c,a.b=b,a.f=null,Hd(a),3!=b||c instanceof Bd||Jd(a,c))}}
function Id(a,b,c,d,e){function f(a){k||(k=!0,d.call(e,a))}
function g(a){k||(k=!0,c.call(e,a))}
var k=!1;try{b.call(a,g,f)}catch(l){f(l)}}
function Hd(a){a.i||(a.i=!0,Qc(a.l,a))}
function Ed(a){var b=null;a.c&&(b=a.c,a.c=b.next,b.next=null);a.c||(a.g=null);return b}
M.prototype.l=function(){for(var a;a=Ed(this);)Fd(this,a,this.b,this.o);this.i=!1};
function Fd(a,b,c,d){if(3==c&&b.onRejected&&!b.f)for(;a&&a.h;a=a.f)a.h=!1;if(b.b)b.b.f=null,Kd(b,c,d);else try{b.f?b.c.call(b.context):Kd(b,c,d)}catch(e){Ld.call(null,e)}Jc(wd,b)}
function Kd(a,b,c){2==b?a.c.call(a.context,c):a.onRejected&&a.onRejected.call(a.context,c)}
function Jd(a,b){a.h=!0;Qc(function(){a.h&&Ld.call(null,b)})}
var Ld=Kc;function Bd(a){E.call(this,a)}
C(Bd,E);Bd.prototype.name="cancel";function N(a){L.call(this);this.i=1;this.g=[];this.h=0;this.b=[];this.f={};this.l=!!a}
...
function Md(a,b,c,d){if(b=a.f[b]){var e=a.b;(b=Ka(b,function(a){return e[a+1]==c&&e[a+2]==d}))&&a.K(b)}}
...
h.j=function(){N.w.j.call(this);this.clear();this.g.length=0};function Od(a){this.b=a}
...
Pd.prototype.set=function(a,b){Pd.w.set.call(this,a,Rd(b))};
Pd.prototype.c=function(a){a=Pd.w.get.call(this,a);if(!r(a)||a instanceof Object)return a;throw"Storage: Invalid value was encountered";};
Pd.prototype.get=function(a){if(a=this.c(a)){if(a=a.data,!r(a))throw"Storage: Invalid value was encountered";}else a=void 0;return a};function Sd(a){this.b=a}
C(Sd,Pd);Sd.prototype.set=function(a,b,c){if(b=Rd(b)){if(c){if(c<A()){Sd.prototype.remove.call(this,a);return}b.expiration=c}b.creation=A()}Sd.w.set.call(this,a,b)};
Sd.prototype.c=function(a){var b=Sd.w.c.call(this,a);if(b){var c=b.creation,d=b.expiration;if(d&&d<A()||c&&c>A())Sd.prototype.remove.call(this,a);else return b}};function Td(){}
;function Ud(){}
C(Ud,Td);Ud.prototype.clear=function(){var a=id(this.D(!0)),b=this;F(a,function(a){b.remove(a)})};function Vd(a){this.b=a}
...
h.D=function(a){var b=0,c=this.b,d=new fd;d.next=function(){if(b>=c.length)throw ed;var d=c.key(b++);if(a)return d;d=c.getItem(d);if(!t(d))throw"Storage mechanism: Invalid value was encountered";return d};
return d};
...
C(Wd,Vd);function Xd(a,b){this.c=a;this.b=null;if(mb&&!(9<=Number(wb))){Yd||(Yd=new jd);this.b=Yd.get(a);this.b||(b?this.b=document.getElementById(b):(this.b=document.createElement("userdata"),this.b.addBehavior("#default#userData"),document.body.appendChild(this.b)),Yd.set(a,this.b));try{this.b.load(this.c)}catch(c){this.b=null}}}
...
h.D=function(a){var b=0,c=this.b.XMLDocument.documentElement.attributes,d=new fd;d.next=function(){if(b>=c.length)throw ed;var d=c[b++];if(a)return decodeURIComponent(d.nodeName.replace(/\./g,"%")).substr(1);d=d.nodeValue;if(!t(d))throw"Storage mechanism: Invalid value was encountered";return d};
return d};
...
function ae(a){try{a.b.save(a.c)}catch(b){throw"Storage mechanism: Quota exceeded";}}
;function be(a,b){this.c=a;this.b=b+"::"}
C(be,Ud);be.prototype.set=function(a,b){this.c.set(this.b+a,b)};
be.prototype.get=function(a){return this.c.get(this.b+a)};
be.prototype.remove=function(a){this.c.remove(this.b+a)};
be.prototype.D=function(a){var b=this.c.D(!0),c=this,d=new fd;d.next=function(){for(var d=b.next();d.substr(0,c.b.length)!=c.b;)d=b.next();return a?d.substr(c.b.length):c.c.get(d)};
return d};function ce(){this.c=[];this.b=-1}
ce.prototype.set=function(a,b){b=void 0===b?!0:b;0<=a&&52>a&&0===a%1&&this.c[a]!=b&&(this.c[a]=b,this.b=-1)};
ce.prototype.get=function(a){return!!this.c[a]};
function de(a){-1==a.b&&(a.b=Ja(a.c,function(a,c,d){return c?a+Math.pow(2,d):a},0));
return a.b}
...
var me=new function(){var a=window.document;this.b=window;this.c=a};A();function pe(a){return a&&window.yterr?function(){try{return a.apply(this,arguments)}catch(b){R(b)}}:a}
...
b.ha&&0<b.timeout&&(f=T(function(){e||(e=!0,U(f),b.ha.call(b.context||q))},b.timeout))}else Ge(a,b)}
function Ge(a,b){var c=b.format||"JSON";a=Ee(a,b);var d=Fe(a,b),e=!1,f,g=He(a,function(a){if(!e){e=!0;f&&U(f);var d=te(a),g=null,k=400<=a.status&&500>a.status,da=500<=a.status&&600>a.status;if(d||k||da)g=Ie(c,a,b.kb);if(d)a:if(a&&204==a.status)d=!0;else{switch(c){case "XML":d=0==parseInt(g&&g.return_code,10);break a;case "RAW":d=!0;break a}d=!!g}g=g||{};k=b.context||q;d?b.onSuccess&&b.onSuccess.call(k,a,g):b.onError&&b.onError.call(k,a,g);b.da&&b.da.call(k,a,g)}},b.method,d,b.headers,b.responseType,
b.withCredentials);
b.L&&0<b.timeout&&(f=T(function(){e||(e=!0,g.abort(),U(f),b.L.call(b.context||q,g))},b.timeout));
return g}
function Ee(a,b){b.wa&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var c=Q("XSRF_FIELD_NAME",void 0),d=b.Ta;d&&(d[c]&&delete d[c],a=we(a,d||{},!0));return a}
function Fe(a,b){var c=Q("XSRF_FIELD_NAME",void 0),d=Q("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.B,g=ge("XSRF_FIELD_NAME"),k;b.headers&&(k=b.headers["Content-Type"]);b.lb||I(J(3,a))&&!b.withCredentials&&I(J(3,a))!=document.location.hostname||"POST"!=b.method||k&&"application/x-www-form-urlencoded"!=k||b.B&&b.B[g]||(f||(f={}),f[c]=d);f&&t(e)&&(e=ve(e),jb(e,f),e=b.ia&&"JSON"==b.ia?JSON.stringify(e):nc(e));f=e||f&&!eb(f);!ze&&f&&"POST"!=b.method&&(ze=!0,R(Error("AJAX request with postData should use POST")));
return e}
...
Re[a.message]||0<=c.indexOf("/YouTubeCenter.js")||0<=c.indexOf("/mytube.js")))){b={Ta:{a:"logerror",t:"jserror",type:a.name,msg:a.message.substr(0,1E3),line:e,level:b,"client.name":f.name},B:{url:Q("PAGE_NAME",window.location.href),file:a.fileName},method:"POST"};f.version&&(b["client.version"]=f.version);c&&(b.B.stack=c);for(var g in f)b.B["client."+g]=f[g];if(g=Q("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(var k in g)b.B[k]=g[k];Ge(Q("ECATCHER_REPORT_HOST","")+"/error_204",b);Re[a.message]=
!0;Se++}}
...
;function Cf(){this.c=!1;this.b=null}
Cf.prototype.initialize=function(a,b,c,d,e){var f=this;b?(this.c=!0,mf(b,function(){f.c=!1;window.botguard?Df(f,c,d):(rf(b),qe(Error("Unable to load Botguard from "+b)))},e)):a&&(eval(a),window.botguard?Df(this,c,d):qe(Error("Unable to load Botguard from JS")))};
...
function Jf(a){if(a){if(Ef.c)return!1;if(S("botguard_periodic_refresh"))return 72E5<O()-Gf;if(S("botguard_always_refresh"))return Hf!=a}else return!1;return!Ff}
...
function Pf(a){if(document.body&&document.documentElement){var b=document.body.scrollTop+document.documentElement.scrollTop;a.b=a.clientX+(document.body.scrollLeft+document.documentElement.scrollLeft);a.c=a.clientY+b}}
...
;function Uf(a){this.u=a;this.b=null;this.h=0;this.l=null;this.i=0;this.f=[];for(a=0;4>a;a++)this.f.push(0);this.g=0;this.C=V(window,"mousemove",z(this.F,this));a=z(this.A,this);za(a)&&(a=pe(a));this.G=window.setInterval(a,25)}
C(Uf,L);Uf.prototype.F=function(a){r(a.b)||Pf(a);var b=a.b;r(a.c)||Pf(a);this.b=new Tb(b,a.c)};
Uf.prototype.A=function(){if(this.b){var a=O();if(0!=this.h){var b=this.l,c=this.b,d=b.x-c.x;b=b.y-c.y;d=Math.sqrt(d*d+b*b)/(a-this.h);this.f[this.g]=.5<Math.abs((d-this.i)/this.i)?1:0;for(c=b=0;4>c;c++)b+=this.f[c]||0;3<=b&&this.u();this.i=d}this.h=a;this.l=this.b;this.g=(this.g+1)%4}};
Uf.prototype.j=function(){window.clearInterval(this.G);Tf(this.C)};var Vf={};function Wf(a){var b=void 0===a?{}:a;a=void 0===b.b?!0:b.b;b=void 0===b.c?!1:b.c;if(null==w("_lact",window)){var c=parseInt(Q("LACT"),10);c=isFinite(c)?A()-Math.max(c,0):-1;v("_lact",c,window);v("_fact",c,window);-1==c&&Xf();V(document,"keydown",Xf);V(document,"keyup",Xf);V(document,"mousedown",Xf);V(document,"mouseup",Xf);a&&(b?V(window,"touchmove",function(){Yf("touchmove",200)},{passive:!0}):(V(window,"resize",function(){Yf("resize",200)}),V(window,"scroll",function(){Yf("scroll",200)})));
...
function lg(a,b){var c=cg[a],d=jg[a]||{};jg[a]=d;var e=Math.round(O());for(m in W[a]){var f=b.b;f={client:{hl:f.Ca,gl:f.Ba,clientName:f.za,clientVersion:f.Aa}};var g=window.devicePixelRatio;g&&1!=g&&(f.client.screenDensityFloat=String(g));Q("DELEGATED_SESSION_ID")&&!S("pageid_as_header_web")&&(f.user={onBehalfOfUser:Q("DELEGATED_SESSION_ID")});f={context:f};f[c]=ng(a,m);d.dispatchedEventCount=d.dispatchedEventCount||0;d.dispatchedEventCount+=f[c].length;if(g=ig[m])a:{var k=m;if(g.videoId)var l="VIDEO";
else if(g.playlistId)l="PLAYLIST";else break a;f.credentialTransferTokenTargetId=g;f.context=f.context||{};f.context.user=f.context.user||{};f.context.user.credentialTransferTokens=[{token:k,scope:l}]}delete ig[m];f.requestTimeMs=e;if(g=ge("EVENT_ID"))l=(Q("BATCH_CLIENT_COUNTER",void 0)||0)+1,l>$f&&(l=1),P("BATCH_CLIENT_COUNTER",l),g={serializedEventId:g,clientCounter:l},f.serializedClientEventId=g,ag&&bg&&S("log_gel_rtt_web")&&(f.previousBatchInfo={serializedClientEventId:ag,roundtripMs:bg}),ag=
g,bg=0;og(b,a,f,{retry:eg.has(a),onSuccess:z(pg,this,O())})}if(d.previousDispatchMs){c=e-d.previousDispatchMs;var m=d.diffCount||0;d.averageTimeBetweenDispatchesMs=m?(d.averageTimeBetweenDispatchesMs*m+c)/(m+1):c;d.diffCount=m+1}d.previousDispatchMs=e}
...
;function rg(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||Q("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.hb||Q("AUTHORIZATION"))||(a?b="Bearer "+w("gapi.auth.getToken")().gb:b=Hc([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=Q("SESSION_INDEX",0),S("pageid_as_header_web")&&(d["X-Goog-PageId"]=Q("DELEGATED_SESSION_ID")));return d}
...
;function ug(){var a=new Wd;(a=a.isAvailable()?new be(a,"yt.innertube"):null)||(a=new Xd("yt.innertube"),a=a.isAvailable()?a:null);this.b=a?new Sd(a):null;this.c=document.domain||window.location.hostname}
ug.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.b)try{this.b.set(a,b,A()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(nd(b))}catch(f){return}else e=escape(b);tg(a,e,c,this.c)};
...
;function zg(a){var b=this;this.b=a||{xa:ge("INNERTUBE_API_KEY"),ya:ge("INNERTUBE_API_VERSION"),za:Q("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),Aa:ge("INNERTUBE_CONTEXT_CLIENT_VERSION"),Ca:ge("INNERTUBE_CONTEXT_HL"),Ba:ge("INNERTUBE_CONTEXT_GL"),Da:ge("INNERTUBE_HOST_OVERRIDE")||"",Ea:!!Q("INNERTUBE_USE_THIRD_PARTY_AUTH",!1)};vf(function(){yg(b)},0,5E3)}
function og(a,b,c,d){!Q("VISITOR_DATA")&&.01>Math.random()&&R(Error("Missing VISITOR_DATA when sending innertube request."),"WARNING");var e={headers:{"Content-Type":"application/json"},method:"POST",B:c,ia:"JSON",L:function(){d.L()},
...
timeout:d.timeout,withCredentials:!0},f="",g=a.b.Da;g&&(f=g);g=a.b.Ea||!1;var k=rg(g,f,d);Object.assign(e.headers,k);e.headers.Authorization&&!f&&(e.headers["x-origin"]=window.location.origin);var l=""+f+("/youtubei/"+a.b.ya+"/"+b)+"?alt=json&key="+a.b.xa,m;if(d.retry&&S("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=f&&(m=wg(b,c,k,g))){var u=e.onSuccess,da=e.ga;e.onSuccess=function(a,b){xg(m);u(a,b)};
c.ga=function(a,b){xg(m);da(a,b)}}try{S("use_fetch_for_op_xhr")?De(l,e):Me(l,e)}catch(Dd){if("InvalidAccessError"==Dd)m&&(xg(m),m=0),R(Error("An extension is blocking network request."),"WARNING");
...
n(Rg,L);Rg.prototype.j=function(){for(;this.b.length;){var a=this.b.pop();a.target.removeEventListener(a.name,a.jb)}L.prototype.j.call(this)};var Sg=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function Tg(a){a=a||"";if(window.spf){var b=a.match(Sg);spf.style.load(a,b?b[1]:"",void 0)}else Ug(a)}
...
;function Xg(a,b){L.call(this);this.i=this.R=a;this.C=b;this.l=!1;this.api={};this.O=this.A=null;this.F=new N;Zc(this,Ea($c,this.F));this.g={};this.M=this.P=this.f=this.W=this.b=null;this.G=!1;this.h=this.u=null;this.T={};this.ma=["onReady"];this.V=null;this.ea=NaN;this.N={};Yg(this);this.U("WATCH_LATER_VIDEO_ADDED",this.Ga.bind(this));this.U("WATCH_LATER_VIDEO_REMOVED",this.Ha.bind(this));this.U("onAdAnnounce",this.qa.bind(this));this.na=new Rg(this);Zc(this,Ea($c,this.na))}
n(Xg,L);h=Xg.prototype;
h.ca=function(a){if(!this.c){a instanceof Og||(a=new Og(a));this.W=a;this.b=a.clone();this.f=this.b.attrs.id||this.f;"video-player"==this.f&&(this.f=this.C,this.b.attrs.id=this.C);this.i.id==this.f&&(this.f+="-player",this.b.attrs.id=this.f);this.b.args.enablejsapi="1";this.b.args.playerapiid=this.C;this.P||(this.P=Zg(this,this.b.args.jsapicallback||"onYouTubePlayerReady"));this.b.args.jsapicallback=null;if(a=this.b.attrs.width)this.i.style.width=jc(Number(a)||a);if(a=this.b.attrs.height)this.i.style.height=jc(Number(a)||
a);$g(this);this.l&&ah(this)}};
...
function $g(a){if(!a.c&&!a.G){var b=bh(a);if(b&&"html5"==(ch(a)?"html5":null))a.M="html5",a.l||dh(a);else if(eh(a),a.M="html5",b&&a.h)a.R.appendChild(a.h),dh(a);else{a.b.loaded=!0;var c=!1;a.u=function(){c=!0;var b=a.b.clone();w("yt.player.Application.create")(a.R,b);dh(a)};
a.G=!0;b?a.u():(mf(a.b.assets.js,a.u),Tg(a.b.assets.css),fh(a)&&!c&&v("yt.player.Application.create",null,void 0))}}}
function ch(a){var b=Vb(a.f);!b&&a.i&&a.i.querySelector&&(b=a.i.querySelector("#"+a.f));return b}
function dh(a){if(!a.c){var b=ch(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.G=!1,b.isNotServable&&b.isNotServable(a.b.args.video_id)||gh(a)):a.ea=T(function(){dh(a)},50)}}
function gh(a){Yg(a);a.l=!0;var b=ch(a);b.addEventListener&&(a.A=hh(a,b,"addEventListener"));b.removeEventListener&&(a.O=hh(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.api[e]||(a.api[e]=hh(a,b,e))}for(var f in a.g)a.A(f,a.g[f]);ah(a);a.P&&a.P(a.api);a.F.J("onReady",a.api)}
function hh(a,b,c){var d=b[c];return function(){try{return a.V=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.V=e,qe(e))}}}
function Yg(a){a.l=!1;if(a.O)for(var b in a.g)a.O(b,a.g[b]);for(var c in a.N)U(parseInt(c,10));a.N={};a.A=null;a.O=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.U.bind(a);a.api.removeEventListener=a.Ka.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.ua.bind(a);a.api.getPlayerType=a.va.bind(a);a.api.getCurrentVideoConfig=a.ta.bind(a);a.api.loadNewVideoConfig=a.ca.bind(a);a.api.isReady=a.Fa.bind(a)}
h.Fa=function(){return this.l};
h.U=function(a,b){var c=this,d=Zg(this,b);if(d){if(!(0<=Ga(this.ma,a)||this.g[a])){var e=ih(this,a);this.A&&this.A(a,e)}this.F.subscribe(a,d);"onReady"==a&&this.l&&T(function(){d(c.api)},0)}};
h.Ka=function(a,b){if(!this.c){var c=Zg(this,b);c&&Md(this.F,a,c)}};
function Zg(a,b){var c=b;if("string"==typeof b){if(a.T[b])return a.T[b];c=function(){var a=w(b);a&&a.apply(q,arguments)};
a.T[b]=c}return c?c:null}
function ih(a,b){var c="ytPlayer"+b+a.C;a.g[b]=c;q[c]=function(c){var d=T(function(){if(!a.c){a.F.J(b,c);var e=a.N,g=String(d);g in e&&delete e[g]}},0);
fb(a.N,String(d))};
return c}
h.qa=function(a){gf("a11y-announce",a)};
h.Ga=function(a){gf("WATCH_LATER_VIDEO_ADDED",a)};
h.Ha=function(a){gf("WATCH_LATER_VIDEO_REMOVED",a)};
h.va=function(){return this.M||(ch(this)?"html5":null)};
h.ua=function(){return this.V};
function eh(a){a.cancel();Yg(a);a.M=null;a.b&&(a.b.loaded=!1);var b=ch(a);b&&(bh(a)||!fh(a)?a.h=b:(b&&b.destroy&&b.destroy(),a.h=null));for(a=a.R;b=a.firstChild;)a.removeChild(b)}
h.cancel=function(){this.u&&sf(this.b.assets.js,this.u);U(this.ea);this.G=!1};
h.j=function(){eh(this);if(this.h&&this.b&&this.h.destroy)try{this.h.destroy()}catch(b){R(b)}this.T=null;for(var a in this.g)q[this.g[a]]=null;this.W=this.b=this.api=null;delete this.R;delete this.i;L.prototype.j.call(this)};
function fh(a){return a.b&&a.b.args&&a.b.args.fflags?-1!=a.b.args.fflags.indexOf("player_destroy_old_version=true"):!1}
;var jh={},kh="player_uid_"+(1E9*Math.random()>>>0);function lh(a){var b="player";b=t(b)?Vb(b):b;var c=kh+"_"+(b[Aa]||(b[Aa]=++Ba)),d=jh[c];if(d)return d.ca(a),d.api;d=new Xg(b,c);jh[c]=d;gf("player-added",d.api);Zc(d,Ea(mh,d));T(function(){d.ca(a)},0);
return d.api}
function mh(a){delete jh[a.C]}
...
th.prototype.toString=function(){return this.topic};var uh=w("ytPubsub2Pubsub2Instance")||new N;N.prototype.subscribe=N.prototype.subscribe;N.prototype.unsubscribeByKey=N.prototype.K;N.prototype.publish=N.prototype.J;N.prototype.clear=N.prototype.clear;v("ytPubsub2Pubsub2Instance",uh,void 0);v("ytPubsub2Pubsub2SubscribedKeys",w("ytPubsub2Pubsub2SubscribedKeys")||{},void 0);v("ytPubsub2Pubsub2TopicToKeys",w("ytPubsub2Pubsub2TopicToKeys")||{},void 0);v("ytPubsub2Pubsub2IsAsync",w("ytPubsub2Pubsub2IsAsync")||{},void 0);
...
Fh="isContinuation isNavigation kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist".split(" "),Gh={},Hh=(Gh.pa="LATENCY_ACTION_",Gh.yt_pt="LATENCY_PLAYER_",Gh.yt_vst="VIDEO_STREAM_TYPE_",Gh),Ih=!1;
...
;function Xh(a){L.call(this);this.b=a;this.b.subscribe("command",this.ja,this);this.f={};this.h=!1}
C(Xh,L);h=Xh.prototype;h.start=function(){this.h||this.c||(this.h=!0,Yh(this.b,"RECEIVING"))};
h.ja=function(a,b,c){if(this.h&&!this.c){var d=b||{};switch(a){case "addEventListener":t(d.event)&&(a=d.event,a in this.f||(b=z(this.Ma,this,a),this.f[a]=b,this.addEventListener(a,b)));break;case "removeEventListener":t(d.event)&&Zh(this,d.event);break;default:this.g.isReady()&&this.g[a]&&(b=this.g.handleExternalCall(a,$h(a,b||{}),c||null),(b=ai(a,b))&&this.h&&!this.c&&Yh(this.b,a,b))}}};
h.Ma=function(a,b){this.h&&!this.c&&Yh(this.b,a,this.Y(a,b))};
h.Y=function(a,b){if(null!=b)return{value:b}};
function Zh(a,b){b in a.f&&(a.removeEventListener(b,a.f[b]),delete a.f[b])}
h.j=function(){var a=this.b;a.c||Md(a.b,"command",this.ja,this);this.b=null;for(var b in this.f)Zh(this,b);Xh.w.j.call(this)};function bi(a,b){Xh.call(this,b);this.g=a;this.start()}
C(bi,Xh);bi.prototype.addEventListener=function(a,b){this.g.addEventListener(a,b)};
bi.prototype.removeEventListener=function(a,b){this.g.removeEventListener(a,b)};
...
bi.prototype.Y=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return bi.w.Y.call(this,a,b)};
bi.prototype.j=function(){bi.w.j.call(this);delete this.g};function ci(a,b,c,d){L.call(this);this.f=b||null;this.u="*";this.g=c||null;this.sessionId=null;this.channel=d||null;this.C=!!a;this.l=z(this.A,this);window.addEventListener("message",this.l)}
n(ci,L);ci.prototype.A=function(a){if(!("*"!=this.g&&a.origin!=this.g||this.f&&a.source!=this.f)&&t(a.data)){try{var b=JSON.parse(a.data)}catch(c){return}if(!(null==b||this.C&&(this.sessionId&&this.sessionId!=b.id||this.channel&&this.channel!=b.channel))&&b)switch(b.event){case "listening":"null"!=a.origin&&(this.g=this.u=a.origin);this.f=a.source;this.sessionId=b.id;this.b&&(this.b(),this.b=null);break;case "command":this.h&&(!this.i||0<=Ga(this.i,b.func))&&this.h(b.func,b.args,a.origin)}}};
ci.prototype.sendMessage=function(a,b){var c=b||this.f;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=nd(a);c.postMessage(d,this.u)}catch(e){R(e,"WARNING")}}};
ci.prototype.j=function(){window.removeEventListener("message",this.l);L.prototype.j.call(this)};function di(a,b,c){ci.call(this,a,b,c||Q("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname,"widget");this.i=this.b=this.h=null}
n(di,ci);function ei(){var a=this.c=new di(!!Q("WIDGET_ID_ENFORCE")),b=z(this.Ja,this);a.h=b;a.i=null;this.c.channel="widget";if(a=Q("WIDGET_ID"))this.c.sessionId=a;this.g=[];this.i=!1;this.h={}}
h=ei.prototype;h.Ja=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.h[a]||"onReady"==a||(this.addEventListener(a,fi(this,a)),this.h[a]=!0)):this.la(a,b,c)};
h.la=function(){};
...
h.dispose=function(){this.c=null};function hi(a){ei.call(this);this.b=a;this.f=[];this.addEventListener("onReady",z(this.Ia,this));this.addEventListener("onVideoProgress",z(this.Qa,this));this.addEventListener("onVolumeChange",z(this.Ra,this));this.addEventListener("onApiChange",z(this.La,this));this.addEventListener("onPlaybackQualityChange",z(this.Na,this));this.addEventListener("onPlaybackRateChange",z(this.Oa,this));this.addEventListener("onStateChange",z(this.Pa,this));this.addEventListener("onWebglSettingsChanged",z(this.Sa,
this))}
C(hi,ei);h=hi.prototype;h.la=function(a,b,c){if(this.b[a]){b=b||[];if(0<b.length&&Th(a)){var d=b;if(y(d[0])&&!x(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=Vh.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=Uh.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=Wh.apply(window,d)}d=e}b.length=1;b[0]=d}this.b.handleExternalCall(a,b,c);Th(a)&&gi(this,this.Z())}};
...
h.Na=function(a){gi(this,{playbackQuality:a})};
h.Oa=function(a){gi(this,{playbackRate:a})};
...
h.Ra=function(){gi(this,{muted:this.b.isMuted(),volume:this.b.getVolume()})};
h.Qa=function(a){a={currentTime:a,videoBytesLoaded:this.b.getVideoBytesLoaded(),videoLoadedFraction:this.b.getVideoLoadedFraction(),currentTimeLastUpdated_:A()/1E3,playbackRate:this.b.getPlaybackRate(),mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());gi(this,a)};
h.Sa=function(){var a={sphericalProperties:this.b.getSphericalProperties()};gi(this,a)};
h.dispose=function(){hi.w.dispose.call(this);for(var a=0;a<this.f.length;a++){var b=this.f[a];this.b.removeEventListener(b.eventType,b.listener)}this.f=[]};function ii(a){a=void 0===a?!1:a;L.call(this);this.b=new N(a);Zc(this,Ea($c,this.b))}
C(ii,L);ii.prototype.subscribe=function(a,b,c){return this.c?0:this.b.subscribe(a,b,c)};
ii.prototype.h=function(a,b){this.c||this.b.J.apply(this.b,arguments)};function ji(a,b,c){ii.call(this);this.f=a;this.g=b;this.i=c}
C(ji,ii);function Yh(a,b,c){if(!a.c){var d=a.f;d.c||a.g!=d.b||(a={id:a.i,command:b},c&&(a.data=c),d.b.postMessage(nd(a),d.g))}}
ji.prototype.j=function(){this.g=this.f=null;ji.w.j.call(this)};function ki(a,b,c){L.call(this);this.b=a;this.g=c;this.h=V(window,"message",z(this.i,this));this.f=new ji(this,a,b);Zc(this,Ea($c,this.f))}
...
ki.prototype.j=function(){Tf(this.h);this.b=null;ki.w.j.call(this)};function li(){var a=hb(mi),b;return Ad(new M(function(c,d){a.onSuccess=function(a){te(a)?c(a):d(new ni("Request failed, status="+a.status,"net.badstatus",a))};
a.onError=function(a){d(new ni("Unknown request error","net.unknown",a))};
a.L=function(a){d(new ni("Request timed out","net.timeout",a))};
...
n(ni,E);function oi(){this.c=0;this.b=null}
oi.prototype.then=function(a,b,c){return 1===this.c&&a?(a=a.call(c,this.b),td(a)?a:pi(a)):2===this.c&&b?(a=b.call(c,this.b),td(a)?a:qi(a)):this};
oi.prototype.getValue=function(){return this.b};
oi.prototype.$goog_Thenable=!0;function qi(a){var b=new oi;a=void 0===a?null:a;b.c=2;b.b=void 0===a?null:a;return b}
function pi(a){var b=new oi;a=void 0===a?null:a;b.c=1;b.b=void 0===a?null:a;return b}
...
;function yi(a){if("1"!==bb(he(),"args","privembed")){a&&ie();try{xi().then(function(a){a=le(a);a.bsq=zi++;Me("//www.youtube.com/ad_data_204",{wa:!1,B:a,withCredentials:!0})},function(){}),T(yi,18E5)}catch(b){R(b)}}}
...
function Li(a){var b=Kg();a=Hi[a.id];b&&a&&qg("visualElementGestured",{csn:b,ve:Eg(a),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"},zg,void 0,void 0)}
function Mi(a){a=a.ids;var b=Kg();if(b)for(var c=0;c<a.length;c++){var d=Hi[a[c]];d&&qg("visualElementShown",{csn:b,ve:Eg(d),eventType:1},zg,void 0,void 0)}}
...
Mi);a.addEventListener("onReady",Ni);b=Q("POST_MESSAGE_ID","player");Q("ENABLE_JS_API")?Gi=new hi(a):Q("ENABLE_POST_API")&&t(b)&&t(c)&&(Fi=new ki(window.parent,b,c),Gi=new bi(a,Fi.f));c=ge("BG_P");Jf(c)&&(Q("BG_I")||Q("BG_IU"))&&(Ff=!0,Ef.initialize(Q("BG_I",null),Q("BG_IU",null),c,If,void 0));Af()},void 0);
