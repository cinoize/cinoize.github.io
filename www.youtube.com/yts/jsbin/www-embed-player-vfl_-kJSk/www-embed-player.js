...
Fb.prototype.ba=!0;Fb.prototype.Y=function(){return this.g};
Fb.prototype.J=!0;Fb.prototype.I=function(){return this.f.toString()};
function Hb(a){if(a instanceof Fb&&a.constructor===Fb&&a.h===Gb)return a.f;Aa(a);return"type_error:SafeHtml"}
var Gb={};function Ib(a,b){var c=new Fb;c.f=a;c.g=b;return c}
...
return k}
;var Re={},Se=0;
function Te(a,b,c,d,e){e=void 0===e?"":e;a&&(c&&(c=Bb,c=!(c&&0<=c.toLowerCase().indexOf("cobalt"))),c?a&&(a instanceof F||(a="object"==typeof a&&a.J?a.I():String(a),yb.test(a)||(a="about:invalid#zClosurez"),a=Ab(a)),b=xb(a).toString(),"about:invalid#zClosurez"===b?a="":(b instanceof Fb?a=b:(d="object"==typeof b,a=null,d&&b.ba&&(a=b.Y()),b=ob(d&&b.J?b.I():String(b)),a=Ib(b,a)),a=Hb(a).toString(),a=encodeURIComponent(String(ld(a)))),/^[\s\xa0]*$/.test(a)||(a=nc("IFRAME",{src:'javascript:"<body><img src=\\""+'+a+
...
;function Zf(a){this.B=a;this.f=null;this.j=0;this.o=null;this.l=0;this.h=[];for(a=0;4>a;a++)this.h.push(0);this.i=0;this.F=U(window,"mousemove",z(this.H,this));a=z(this.C,this);Da(a)&&(a=oe(a));this.K=window.setInterval(a,25)}
...
wh.prototype.toString=function(){return this.topic};var xh=y("ytPubsub2Pubsub2Instance")||new K;K.prototype.subscribe=K.prototype.subscribe;K.prototype.unsubscribeByKey=K.prototype.M;K.prototype.publish=K.prototype.L;K.prototype.clear=K.prototype.clear;x("ytPubsub2Pubsub2Instance",xh,void 0);x("ytPubsub2Pubsub2SubscribedKeys",y("ytPubsub2Pubsub2SubscribedKeys")||{},void 0);x("ytPubsub2Pubsub2TopicToKeys",y("ytPubsub2Pubsub2TopicToKeys")||{},void 0);x("ytPubsub2Pubsub2IsAsync",y("ytPubsub2Pubsub2IsAsync")||{},void 0);
...
;function $h(a){I.call(this);this.f=a;this.f.subscribe("command",this.ja,this);this.h={};this.j=!1}
B($h,I);m=$h.prototype;m.start=function(){this.j||this.g||(this.j=!0,ai(this.f,"RECEIVING"))};
...
m.Na=function(a,b){this.j&&!this.g&&ai(this.f,a,this.Z(a,b))};
m.Z=function(a,b){if(null!=b)return{value:b}};
function bi(a,b){b in a.h&&(a.removeEventListener(b,a.h[b]),delete a.h[b])}
m.m=function(){var a=this.f;a.g||Jd(a.f,"command",this.ja,this);this.f=null;for(var b in this.h)bi(this,b);$h.A.m.call(this)};function ei(a,b){$h.call(this,b);this.i=a;this.start()}
B(ei,$h);ei.prototype.addEventListener=function(a,b){this.i.addEventListener(a,b)};
...
ei.prototype.m=function(){ei.A.m.call(this);delete this.i};function fi(a,b,c,d){I.call(this);this.h=b||null;this.B="*";this.i=c||null;this.sessionId=null;this.channel=d||null;this.F=!!a;this.o=z(this.C,this);window.addEventListener("message",this.o)}
n(fi,I);fi.prototype.C=function(a){if(!("*"!=this.i&&a.origin!=this.i||this.h&&a.source!=this.h)&&v(a.data)){try{var b=JSON.parse(a.data)}catch(c){return}if(!(null==b||this.F&&(this.sessionId&&this.sessionId!=b.id||this.channel&&this.channel!=b.channel))&&b)switch(b.event){case "listening":"null"!=a.origin&&(this.i=this.B=a.origin);this.h=a.source;this.sessionId=b.id;this.f&&(this.f(),this.f=null);break;case "command":this.j&&(!this.l||0<=Ma(this.l,b.func))&&this.j(b.func,b.args,a.origin)}}};
fi.prototype.sendMessage=function(a,b){var c=b||this.h;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=ld(a);c.postMessage(d,this.B)}catch(e){Q(e,"WARNING")}}};
fi.prototype.m=function(){window.removeEventListener("message",this.o);I.prototype.m.call(this)};function gi(a,b,c){fi.call(this,a,b,c||P("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname,"widget");this.l=this.f=this.j=null}
n(gi,fi);function hi(){var a=this.g=new gi(!!P("WIDGET_ID_ENFORCE")),b=z(this.Ka,this);a.j=b;a.l=null;this.g.channel="widget";if(a=P("WIDGET_ID"))this.g.sessionId=a;this.i=[];this.l=!1;this.j={}}
m=hi.prototype;m.Ka=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.j[a]||"onReady"==a||(this.addEventListener(a,ii(this,a)),this.j[a]=!0)):this.la(a,b,c)};
m.la=function(){};
...
m.dispose=function(){this.g=null};function ki(a){hi.call(this);this.f=a;this.h=[];this.addEventListener("onReady",z(this.Ia,this));this.addEventListener("onVideoProgress",z(this.Ra,this));this.addEventListener("onVolumeChange",z(this.Sa,this));this.addEventListener("onApiChange",z(this.Ma,this));this.addEventListener("onPlaybackQualityChange",z(this.Oa,this));this.addEventListener("onPlaybackRateChange",z(this.Pa,this));this.addEventListener("onStateChange",z(this.Qa,this));this.addEventListener("onWebglSettingsChanged",z(this.Ta,
this))}
B(ki,hi);m=ki.prototype;m.la=function(a,b,c){if(this.f.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&Wh(a)){var d=b;if(Ea(d[0])&&!Ba(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=Yh.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=Xh.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=Zh.apply(window,d)}d=e}b.length=1;b[0]=d}this.f.handleExternalCall(a,b,c);Wh(a)&&ji(this,this.aa())}};
...
m.Sa=function(){ji(this,{muted:this.f.isMuted(),volume:this.f.getVolume()})};
m.Ra=function(a){a={currentTime:a,videoBytesLoaded:this.f.getVideoBytesLoaded(),videoLoadedFraction:this.f.getVideoLoadedFraction(),currentTimeLastUpdated_:A()/1E3,playbackRate:this.f.getPlaybackRate(),mediaReferenceTime:this.f.getMediaReferenceTime()};this.f.getProgressState&&(a.progressState=this.f.getProgressState());ji(this,a)};
m.Ta=function(){var a={sphericalProperties:this.f.getSphericalProperties()};ji(this,a)};
m.dispose=function(){ki.A.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function li(a){a=void 0===a?!1:a;I.call(this);this.f=new K(a);Xc(this,Ja(Yc,this.f))}
B(li,I);li.prototype.subscribe=function(a,b,c){return this.g?0:this.f.subscribe(a,b,c)};
li.prototype.j=function(a,b){this.g||this.f.L.apply(this.f,arguments)};function mi(a,b,c){li.call(this);this.h=a;this.i=b;this.l=c}
B(mi,li);function ai(a,b,c){if(!a.g){var d=a.h;d.g||a.i!=d.f||(a={id:a.l,command:b},c&&(a.data=c),d.f.postMessage(ld(a),d.i))}}
mi.prototype.m=function(){this.i=this.h=null;mi.A.m.call(this)};function ni(a,b,c){I.call(this);this.f=a;this.i=c;this.j=U(window,"message",z(this.l,this));this.h=new mi(this,a,b);Xc(this,Ja(Yc,this.h))}
B(ni,I);ni.prototype.l=function(a){var b;if(b=!this.g)if(b=a.origin==this.i)a:{b=this.f;do{b:{var c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,v(b))){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.h,c.g||c.j("command",b.command,b.data,a.origin))}};
ni.prototype.m=function(){Yf(this.j);this.f=null;ni.A.m.call(this)};function oi(){var a=bb(pi),b;return yd(new J(function(c,d){a.onSuccess=function(e){Ae(e)?c(e):d(new qi("Request failed, status="+e.status,"net.badstatus",e))};
a.onError=function(e){d(new qi("Unknown request error","net.unknown",e))};
a.N=function(e){d(new qi("Request timed out","net.timeout",e))};
...
n(qi,D);function ri(){this.g=0;this.f=null}
ri.prototype.then=function(a,b,c){return 1===this.g&&a?(a=a.call(c,this.f),rd(a)?a:si(a)):2===this.g&&b?(a=b.call(c,this.f),rd(a)?a:ti(a)):this};
ri.prototype.getValue=function(){return this.f};
ri.prototype.$goog_Thenable=!0;function ti(a){var b=new ri;a=void 0===a?null:a;b.g=2;b.f=void 0===a?null:a;return b}
function si(a){var b=new ri;a=void 0===a?null:a;b.g=1;b.f=void 0===a?null:a;return b}
...
;function Bi(a){if("1"!==Wa(ke(),"args","privembed")){a&&le();try{Ai().then(function(b){R("pass_biscotti_id_in_header_ajax_tv")||R("pass_biscotti_id_in_header_ajax")||(b=re(b),b.bsq=Ci++,Qe("//www.youtube.com/ad_data_204",{va:!1,D:b,withCredentials:!0}))},function(){}),S(Bi,18E5)}catch(b){Q(b)}}}
var Ci=0;var Z=y("ytglobal.prefsUserPrefsPrefs_")||{};x("ytglobal.prefsUserPrefsPrefs_",Z,void 0);function Di(){this.f=P("ALT_PREF_COOKIE_NAME","PREF");var a=ec.get(""+this.f,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
...
Pi);b=P("POST_MESSAGE_ID","player");P("ENABLE_JS_API")?Ji=new ki(a):P("ENABLE_POST_API")&&v(b)&&v(c)&&(Ii=new ni(window.parent,b,c),Ji=new ei(a,Ii.h));c=je("BG_P");Of(c)&&(P("BG_I")||P("BG_IU"))&&(Kf=!0,Jf.initialize(P("BG_I",null),P("BG_IU",null),c,Nf,void 0));Ff()},void 0);
