...
X.upg_chip_ids_string="unpluggedInfo.upgChipIdsString",X.vph="viewportHeight",X.vpw="viewportWidth",X.yt_vis="isVisible",X),kh="ap c cver ei srt yt_fss yt_li plid vpil vpni vpst yt_eil vpni2 vpil2 icrc icrt pa GetBrowse_rid GetPlayer_rid GetSearch_rid GetWatchNext_rid cmt d_vpct d_vpnfi d_vpni pc pfa pfeh pftr prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis yt_ref yt_sts".split(" "),lh="isNavigation kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist".split(" "),
mh=!1;function nh(){var a=oh().info.yt_lt="hot_bg";ph().info_yt_lt=a;if(qh())if("yt_lt"in jh){var b=jh.yt_lt;0<=Ha(lh,b)&&(a=!!a);var c=a;if(qh()){a={};b=b.split(".");for(var d=a,e=0;e<b.length-1;e++)d[b[e]]=d[b[e]]||{},d=d[b[e]];d[b[b.length-1]]=c;c=rh();b=Object.keys(a).join("");Xg("info_"+b+"_"+c)||(a.clientActionNonce=c,mg("latencyActionInfo",a,void 0,void 0))}}else 0<=Ha(kh,"yt_lt")||R(Error("Unknown label yt_lt logged with GEL CSI."))}
...
var uh=y(W.clearResourceTimings||W.webkitClearResourceTimings||W.mozClearResourceTimings||W.msClearResourceTimings||W.oClearResourceTimings||ua,W);function rh(){var a=oh().nonce;a||(a=xg(),oh().nonce=a);return a}
...
function yh(){dh();if(!qh()){var a=th(),b=oh().info,c=a._start;for(f in a)if(0==f.lastIndexOf("_",0)&&xa(a[f])){var d=f.slice(1);if(d in ih){var e=Ka(a[f],function(a){return Math.round(a-c)});
b["all_"+d]=e.join()}delete a[f]}var f=!!b.ap;if(d=w("ytglobal.timingReportbuilder_")){if(a=d(a,b,void 0))zh(a,f),vh(),uh(),wh(!1,void 0),P("TIMING_ACTION")&&O("PREVIOUS_ACTION",P("TIMING_ACTION")),O("TIMING_ACTION","")}else{var g=P("CSI_SERVICE_NAME","youtube");d={v:2,s:g,action:P("TIMING_ACTION",void 0)};e=nh.srt;void 0!==a.srt&&delete b.srt;if(b.h5jse){var h=window.location.protocol+w("ytplayer.config.assets.js");(h=W.getEntriesByName?W.getEntriesByName(h)[0]:null)?b.h5jse=Math.round(b.h5jse-h.responseEnd):
delete b.h5jse}a.aft=sh();xh()&&"youtube"==g&&(nh(),g=a.vc,h=a.pbs,delete a.aft,b.aft=Math.round(h-g));for(var l in b)"_"!=l.charAt(0)&&(d[l]=b[l]);a.ps=N();b={};l=[];for(var m in a)"_"!=m.charAt(0)&&(g=Math.round(a[m]-c),b[m]=g,l.push(m+"."+g));d.rt=l.join(",");(a=w("ytdebug.logTiming"))&&a(d,b);zh(d,f,void 0);bh(hh,new fh(b.aft+(e||0),void 0))}}}
function zh(a,b,c){if(S("debug_csi_data")){var d=w("yt.timing.csiData");d||(d=[],u("yt.timing.csiData",d,void 0));d.push({page:location.href,time:new Date,args:a})}d="";for(var e in a)d+="&"+e+"="+a[e];a="/csi_204?"+d.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b){var f=void 0===f?"":f;try{window.navigator&&window.navigator.sendBeacon&&window.navigator.sendBeacon(a,f)||Le(a,void 0,void 0,void 0,f)}catch(g){Le(a,void 0,void 0,void 0,f)}}else Le(a);wh(!0,c)}
function Ah(a){if("_"!=a[0]){var b=a;W.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),W.mark(b))}b=th();var c=N();b[a]&&(b["_"+a]=b["_"+a]||[b[a]],b["_"+a].push(c));b[a]=c;b=ch();if(c=b[a])tf(c),b[a]=0;ph()["tick_"+a]=void 0;N();qh()?(b=rh(),"_start"==a?Xg("baseline_"+b)||mg("latencyActionBaselined",{clientActionNonce:b},void 0,void 0):Xg("tick_"+a+"_"+b)||mg("latencyActionTicked",{tickName:a,clientActionNonce:b},void 0,void 0),a=!0):a=!1;if(a=!a)a=!w("yt.timing.pingSent_");if(a&&(b=Q("TIMING_ACTION"),
a=th(),w("ytglobal.timingready_")&&b&&a._start&&(b=sh()))){mh||(bh(gh,new eh(Math.round(b-a._start),void 0)),mh=!0);b=!0;c=P("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&yh()}}
;function Bh(a,b){J.call(this);this.j=this.T=a;this.D=b;this.m=!1;this.api={};this.P=this.B=null;this.G=new L;ad(this,Ea(bd,this.G));this.h={};this.N=this.R=this.g=this.Y=this.b=null;this.H=!1;this.i=this.w=null;this.U={};this.oa=["onReady"];this.X=null;this.ga=NaN;this.O={};Ch(this);this.V("WATCH_LATER_VIDEO_ADDED",this.Fa.bind(this));this.V("WATCH_LATER_VIDEO_REMOVED",this.Ga.bind(this));this.V("onAdAnnounce",this.ra.bind(this));this.pa=new Pg(this);ad(this,Ea(bd,this.pa))}
n(Bh,J);k=Bh.prototype;
k.ea=function(a){if(!this.f){a instanceof Mg||(a=new Mg(a));this.Y=a;this.b=a.clone();this.g=this.b.attrs.id||this.g;"video-player"==this.g&&(this.g=this.D,this.b.attrs.id=this.D);this.j.id==this.g&&(this.g+="-player",this.b.attrs.id=this.g);this.b.args.enablejsapi="1";this.b.args.playerapiid=this.D;this.R||(this.R=Dh(this,this.b.args.jsapicallback||"onYouTubePlayerReady"));this.b.args.jsapicallback=null;if(a=this.b.attrs.width)this.j.style.width=kc(Number(a)||a);if(a=this.b.attrs.height)this.j.style.height=kc(Number(a)||
...
function Gh(a){var b=!0,c=Hh(a);c&&a.b&&(a=a.b,b=Ue(c,"version")==a.assets.js);return b&&!!w("yt.player.Application.create")}
...
a.H=!0;b?a.w():(hf(a.b.assets.js,a.w),Rg(a.b.assets.css),Kh(a)&&!c&&u("yt.player.Application.create",null,void 0))}}}
function Hh(a){var b=Wb(a.g);!b&&a.j&&a.j.querySelector&&(b=a.j.querySelector("#"+a.g));return b}
function Ih(a){if(!a.f){var b=Hh(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.H=!1,b.isNotServable&&b.isNotServable(a.b.args.video_id)||Lh(a)):a.ga=T(function(){Ih(a)},50)}}
...
function Mh(a,b,c){var d=b[c];return function(){try{return a.X=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.X=e,me(e))}}}
function Ch(a){a.m=!1;if(a.P)for(var b in a.h)a.P(b,a.h[b]);for(var c in a.O)qe(parseInt(c,10));a.O={};a.B=null;a.P=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.V.bind(a);a.api.removeEventListener=a.Ka.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.va.bind(a);a.api.getPlayerType=a.wa.bind(a);a.api.getCurrentVideoConfig=a.ua.bind(a);a.api.loadNewVideoConfig=a.ea.bind(a);a.api.isReady=a.Ea.bind(a)}
k.Ea=function(){return this.m};
k.V=function(a,b){var c=this,d=Dh(this,b);if(d){if(!(0<=Ha(this.oa,a)||this.h[a])){var e=Nh(this,a);this.B&&this.B(a,e)}this.G.subscribe(a,d);"onReady"==a&&this.m&&T(function(){d(c.api)},0)}};
k.Ka=function(a,b){if(!this.f){var c=Dh(this,b);c&&Od(this.G,a,c)}};
...
k.wa=function(){return this.N||(Hh(this)?"html5":null)};
...
k.l=function(){Jh(this);if(this.i&&this.b&&this.i.destroy)try{this.i.destroy()}catch(b){R(b)}this.U=null;for(var a in this.h)q[this.h[a]]=null;this.Y=this.b=this.api=null;delete this.T;delete this.j;J.prototype.l.call(this)};
function Kh(a){return a.b&&a.b.args&&a.b.args.fflags?-1!=a.b.args.fflags.indexOf("player_destroy_old_version=true"):!1}
;var Oh={},Ph="player_uid_"+(1E9*Math.random()>>>0);function Qh(a){var b="player";b=t(b)?Wb(b):b;var c=Ph+"_"+(b[Aa]||(b[Aa]=++Ba)),d=Oh[c];if(d)return d.ea(a),d.api;d=new Bh(b,c);Oh[c]=d;cf("player-added",d.api);ad(d,Ea(Rh,d));T(function(){d.ea(a)},0);
return d.api}
...
var Uh=Fb(function(){var a=new Yd;return a.isAvailable()?new Ud(a):null}),Th=Fb(function(){var a=new Zd;
...
function Yh(a,b,c,d){if(x(a)&&!xa(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};t(a)&&16==a.length?b.list="PL"+a:b.playlist=a;return b}
...
;function $h(a){J.call(this);this.b=a;this.b.subscribe("command",this.la,this);this.g={};this.i=!1}
A($h,J);k=$h.prototype;k.start=function(){this.i||this.f||(this.i=!0,ai(this.b,"RECEIVING"))};
...
k.Ma=function(a,b){this.i&&!this.f&&ai(this.b,a,this.aa(a,b))};
k.aa=function(a,b){if(null!=b)return{value:b}};
function bi(a,b){b in a.g&&(a.removeEventListener(b,a.g[b]),delete a.g[b])}
k.l=function(){var a=this.b;a.f||Od(a.b,"command",this.la,this);this.b=null;for(var b in this.g)bi(this,b);$h.A.l.call(this)};function ei(a,b){$h.call(this,b);this.h=a;this.start()}
A(ei,$h);ei.prototype.addEventListener=function(a,b){this.h.addEventListener(a,b)};
...
ei.prototype.aa=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return ei.A.aa.call(this,a,b)};
...
fi.prototype.sendMessage=function(a,b){var c=b||this.g;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=pd(a);c.postMessage(d,this.w)}catch(e){R(e,"WARNING")}}};
...
n(gi,fi);function hi(){var a=this.f=new gi(!!P("WIDGET_ID_ENFORCE")),b=y(this.Ja,this);a.i=b;a.j=null;this.f.channel="widget";if(a=P("WIDGET_ID"))this.f.sessionId=a;this.h=[];this.j=!1;this.i={}}
k=hi.prototype;k.Ja=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.i[a]||"onReady"==a||(this.addEventListener(a,ii(this,a)),this.i[a]=!0)):this.na(a,b,c)};
k.na=function(){};
...
k.dispose=function(){this.f=null};function ki(a){hi.call(this);this.b=a;this.g=[];this.addEventListener("onReady",y(this.Ha,this));this.addEventListener("onVideoProgress",y(this.Qa,this));this.addEventListener("onVolumeChange",y(this.Ra,this));this.addEventListener("onApiChange",y(this.La,this));this.addEventListener("onPlaybackQualityChange",y(this.Na,this));this.addEventListener("onPlaybackRateChange",y(this.Oa,this));this.addEventListener("onStateChange",y(this.Pa,this));this.addEventListener("onWebglSettingsChanged",y(this.Sa,
this))}
A(ki,hi);k=ki.prototype;k.na=function(a,b,c){if(this.b[a]){b=b||[];if(0<b.length&&Vh(a)){var d=b;if(x(d[0])&&!xa(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=Xh.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=Wh.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=Yh.apply(window,d)}d=e}Zh(d);b.length=1;b[0]=d}this.b.handleExternalCall(a,b,c);Vh(a)&&ji(this,this.ba())}};
...
mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getVideoContentRect&&(a.videoContentRect=this.b.getVideoContentRect());this.b.getProgressState&&(a.progressState=this.b.getProgressState());this.b.getStoryboardFormat&&(a.storyboardFormat=this.b.getStoryboardFormat());ji(this,a)};
k.Na=function(a){ji(this,{playbackQuality:a})};
k.Oa=function(a){ji(this,{playbackRate:a})};
...
k.Ra=function(){ji(this,{muted:this.b.isMuted(),volume:this.b.getVolume()})};
k.Qa=function(a){a={currentTime:a,videoBytesLoaded:this.b.getVideoBytesLoaded(),videoLoadedFraction:this.b.getVideoLoadedFraction(),currentTimeLastUpdated_:z()/1E3,playbackRate:this.b.getPlaybackRate(),mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());ji(this,a)};
k.Sa=function(){var a={sphericalProperties:this.b.getSphericalProperties()};ji(this,a)};
k.dispose=function(){ki.A.dispose.call(this);for(var a=0;a<this.g.length;a++){var b=this.g[a];this.b.removeEventListener(b.eventType,b.listener)}this.g=[]};function li(a){a=void 0===a?!1:a;J.call(this);this.b=new L(a);ad(this,Ea(bd,this.b))}
A(li,J);li.prototype.subscribe=function(a,b,c){return this.f?0:this.b.subscribe(a,b,c)};
...
A(mi,li);function ai(a,b,c){if(!a.f){var d=a.g;d.f||a.h!=d.b||(a={id:a.j,command:b},c&&(a.data=c),d.b.postMessage(pd(a),d.h))}}
mi.prototype.l=function(){this.h=this.g=null;mi.A.l.call(this)};function ni(a,b,c){J.call(this);this.b=a;this.h=c;this.i=U(window,"message",y(this.j,this));this.g=new mi(this,a,b);ad(this,Ea(bd,this.g))}
A(ni,J);ni.prototype.j=function(a){var b;if(b=!this.f)if(b=a.origin==this.h)a:{b=this.b;do{b:{var c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,t(b))){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.g,c.f||c.i("command",b.command,b.data,a.origin))}};
ni.prototype.l=function(){Pf(this.i);this.b=null;ni.A.l.call(this)};function oi(){var a=kb(pi),b;return Dd(new K(function(c,d){a.onSuccess=function(a){pe(a)?c(a):d(new qi("Request failed, status="+a.status,"net.badstatus",a))};
...
return Bd(a)})}
function qi(a,b){C.call(this,a+", errorCode="+b);this.errorCode=b;this.name="PromiseAjaxError"}
n(qi,C);function ri(a){this.g=void 0===a?null:a;this.f=0;this.b=null}
ri.prototype.then=function(a,b,c){return this.g?this.g.then(a,b,c):1===this.f&&a?(a=a.call(c,this.b),wd(a)?a:si(a)):2===this.f&&b?(a=b.call(c,this.b),wd(a)?a:ti(a)):this};
ri.prototype.getValue=function(){return this.b};
vd(ri);function ti(a){var b=new ri;a=void 0===a?null:a;b.f=2;b.b=void 0===a?null:a;return b}
function si(a){var b=new ri;a=void 0===a?null:a;b.f=1;b.b=void 0===a?null:a;return b}
;function ui(a){C.call(this,a.message||a.description||a.name);this.isMissing=a instanceof vi;this.isTimeout=a instanceof qi&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof Ed}
n(ui,C);ui.prototype.name="BiscottiError";function vi(){C.call(this,"Biscotti ID is missing from server")}
n(vi,C);vi.prototype.name="BiscottiMissingError";var pi={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},wi=null;function xi(){if("1"===eb(ke(),"args","privembed"))return Bd(Error("Biscotti ID is not available in private embed mode"));wi||(wi=Dd(oi().then(yi),function(a){return zi(2,a)}));
return wi}
...
function Bi(a,b){T(function(){Dd(oi().then(yi,function(a){return zi(b,a)}),ua)},a)}
function Ai(a){u("yt.ads.biscotti.lastId_",a,void 0)}
function Ci(){try{var a=w("yt.ads.biscotti.getId_");return a?a():xi()}catch(b){return Bd(b)}}
;function Di(a){if("1"!==eb(ke(),"args","privembed")){a&&(w("yt.ads.biscotti.getId_")||Fa("yt.ads.biscotti.getId_",xi));try{Ci().then(function(a){var b={};b.dt=Ec;b.flash="0";a:{try{var d=window.top.location.href}catch(Za){d=2;break a}d=null!=d?d==window.document.location.href?0:1:2}b=(b.frm=d,b);b.u_tz=-(new Date).getTimezoneOffset();var e=void 0===e?B:e;try{var f=e.history.length}catch(Za){f=0}b.u_his=f;b.u_java=!!B.navigator&&"unknown"!==typeof B.navigator.javaEnabled&&!!B.navigator.javaEnabled&&
...
G.brdim=g.join();Ia=(G.vis={visible:1,hidden:2,prerender:3,preview:4,unloaded:5}[Ga.visibilityState||Ga.webkitVisibilityState||Ga.mozVisibilityState||""]||0,G.wgl=!!B.WebGLRenderingContext,G);for(var ge in Ia)b[ge]=Ia[ge];b.bid=a;b.bsq=Ei++;Ie("//www.youtube.com/ad_data_204",{xa:!1,C:b,withCredentials:!0})},function(){}),T(Di,18E5)}catch(b){R(b)}}}
var Ei=0;var Z=w("ytglobal.prefsUserPrefsPrefs_")||{};u("ytglobal.prefsUserPrefsPrefs_",Z,void 0);function Fi(){this.b=P("ALT_PREF_COOKIE_NAME","PREF");var a=Eb.get(""+this.b,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}}
...
va(Fi);var Ji=null,Ki=null,Li=null,Mi={};function Ni(a){var b=a.id;a=a.ve_type;var c=Bg++;a=new zg({veType:a,veCounter:c,elementIndex:void 0,dataElement:void 0,youtubeData:void 0});Mi[b]=a;b=Gg();c=Fg();b&&c&&Jg(b,c,a)}
function Oi(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(Hg(b,a),a=Fg()))for(var c in Mi){var d=Mi[c];d&&Jg(b,a,d)}}
function Pi(a){Mi[a.id]=new zg({trackingParams:a.tracking_params})}
function Qi(a){var b=Gg();a=Mi[a.id];b&&a&&mg("visualElementGestured",{csn:b,ve:Ag(a),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"})}
function Ri(a){a=a.ids;var b=Gg();if(b)for(var c=0;c<a.length;c++){var d=Mi[a[c]];d&&mg("visualElementShown",{csn:b,ve:Ag(d),eventType:1})}}
...
u("writeEmbed",function(){var a=P("PLAYER_CONFIG",void 0);Di(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=P("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);P("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");a.args.autoplay&&Zh(a.args);Ji=a=Qh(a);a.addEventListener("onScreenChanged",Oi);a.addEventListener("onLogClientVeCreated",Ni);a.addEventListener("onLogServerVeCreated",Pi);a.addEventListener("onLogVeClicked",
Qi);a.addEventListener("onLogVesShown",Ri);a.addEventListener("onReady",Si);b=P("POST_MESSAGE_ID","player");P("ENABLE_JS_API")?Li=new ki(a):P("ENABLE_POST_API")&&t(b)&&t(c)&&(Ki=new ni(window.parent,b,c),Li=new ei(a,Ki.g));c=Q("BG_P");Ff(c)&&(P("BG_I")||P("BG_IU"))&&(Bf=!0,Af.initialize(P("BG_I",null),P("BG_IU",null),c,Ef,void 0));wf()},void 0);
u("yt.www.watch.ads.restrictioncookie.spr",function(a){Le(a+"mac_204?action_fcts=1");return!0},void 0);
var Ti=le(function(){Ah("ol");var a=Fi.getInstance(),b=!!((Ii("f"+(Math.floor(119/31)+1))||0)&67108864),c=1<window.devicePixelRatio;if(document.body&&ed(document.body,"exp-invert-logo"))if(c&&!ed(document.body,"inverted-hdpi")){var d=document.body;d.classList?d.classList.add("inverted-hdpi"):ed(d,"inverted-hdpi")||(d.className+=0<d.className.length?" inverted-hdpi":"inverted-hdpi")}else!c&&ed(document.body,"inverted-hdpi")&&fd();b!=c&&(b="f"+(Math.floor(119/31)+1),d=Ii(b)||0,d=c?d|67108864:d&-67108865,
0==d?delete Z[b]:Z[b]=d.toString(16).toString(),a.save())}),Ui=le(function(){var a=Ji;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();P("PL_ATT")&&Af.dispose();a=0;for(var b=uf.length;a<b;a++)tf(uf[a]);uf.length=0;nf("//static.doubleclick.net/instream/ad_status.js");vf=!1;O("DCLKSTAT",0);cd(Li,Ki);if(a=Ji)a.removeEventListener("onScreenChanged",Oi),a.removeEventListener("onLogClientVeCreated",Ni),a.removeEventListener("onLogServerVeCreated",Pi),a.removeEventListener("onLogVeClicked",Qi),a.removeEventListener("onLogVesShown",Ri),a.removeEventListener("onReady",Si),a.destroy();Mi=
{}});
window.addEventListener?(window.addEventListener("load",Ti),window.addEventListener("unload",Ui)):window.attachEvent&&(window.attachEvent("onload",Ti),window.attachEvent("onunload",Ui));Fa("yt.abuse.player.botguardInitialized",w("yt.abuse.player.botguardInitialized")||Gf);Fa("yt.abuse.player.invokeBotguard",w("yt.abuse.player.invokeBotguard")||Hf);Fa("yt.abuse.dclkstatus.checkDclkStatus",w("yt.abuse.dclkstatus.checkDclkStatus")||xf);
