...
C(F,Error);F.prototype.name="CustomError";var La=Array.prototype.indexOf?function(a,b){return Array.prototype.indexOf.call(a,b,void 0)}:function(a,b){if(x(a))return x(b)&&1==b.length?a.indexOf(b,0):-1;
...
var gb={},fb={},hb;hb=new eb(fb,"");function ib(a,b,c){this.g=a===jb&&b||"";this.f=a===jb&&c||null;this.h=kb}
...
function Kb(a){var b=new ib(jb,hb instanceof eb&&hb.constructor===eb&&hb.g===gb?hb.f:"type_error:Const",null);a.src=b.f?b.f:lb(b).toString()}
...
return a}
var qc={cb:"allow-forms",eb:"allow-modals",fb:"allow-orientation-lock",gb:"allow-pointer-lock",hb:"allow-popups",ib:"allow-popups-to-escape-sandbox",jb:"allow-presentation",kb:"allow-same-origin",lb:"allow-scripts",mb:"allow-top-navigation",nb:"allow-top-navigation-by-user-activation"},sc=Ta(function(){return rc()});
...
function Fd(a,b,c,d){if(b=a.h[b]){var e=a.f;(b=Pa(b,function(f){return e[f+1]==c&&e[f+2]==d}))&&a.N(b)}}
...
Lf.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var Xa=z("ytEventsEventsListeners")||{};y("ytEventsEventsListeners",Xa,void 0);var Nf=z("ytEventsEventsCounter")||{count:0};y("ytEventsEventsCounter",Nf,void 0);
...
var Pf=Ta(function(){var a=!1;try{var b=Object.defineProperty({},"capture",{get:function(){a=!0}});
...
g=ee(g);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),Pf()||"boolean"==typeof d?a.addEventListener(b,g,d):a.addEventListener(b,g,!!d.capture)):a.attachEvent("on"+b,g);Xa[e]=[a,b,c,g,d];return e}
function Qf(a){a&&("string"==typeof a&&(a=[a]),G(a,function(b){if(b in Xa){var c=Xa[b],d=c[0],e=c[1],f=c[3];c=c[4];d.removeEventListener?Pf()||"boolean"==typeof c?d.removeEventListener(e,f,c):d.removeEventListener(e,f,!!c.capture):d.detachEvent&&d.detachEvent("on"+e,f);delete Xa[b]}}))}
...
y("ytLoggingTransportDispatchedStats_",hg,void 0);y("ytytLoggingTransportCapturedTime_",z("ytLoggingTransportCapturedTime_")||{},void 0);function ig(){T(eg);T(fg);fg=0;if(!Ya(W)){for(var a in W){var b=dg[a];b&&(jg(a,b),delete W[a])}Ya(W)||kg()}}
...
function jg(a,b){var c=ag[a],d=hg[a]||{};hg[a]=d;var e=Math.round(U());for(l in W[a]){var f=bb,g=b.f;g={client:{hl:g.Ia,gl:g.Ha,clientName:g.Fa,clientVersion:g.Ga,configInfo:g.Ea}};var h=window.devicePixelRatio;h&&1!=h&&(g.client.screenDensityFloat=String(h));P("DELEGATED_SESSION_ID")&&!R("pageid_as_header_web")&&(g.user={onBehalfOfUser:P("DELEGATED_SESSION_ID")});f=f({context:g});f[c]=lg(a,l);d.dispatchedEventCount=d.dispatchedEventCount||0;d.dispatchedEventCount+=f[c].length;if(g=gg[l])a:{var k=
...
Ra(k.args))}catch(q){throw q.message="yt.pubsub2.Data.deserialize(): "+q.message,q;}}catch(q){throw q.message="yt.pubsub2.pubsub2 cross-binary conversion error for "+b.toString()+": "+q.message,q;}a.call(window,f)}catch(q){Q(q)}},yg[b.toString()]?z("yt.scheduler.instance")?qf(g):S(g,0):g())});
...
t(Gg,tg);var Cg=new ug("screen-created",Gg),Hg=[],Ig=0;function Jg(a,b,c){var d=Kg;b={csn:a,parentVe:rg(b),childVes:Na(c,function(f){return rg(f)})};
c=r(c);for(var e=c.next();!e.done;e=c.next())e=rg(e.value),(Ya(e)||!e.trackingParams&&!e.veType)&&Pe(Error("Child VE logged with no data"),"WARNING");c={da:void 0,P:a};"UNDEFINED_CSN"==a?Lg("visualElementAttached",b,c):pg("visualElementAttached",b,d,c)}
...
function Tg(a){var b=Qg.get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round(U())-d.requestTime)){var e=d.authState,f=Ng(Mg(!1));$a(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round(U())),mg(a,d.method,e,{}));delete b[c]}}Qg.set("requests",b,86400,!0)}}
...
y("yt_logging_screen.setCurrentScreen",bh,void 0);function ch(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=P("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=P("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=I(J(3,window.location.href));g&&f.push(g);g=I(J(3,d));if(0<=La(f,g)||!g&&0==d.lastIndexOf("/",0))if(R("autoescape_tempdata_url")&&(f=document.createElement("a"),Ib(f,d),d=f.href),d){g=d.match(jc);d=g[5];f=g[6];g=g[7];var h="";d&&(h+=d);f&&(h+="?"+f);g&&(h+="#"+g);d=h;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&(b.itct||b.ved)&&
...
;function dh(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||ab(b);this.assets=a.assets||{};this.attrs=a.attrs||ab(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
dh.prototype.clone=function(){var a=new dh,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==za(c)?a[b]=ab(c):a[b]=c}return a};function eh(){L.call(this);this.f=[]}
...
m.Z=function(a,b){var c=this,d=oh(this,b);if(d){if(!(0<=La(this.ta,a)||this.i[a])){var e=yh(this,a);this.C&&this.C(a,e)}this.D.subscribe(a,d);"onReady"==a&&this.A&&S(function(){d(c.api)},0)}};
...
;function Ch(a,b,c){c=void 0===c?{}:c;var d=Kg;P("ytLoggingEventsDefaultDisabled",!1)&&Kg==Kg&&(d=null);pg(a,b,d,c)}
;var Dh=z("ytLoggingLatencyUsageStats_")||{};y("ytLoggingLatencyUsageStats_",Dh,void 0);var Eh=0;function Fh(a){Dh[a]=Dh[a]||{count:0};var b=Dh[a];b.count++;b.time=U();Eh||(Eh=rf(Gh,0,5E3));if(5<b.count){if(6==b.count&&1>1E5*Math.random()){b=0==a.indexOf("info")?"WARNING":"ERROR";var c=Error("CSI data exceeded logging limit with key");c.params=a;Pe(c,b)}return!0}return!1}
function Gh(){var a=U(),b;for(b in Dh)6E4<a-Dh[b].time&&delete Dh[b];Eh=0}
;var X=window.performance||window.mozPerformance||window.msPerformance||window.webkitPerformance||{};function Hh(){var a=P("TIMING_TICK_EXPIRATION");a||(a={},O("TIMING_TICK_EXPIRATION",a));return a}
function Ih(){var a=Hh(),b;for(b in a)tf(a[b]);O("TIMING_TICK_EXPIRATION",{})}
;function Jh(a,b){tg.call(this,1,arguments)}
t(Jh,tg);function Kh(a,b){tg.call(this,1,arguments)}
t(Kh,tg);var Lh=new ug("aft-recorded",Jh),Mh=new ug("timing-sent",Kh);function Nh(){var a;(a=z("ytcsi.data_"))||(a={tick:{},info:{}},Ka("ytcsi.data_",a));return a}
function Oh(){var a=Nh();a.info||(a.info={});return a.info}
function Ph(){var a=Nh();a.tick||(a.tick={});return a.tick}
function Qh(){var a=Nh().nonce;a||(a=Vg(),Nh().nonce=a);return a}
...
function bi(){return!!R("csi_on_gel")||!!Nh().useGel}
function ci(){var a=Nh();if(!("gel"in a))a.gel={gelTicks:{},gelInfos:{}};else if(a.gel){var b=a.gel;b.gelInfos||(b.gelInfos={});b.gelTicks||(b.gelTicks={})}return a.gel}
;var di={vc:!0},ei=!1;
function fi(){Oh().yt_lt="hot_bg";if(bi()){var a="hot_bg";var b=ci();if(b.gelInfos)b.gelInfos.info_yt_lt=!0;else{var c={};b.gelInfos=(c.info_yt_lt=!0,c)}if("yt_lt"in Xh){b=Xh.yt_lt;0<=La(Yh,b)&&(a=!!a);"yt_lt"in $h&&"string"===typeof a&&(a=$h.yt_lt+a.toUpperCase());b=b.split(".");for(var d=c={},e=0;e<b.length-1;e++){var f=b[e];d[f]={};d=d[f]}d[b[b.length-1]]=a;a=Rh({},c)}else 0<=La(ai,"yt_lt")||(a=new Wh("Unknown label logged with GEL CSI"),a.params="yt_lt",fe(a)),a=void 0;a&&bi()&&(b=ci(),"gelInfos"in
b||(b.gelInfos={}),Rh(b.gelInfos,a),b=Qh(),c=Object.keys(a).join(""),Fh("info_"+c+"_"+b)||(a.clientActionNonce=b,Ch("latencyActionInfo",a)))}}
function gi(){var a=Ph();if(a.aft)return a.aft;for(var b=P("TIMING_AFT_KEYS",["ol"]),c=b.length,d=0;d<c;d++){var e=a[b[d]];if(e)return e}return NaN}
A(X.clearResourceTimings||X.webkitClearResourceTimings||X.mozClearResourceTimings||X.msClearResourceTimings||X.oClearResourceTimings||xa,X);function hi(){var a=Ph(),b=a.pbr,c=a.vc;a=a.pbs;return b&&c&&a&&b<c&&c<a&&1==Oh().yt_pvis}
function ii(){Ih();if(!bi()){var a=Ph(),b=Oh(),c=a._start;for(f in a)if(0==f.lastIndexOf("_",0)&&Aa(a[f])){var d=f.slice(1);if(d in di){var e=Na(a[f],function(l){return Math.round(l-c)});
...
k.charAt(0)&&(g=Math.round(a[k]-c),h[k]=g,e.push(k+"."+g));f.rt=e.join(",");(a=z("ytdebug.logTiming"))&&a(f,h);ji(f,!!b.ap);zg(Mh,new Kh(h.aft+(d||0),void 0))}}
...
Bi.prototype.o=function(){Qf(this.j);this.f=null;L.prototype.o.call(this)};function Ci(){var a=ab(Di),b;return ud(new M(function(c,d){a.onSuccess=function(e){re(e)?c(e):d(new Ei("Request failed, status="+e.status,"net.badstatus",e))};
...
t(Ji,F);Ji.prototype.name="BiscottiMissingError";var Di={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Ki=null;function ce(){if("1"===Va(ae(),"args","privembed"))return sd(Error("Biscotti ID is not available in private embed mode"));Ki||(Ki=ud(Ci().then(Li),function(a){return Mi(2,a)}));
return Ki}
...
;function Pi(a){if("1"!==Va(ae(),"args","privembed")){a&&be();try{Oi().then(function(){},function(){}),S(Pi,18E5)}catch(b){Q(b)}}}
...
var cj=ee(function(){var a=Ph(),b;(b=!R("use_first_tick"))||(b=!("ol"in Ph()));if(b){b="ol";X.mark&&(0==b.lastIndexOf("mark_",0)||(b="mark_"+b),X.mark(b));b=Rf();a.ol&&(a._ol=a._ol||[a.ol],a._ol.push(b));a.ol=b;a=Hh();if(b=a.ol)tf(b),a.ol=0;a=ci();a.gelTicks&&(a.gelTicks.tick_ol=!0);Rf();bi()?(a=Qh(),Fh("tick_ol_"+a)||Ch("latencyActionTicked",{tickName:"ol",clientActionNonce:a},{timestamp:void 0}),a=!0):a=!1;if(a=!a)a=!z("yt.timing.pingSent_");if(a&&(b=P("TIMING_ACTION",void 0),a=Ph(),z("ytglobal.timingready_")&&
b&&a._start&&(b=gi()))){ei||(zg(Lh,new Jh(Math.round(b-a._start),void 0)),ei=!0);b=!0;var c=P("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&ii()}}a=Qi.getInstance();c=!!((Ti("f"+(Math.floor(119/31)+1))||0)&67108864);b=1<window.devicePixelRatio;document.body&&Xc(document.body,"exp-invert-logo")&&(b&&!Xc(document.body,"inverted-hdpi")?(d=document.body,d.classList?d.classList.add("inverted-hdpi"):Xc(d,"inverted-hdpi")||(d.className+=0<d.className.length?" inverted-hdpi":
