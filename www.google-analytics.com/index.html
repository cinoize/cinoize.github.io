...
<html class="glue-flexbox" lang="en">
  ...
  <meta property="og:site_name" content="Google Marketing Platform">
    <meta property="og:description" content="Google Analytics gives you the tools you need to better understand your customers. You can then use those business insights to take action, such as improving your website, creating tailored audience lists, and more.">
            <meta property="og:image" content="https://marketingplatform.google.com/about/static/images/gmp/analytics-smb-hero.jpg">
...
<!-- Twitter card -->
  ...
  <meta name="twitter:title" content="Analytics Tools &amp; Solutions for Your Business - Google Analytics">
    <meta name="twitter:description" content="Google Analytics gives you the tools you need to better understand your customers. You can then use those business insights to take action, such as improving your website, creating tailored audience lists, and more.">
            <meta property="twitter:image" content="https://marketingplatform.google.com/about/static/images/gmp/analytics-smb-hero.jpg">
...
<base href="/about/">
  ...
  <body data-ng-controller="MainController as ctrl"
    ...
    <!-- End Google Tag Manager (noscript) --><!-- Google Cookie Consent Bar -->
      <script data-autoload-cookie-consent-bar="true"
              src="https://www.gstatic.com/brandstudio/kato/cookie_choice_component/cookie_consent_bar.v2.js"></script>
...
<div id="h-js-header__drawer" class="h-c-header__drawer" tabindex="0"
...
<div id="h-js-header__drawer-backdrop" class="h-c-header__drawer-backdrop"></div></div><main class="gmp-page gmp-page--no-newsletter">
...
<div class="secondary-hero">
  ...
  <div class="secondary-hero__background">
        ...
        <picture>
          ...
          <img src="static/images/gmp/analytics-smb-hero.jpg" alt="Get to know your customers." class="gmp-no-grab secondary-hero__image">
        </picture>
      </div>
    ...
    <div class="h-c-grid highlights-module__sticky-wrapper">
      ...
      <div class="h-c-grid__col h-c-grid__col-l--6">
        <div class="highlights-module__sticky-el">
                <img alt="See&amp;nbsp;what’s&amp;nbsp;in&amp;nbsp;it for&amp;nbsp;you." srcset="static/images/gmp/analytics-smb-benefit.jpg 1x, static/images/gmp/analytics-smb-benefit_2x.jpg 2x" src="static/images/gmp/analytics-smb-benefit.jpg" class="gmp-no-grab highlights-module__image-desktop">
      ...
      <img src="static/images/gmp/analytics-smb-benefit.jpg" alt="See&amp;nbsp;what’s&amp;nbsp;in&amp;nbsp;it for&amp;nbsp;you." class='gmp-no-grab highlights-module__image-mobile'>
    </picture>
        ...
        <div class="highlights-module__listing">
          <ul class="highlights-module__highlights">
              <li class="highlights-module__highlight">
                <picture>
   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" role="img" aria-label="landscape icon" class="gmp-circle-icon gmp-circle-icon--yellow highlights-module__icon">
    <title>landscape icon</title>
    <circle class="gmp-icon--accent" cx="22.5" cy="22.5" r="22.5"/>
      <path d="m35.9 29.57v-14.62a2.44 2.44 0 0 0 -2.44-2.44h-21.92a2.44 2.44 0 0 0 -2.44 2.44v14.62a2.44 2.44 0 0 0 2.44 2.43h21.92a2.44 2.44 0 0 0 2.44-2.43zm-17.66-6.7 3 3.66 4.31-5.53 5.45 7.35h-17z" fill="#fff"/>
   </svg>
 </picture>
                <h4 class="h-c-headline h-c-headline--four h-has-bottom-margin">Build a complete picture.</h3>
                <p>Understand your site and app users to better evaluate the performance of your marketing, content, products, and more.</p>
              </li>
              <li class="highlights-module__highlight">
                <picture>
   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" role="img" aria-label="bulb icon" class="gmp-circle-icon gmp-circle-icon--yellow highlights-module__icon">
    ...
    <circle class="gmp-icon--accent" cx="22.5" cy="22.5" r="22.5"/>
      <path d="m18.74 33a1.26 1.26 0 0 0 1.26 1.21h5a1.26 1.26 0 0 0 1.26-1.21v-1.29h-7.52zm3.76-23.84a8.71 8.71 0 0 0 -8.77 8.77 8.55 8.55 0 0 0 3.76 7.14v2.93a1.26 1.26 0 0 0 1.25 1.25h7.52a1.26 1.26 0 0 0 1.25-1.25v-2.93a8.9 8.9 0 0 0 3.76-7.14 8.71 8.71 0 0 0 -8.77-8.77z" fill="#fff"/>
                ...
                <h4 class="h-c-headline h-c-headline--four h-has-bottom-margin">Get insights only Google can give.</h3>
                <p>Access Google’s unique insights and machine learning capabilities to help get the most out of your data.</p>
              </li>
              <li class="highlights-module__highlight">
                <picture>
   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" role="img" aria-label="restart icon" class="gmp-circle-icon gmp-circle-icon--yellow highlights-module__icon">
    ...
    <circle class="gmp-icon--accent" cx="22.5" cy="22.5" r="22.5"/>
      <path d="m22.5 14.22v4l5.36-5.36-5.36-5.34v4a10.7 10.7 0 0 0 -9.06 16.48l2-2a7.87 7.87 0 0 1 -.94-3.75 8 8 0 0 1 8-8.03zm9.06 2.33-2 2a8 8 0 0 1 -7.06 11.75v-4l-5.36 5.36 5.36 5.34v-4a10.7 10.7 0 0 0 9.06-16.43z" fill="#fff"/>
                ...
                <h4 class="h-c-headline h-c-headline--four h-has-bottom-margin">Connect your insights to results.</h3>
              ...
              <li class="highlights-module__highlight">
                <picture>
   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" role="img" aria-label="checklist icon" class="gmp-circle-icon gmp-circle-icon--yellow highlights-module__icon">
    ...
    <circle class="gmp-icon--accent" cx="22.5" cy="22.5" r="22.5"/>
      <path d="m25 20h-16v2.67h16zm0-5.34h-16v2.67h16zm-16 13.34h10.68v-2.66h-10.68zm26-6 2 2-9.3 9.35-6-6 2-2 4 4z" fill="#fff"/>
                ...
                <h4 class="h-c-headline h-c-headline--four h-has-bottom-margin">Make your data work for you.</h3>
...
<div class="two-column-tout">
  <div class="h-c-page">
    ...
    data-g-label="dive into the details"
      ...
      <img src="static/images/gmp/analytics-smb-feature-tout.jpg" alt="Dive into the details." class='gmp-no-grab '>
    </picture>
        </div>
      </div>
...
<div class="highlights-module">
  <div class="h-c-page">
    ...
    <div class="h-c-grid highlights-module__sticky-wrapper">
      ...
      <div class="h-c-grid__col h-c-grid__col-l--6">
        <div class="highlights-module__sticky-el">
                <img alt="Designed to work together." srcset="static/images/gmp/analytics-smb-integration.jpg 1x, static/images/gmp/analytics-smb-integration_2x.jpg 2x" src="static/images/gmp/analytics-smb-integration.jpg" class="gmp-no-grab highlights-module__image-desktop">
      ...
      <img src="static/images/gmp/analytics-smb-integration.jpg" alt="Designed to work together." class='gmp-no-grab highlights-module__image-mobile'>
    </picture>
        ...
        <div class="highlights-module__listing">
          <ul class="highlights-module__highlights">
              <li class="highlights-module__highlight">
                <picture>
   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" role="img" aria-label="googleads icon" class="gmp-circle-icon gmp-circle-icon--white highlights-module__icon">
    ...
    <circle class="gmp-icon--accent" cx="22.5" cy="22.5" r="22.5"/>
      <rect width="45" height="45" fill="#ffffff"/><g transform="matrix(1.18, 0, 0, 1.18, -10, 1)"><path d="m9.28 16.03h17.59v8.8h-17.59z" fill="#fbbc04" transform="matrix(.5 -.8660254 .8660254 .5 -8.65 25.87)"/><path d="m35.09 25.85-8.8-15.24a4.4 4.4 0 1 0 -7.62 4.39l8.8 15.24a4.4 4.4 0 1 0 7.62-4.4z" fill="#4285f4"/><circle cx="13.68" cy="28.05" fill="#34a853" r="4.4"/></g>
                ...
                <h4 class="h-c-headline h-c-headline--four h-has-bottom-margin">Google Ads</h3>
                <p>Gain deeper insights into how users from your Google Ads campaigns engage with your site.</p>
              </li>
              <li class="highlights-module__highlight">
                <picture>
   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" role="img" aria-label="data-studio icon" class="gmp-circle-icon gmp-circle-icon--white highlights-module__icon">
    <title>data-studio icon</title>
    <circle class="gmp-icon--accent" cx="22.5" cy="22.5" r="22.5"/>
      <rect width="45" height="45" fill="#ffffff"/><g transform="matrix(1.18, 0, 0, 1.18, -10, 1)"><path d="m31.78 28h-9.35a3.29 3.29 0 0 0 -3.53 3.27 3.25 3.25 0 0 0 3.53 3.27h9.35z" fill="#669df6"/><ellipse cx="31.78" cy="31.24" fill="#1a73e8" rx="3.22" ry="3.27"/><path d="m22.13 19.27h-9.35a3.29 3.29 0 0 0 -3.53 3.27 3.25 3.25 0 0 0 3.53 3.27h9.35z" fill="#669df6"/><ellipse cx="22.13" cy="22.54" fill="#1a73e8" rx="3.22" ry="3.27"/><path d="m31.78 10.57h-9.35a3.29 3.29 0 0 0 -3.53 3.27 3.25 3.25 0 0 0 3.53 3.27h9.35z" fill="#669df6"/><ellipse cx="31.78" cy="13.84" fill="#1a73e8" rx="3.22" ry="3.27"/></g>
   </svg>
 </picture>
                <h4 class="h-c-headline h-c-headline--four h-has-bottom-margin">Data Studio</h3>
                <p>Connect Analytics with Data Studio to easily build performance dashboards and create customized reports.</p>
              </li>
              <li class="highlights-module__highlight">
                <picture>
   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" role="img" aria-label="optimize icon" class="gmp-circle-icon gmp-circle-icon--white highlights-module__icon">
    <title>optimize icon</title>
    <circle class="gmp-icon--accent" cx="22.5" cy="22.5" r="22.5"/>
      <rect width="45" height="45" fill="#ffffff"/><g transform="matrix(1.18, 0, 0, 1.18, -10, 1)"><path d="m26.47 22.89a3.61 3.61 0 0 0 -3.65-3.52h-9.4v7h6.09v5.92a3.46 3.46 0 0 0 3.26 3.71h.13a3.61 3.61 0 0 0 3.58-3.65z" fill="#b366f6"/><circle cx="13.37" cy="22.93" fill="#8430ce" r="3.56"/><path d="m35.15 13.45a3.58 3.58 0 0 0 -3.58-3.54h-9.57a3.58 3.58 0 0 0 0 7.09h6.16v5.92a3.52 3.52 0 0 0 7 .29q0-.14 0-.29z" fill="#c58af8"/></g>
   </svg>
 </picture>
                <h4 class="h-c-headline h-c-headline--four h-has-bottom-margin">Optimize</h3>
                <p>Create custom site experiences using the audiences you’ve already created in Analytics.</p>
              </li>
          </ul>
   ...
   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" role="img" aria-label="googleads icon" class="gmp-circle-icon gmp-circle-icon--white highlights-module__icon">
    ...
    <circle class="gmp-icon--accent" cx="22.5" cy="22.5" r="22.5"/>
      <rect width="45" height="45" fill="#ffffff"/><g transform="matrix(1.18, 0, 0, 1.18, -10, 1)"><path d="m9.28 16.03h17.59v8.8h-17.59z" fill="#fbbc04" transform="matrix(.5 -.8660254 .8660254 .5 -8.65 25.87)"/><path d="m35.09 25.85-8.8-15.24a4.4 4.4 0 1 0 -7.62 4.39l8.8 15.24a4.4 4.4 0 1 0 7.62-4.4z" fill="#4285f4"/><circle cx="13.68" cy="28.05" fill="#34a853" r="4.4"/></g>
                ...
                <p class="highlights-module__description">Gain deeper insights into how users from your Google Ads campaigns engage with your site.</p>
              </li>
              <li class="h-c-carousel__item">
                <picture>
   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" role="img" aria-label="data-studio icon" class="gmp-circle-icon gmp-circle-icon--white highlights-module__icon">
    ...
    <circle class="gmp-icon--accent" cx="22.5" cy="22.5" r="22.5"/>
      <rect width="45" height="45" fill="#ffffff"/><g transform="matrix(1.18, 0, 0, 1.18, -10, 1)"><path d="m31.78 28h-9.35a3.29 3.29 0 0 0 -3.53 3.27 3.25 3.25 0 0 0 3.53 3.27h9.35z" fill="#669df6"/><ellipse cx="31.78" cy="31.24" fill="#1a73e8" rx="3.22" ry="3.27"/><path d="m22.13 19.27h-9.35a3.29 3.29 0 0 0 -3.53 3.27 3.25 3.25 0 0 0 3.53 3.27h9.35z" fill="#669df6"/><ellipse cx="22.13" cy="22.54" fill="#1a73e8" rx="3.22" ry="3.27"/><path d="m31.78 10.57h-9.35a3.29 3.29 0 0 0 -3.53 3.27 3.25 3.25 0 0 0 3.53 3.27h9.35z" fill="#669df6"/><ellipse cx="31.78" cy="13.84" fill="#1a73e8" rx="3.22" ry="3.27"/></g>
                ...
                <h4 class="h-c-headline h-c-headline--four highlights-module__subhead">Data Studio</h4>
                <p class="highlights-module__description">Connect Analytics with Data Studio to easily build performance dashboards and create customized reports.</p>
              </li>
              <li class="h-c-carousel__item">
                <picture>
   <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" role="img" aria-label="optimize icon" class="gmp-circle-icon gmp-circle-icon--white highlights-module__icon">
    ...
    <circle class="gmp-icon--accent" cx="22.5" cy="22.5" r="22.5"/>
      <rect width="45" height="45" fill="#ffffff"/><g transform="matrix(1.18, 0, 0, 1.18, -10, 1)"><path d="m26.47 22.89a3.61 3.61 0 0 0 -3.65-3.52h-9.4v7h6.09v5.92a3.46 3.46 0 0 0 3.26 3.71h.13a3.61 3.61 0 0 0 3.58-3.65z" fill="#b366f6"/><circle cx="13.37" cy="22.93" fill="#8430ce" r="3.56"/><path d="m35.15 13.45a3.58 3.58 0 0 0 -3.58-3.54h-9.57a3.58 3.58 0 0 0 0 7.09h6.16v5.92a3.52 3.52 0 0 0 7 .29q0-.14 0-.29z" fill="#c58af8"/></g>
                ...
                <h4 class="h-c-headline h-c-headline--four highlights-module__subhead">Optimize</h4>
                <p class="highlights-module__description">Create custom site experiences using the audiences you’ve already created in Analytics.</p>
              </li>
          </ul>
  ...
  <div class="h-c-page">
    <div class="h-c-grid">
      ...
      <div class="h-c-grid__col h-c-grid__col--6 h-c-grid__col-l--4 h-c-grid__col--offset-1 compare-module__header">
        ...
        <h3 class="h-c-headline h-c-headline--one">Find a solution that fits.</h3>
        <p class="h-c-tile__description">Analytics offers small business and enterprise solutions to help you see what’s working and fix what’s not.</p>
          <p>    <a     data-g-event="product: analytics: overview"
...
<li class="h-c-carousel__item product-card">
                ...
                <div class="h-c-tile h-c-tile--border h-c-tile--hoverable h-c-tile--small-height product-card--active">
                  <div class="h-c-tile__header h-c-tile__header--icon product-card__header">
                    <picture>
    <svg id="analytics_icon_svg" data-name="analytics_icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" role="img" aria-label="analytics icon" class="gmp-product-icon gmp-product-icon--fixed">
      <title>GMP_Logo_analytics</title>
          <path class="yellow-1" d="M45.26,41.65a5.85,5.85,0,0,1-6.54,5.84,6,6,0,0,1-5.12-6.08V6.59A6,6,0,0,1,38.73.51a5.85,5.85,0,0,1,6.53,5.84Z"/><path class="yellow-2" d="M8.57,35.88a5.83,5.83,0,1,1-5.83,5.83A5.83,5.83,0,0,1,8.57,35.88ZM23.91,18.21a6,6,0,0,0-5.67,6.13V40c0,4.25,1.87,6.83,4.61,7.38a5.84,5.84,0,0,0,7-5.74V24.07A5.85,5.85,0,0,0,23.91,18.21Z"/>
                  ...
                  <div class="h-c-tile__body">
                    ...
                    <p class="h-c-tile__description">Get a complete view of your customers for better insights to grow your business — for free.</p>
                  </div>
                </div>
      ...
      <title>GMP_Logo_analytics</title>
          <path class="yellow-1" d="M45.26,41.65a5.85,5.85,0,0,1-6.54,5.84,6,6,0,0,1-5.12-6.08V6.59A6,6,0,0,1,38.73.51a5.85,5.85,0,0,1,6.53,5.84Z"/><path class="yellow-2" d="M8.57,35.88a5.83,5.83,0,1,1-5.83,5.83A5.83,5.83,0,0,1,8.57,35.88ZM23.91,18.21a6,6,0,0,0-5.67,6.13V40c0,4.25,1.87,6.83,4.61,7.38a5.84,5.84,0,0,0,7-5.74V24.07A5.85,5.85,0,0,0,23.91,18.21Z"/>
                  ...
                  <div class="h-c-tile__body">
                    ...
                    <p class="h-c-tile__description">Get a complete view of your audience with advanced tools for deeper insights.</p>
                      <ul class="h-c-tile__links">
                        <li class="h-c-tile__link">
                          <svg role="img" class="h-c-tile__link h-c-tile__link--arrow">
  ...
  <div class="h-c-page">
    ...
    <div class="h-c-grid">
      ...
      <div class="h-c-grid__col h-c-grid__col-xl--offset-1 h-c-grid__col-l--6 h-c-grid__col-xl--5  h-c-grid__col--align-middle two-column-tout__content">
        ...
        <h3 class="h-c-headline h-c-headline--one">Mumzworld reaches a 300% return on ad spend with Google Analytics.</h3>
        <p class="h-u-mb-std two-column-tout__description">Mumzworld used Analytics to gain insight into their return on advertising investment and make sense of their retail data to improve product availability. The result was a 300% return on ad spend.</p>
              <a     data-g-event="product: analytics: overview"
    data-g-action="resource featured: case study"
    data-g-label="resource: mumzworld reaches a 300 percent return on ad spend with google analytics"
    data-g-restype="case study"      data-g-resproduct="analytics" 
        href="/about/resources/mumzworld-reaches-return-on-ad-spend-with-analytics/"
        title="Read more"
        class="h-c-link h-c-link--internal gmp-link"
         >Read more</a>
      </div>
      ...
      <div class="h-c-grid__col h-c-grid__col-l--6  h-c-grid__col--align-middle">
        <div class="two-column-tout__image">
              <picture>
      <source media="(max-width: 767px)" srcset="static/images/gmp/analytics-smb-featured-resource-mobile.jpg 1x, static/images/gmp/analytics-smb-featured-resource-mobile_2x.jpg 2x">
      <source media="(min-width: 768px)" srcset="static/images/gmp/analytics-smb-featured-resource.jpg 1x, static/images/gmp/analytics-smb-featured-resource_2x.jpg 2x">
      <img src="static/images/gmp/analytics-smb-featured-resource.jpg" alt="Mumzworld reaches a 300% return on ad spend with Google Analytics." class='gmp-no-grab '>
    </picture>
        </div>
      </div>
...
<div class="h-c-social__group">
    ...
    data-g-label="global footer"
                  ...
                  target="_blank" >
                <svg role="img" aria-hidden="true" class="h-c-icon h-c-icon--20px h-c-icon--social h-c-icon--no-padding">
...
>
      ...
      <div class="h-c-footer__site-links-grid">
          <div class="h-c-footer__site-links-column glue-a-zippy--v-smooth-expand" id="column-1">
              <h4 class="h-c-footer__site-links-header ">
                ...
                <svg role="img" aria-hidden="true" class="h-c-icon h-c-icon--32px h-c-icon--footer h-c-footer__expand">
 ...
 >Business Solutions</a>
                    ...
                    <li class="h-c-footer__site-links-list-item">
                          <a     data-g-event="product: analytics: overview"
    data-g-action="more from google: g suite"
    data-g-label="global footer"

        href="https://gsuite.google.com/?utm_source=marketingplatform.google.com&utm_medium=et&utm_campaign=marketingplatform.google.com%2Fabout%2Fanalytics%2F"
        title="G Suite"
        class="h-c-footer__link"
            target="_blank"
 >G Suite</a>
  ...
  <section class="h-c-footer__global">
    ...
    data-g-label="global footer"
          ...
          class="">
        <svg role="img" aria-hidden="true" class="h-c-footer__logo-img">
