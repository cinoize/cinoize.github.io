(function($) {
  Drupal.behaviors.mobilemenu = {
    attach: function (context) {
    	$('#block-mobilemenu-mobilemenu h2,#block-mobilemenu-mobilemenu li.close').click(function(){
    		console.log('open/close: ' + parseInt($('ul.mobile-menu').css('left')));
    		$('ul.mobile-menu').slideToggle(200);
