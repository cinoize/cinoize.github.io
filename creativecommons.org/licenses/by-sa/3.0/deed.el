...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:cc="http://creativecommons.org/ns#" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:dct="http://purl.org/dc/terms/" xmlns:frbr="http://purl.org/vocab/frbr/core#" xml:lang="el">
<head about="http://creativecommons.org/licenses/by-sa/3.0/">
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
<meta http-equiv="Content-Type" content="application/xhtml+xml; charset=utf-8" />
<title>Creative Commons &mdash; Αναφορά Δημιουργού - Παρόμοια Διανομή 3.0 Μη εισαγόμενο
...
<button id="menu-toggle" class="menu-toggle"><i class="cc-icon-menu"></i> <span>Μενού</span></button>
<div id="site-header-menu" class="site-header-menu">
<nav id="mobile-navigation" class="mobile-navigation" role="navigation" aria-label="Mobile Menu">
<div class="menu-mobile-menu-container"><ul id="menu-mobile-menu" class="mobile-menu">
<li id="menu-item-48798" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48798"><a href="https://creativecommons.org/share-your-work/">Πραγματοποιείστε Διαμοιρασμό του έργου σας</a></li>
<li id="menu-item-48799" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48799"><a href="https://creativecommons.org/use-remix/">Χρήση και Επεξεργασία</a></li>
...
<li id="menu-item-48801" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48801"><a href="https://creativecommons.org/blog/">Ιστολόγιο</a></li>
...
<li id="menu-item-48803" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48803"><a href="https://creativecommons.org/use-remix/search-the-commons/">Αναζητείστε Υλικό Creative Commons</a></li>
</ul></div>
</nav>
<nav id="site-navigation" class="main-navigation" role="navigation" aria-label="Primary Menu">
<div class="menu-primary-menu-container"><ul id="menu-primary-menu" class="primary-menu">
<li id="menu-item-48791" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48791"><a href="https://creativecommons.org/share-your-work/">Πραγματοποιείστε Διαμοιρασμό του έργου σας</a></li>
<li id="menu-item-48792" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48792"><a href="https://creativecommons.org/use-remix/">Χρήση και Επεξεργασία</a></li>
...
<li id="menu-item-48793" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48793"><a href="https://creativecommons.org/blog/">Ιστολόγιο</a></li>
</ul></div>
</nav>
...
<li id="menu-item-48806" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48806"><a href="https://creativecommons.org/about/contact/">Επικοινωνία</a></li>
</ul></div>
</nav>
...
<li id="menu-item-48809" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-48809"><a href="mailto:info@creativecommons.org"><span class="screen-reader-text">Ηλεκτρονικό Ταχυδρομίο</span></a></li>
</ul></div>
</nav>
</div>
</div>
...
<p class="donate-text">Βοηθείστε μας να δημιουργήσουμε ένα βιώσιμο, διεπιστημονικό διεθνές δίκτυο κοινών.</p>
<div class="donate-action"><a href="https://us.netdonor.net/page/6650/donate/1?ea.tracking.id=deed-top" class="button donate arrow">Δωρεά<span class="hide-on-mobile"> Τώρα</span></a></div>
</div>
</div>
</div>
</section>
...
<h1><span>Πράξη Κοινών Creative Commons</span></h1>
<div id="deed-license">
<h2>
...
<span class="cc-license-title" property="dc:title dct:title">Αναφορά Δημιουργού - Παρόμοια Διανομή 3.0 Μη εισαγόμενο</span>
...
<h3 style="text-align: center" resource="http://creativecommons.org/ns#Reproduction" rel="cc:permits">Μπορείτε να:</h3>
...
<img src="/images/deed/FreeCulturalWorks_seal_x2.jpg" style="border: 0" alt="Αυτή η άδεια είναι αποδεκτή για Ελεύθερα " />
</a>
...
<li class="license">Ο αδειοδότης δεν μπορεί να ανακαλέσει αυτές τις ελευθερίες όσο εσείς ακολουθείτε τους όρους της άδειας.</li>
</ul>
</div>
...
<li class="license by">
<p>
<strong>Αναφορά Δημιουργού</strong> &mdash; <span rel="cc:requires" resource="http://creativecommons.org/ns#Attribution">Θα πρέπει να καταχωρίσετε <a href="#" id="appropriate_credit_popup" class="helpLink"> αναφορά στο δημιουργό </a> , με σύνδεσμο της άδειας, και <span rel="cc:cc:requires" resource="http://creativecommons.org/ns#Notice"> <a href="#" id="indicate_changes_popup" class="helpLink"> με αναφορά αν έχουν γίνει αλλαγές </a> . Μπορείτε να το κάνετε αυτό με οποιονδήποτε εύλογο τρόπο, αλλά όχι με τρόπο που να υπονοεί ότι ο δημιουργός αποδέχεται το έργο σας ή τη χρήση που εσείς κάνετε.
<span id="by-more-container"></span>
</p>
<p id="work-attribution-container" style="display:none;">
<strong>
Κάντε Αναφορά Δημιουργού σ'αυτό το έργο:
</strong>
<br />
...
<img src="/images/information.png" alt="Πληροφορία" />
</a>
</p>
</li>
<li class="license sa" rel="cc:requires" resource="http://creativecommons.org/ns#ShareAlike">
<p>
<strong>Παρόμοια Διανομή</strong> &mdash; Αν αναμείξετε, τροποποιήσετε, ή δημιουργήσετε πάνω στο υλικό, πρέπει ν δινείμετε τις δικές σας συνεισφορές υπό την <a href="#" id="same_license_popup" class="helpLink">ίδια άδεια</a> όπως και το πρωτότυπο.
...
<li class="license">
<strong>Δεν υπάρχουν πρόσθετοι περιορισμοί</strong> &mdash; Δε μπορείτε να εφαρμόσετε νομικούς όρους ή <a href="#" id="technological_measures_popup" class="helpLink">τεχνολογικά μέτρα</a> που να περιορίζουν νομικά τους άλλους από το να κάνουν ο,τιδήποτε επιτρέπει η άδεια.
</li>
</ul>
</div>
<div class="row"><div class="col-md-offset-1 col-md-10"><hr /></div></div>
...
<li class="license">
Δεν παρέχεται καμία εγγύηση. Η άδεια μπορεί να μη σας δίνει όλα τα απαραίτητα δικαιώματα για τη χρήση που σκοπεύετε. Για παράδειγμα, άλλα δικιώματα, όπως <a href="#" id="publicity_privacy_or_moral_rights_popup" class="helpLink">διαφήμιση, ιδιωτικότητα, ή ηθικά δικαιώματα</a> μπορεί να περιορίσουν το πως χρησιμοποιείτε το υλικό.
</li>
</ul>
</div>
...
<a href="https://wiki.creativecommons.org/FAQ">Μάθετε περισσότερα</a> σχετικά με την CC αδειοδότηση ή <a id="get_this" href="/choose/results-one?license_code=by-sa&amp;amp;jurisdiction=&amp;amp;version=3.0&amp;amp;lang=el">χρησιμοποιήστε την άδεια</a> σε δικό σας υλικό.
</p>
<noscript>
                  <div id="deed-donate-footer">
                    <div class="footer-trigger">
                      ...
                      <div class="footer-trigger-content">
                        <p>Οι εν λόγω άδειες και τα εργαλεία προσφέρονται ελεύθερα στο κοινό με απλοποιημένους νομικούς όρους, εξαιτίας του μη κερδοσκοπικού χαρακτήρα τoυ οργανισμού Creative Commons, ο οποίος συντηρείται με δωρεές. Εάν σας αρέσουν οι παρεχόμενες από εμάς άδειες και τα εργαλεία και υποστηρίζετε την ελεύθερη διάθεσή τους σε όλους, συμβάλετε κι εσείς και υποστηρίξτε τη δράση μας με μία δωρεά.</p>
...
<p class="desktop-only">Οι εν λόγω άδειες και τα εργαλεία προσφέρονται ελεύθερα στο κοινό με απλοποιημένους νομικούς όρους, εξαιτίας του μη κερδοσκοπικού χαρακτήρα τoυ οργανισμού Creative Commons, ο οποίος συντηρείται με δωρεές. Εάν σας αρέσουν οι παρεχόμενες από εμάς άδειες και τα εργαλεία και υποστηρίζετε την ελεύθερη διάθεσή τους σε όλους, συμβάλετε κι εσείς και υποστηρίξτε τη δράση μας με μία δωρεά.</p>
<p class="mobile-only">Όταν μοιράζεσαι, όλοι βγαίνουν κερδισμένοι.</p>
...
<label class="gfield_label">Συμβάλλετε σήμερα στον οργανισμό Creative Commons</label>
...
<input name="transaction.donationAmt.other" type="text" id="input_10_1_other" tabindex="5" style="max-width: 80%" placeholder="Ποσό" aria-label="Ποσό">
</li>
</ul>
<input type="hidden" name="type" value="One Time">
<input type="hidden" name="ea.tracking.id" value="deed-overlay">
<input type="submit" id="gform_submit_button_10" class="gform_button button" value="Κάντε μια δωρεά τώρα" tabindex="6">
</div>
</div>
 </form>
</div>
...
<li id="menu-item-48794" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48794"><a href="https://creativecommons.org/about/contact/">Επικοινωνία</a></li>
<li id="menu-item-48795" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48795"><a href="https://creativecommons.org/privacy/">Προστασία Προσωπικών Δεδομένων</a></li>
<li id="menu-item-48796" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48796"><a href="https://creativecommons.org/policies/">Πολιτικές</a></li>
<li id="menu-item-48797" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48797"><a href="https://creativecommons.org/terms/">Όροι</a></li>
</ul>
</div>
</div>
</div>
<div class="column cc-footer-contact">
<h6><a href="https://creativecommons.org/about/contact">Περιμένουμε νέα σας!</a></h6>
<address>
Creative Commons<br />
...
<li><a href="https://creativecommons.org/faq">Συχνές ερωτήσεις</a></li>
</ul>
</div>
...
<div class="bd">
<p>Η σελίδα από την οποία προήλθατε περιέχει ενσωματωμένα μεταδεδομένα χορήγησης αδειών, συμπεριλαμβανομένων δεδομένων για το πώς ο δημιουργός επιθυμεί να αναφέρεται σε περαιτέρω χρήση. Μπορείτε να χρησιμοποιήσετε τον κώδικα HTML, εδώ για να αναφέρετε το έργο. Με αυτόν τον τρόπο θα περιλαμβάνονται μεταδεδομένα για την ιστοσελίδα σας έτσι ώστε οι άλλοι μπορούν να βρουν το πρωτότυπο έργο, επίσης.</p>
</div>
</div>
<div id="help_mediation_and_arbitration_popup" class="help_panel">
<div class="bd">
<p>Οι ισχύοντες κανόνες διαμεσολάβησης θα υποδεικνύονται στη σημείωση copyright που δημοσιεύεται με το έργο, ή αν δεν υπάρχει καμία τέτοια, τότε στο αίτημα για διαμεσολάβηση. Εκτός και αν, σε κάποια σημείωση copyright που είναι επισυνημμένη στο έργο, έχει υποδειχθεί διαφορετικά, θα ισχύουν οι κανόνες Διαμεσολάβησης UNCITRAL που ισχύουν σε κάθε διαμεσολάβηση.</p>
<p><a href="https://wiki.creativecommons.org/Intergovernmental_Organizations#What_should_I_know_before_I_use_a_work_licensed_under_the_IGO_3.0_ported_licenses.3F">Περισσότερες πληροφορίες</a>.</p>
</div>
</div>
<div id="help_appropriate_credit_popup" class="help_panel">
<div class="bd">
<p>Εάν υπάρχουν, πρέπει να δώσετε το όνομα του αρχικού δημιουργού και τα ονόματα τρίτων, ανφορά στα πνευματικά δικαιώματα, την αρχική άδεια, αποποίησης ευθύνης και σύνδεσμο στο υλικό. Οι άδειες CC πριν από την έκδοση 4.0 απαιτούν να παρέχετε τον τίτλο του υλικού.</p>
<p><a href="https://wiki.creativecommons.org/License_Versions#Detailed_attribution_comparison_chart">Περισσότερες πληροφορίες</a>.</p>
</div>
</div>
<div id="help_indicate_changes_popup" class="help_panel">
<div class="bd">
<p>Στην έκδοση 4.0, πρέπει να υποδείξετε εάν τροποποιήσατε το υλικό και διατηρήσατε μια ένδειξη για τις προηγούμενες τροποποιήσεις. Στην έκδοση 3.0 και στις προγενέστερες εκδόσεις της αδείας, η ένδειξη των αλλαγών απαιτείται μόνο αν δημιουργήσατε ένα παράγωγο έργο.</p>
<p><a href="https://wiki.creativecommons.org/Best_practices_for_attribution#This_is_a_good_attribution_for_material_you_modified_slightly">Οδηγός σήμανσης</a>.</p>
<p><a href="https://wiki.creativecommons.org/License_Versions#Modifications_and_adaptations_must_be_marked_as_such ">Περισσότερες πληροφορίες</a>.</p>
</div>
</div>
<div id="help_same_license_popup" class="help_panel">
<div class="bd">
<p>Μπορείτε επίσης να χρησιμοποιήσετε μια άδεια καταχωρημένη ως συμβατή στο <a href="https://creativecommons.org/compatiblelicenses">https://creativecommons.org/compatiblelicenses</a></p>
<p><a href="https://wiki.creativecommons.org/FAQ#If_I_derive_or_adapt_material_offered_under_a_Creative_Commons_license.2C_which_CC_license.28s.29_can_I_use.3F">Περισσότερες πληροφορίες</a>.</p>
</div>
</div>
<div id="help_commercial_purposes_popup" class="help_panel">
<div class="bd">
<p>Ως εμπορική χρήση νοείται πρωτίστως εκείνη που αποσκοπεί στον προσπορισμό ενός εμπορικού πλεονεκτήματος ή μιας χρηματικής ανταμοιβής.</p>
<p><a href="https://wiki.creativecommons.org/Frequently_Asked_Questions#Does_my_use_violate_the_NonCommercial_clause_of_the_licenses.3F">Περισσότερες πληροφορίες</a>.</p>
</div>
</div>
<div id="help_some_kinds_of_mods_popup" class="help_panel">
<div class="bd">
<p>Η απλή αλλαγή του φορμά δεν δημιουργεί ένα παράγωγο.</p>
<p><a href="https://wiki.creativecommons.org/Frequently_Asked_Questions#When_is_my_use_considered_an_adaptation.3F">Περισσότερες πληροφορίες</a>.</p>
</div>
</div>
<div id="help_technological_measures_popup" class="help_panel">
<div class="bd">
<p>Η άδεια απαγορεύει τη εφαρμογή αποτελεσματικών τεχνολογικών μέτρων, που ορίζονται με αναφορά στο Άρθρο 11 της Συνθήκης της Παγκόσμιας Οργάνωσης για την Προστασία της Πνευματικής Ιδιοκτησίας/ WIPO, σχετικά με το Copyright.</p>
<p><a href="https://wiki.creativecommons.org/License_Versions#Application_of_effective_technological_measures_by_users_of_CC-licensed_works_prohibited">Περισσότερες πληροφορίες</a>.</p>
</div>
</div>
<div id="help_exception_or_limitation_popup" class="help_panel">
<div class="bd">
<p>Τα δικαιώματα των χρηστών, πέραν των εξαιρέσεων και των περιορισμών όπως η ορθή χρήση και διανομή, δεν επηρεάζονται από τις άδειες της CC. </p>
<p><a href="https://wiki.creativecommons.org/Frequently_Asked_Questions#Do_Creative_Commons_licenses_affect_exceptions_and_limitations_to_copyright.2C_such_as_fair_dealing_and_fair_use.3F">Περισσότερες πληροφορίες</a>.</p>
</div>
</div>
<div id="help_publicity_privacy_or_moral_rights_popup" class="help_panel">
<div class="bd">
<p>Ενδέχεται να πρέπει να λάβετε περαιτέρω αδειοδότηση πριν χρησιμοποιήσετε αυτό το υλικό όπως επιθυμείτε.</p>
<p><a href="https://wiki.creativecommons.org/Considerations_for_licensors_and_licensees">Περισσότερες πληροφορίες</a>.</p>
</div>
</div>
</div>
...
<script type='text/javascript'>
  /* <![CDATA[ */
  var screenReaderText = {"expand":"Παιδικό μενού","collapse":"Ελαχιστοποίηση παιδικού μενού"};
  /* ]]> */
  </script>
