...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:cc="http://creativecommons.org/ns#" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:dct="http://purl.org/dc/terms/" xmlns:frbr="http://purl.org/vocab/frbr/core#" xml:lang="cs">
<head about="http://creativecommons.org/licenses/by-sa/3.0/">
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
<meta http-equiv="Content-Type" content="application/xhtml+xml; charset=utf-8" />
<title>Creative Commons &mdash; Uveďte původ-Zachovejte licenci 3.0 Unported
...
<li id="menu-item-48798" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48798"><a href="https://creativecommons.org/share-your-work/">Sdílejte svou práci</a></li>
<li id="menu-item-48799" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48799"><a href="https://creativecommons.org/use-remix/">Použijte &#038; remixujte</a></li>
...
<li id="menu-item-48803" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48803"><a href="https://creativecommons.org/use-remix/search-the-commons/">Hledejte v Commons</a></li>
</ul></div>
</nav>
<nav id="site-navigation" class="main-navigation" role="navigation" aria-label="Primary Menu">
<div class="menu-primary-menu-container"><ul id="menu-primary-menu" class="primary-menu">
<li id="menu-item-48791" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48791"><a href="https://creativecommons.org/share-your-work/">Sdílejte svou práci</a></li>
<li id="menu-item-48792" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48792"><a href="https://creativecommons.org/use-remix/">Použijte &#038; remixujte</a></li>
...
<li id="menu-item-48809" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-48809"><a href="mailto:info@creativecommons.org"><span class="screen-reader-text">Email</span></a></li>
</ul></div>
</nav>
</div>
</div>
...
<p class="donate-text">Pomozte nám vybudovat živou, společnou globální komunitu</p>
<div class="donate-action"><a href="https://us.netdonor.net/page/6650/donate/1?ea.tracking.id=deed-top" class="button donate arrow">Darovat<span class="hide-on-mobile"> Teď</span></a></div>
</div>
</div>
</div>
</section>
...
<h1><span>Zkrácené znění licence Creative Commons</span></h1>
<div id="deed-license">
<h2>
...
<span class="cc-license-title" property="dc:title dct:title">Uveďte původ-Zachovejte licenci 3.0 Unported</span>
...
<h3 style="text-align: center" resource="http://creativecommons.org/ns#Reproduction" rel="cc:permits">Dílo smíte:</h3>
...
<img src="/images/deed/FreeCulturalWorks_seal_x2.jpg" style="border: 0" alt="Tato licence je vhodná pro díla Svobodné kultury" />
</a>
...
<li class="license by">
<p>
<strong>Uveďte původ</strong> &mdash; <span rel="cc:requires" resource="http://creativecommons.org/ns#Attribution">Je Vaší povinností <a href="#" id="appropriate_credit_popup" class="helpLink">uvést autorství</a>, poskytnout s dílem odkaz na licenci a <span rel="cc:requires" resource="http://creativecommons.org/ns#Notice"><a href="#" id="indicate_changes_popup" class="helpLink">vyznačit Vámi provedené změny</a>. Toho můžete docílit jakýmkoli rozumným způsobem, nicméně nikdy ne způsobem naznačujícím, že by poskytovatel licence schvaloval nebo podporoval Vás nebo Váš způsob užití díla.
...
<img src="/images/information.png" alt="Informace" />
</a>
</p>
</li>
<li class="license sa" rel="cc:requires" resource="http://creativecommons.org/ns#ShareAlike">
<p>
<strong>Zachovejte licenci</strong> &mdash; Pokud budete toto dílo upravovat, pozměňovat nebo na něj navazovat, musíte svoje odvozená díla vystavovat pod <a href="#" id="same_license_popup" class="helpLink">stejnou licencí</a> jako původní dílo.
...
<li class="license">
<strong>Žádná další omezení</strong> &mdash; Nesmíte použít právní omezení nebo <a href="#" id="technological_measures_popup" class="helpLink">účinné technické prostředky ochrany</a>, které by omezovaly ostatní v možnostech poskytnutých touto licencí.
</li>
</ul>
</div>
<div class="row"><div class="col-md-offset-1 col-md-10"><hr /></div></div>
...
<a href="https://wiki.creativecommons.org/FAQ">Zjistěte více</a> o licencích Creative Commons nebo <a id="get_this" href="/choose/results-one?license_code=by-sa&amp;amp;jurisdiction=&amp;amp;version=3.0&amp;amp;lang=cs"> použijte CC licenci</a> pro vlastní obsah.
</p>
<noscript>
                  <div id="deed-donate-footer">
                    <div class="footer-trigger">
                      ...
                      <div class="footer-trigger-content">
                        <p>Tento obsah je volně dostupný díky jednoduchým právním podmínkám organizace Creative Commons, neziskové organizaci, která může existovat pouze díky příspěvkům dárců. Pokud se Vám tato iniciativa líbí a líbí se Vám, že je pro všechny zdarma, zvažte prosím, že podpoříte tuto činnost svým příspěvkem.</p>
...
<p class="desktop-only">Tento obsah je volně dostupný díky jednoduchým právním podmínkám organizace Creative Commons, neziskové organizaci, která může existovat pouze díky příspěvkům dárců. Pokud se Vám tato iniciativa líbí a líbí se Vám, že je pro všechny zdarma, zvažte prosím, že podpoříte tuto činnost svým příspěvkem.</p>
<p class="mobile-only">Když sdílíte, každý vyhrává.</p>
...
<label class="gfield_label">Přispějte Creative Commons</label>
...
<input name="transaction.donationAmt.other" type="text" id="input_10_1_other" tabindex="5" style="max-width: 80%" placeholder="Množství" aria-label="Množství">
</li>
</ul>
<input type="hidden" name="type" value="One Time">
<input type="hidden" name="ea.tracking.id" value="deed-overlay">
<input type="submit" id="gform_submit_button_10" class="gform_button button" value="Přispět nyní" tabindex="6">
</div>
</div>
</form>
</div>
...
<li id="menu-item-48795" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48795"><a href="https://creativecommons.org/privacy/">Soukromí</a></li>
<li id="menu-item-48796" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48796"><a href="https://creativecommons.org/policies/">Zásady</a></li>
<li id="menu-item-48797" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48797"><a href="https://creativecommons.org/terms/">Podmínky</a></li>
</ul>
</div>
</div>
</div>
<div class="column cc-footer-contact">
<h6><a href="https://creativecommons.org/about/contact">Ozvěte se nám!</a></h6>
<address>
Creative Commons<br />
...
<li><a href="https://creativecommons.org/faq">Často kladené dotazy</a></li>
</ul>
</div>
...
<div class="bd">
<p>Stránka, ze které jste přišli, obsahovala digitální kód, který specifikuje způsob, jak si autor přeje být citován při šíření jeho díla. Můžete využít tento HTML kód jeho vložením do zdrojového kódu stránek, na kterých budete toto dílo šířit. Na stránkách se zobrazí požadované informace tak, aby ostatní lidé mohli nalézt cestu k původnímu dílu.</p>
</div>
</div>
<div id="help_mediation_and_arbitration_popup" class="help_panel">
<div class="bd">
<p>Použitelná pravidla mimosoudního řešení sporů budou určena v autorské doložce vydané spolu s dílem, popřípadě v návrhu na mimosoudní řešení sporu. Nebude-li stanoveno v autorské doložce jinak, na jakékoli spory se použije rozhodčí řád UNCITRAL.</p>
<p><a href="https://wiki.creativecommons.org/Intergovernmental_Organizations#What_should_I_know_before_I_use_a_work_licensed_under_the_IGO_3.0_ported_licenses.3F">Více informací</a>.</p>
</div>
</div>
<div id="help_appropriate_credit_popup" class="help_panel">
<div class="bd">
<p>Pokud jsou následující informace známé, musíte uvést: jméno autora a spoluautorů, informace o autorských právech, informace o licenci, prohlášení o vyloučení odpovědnosti a odkaz na dílo. Licence předcházející verzi 4.0 zároveň požadují, aby byl uveden název materiálu, pokud je znám, a mohou mít i další drobné odlišné požadavky.</p>
<p><a href="https://wiki.creativecommons.org/License_Versions#Detailed_attribution_comparison_chart">Více informací</a>.</p>
</div>
</div>
<div id="help_indicate_changes_popup" class="help_panel">
<div class="bd">
<p>Ve verzi 4.0 musíte uvést, zda jste dílo upravili a zároveň zachovat záznamy o předchozích úpravách. Ve verzi 3.0 a předešlých verzích licencí musíte zaznamenat změny pouze v případě, že jste vytvořili odvozené dílo.</p>
<p><a href="https://wiki.creativecommons.org/Best_practices_for_attribution#This_is_a_good_attribution_for_material_you_modified_slightly">Průvodce označením</a>.</p>
<p><a href="https://wiki.creativecommons.org/License_Versions#Modifications_and_adaptations_must_be_marked_as_such ">Více informací</a>.</p>
</div>
</div>
<div id="help_same_license_popup" class="help_panel">
<div class="bd">
<p>Můžete použít také licenci uvedenou jako kompatibilní v tomto seznamu: <a href="https://creativecommons.org/compatiblelicenses">https://creativecommons.org/compatiblelicenses</a></p>
<p><a href="https://wiki.creativecommons.org/FAQ#If_I_derive_or_adapt_material_offered_under_a_Creative_Commons_license.2C_which_CC_license.28s.29_can_I_use.3F">Více informací</a>.</p>
</div>
</div>
<div id="help_commercial_purposes_popup" class="help_panel">
<div class="bd">
<p>Komerčním využitím se rozumí použít dílo za účelem obchodního zisku nebo peněžní odměny.</p>
<p><a href="https://wiki.creativecommons.org/Frequently_Asked_Questions#Does_my_use_violate_the_NonCommercial_clause_of_the_licenses.3F">Více informací</a>.</p>
</div>
</div>
<div id="help_some_kinds_of_mods_popup" class="help_panel">
<div class="bd">
<p>Pouhá změna formátu nikdy nevytváří odvozené dílo.</p>
<p><a href="https://wiki.creativecommons.org/Frequently_Asked_Questions#When_is_my_use_considered_an_adaptation.3F">Více informací</a>.</p>
</div>
</div>
<div id="help_technological_measures_popup" class="help_panel">
<div class="bd">
<p>Tato licence zakazuje použití účinných technologických prostředků ve smyslu článku 11 Smlouvy WIPO o právu autorském.</p>
<p><a href="https://wiki.creativecommons.org/License_Versions#Application_of_effective_technological_measures_by_users_of_CC-licensed_works_prohibited">Více informací</a>.</p>
</div>
</div>
<div id="help_exception_or_limitation_popup" class="help_panel">
<div class="bd">
<p>Práva uživatelů díla plynoucí z volného užití díla nejsou licencí Creative Commons dotčena.</p>
<p><a href="https://wiki.creativecommons.org/Frequently_Asked_Questions#Do_Creative_Commons_licenses_affect_exceptions_and_limitations_to_copyright.2C_such_as_fair_dealing_and_fair_use.3F">Více informací</a>.</p>
</div>
</div>
<div id="help_publicity_privacy_or_moral_rights_popup" class="help_panel">
<div class="bd">
<p>Je možné, že budete potřebovat získat další povolení, než budete moci dílo použít, jak máte v úmyslu.</p>
<p><a href="https://wiki.creativecommons.org/Considerations_for_licensors_and_licensees">Více informací</a>.</p>
</div>
</div>
</div>
...
<script type='text/javascript'>
  /* <![CDATA[ */
  var screenReaderText = {"expand":"rozbalit menu níže","collapse":"sbalit menu níže"};
  /* ]]> */
  </script>
