...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:cc="http://creativecommons.org/ns#" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:dct="http://purl.org/dc/terms/" xmlns:frbr="http://purl.org/vocab/frbr/core#" xml:lang="ru">
<head about="http://creativecommons.org/licenses/by-sa/3.0/">
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
<meta http-equiv="Content-Type" content="application/xhtml+xml; charset=utf-8" />
<title>Creative Commons &mdash; «Attribution-ShareAlike» («Атрибуция — На тех же условиях») 3.0 Непортированная
...
<button id="menu-toggle" class="menu-toggle"><i class="cc-icon-menu"></i> <span>Меню</span></button>
<div id="site-header-menu" class="site-header-menu">
<nav id="mobile-navigation" class="mobile-navigation" role="navigation" aria-label="Mobile Menu">
<div class="menu-mobile-menu-container"><ul id="menu-mobile-menu" class="mobile-menu">
<li id="menu-item-48798" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48798"><a href="https://creativecommons.org/share-your-work/">Делитесь</a></li>
<li id="menu-item-48799" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48799"><a href="https://creativecommons.org/use-remix/">Пользуйтесь</a></li>
...
<li id="menu-item-48801" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48801"><a href="https://creativecommons.org/blog/">Блог</a></li>
...
<li id="menu-item-48803" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48803"><a href="https://creativecommons.org/use-remix/search-the-commons/">Поиск по сайту</a></li>
</ul></div>
</nav>
<nav id="site-navigation" class="main-navigation" role="navigation" aria-label="Primary Menu">
<div class="menu-primary-menu-container"><ul id="menu-primary-menu" class="primary-menu">
<li id="menu-item-48791" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48791"><a href="https://creativecommons.org/share-your-work/">Делитесь</a></li>
<li id="menu-item-48792" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48792"><a href="https://creativecommons.org/use-remix/">Пользуйтесь</a></li>
...
<li id="menu-item-48793" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48793"><a href="https://creativecommons.org/blog/">Блог</a></li>
</ul></div>
</nav>
...
<li id="menu-item-48806" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48806"><a href="https://creativecommons.org/about/contact/">Информация для связи</a></li>
</ul></div>
</nav>
...
<li id="menu-item-48809" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-48809"><a href="mailto:info@creativecommons.org"><span class="screen-reader-text">Эл. почта</span></a></li>
</ul></div>
</nav>
</div>
</div>
...
<p class="donate-text">Помогите нам построить глобальные сообщества - динамичные и проникнутые духом сотрудничества</p>
<div class="donate-action"><a href="https://us.netdonor.net/page/6650/donate/1?ea.tracking.id=deed-top" class="button donate arrow">Пожертвовать<span class="hide-on-mobile"> Сейчас</span></a></div>
</div>
</div>
</div>
</section>
...
<h1><span>Краткое описание лицензии Creative Commons</span></h1>
<div id="deed-license">
<h2>
...
<span class="cc-license-title" property="dc:title dct:title">«Attribution-ShareAlike» («Атрибуция — На тех же условиях») 3.0 Непортированная</span>
...
<h3 style="text-align: center" resource="http://creativecommons.org/ns#Reproduction" rel="cc:permits">Вы можете свободно:</h3>
...
<img src="/images/deed/FreeCulturalWorks_seal_x2.jpg" style="border: 0" alt="Эта лицензия применима для свободных произведений культуры (<i>Free Cultural Works</i>)." />
</a>
...
<li class="license">Лицензиар не вправе аннулировать эти свободы пока вы выполняете условия лицензии.</li>
</ul>
</div>
...
<li class="license">
<strong>Без дополнительных ограничений</strong> &mdash; Вы не вправе применять юридические ограничения или <a href="#" id="technological_measures_popup" class="helpLink">технологические меры</a>, создающие другим юридические препятствия в выполнении чего-либо из того, что разрешено лицензией.
</li>
</ul>
</div>
<div class="row"><div class="col-md-offset-1 col-md-10"><hr /></div></div>
...
<li class="license">
Вам не даётся никаких гарантий. Лицензия может не включать все разрешения, необходимые вам для использования произведения (материала) по вашему замыслу. Например, иные права, такие как <a href="#" id="publicity_privacy_or_moral_rights_popup" class="helpLink">право на обнародование, неприкосновенность частной жизни или неимущественные права</a> могут ограничить вашу возможность использовать данный материал.
</li>
</ul>
</div>
...
<a href="https://wiki.creativecommons.org/FAQ">Узнайте больше</a> о лицензиях CC или <a id="get_this" href="/choose/results-one?license_code=by-sa&amp;amp;jurisdiction=&amp;amp;version=3.0&amp;amp;lang=ru">используйте эту лицензию</a> для своих собственных произведений.
</p>
<noscript>
                  <div id="deed-donate-footer">
                    <div class="footer-trigger">
                      ...
                      <div class="footer-trigger-content">
                        <p>Этот контент свободно доступен на простых юридических условиях благодаря Creative Commons, некоммерческой организации, которая живёт за счёт пожертвований. Если вам нравятся эти материалы и то, что они для всех бесплатны, подумайте о пожертвовании, чтобы поддержать нашу работу.</p>
...
<p class="desktop-only">Этот контент свободно доступен на простых юридических условиях благодаря Creative Commons, некоммерческой организации, которая живёт за счёт пожертвований. Если вам нравятся эти материалы и то, что они для всех бесплатны, подумайте о пожертвовании, чтобы поддержать нашу работу.</p>
<p class="mobile-only">Вы поделились материалами - выиграли все!</p>
...
<label class="gfield_label">Внесите свой вклад в Creative Commons сегодня</label>
...
<input name="transaction.donationAmt.other" type="text" id="input_10_1_other" tabindex="5" style="max-width: 80%" placeholder="Количество" aria-label="Количество">
</li>
</ul>
<input type="hidden" name="type" value="One Time">
<input type="hidden" name="ea.tracking.id" value="deed-overlay">
<input type="submit" id="gform_submit_button_10" class="gform_button button" value="Внести пожертвование" tabindex="6">
</div>
</div>
</form>
</div>
...
<li id="menu-item-48794" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48794"><a href="https://creativecommons.org/about/contact/">Информация для связи</a></li>
<li id="menu-item-48795" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48795"><a href="https://creativecommons.org/privacy/">Конфиденциальность</a></li>
<li id="menu-item-48796" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48796"><a href="https://creativecommons.org/policies/">Правила</a></li>
<li id="menu-item-48797" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-48797"><a href="https://creativecommons.org/terms/">Условия</a></li>
</ul>
</div>
</div>
</div>
<div class="column cc-footer-contact">
<h6><a href="https://creativecommons.org/about/contact">Мы будем рады услышать ваше мнение!</a></h6>
<address>
Creative Commons<br />
...
<li><a href="https://creativecommons.org/faq">Часто задаваемые вопросы</a></li>
</ul>
</div>
...
<div class="hd">
Что означает «Атрибутируйте это произведение»?
</div>
<div class="bd">
<p>Страница, с которой вы пришли, содержит встроенные метаданные о лицензировании, включающие информацию о том, как автор хотел бы быть упомянутым при повторном использовании. Вы можете использовать этот HTML-код для цитирования произведения. Это позволит включить метаданные в вашу страницу и также даст другим хорошую возможность найти оригинал произведения.</p>
</div>
</div>
<div id="help_mediation_and_arbitration_popup" class="help_panel">
<div class="bd">
<p>Применяемые правила посредничества будут указаны в уведомлении об авторских правах, публикуемом вместе с произведением, или, в случае отсутствия такого уведомления, в запросе на осуществление посредничества. В случае отсутствия иных договоренностей, указанных в уведомлении об авторских правах, которое опубликовано вместе с произведением, в отношении любого арбитражного процесса будут применяться Правила Арбитража Комиссии ООН по праву международной торговли (ЮНСИТРАЛ).</p>
<p><a href="https://wiki.creativecommons.org/Intergovernmental_Organizations#What_should_I_know_before_I_use_a_work_licensed_under_the_IGO_3.0_ported_licenses.3F">Подробнее</a>.</p>
</div>
</div>
<div id="help_appropriate_credit_popup" class="help_panel">
<div class="bd">
<p>Вы должны указать имя автора (создателя) произведения (материала) и стороны атрибуции, уведомление об авторских правах, название лицензии, уведомление об оговорке и ссылку на материал, если они предоставлены вместе с материалом. Лицензии CC до версии 4.0 требуют от вас также предоставить, если имеется, название произведения и могут иметь другие небольшие различия.</p>
<p><a href="https://wiki.creativecommons.org/License_Versions#Detailed_attribution_comparison_chart">Подробнее</a>.</p>
</div>
</div>
<div id="help_indicate_changes_popup" class="help_panel">
<div class="bd">
<p>В соответствии с версией лицензии 4.0 вы должны указать внесённые вами изменения в материал и сохранить указания на предыдущие изменения. В соответствии с версией лицензии 3.0 и более ранними версиями лицензий указание внесенных изменений требуется только в случае создания вами производного материала.</p>
<p><a href="https://wiki.creativecommons.org/Best_practices_for_attribution#This_is_a_good_attribution_for_material_you_modified_slightly">Руководство по маркировке контента</a>.</p>
<p><a href="https://wiki.creativecommons.org/License_Versions#Modifications_and_adaptations_must_be_marked_as_such ">Подробнее</a>.</p>
</div>
</div>
<div id="help_same_license_popup" class="help_panel">
<div class="bd">
<p>Вы также можете использовать лицензию, входящую в список совместимых на странице <a href="https://creativecommons.org/compatiblelicenses">https://creativecommons.org/compatiblelicenses</a></p>
<p><a href="https://wiki.creativecommons.org/FAQ#If_I_derive_or_adapt_material_offered_under_a_Creative_Commons_license.2C_which_CC_license.28s.29_can_I_use.3F">Подробнее</a>.</p>
</div>
</div>
<div id="help_commercial_purposes_popup" class="help_panel">
<div class="bd">
<p>Использование в коммерческих целях – это использование, в первую очередь направленное на получение коммерческого преимущества или денежного вознаграждения.</p>
<p><a href="https://wiki.creativecommons.org/Frequently_Asked_Questions#Does_my_use_violate_the_NonCommercial_clause_of_the_licenses.3F">Подробнее</a>.</p>
</div>
</div>
<div id="help_some_kinds_of_mods_popup" class="help_panel">
<div class="bd">
<p>Одно лишь изменение формата не является созданием производного материала.</p>
<p><a href="https://wiki.creativecommons.org/Frequently_Asked_Questions#When_is_my_use_considered_an_adaptation.3F">Подробнее</a>.</p>
</div>
</div>
<div id="help_technological_measures_popup" class="help_panel">
<div class="bd">
<p>Лицензия запрещает применение эффективных технических средств, определённых согласно Статье 11 Договора ВОИС по авторскому праву.</p>
<p><a href="https://wiki.creativecommons.org/License_Versions#Application_of_effective_technological_measures_by_users_of_CC-licensed_works_prohibited">Подробнее</a>.</p>
</div>
</div>
<div id="help_exception_or_limitation_popup" class="help_panel">
<div class="bd">
<p>Права пользователей в соответствии с ограничениями и исключениями, такими как добросовестное использование и честное использование, не затрагиваются лицензиями CC.</p>
<p><a href="https://wiki.creativecommons.org/Frequently_Asked_Questions#Do_Creative_Commons_licenses_affect_exceptions_and_limitations_to_copyright.2C_such_as_fair_dealing_and_fair_use.3F">Подробнее</a>.</p>
</div>
</div>
<div id="help_publicity_privacy_or_moral_rights_popup" class="help_panel">
<div class="bd">
<p>Вам может потребоваться получить дополнительные разрешения на использование этого материала по вашему замыслу.</p>
<p><a href="https://wiki.creativecommons.org/Considerations_for_licensors_and_licensees">Подробнее</a>.</p>
</div>
</div>
</div>
...
<script type='text/javascript'>
  /* <![CDATA[ */
  var screenReaderText = {"expand":"Раскрыть меню нижнего уровня","collapse":"Свернуть меню нижнего уровня"};
  /* ]]> */
  </script>
