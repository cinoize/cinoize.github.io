...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:cc="http://creativecommons.org/ns#" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:dct="http://purl.org/dc/terms/" xmlns:frbr="http://purl.org/vocab/frbr/core#" xml:lang="be">
<head about="http://creativecommons.org/licenses/by-sa/3.0/">
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
<meta http-equiv="Content-Type" content="application/xhtml+xml; charset=utf-8" />
<title>Creative Commons &mdash; Пазначэнне аўтарства - На тых самых умовах 3.0 Непартаваная
...
<div class="donate-action"><a href="https://us.netdonor.net/page/6650/donate/1?ea.tracking.id=deed-top" class="button donate arrow">Donate<span class="hide-on-mobile"> Now</span></a></div>
</div>
</div>
</div>
</section>
...
<span class="cc-license-title" property="dc:title dct:title">Пазначэнне аўтарства - На тых самых умовах 3.0 Непартаваная</span>
...
<h3 style="text-align: center" resource="http://creativecommons.org/ns#Reproduction" rel="cc:permits">Вы можаце:</h3>
...
<img src="/images/deed/FreeCulturalWorks_seal_x2.jpg" style="border: 0" alt="Гэта ліцэнзія прымальная для твораў Свабоднай культуры." />
</a>
...
<li class="license">Ліцэнзіяр не можа ануляваць гэтыя свабоды пакуль вы прытрымліваецеся ліцэнзіных палажэнняў.</li>
</ul>
</div>
...
<li class="license by">
<p>
<strong>Пазначэнне аўтарства</strong> &mdash; <span rel="cc:requires" resource="http://creativecommons.org/ns#Attribution">Вы павінны даць <a href="#" id="appropriate_credit_popup" class="helpLink">адпаведны давер</a></span>, прадаставіць спасылку на ліцэнзію і <span rel="cc:requires" resource="http://creativecommons.org/ns#Notice"><a href="#" id="indicate_changes_popup" class="helpLink">абазначыць, калі былі нейкія змены</a></span>. Вы можаце рабіць гэтак жа у любой суадноснай манеры, але не шляхам падтрымкі вас або вашага выкарыстання ліцэнзіярам.
<span id="by-more-container"></span>
</p>
<p id="work-attribution-container" style="display:none;">
<strong>
Пазначце аўтара гэтага твору:
</strong>
<br />
...
<img src="/images/information.png" alt="Інфармацыя" />
</a>
</p>
</li>
<li class="license sa" rel="cc:requires" resource="http://creativecommons.org/ns#ShareAlike">
<p>
<strong>На тых самых умовах</strong> &mdash; Калі вы рэміксуеце, або робіце твор на гатовым матэрыяле, вы павінны распаўсюджваць ваш унёсак пад <a href="#" id="same_license_popup" class="helpLink">гэткай жа ліцэнзіяй</a> як арыгінальная.
...
<li class="license">
<strong>Няма дададковых абмежаванняў</strong> &mdash; Вы не можаце прымяніць юрыдычныя палажэнні або <a href="#" id="technological_measures_popup" class="helpLink">тэхналагічныя меры</a> што легальна абмяжоўваюць іншых асоб рабіць усё згодна ліцэнзійных дазволаў.
</li>
</ul>
</div>
<div class="row"><div class="col-md-offset-1 col-md-10"><hr /></div></div>
...
<li class="license">
Гарантыя не дадзена. Гэта ліцэнзія не можа даваць вам любых дазволаў, якія б вы намераваліся мець. Напрыклад, іншыя правы такія як <a href="#" id="publicity_privacy_or_moral_rights_popup" class="helpLink">публічнае, прыватнае, або маральныя правы</a> могуць абмяжоўваць выкарыстанне матэрыяла.
</li>
</ul>
</div>
...
<a href="https://wiki.creativecommons.org/FAQ">Чытайце больш падрабязна</a> пра ліцэнзаванне CC ці <a id="get_this" href="/choose/results-one?license_code=by-sa&amp;amp;jurisdiction=&amp;amp;version=3.0&amp;amp;lang=be">выкарыстоўвайце ліцэнзію</a> для вашых асабістых матэрыялаў.
</p>
<noscript>
                  <div id="deed-donate-footer">
                    <div class="footer-trigger">
                      ...
                      <div class="footer-trigger-content">
                        <p>Гэты кантэнт знаходзіцца ў свабодным доступе і можа выкарыстоўвацца на спрошчаных юрыдычных умовах дзякуючы Creative Commons, некамерцыйнай арганізацыі, якая працягвае інсаванне на ахвярванні. Калі вам падабаецца гэты кантэнт і падабаецца тое, што ён даступны кожнаму, калі ласка, падумайце пра ахвяраванні на падтрмку нашай працы.  </p>
...
<p class="desktop-only">Гэты кантэнт знаходзіцца ў свабодным доступе і можа выкарыстоўвацца на спрошчаных юрыдычных умовах дзякуючы Creative Commons, некамерцыйнай арганізацыі, якая працягвае інсаванне на ахвярванні. Калі вам падабаецца гэты кантэнт і падабаецца тое, што ён даступны кожнаму, калі ласка, падумайце пра ахвяраванні на падтрмку нашай працы. </p>
<p class="mobile-only">When you share, everyone wins.</p>
...
<label class="gfield_label">Contribute today to Creative Commons</label>
...
<input name="transaction.donationAmt.other" type="text" id="input_10_1_other" tabindex="5" style="max-width: 80%" placeholder="Amount" aria-label="Amount">
</li>
</ul>
<input type="hidden" name="type" value="One Time">
<input type="hidden" name="ea.tracking.id" value="deed-overlay">
<input type="submit" id="gform_submit_button_10" class="gform_button button" value="Ахвяруйце зараз" tabindex="6">
</div>
</div>
</form>
</div>
...
<li><a href="https://creativecommons.org/faq">Часта задаваныя пытанні</a></li>
</ul>
</div>
...
<div class="hd">
Што азначае "Пазначце аўтара гэтага твору"?
</div>
<div class="bd">
<p>Старонка, з якой вы прыйшлі, утрымоўвае ўбудаваныя ліцэнзійныя метададзеныя, якія ўключаюць інфармацыю пра тое, як творца жадаў бы быць згаданым пры паўторным выкарыстанні яго твору. Вы можаце выкарыстоўваць гэты HTML-код для цытавання твору. Гэта дазволіць уключыць метададзеныя ў вашу старонку, такім чынам іншыя змогуць знайсці арыгінал.</p>
</div>
</div>
<div id="help_mediation_and_arbitration_popup" class="help_panel">
<div class="bd">
<p>Дастасоўныя правілы медыяцыі будуць абазначаны ў зацемцы аўтарскага права апублікаванага з творам, або, калі няма такой пазнакі, тады ў запыце на медыяцыю. Калі не абазначана іначай у паведамленні аўтарскага права далучанага да твору, прымяняюцца правілы арбітражу Камісіі ААН па праву міжнароднага гандлю - UNCITRAL.</p>
<p><a href="https://wiki.creativecommons.org/Intergovernmental_Organizations#What_should_I_know_before_I_use_a_work_licensed_under_the_IGO_3.0_ported_licenses.3F">Больш інфармацыі</a>.</p>
</div>
</div>
<div id="help_appropriate_credit_popup" class="help_panel">
<div class="bd">
<p>Калі прапанаваны заўвагі, ліцэнзійныя заўвагі, адмовы ад адказнасці, спасылкі на матэрыял, вы павінны прадаставіць імя стваральніка і пазнакі іншых удзельнікаў. Ліцэнзіі СС да версіі 4.0 таксама патрабуюць прадаставіць назву матэрыяла, калі зроблены і іншыя невялікія праўкі.</p>
<p><a href="https://wiki.creativecommons.org/License_Versions#Detailed_attribution_comparison_chart">Больш інфармацыі</a>.</p>
</div>
</div>
<div id="help_indicate_changes_popup" class="help_panel">
<div class="bd">
<p>У версіі 4.0, вы павінны ўказаць, калі вы мадыфікавалі гэты матэрыял або адзнаку аб папярэдніх мадыфікацыях. У версіі 3.0 і ранейшых версіях ліцэнзій пазнака зменаў неабходная, толькі калі вы стварылі залежны твор.</p>
<p><a href="https://wiki.creativecommons.org/Best_practices_for_attribution#This_is_a_good_attribution_for_material_you_modified_slightly">Падручнік пазначэнняў</a>.</p>
<p><a href="https://wiki.creativecommons.org/License_Versions#Modifications_and_adaptations_must_be_marked_as_such ">Больш інфармацыі</a>.</p>
</div>
</div>
<div id="help_same_license_popup" class="help_panel">
<div class="bd">
<p>Вы можаце таксама выкарыстоўваць ліцэнзію сумяшчальную з <a href="https://creativecommons.org/compatiblelicenses">https://creativecommons.org/compatiblelicenses</a></p>
<p><a href="https://wiki.creativecommons.org/FAQ#If_I_derive_or_adapt_material_offered_under_a_Creative_Commons_license.2C_which_CC_license.28s.29_can_I_use.3F">Больш інфармацыі</a>.</p>
</div>
</div>
<div id="help_commercial_purposes_popup" class="help_panel">
<div class="bd">
<p>Камерцыйнае выкарыстанне - гэта галоўным чынам намер атрымаць камерцыйную выгоду або грашовую кампенсацыю. </p>
<p><a href="https://wiki.creativecommons.org/Frequently_Asked_Questions#Does_my_use_violate_the_NonCommercial_clause_of_the_licenses.3F">Больш інфармацыі</a>.</p>
</div>
</div>
<div id="help_some_kinds_of_mods_popup" class="help_panel">
<div class="bd">
<p>Адна змена фармату не стварае залежнага твору.</p>
<p><a href="https://wiki.creativecommons.org/Frequently_Asked_Questions#When_is_my_use_considered_an_adaptation.3F">Больш інфармацыі</a>.</p>
</div>
</div>
<div id="help_technological_measures_popup" class="help_panel">
<div class="bd">
<p>Ліцэнзія забараняе прымяняць эфектыўныя тэхналагічныя сродкі, вызначыная спасылкай на Артыкул 11 Дамовы Аб Аўтарскім Праве САІУ - WIPO Copyright Treaty.</p>
<p><a href="https://wiki.creativecommons.org/License_Versions#Application_of_effective_technological_measures_by_users_of_CC-licensed_works_prohibited">Больш інфармацыі</a>.</p>
</div>
</div>
<div id="help_exception_or_limitation_popup" class="help_panel">
<div class="bd">
<p>Такія выключэнні і абмежаванні правой карыстальнікаў як добрасумленнае выкарыстанне і чэсная дзелавая практыка не падпадаюць пад уздзеянне СС ліцэнзіяў. </p>
<p><a href="https://wiki.creativecommons.org/Frequently_Asked_Questions#Do_Creative_Commons_licenses_affect_exceptions_and_limitations_to_copyright.2C_such_as_fair_dealing_and_fair_use.3F">Больш інфармацыі</a>.</p>
</div>
</div>
<div id="help_publicity_privacy_or_moral_rights_popup" class="help_panel">
<div class="bd">
<p>Вам магчыма неабходна атрымаць дадатковыя доступы перад выкарыстаннем матэрыялы, якія вы жадаеце.</p>
<p><a href="https://wiki.creativecommons.org/Considerations_for_licensors_and_licensees">Больш інфармацыі</a>.</p>
</div>
</div>
</div>
